...
if(namaUser1.equals("Employee")){
    flyout.addMenuFlyOut("employee.jsp", "Employee", dictionaryD.getWord("DATA_BANK"), false, null, "data_bank", ""+approot+"/employee/databank/employee_view_new.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("employee.jsp", "Employee", "Form Schedule", true, "Form Schedule Change", "employee", "#", ""+approot+"/employee/formschedulechange/emp_schedule_change.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_FORM_SCHEDULE_CHANGE, AppObjInfo.OBJ_MENU_FRM_SCHEDULE_CHANGE), 
             AppObjInfo.COMMAND_VIEW)));
flyout.addMenuFlyOut("employee.jsp", "Employee", "Form Schedule", true, "Form Schedule EO", "employee", "#", ""+approot+"/employee/formschedulechange/emp_schedule_EO.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_FORM_SCHEDULE_CHANGE, AppObjInfo.OBJ_MENU_FRM_SCHEDULE_EO), 
             AppObjInfo.COMMAND_VIEW)));
flyout.addMenuFlyOut("employee.jsp", "Employee", "Form Schedule", true, "Form Schedule EH", "employee", "#", ""+approot+"/employee/formschedulechange/emp_schedule_EH.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_FORM_SCHEDULE_CHANGE, AppObjInfo.OBJ_MENU_FRM_SCHEDULE_EH), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("training.jsp", "Training", dictionaryD.getWord(I_Dictionary.TRAINING_TYPE), false, null, "training_type", ""+approot+"/masterdata/list_train_type.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_TYPE, AppObjInfo.OBJ_MENU_TRAINING_TYPE), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("training.jsp", "Training", dictionaryD.getWord(I_Dictionary.TRAINING_VENUE), false, null, "training_venue", ""+approot+"/masterdata/list_train_venue.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_VANUE, AppObjInfo.OBJ_MENU_TRAINING_VANUE), 
             AppObjInfo.COMMAND_VIEW)));
			 			 
flyout.addMenuFlyOut("training.jsp", "Training", dictionaryD.getWord(I_Dictionary.TRAINING_PROGRAM), false, null, "training_program", ""+approot+"/masterdata/srctraining.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_PROGRAM, AppObjInfo.OBJ_MENU_TRAINING_PROGRAM), 
             AppObjInfo.COMMAND_VIEW)));
			 	 
flyout.addMenuFlyOut("training.jsp", "Training", dictionaryD.getWord(I_Dictionary.TRAINING_PLAN), false, null, "training_plan", ""+approot+"/employee/training/training_plan_list.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_PLAN, AppObjInfo.OBJ_MENU_TRAINING_PLAN), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("training.jsp", "Training", dictionaryD.getWord(I_Dictionary.TRAINING_ACTUAL), false, null, "training_actual", ""+approot+"/employee/training/training_actual_list.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_ACTUAL, AppObjInfo.OBJ_MENU_TRAINING_ACTUAL), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("training.jsp", "Training", dictionaryD.getWord(I_Dictionary.TRAINING_SEARCH), false, null, "training_search", ""+approot+"/employee/training/search_training.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("training.jsp", "Training", dictionaryD.getWord(I_Dictionary.TRAINING_HISTORY), false, null, "training_history", ""+approot+"/employee/training/src_training_hist_hr.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("training.jsp", "Training", "Training Organizer", false, null, "training_organizer", ""+approot+"/masterdata/contact/srccontact_list.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("training.jsp", "Training", dictionaryD.getWord(I_Dictionary.ORGANIZER_TYPE), false, null, "training_organizer", ""+approot+"/masterdata/contact/contact_class.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_ORGANIZER , AppObjInfo.OBJ_TRAINING_ORGANIZER_CONTACT ), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("master_data.jsp", "Master Data", dictionaryD.getWord(I_Dictionary.COMPANY), true, dictionaryD.getWord(I_Dictionary.POSITION), "company", "#", ""+approot+"/masterdata/srcposition.jsp",userSession.checkPrivilege(AppObjInfo.composeCode(
             ...
             AppObjInfo.COMMAND_VIEW)));
flyout.addMenuFlyOut("master_data.jsp", "Master Data", dictionaryD.getWord(I_Dictionary.COMPANY), true, dictionaryD.getWord(I_Dictionary.POSITION) + dictionaryD.getWord(I_Dictionary.GROUP) , "company", "#", ""+approot+"/masterdata/positiongroup.jsp",userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_MASTERDATA, AppObjInfo.G2_MENU_MD_COMPANY, AppObjInfo.OBJ_MENU_POSITION), 
             AppObjInfo.COMMAND_VIEW)));
