...
<%!    public String drawList(Vector objectClass, long warningId) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add("" + warning.getValidUntil());
            rowx.add("" + PstWarning.namaSatuanValidUntil[warning.getSatuanValidUntil()]);                              
                                                                                                ...
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                                                    ...
                                                                                                    <tr align="left" valign="top">
                                                                                                     ...
                                                                                                     <tr align="left" valign="top">
                                                                                                        ...
                                                                                                        <td height="21" colspan="2" width="92%">
                                                                                                            <input type="text" name="<%=frmWarning.fieldNames[FrmWarning.FRM_FIELD_VALID_UNTIL]%>"  value="<%= "" + warning.getValidUntil()%>" class="formElemen" size="40">
                                                                                                            * <%= frmWarning.getErrorMsg(FrmWarning.FRM_FIELD_VALID_UNTIL)%>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                     <tr align="left" valign="top">
                                                                                                        <td height="21" valign="top" width="1%">&nbsp;</td>
                                                                                                        ...
                                                                                                        <td height="21" colspan="2" width="92%">
                                                                                                            <select name="<%=frmWarning.fieldNames[FrmWarning.FRM_FIELD_SATUAN_VALID_UNTIL]%>">
                                                                                                                <%
                                                                                                                    for(int xy = 0 ; xy < PstWarning.namaSatuanValidUntil.length; xy++ ){
                                                                                                                        String selected = "";
                                                                                                                        if(warning.getSatuanValidUntil()>=0){
                                                                                                                            if(warning.getSatuanValidUntil() == xy){
                                                                                                                                selected = "selected";
                                                                                                                            }else{
                                                                                                                                 selected = "";
                                                                                                                            }
                                                                                                                        ...
                                                                                                                        <option value="<%=xy%>" <%=selected%>><%=PstWarning.namaSatuanValidUntil[xy]%></option>
                                                                                                                        <%
                                                                                                                    } 
                                                                                                                %> 
                                                                                                            </select>
