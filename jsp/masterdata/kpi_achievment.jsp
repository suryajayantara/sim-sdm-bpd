                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="listgensell" colspan="3" style="padding: 10px">
                                                                                                    ...
                                                                                                    <table class="listgen" width="100%" cellspacing="1" border="0">
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td class="listgensell">
                                                                                                                    <input class="achievement" type="number" id="achievement-<%=targetDetail.getOID()%>" value="<%=objKpiEmployeeAchiev.getAchievement()%> "<%= score%>>%
                                                                                                                </td>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <select class="status" id="status-<%=targetDetail.getOID()%>">
                                                                                                                        <%
                                                                                                                            ...
                                                                                                                            if (objKpiEmployeeAchiev.getStatus() == PstKPI_Employee_Achiev.TYPE_TO_BE_APPROVE) {
                                                                                                                                ToBeApprove = "selected";
                                                                                                                            }
                                                                                                                            if (objKpiEmployeeAchiev.getStatus() == PstKPI_Employee_Achiev.TYPE_TO_BE_CORRECTED) {
                                                                                                                                ToBeCorrected = "selected";
                                                                                                                            }
                                                                                                                        %>
                                                                                                                        ...
                                                                                                                        <option value="<%=PstKPI_Employee_Achiev.TYPE_IN_PROGRESS%>">
                                                                                                                            <%=PstKPI_Employee_Achiev.typeAchiev[PstKPI_Employee_Achiev.TYPE_IN_PROGRESS]%></option>
                                                                                                                        <option value="<%=PstKPI_Employee_Achiev.TYPE_FINISH%>"><%=PstKPI_Employee_Achiev.typeAchiev[PstKPI_Employee_Achiev.TYPE_FINISH]%>
                                                                                                                        </option> 
                                                                                                                        <option value="<%=PstKPI_Employee_Achiev.TYPE_TO_BE_APPROVE%>">
                                                                                                                            <%=PstKPI_Employee_Achiev.typeAchiev[PstKPI_Employee_Achiev.TYPE_TO_BE_APPROVE]%>
                                                                                                                        </option>
                                                                                                                        <option value="<%=PstKPI_Employee_Achiev.TYPE_TO_BE_CORRECTED%>">
                                                                                                                            <%=PstKPI_Employee_Achiev.typeAchiev[PstKPI_Employee_Achiev.TYPE_TO_BE_CORRECTED]%>
                                                                                                                        </option>
                                                                                                                    </select>
                                                                                                                </td>
                                                                                                                                                                                                                                <%
                                                                                                        ...
                                                                                                        <input type="hidden" id="targetId-<%=targetDetail.getOID()%>" value="<%=objKpiEmployeeAchiev.getTargetId() %>">
                                                                                                        <input type="hidden" id="employeeId-<%=targetDetail.getOID()%>" value="<%=empId%>"> 
                                                                                                        <input type="hidden" name="<%=FrmKPI_Employee_Achiev.fieldNames[FrmKPI_Employee_Achiev.FRM_FIELD_KPI_EMPLOYEE_ACHIEV_ID]%>" id="oidKpiEmployeeAchiev-<%=targetDetail.getOID()%>" value="<%=objKpiEmployeeAchiev.getOID()%>">
                                                                                                        </tr>
                                                                                                        <%
                                                                                                            }
                                                                                                        %>
...
<script language="JavaScript">
        $("body").on("change", ".achievement, .status, .notes", function (e) {
            ...
            const employeeAchievId = parseInt($("#oidKpiEmployeeAchiev-" + targetDetail).val());
            const data = {
    ...
    <%=FrmKPI_Employee_Achiev.fieldNames[FrmKPI_Employee_Achiev.FRM_FIELD_KPI_EMPLOYEE_ACHIEV_ID]%>: employeeAchievId
            }
            if (achievement < 0) {
