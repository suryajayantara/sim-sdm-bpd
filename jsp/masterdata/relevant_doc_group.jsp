...
<!--script type="text/javascript">
    function loadSystem(str) {
        if (str.length == 0) { 
            ...
            xmlhttp.open("GET", "relevant_doc_group_ajax.jsp?hidden_doc_group_id=" + str, true);
            xmlhttp.send();
        }
    }
    ...
    function loadModul(str) {
        if (str.length == 0) { 
            ...
            xmlhttp.open("GET", "relevant_doc_group_ajax.jsp?<!--%=PstEmpRelevantDocGroup.fieldNames[PstEmpRelevantDocGroup.FLD_SYSTEM_NAME]%--><!--=" + str, true);
            xmlhttp.send();-->
    <!--    }
    }-->
<!--/script-->
