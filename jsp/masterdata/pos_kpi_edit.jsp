    ...
    <body>
        ...
        <table>
            ...
            <tr>
                ...
                <td valign="top"><input maxlength="6" type="text" name="<%=frmPosKpi.fieldNames[frmPosKpi.FRM_FIELD_DURATION_MONTH]%>" value="<%=posKpi.getDurationMonth()%>" /></td>
            </tr>
            <tr>
                <td valign="top">Minimum Achievment</td>
                <td valign="top"><input maxlength="6" type="text" name="<%=frmPosKpi.fieldNames[frmPosKpi.FRM_FIELD_KPI_MIN_ACHIEVMENT]%>" value="<%=posKpi.getKpiMinAchievment()%>" /></td>
            </tr>
            <tr>
                <td valign="top">Recommended Achievment</td>
                <td valign="top"><input maxlength="6" type="text" name="<%=frmPosKpi.fieldNames[frmPosKpi.FRM_FIELD_KPI_RECOMMEND_ACHIEV]%>" value="<%=posKpi.getKpiRecommendAchiev()%>" /></td>
            </tr>
            <tr>
                <td valign="top">Score Minimum</td>
                <td valign="top"><input maxlength="4" type="text" name="<%=frmPosKpi.fieldNames[frmPosKpi.FRM_FIELD_SCORE_MIN]%>" value="<%=posKpi.getScoreMin()%>" /></td>
            </tr>
            <tr>
                <td valign="top">Score Recommended</td>
                <td valign="top">
                    <input type="text" maxlength="4" name="<%=frmPosKpi.fieldNames[frmPosKpi.FRM_FIELD_SCORE_RECOMMENDED]%>" value="<%=posKpi.getScoreRecommended()%>" />
                </td>
            </tr>
            <tr>
