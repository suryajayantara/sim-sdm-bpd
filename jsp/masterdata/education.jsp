                                                  ...
                                                  <table cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <tr> 
                                                      ...
                                                      <td height="22" valign="middle" colspan="3" width="951"><a href="javascript:cmdAdd()" class="command">
                                                              <%=dictionaryD.getWord(I_Dictionary.ADD_NEW_EDUCATION)%>
                                                          </a> </td>
                                                    </tr>
                                                  </table>
                                                </td>
                                          ...
                                          <td height="8" valign="middle" colspan="3"> 
                                            ...
                                            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                              ...
                                              <tr align="left" valign="top"> 
                                                ...
                                                <td height="21" colspan="2" width="92%"> 
                                                  <input type="text" name="<%=frmEducation.fieldNames[FrmEducation.FRM_FIELD_EDUCATION_LEVEL] %>"  value="<%= ""+education.getEducationLevel() %>" class="formElemen" size="20">
