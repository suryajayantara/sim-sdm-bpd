                                                            ...
                                                            <table style="color:#474747; background-color: #E3E3E3; padding:12px" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <tr>
                                                                            <th valign="middle">Full Access</th>
                                                                            <td>&nbsp;</td>
                                                                            <td valign="middle">
                                                                                <%
                                                                                if (customField.getFullAccess()==0){
                                                                                    %>
                                                                                    <input type="radio" name="<%=FrmCustomFieldMaster.fieldNames[FrmCustomFieldMaster.FRM_FIELD_FULL_ACCESS]%>" value="0" checked="checked" />No
                                                                                    <input type="radio" name="<%=FrmCustomFieldMaster.fieldNames[FrmCustomFieldMaster.FRM_FIELD_FULL_ACCESS]%>" value="1" />Yes
                                                                                    <%
                                                                                } else {
                                                                                    %>
                                                                                    <input type="radio" name="<%=FrmCustomFieldMaster.fieldNames[FrmCustomFieldMaster.FRM_FIELD_FULL_ACCESS]%>" value="0" />No
                                                                                    <input type="radio" name="<%=FrmCustomFieldMaster.fieldNames[FrmCustomFieldMaster.FRM_FIELD_FULL_ACCESS]%>" value="1" checked="checked" />Yes
                                                                                    <%
                                                                                }
                                                                                %>
