...
<% 
/* 
 * Page Name  		:  kpi_company_target_real.jsp
...
%>
<!-- Jsp Block -->
<%!    public String drawList(int iCommand, Vector objectClass, long kpi_company_target_realId, FrmKPI_Company_Target frmObject, int tahun, long kpiListId) {
	...
	//	    total = total + kPI_Company_Target.getTarget();
         //           
           //     }    
            ...
            lstData.add(rowx);
           // lstLinkData.add(String.valueOf(kpi_company_target_real.getOID()));
...
<%!
	...
	public String drawListAll(JspWriter outJsp,int iCommand, Hashtable objectClass, long kpi_company_target_realId, FrmKPI_Company_Target frmObject, int tahun, long kpiListId, long companyId, long divId, Hashtable HDepartment,Vector VDepartment,long depId, Hashtable HSection,Vector VSection,long secId, Hashtable HEmployee,Vector VEmployee)
{
		ControlList ctrlist = new ControlList();
                ctrlist.setAreaWidth("150%");
                ctrlist.setListStyle("listgen");
...
<%!
	...
	public String drawListAllEdit(JspWriter outJsp,int iCommand, Hashtable objectClass, long kpi_company_target_realId, FrmKPI_Company_Target frmObject, int tahun, long kpiListId, long companyId, long divId, Hashtable HDepartment,Vector VDepartment,long depId, Hashtable HSection,Vector VSection,long secId, Hashtable HEmployee,Vector VEmployee)
{
		ControlList ctrlist = new ControlList();
                ctrlist.setAreaWidth("150%");
                ctrlist.setListStyle("listgen");
...
<%!
	...
	public String drawListDiv(JspWriter outJsp,int iCommand, Hashtable objectClass, long kpi_company_target_realId, FrmKPI_Company_Target frmObject, int tahun, long kpiListId, long companyId)
{
		ControlList ctrlist = new ControlList();
                ctrlist.setAreaWidth("150%");
                ctrlist.setListStyle("listgen");
...
<%!
	...
	public String drawListDep(JspWriter outJsp,int iCommand, Hashtable objectClass, long kpi_company_target_realId, FrmKPI_Company_Target frmObject, int tahun, long kpiListId, long companyId, Vector VDepartment)
{
		ControlList ctrlist = new ControlList();
                ctrlist.setAreaWidth("150%");
                ctrlist.setListStyle("listgen");
...
<%!
	...
	public String drawListSec(JspWriter outJsp,int iCommand, Hashtable objectClass, long kpi_company_target_realId, FrmKPI_Company_Target frmObject, int tahun, long kpiListId, long companyId, Vector VSection)
{
		ControlList ctrlist = new ControlList();
                ctrlist.setAreaWidth("150%");
                ctrlist.setListStyle("listgen");
...
<%!
	...
	public String drawListEmp(JspWriter outJsp,int iCommand, Hashtable objectClass, long kpi_company_target_realId, FrmKPI_Company_Target frmObject, int tahun, long kpiListId, long companyId, Vector VEmp)
{
		ControlList ctrlist = new ControlList();
                ctrlist.setAreaWidth("150%");
                ctrlist.setListStyle("listgen");
...
<%
            ...
            long oidKPI_Company_Target = FRMQueryString.requestLong(request, "hidden_kpi_company_target_real_id");
          ...
          //  }
           ...
           VEmployee = PstEmployee.list(0, 0, " SECTION_ID = "+secId,"");
            ...
            KPI_Company_Target kpi_company_target_real = ctrlKPI_Company_Target.getdKPI_Company_Target();
          ...
          //  listKPI_Company_Target = PstKPI_Company_Target.list(start, recordToGet, whereClause, orderClause);
           ...
           //cek dulu sudah ada atau tidak kpi company targetnya
            ...
            if ((iCommand == Command.SAVE) && (iErrCode == FRMMessage.NONE)) {
                //start = PstKPI_Company_Target.findLimitStart(kpi_company_target_real.getOID(),recordToGet, whereClause);
                oidKPI_Company_Target = kpi_company_target_real.getOID();
            }
...
function cmdAdd(){
	...
	document.frmKPI_Company_Target.action="kpi_company_target_real.jsp";
...
function cmdSaveModif(type){
	...
	document.frmKPI_Company_Target.action="kpi_company_target_real.jsp?type = "+type;
	document.frmKPI_Company_Target.submit();
}
...
function cmdDep(divId){
	...
	document.frmKPI_Company_Target.action="kpi_company_target_real.jsp?divId = "+divId;
	document.frmKPI_Company_Target.submit();
}
...
function cmdSec(depId){
	...
	document.frmKPI_Company_Target.prev_command.value="<%=prevCommand%>";
        ...
        document.frmKPI_Company_Target.secId.value=0;
	document.frmKPI_Company_Target.action="kpi_company_target_real.jsp?depId = "+depId;
	document.frmKPI_Company_Target.submit();
}
function cmdEmp(secId){
	...
	document.frmKPI_Company_Target.action="kpi_company_target_real.jsp?secId = "+secId;
	document.frmKPI_Company_Target.submit();
}
function cmdEditDep(divisiId,tahun,kpilistId,companyId){
	...
	document.frmKPI_Company_Target.command.value="<%=Command.EDIT%>";
	document.frmKPI_Company_Target.prev_command.value="<%=prevCommand%>";
	document.frmKPI_Company_Target.action="kpi_company_target_real.jsp?divisiOid= "+divisiId+"";
	document.frmKPI_Company_Target.submit();
}
