       ...
       <div class="box">
        ...
        <div class="content-main">
           ...
           <!--data ini akan muncul ketika user klik detail pada kpi setting list-->
                ...
                <div>&nbsp;</div>
                <div>Sasaran Kinerja</div>
                         <table class="tblStyle" style="width: 100%;">
                              <tr>
                                <td class="title_tbl"></td>
                                <td class="title_tbl"><center>KPI Group</center></td>
                                <td class="title_tbl"></td>
                                <td class="title_tbl"><center>Key Performance Indicator</center></td>
                                <td class="title_tbl"><center>Distribution Option</center></td>
                                <td class="title_tbl"><center>Satuan Ukur</center></td>
                                <td class="title_tbl"><center>Target</td>
                                <td class="title_tbl"><center>Bobot</center></td>
                              </tr>
