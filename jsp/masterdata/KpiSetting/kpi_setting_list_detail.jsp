...
<% 
    ...
    /*controller bisa untuk menampilkan data berdasarkan oid, bisa kok,sans, karena menggunakan icommand EDIT, yang dimana di CTRL itu comand edit ngefetch data berdasarkan oid*/ 
