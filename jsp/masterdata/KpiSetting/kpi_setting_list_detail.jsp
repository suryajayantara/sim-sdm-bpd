                ...
                <table class="tblStyle" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <tr style="background-color: #F3f3f3;">
                            <td class="p-3" value="<%= objKpiGroup.getOID()%>" style="font-size: 20px"><%= objKpiGroup.getGroup_title()%> </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <!-- table kpi list -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="5%" class="text-center">
                                                ...
                                                <a href="javascript:cmdEditKpiSettingTarget('<%=kpiSetting.getOID()%>','<%=objKpiGroup.getOID() %>','<%=entKpiList.getOID() %>')" style="color: #FFF; background-color: #ffc107;"  class="btn-small">Edit</a>
                                            </td>
                                            <td> - </td>
                                        </tr>
...
//            }
            ...
            function cmdEditKpiSettingTarget(oidKpiSetting, oidKpiGroup, oidKpiList) {
                ...
                document.FRM_NAME_KPISETTINGLIST.command.value = "<%= Command.EDIT%>";
                document.FRM_NAME_KPISETTINGLIST.action = "kpi_setting_target.jsp";
