                    ...
                    %>
                        <div style="margin-bottom: 1rem;">
                            ...
                            <table class="tblStyle" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th class="title_tbl" style="text-align: center;">No.</th>
                                ...
                                <tbody>
                                    <%
                                        Vector vKpiSettingGroup = PstKpiSettingGroup.list(0, 0, PstKpiSettingGroup.fieldNames[PstKpiSettingGroup.FLD_KPI_SETTING_GROUP_ID] + " = " + entKpiSettingType.getOID(), "");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <table class="tblStyle" style="width: 100%;">
                                                    <thead>
                                                        <tr>
                                                            <th class="title_tbl"><center>No.</center></th>
                                                            <th class="title_tbl"><center>Key Performance Indicator</center></th>
                                                            <th class="title_tbl"><center>Distribution Option</center></th>
                                                            <th class="title_tbl"><center>Satuan Ukur</center></th>
                                                            <th class="title_tbl"><center>Target</center></th>
                                                            <th class="title_tbl"><center>Bobot</center></th>
                                                            <th class="title_tbl"><center>Action</center></th>
                                                        </tr>
                                                    </thead>

                                                    <tbody>
                                                        <%
                                                            Vector vKpiSettingList = PstKpiSettingList.list(0, 0, PstKpiSettingList.fieldNames[PstKpiSettingList.FLD_KPI_SETTING_LIST_ID] + " = " + entKpiSettingGroup.getOID(), "");
                                                            for(int k = 0; k < vKpiSettingList.size(); k++){
                                                                KpiSettingList entKpiSettingList = (KpiSettingList) vKpiSettingList.get(k);
                                                                KPI_List entKpiList = PstKPI_List.fetchExc(entKpiSettingList.getKpiListId());
                                                                KpiDistribution entKpiDistribution = PstKpiDistribution.fetchExc(entKpiSettingList.getKpiDistributionId());
