...
long historyType = FRMQueryString.requestLong(request, FrmEmpDocListMutation.fieldNames[FrmEmpDocListMutation.FRM_FIELD_HISTORY_TYPE]);
long historyGroup = FRMQueryString.requestLong(request, FrmEmpDocListMutation.fieldNames[FrmEmpDocListMutation.FRM_FIELD_HISTORY_GROUP]);
                                                                                          ...
                                                                                          <tr>
                                                                                                ...
                                                                                                <%=ControlDate.drawDateWithStyle(FrmEmpDocListMutation.fieldNames[FrmEmpDocListMutation.FRM_FIELD_WORK_FROM], dateF == null ? empDocListMutation.getWorkFrom() : dateF, 20, -150, "formElemen")%> 
                                                                                                  ...
                                                                                                  <tr> 
                                                                                                    ...
                                                                                                    <td width="1%">:</td>
                                                                                                    <td width="80%"> 
                                                                                                    <select name="<%=FrmEmpDocListMutation.fieldNames[FrmEmpDocListMutation.FRM_FIELD_HISTORY_GROUP]%>">
                                                                                                        <%
                                                                                                        for(int g=0; g<PstCareerPath.historyGroup.length; g++){
                                                                                                            if (empDocListMutation.getHistoryGroup() == g){
                                                                                                                %>
                                                                                                  ...
                                                                                                  <tr> 
                                                                                                    ...
                                                                                                    <td width="1%">:</td>
                                                                                                    <td width="80%"> 
                                                                                                    <select name="<%=FrmEmpDocListMutation.fieldNames[FrmEmpDocListMutation.FRM_FIELD_HISTORY_TYPE]%>">
                                                                                                        <%
                                                                                                        for(int t=0; t<PstCareerPath.historyType.length; t++){
                                                                                                            if (empDocListMutation.getHistoryType() == t){
                                                                                                                %>
