        ...
        for (int i = 0; i < listGradeLevel.size(); i++) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn-small-1" style="color:#575757;" href="javascript:cmdSetAsMin('<%=gradeLevel.getOID()%>','<%= gradeLevel.getCodeLevel() %>')">Set Min</a>
                    
                    &nbsp;
                    
                    <a class="btn-small-1" style="color:#575757;" href="javascript:cmdSetAsMax('<%=gradeLevel.getOID()%>','<%= gradeLevel.getCodeLevel() %>')">Set Max</a>
