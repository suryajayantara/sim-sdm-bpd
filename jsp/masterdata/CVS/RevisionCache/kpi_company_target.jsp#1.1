	...
	public String drawListAllEdit(JspWriter outJsp,int iCommand, Hashtable objectClass, long kpi_company_targetId, FrmKPI_Company_Target frmObject, int tahun, long kpiListId, long companyId, long divId, Hashtable HDepartment,Vector VDepartment,long depId, Hashtable HSection,Vector VSection,long secId, Hashtable HEmployee,Vector VEmployee)
{
		...
		ctrlist.addHeader("Target (Value)","10%");
                ctrlist.addHeader("Avr/month","10%");
                ctrlist.addHeader("Achievment","10%");
                //ctrlist.addHeader("Achievement","10%");
			 ...
			 rowx = new Vector();
                        if (kPI_Division_Target.getTarget()>0 && iCommand ==  Command.EDIT){
                         ...
                         if (divId ==0){
                             ...
                             rowx.add("<input type=\"text\" name=\"targetDiv"+division.getOID() +"\" value=\""+Formater.formatNumber((kPI_Division_Target.getTarget()), "#,###.##") +"\" class=\"elemenForm\" oninput=\"javascript:cmdSetPersenDiv("+total+","+division.getOID()+")\"> ");
                         } else{
                         ...
                         double n = PstKPI_Employee_Achiev.listAlldataAchCount(tahun, kpiListId, companyId,division.getOID(),0,0);
                         rowx.add(""+Formater.formatNumber((n), "#,###.##"));
                        // rowx.add("Achievement"); 
                         if(iCommand == Command.EDIT ){
                            lstData.add(rowx);
                         } else {
                            ...
                            if (divId >0 && divId == division.getOID()){
                                    ...
                                    if (depId ==0){
                                       ...
                                       rowx.add("<input type=\"text\" name=\"targetDep"+department.getOID() +"\" value=\""+Formater.formatNumber((kPI_Department_Target.getTarget()), "#,###.##") +"\" class=\"elemenForm\" oninput=\"javascript:cmdSetPersenDep("+total+","+department.getOID()+")\"> ");
                                     ...
                                     //rowx.add(""+Formater.formatNumber((kPI_Department_Target.getTarget()), "#,###.##") );
                                     rowx.add(""+Formater.formatNumber(((kPI_Department_Target.getTarget()/vtotal.size())), "#,###.##"));
                                     double nx = PstKPI_Employee_Achiev.listAlldataAchCount(tahun, kpiListId, companyId,division.getOID(),department.getOID(),0);
                                     rowx.add(""+Formater.formatNumber((nx), "#,###.##"));
                                    // rowx.add("Achievement"); 
                                        lstData.add(rowx);
                                                                                   
                                        if (depId > 0 && depId == department.getOID()){    

                                            Hashtable hashPositian = PstPosition.listHast0Value(0, 0, "", "");
                                            for (int is = 0; is < VSection.size(); is++) {
                                                         Section section = (Section)VSection.get(is);
                                                         if (HSection == null){
                                                             continue;
                                                        ...
                                                        // rowx.add(""+department.getDepartment() );
                                                         ...
                                                         if (secId ==0){
                                                            ...
                                                            rowx.add("<input type=\"text\" name=\"targetSec"+section.getOID() +"\" value=\""+Formater.formatNumber((kPI_Section_Target.getTarget()/total*100), "#,###.##") +"\" class=\"elemenForm\" oninput=\"javascript:cmdSetPersenSec("+total+","+section.getOID()+")\"> * ");
                                                         ...
                                                         rowx.add(""+Formater.formatNumber(((kPI_Section_Target.getTarget()/vtotal.size())), "#,###.##"));
                                                         double nSection = PstKPI_Employee_Achiev.listAlldataAchCount(tahun, kpiListId, companyId,division.getOID(),department.getOID(),section.getOID());
                                                         rowx.add(""+Formater.formatNumber((nSection), "#,###.##"));
                                                        // rowx.add("Achievement"); 
                                                            lstData.add(rowx);
                                                           ...
                                                           if (secId > 0 && secId == section.getOID()){   
                                                               ...
                                                               for (int ie = 0; ie < VEmployee.size(); ie++) {
                                                                             ...
                                                                             KPI_Employee_Target kPI_Employee_Target = (KPI_Employee_Target) HEmployee.get(employee.getOID());
                                                                             double nEmp = PstKPI_Employee_Achiev.listAlldataAchCount(tahun, kpiListId, companyId,division.getOID(),department.getOID(),0,employee.getOID() );
                                                                             if (nEmp == 0){
                                                                                 continue;
                                                                             }
                                                                                 
                                                                                 
                                                                             String whereClause = PstMappingPosition.fieldNames[PstMappingPosition.FLD_DOWN_POSITION_ID]+"="+employee.getPositionId();
                                                                             whereClause += " AND "+PstMappingPosition.fieldNames[PstMappingPosition.FLD_TYPE_OF_LINK]+"="+1;
                                                                             MappingPosition mappingPosition = new MappingPosition();
                                                                             mappingPosition = PstMappingPosition.getMappingPosition(0, 0, whereClause, "");
                                                                             if (nEmp > 0){
                                                                                 try{
                                                                                 String nilaiUpPositionS = ""+(hashPositian.get(String.valueOf(mappingPosition.getUpPositionId())));
                                                                                 double nilaiUpPosition = Double.parseDouble( nilaiUpPositionS );
                                                                                 hashPositian.remove(""+mappingPosition.getUpPositionId());
                                                                                 hashPositian.put(""+mappingPosition.getUpPositionId(), ""+(nilaiUpPosition+nEmp));
                                                                                 }catch(Exception e){}
                                                                             }
                                                            }
                                                            ...
                                                            for (int ie = 0; ie < VEmployee.size(); ie++) {
                                                                            ...
                                                                            // rowx.add(""+department.getDepartment() );
                                                                             ...
                                                                             //rowx.add("<input type=\"text\" name=\"targetEmp"+employee.getOID() +"\" value=\""+Formater.formatNumber((kPI_Employee_Target.getTarget()/total*100), "#,###.##") +"\" class=\"elemenForm\" oninput=\"javascript:cmdSetPersenEmp("+total+","+employee.getOID()+")\"> * ");

                                                                             rowx.add(""+Formater.formatNumber((kPI_Employee_Target.getTarget()), "#,###.##") );
                                                                             rowx.add(""+Formater.formatNumber(((kPI_Employee_Target.getTarget()/vtotal.size())), "#,###.##"));
                                                                             
                                                                             
                                                                            double nEmp = PstKPI_Employee_Achiev.listAlldataAchCount(tahun, kpiListId, companyId,division.getOID(),department.getOID(),section.getOID(),employee.getOID());
                                                         //rowx.add(""+Formater.formatNumber((nEmp), "#,###.##"));
                                                                            rowx.add(""+Formater.formatNumber((nEmp), "#,###.##") + " | " + hashPositian.get(""+employee.getPositionId()) + " (akumulasi dari down position)" );
                                                                            // rowx.add("Achievement"); 
                                                                                lstData.add(rowx);
                                            ...
                                            VemployeDepart = PstEmployee.listEmpInPosition(0, 0, " he.DEPARTMENT_ID = "+department.getOID()+" AND he.SECTION_ID = "+0," hp."+PstPosition.fieldNames[PstPosition.FLD_POSITION_ID]);
                                                ...
                                                for (int ie = 0; ie < VemployeDepart.size(); ie++) {
                                                                            ...
                                                                            // rowx.add(""+department.getDepartment() );
                                                                             ...
                                                                             if (kPI_Employee_Target.getTarget()>0 && iCommand ==  Command.EDIT){
                                                                                rowx.add("----------<a href=\"javascript:cmdSec('"+employee.getSectionId()+"','"+employee.getOID()+"')\">"+employee.getFullName()+"-"+position.getPosition()+"</a> ");
                                                                             }else{
                                                                                rowx.add("----------"+employee.getFullName()+"-"+position.getPosition());
                                                                             ...
                                                                             if (secId ==0){
                                                                                rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[FrmKPI_Company_Target.FRM_FIELD_PERCENT_E]+employee.getOID() +"\" value=\""+Formater.formatNumber((kPI_Employee_Target.getTarget()/total*100), "#,###.##") +"\" class=\"elemenForm\">  ");
                                                                                rowx.add("<input type=\"text\" name=\"targetEmp"+employee.getOID() +"\" value=\""+Formater.formatNumber((kPI_Employee_Target.getTarget()), "#,###.##") +"\" class=\"elemenForm\" oninput=\"javascript:cmdSetPersenEmp("+total+","+employee.getOID()+")\"> * ");
                                                                             } else {
...
function cmdSetPersenDiv(total, divOid){
                var inputNameTarget = "targetDiv"+divOid;
                var inputNameTargetPersen = "FRM_FIELD_TARGET_DIVISION"+divOid;
                var x = document.frmKPI_Company_Target.elements[inputNameTarget].value;
                var totPersen = x/total*100;
                document.frmKPI_Company_Target.elements[inputNameTargetPersen].value = totPersen;
            }
            
          
function cmdSetPersenDep(total, depOid){
                var inputNameTarget = "targetDep"+depOid;
                var inputNameTargetPersen = "FRM_FIELD_TARGET_DEPARTMENT"+depOid;
                var x = document.frmKPI_Company_Target.elements[inputNameTarget].value;
                var totPersen = x/total*100;
                document.frmKPI_Company_Target.elements[inputNameTargetPersen].value = totPersen;
            }   
            
function cmdSetPersenSec(total, secOid){
                var inputNameTarget = "targetSec"+secOid;
                var inputNameTargetPersen = "FRM_FIELD_TARGET_SECTION"+secOid;
                var x = document.frmKPI_Company_Target.elements[inputNameTarget].value;
                var totPersen = x/total*100;
                document.frmKPI_Company_Target.elements[inputNameTargetPersen].value = totPersen;
            }   
            
function cmdSetPersenEmp(total, empOid){
                var inputNameTarget = "targetEmp"+empOid;
                
                var inputNameTargetPersen = "FRM_FIELD_TARGET_E"+empOid;
                var x = document.frmKPI_Company_Target.elements[inputNameTarget].value;
                var totPersen = x/total*100;
                document.frmKPI_Company_Target.elements[inputNameTargetPersen].value = totPersen;
            }             
                                                ...
                                                <td colspan="3" >
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      <td width="17%" height="21" nowrap> 
                                                        ...
                                                        <td width="83%"> <%= ControlCombo.draw(frmKPI_Company_Target.fieldNames[frmKPI_Company_Target.FRM_FIELD_YEAR],"formElemen",null, ""+tahun, frmKPI_Company_Target.getYearValue(), frmKPI_Company_Target.getYearKey(), "onChange=\"javascript:cmdUpdateSec()\"") %> 
                                                        </td> 
                                                    </tr>
                                                  ...
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <tr> 
                                                      <td class="listtitle">Doc  List</td>
                                                      <td >*)entry 
                                                        required </td>
                                                    </tr>
                                                  </table>
