<%@page import="com.dimata.harisma.form.masterdata.FrmKPI_Employee_Achiev"%>
<%@page import="com.dimata.harisma.form.masterdata.CtrlKPI_Employee_Achiev"%>
...
long oidEmpAchiev = FRMQueryString.requestLong(request, "oid_emp_achiev");
...
String whereClause = PstKPI_Employee_Achiev.fieldNames[PstKPI_Employee_Achiev.FLD_KPI_EMPLOYEE_ACHIEV_ID]+ " = "+oidEmpAchiev;
String orderClause = PstKPI_Employee_Achiev.fieldNames[PstKPI_Employee_Achiev.FLD_ACHIEV_PROOF];

CtrlKPI_Employee_Achiev ctrlKPI_Employee_Achiev = new CtrlKPI_Employee_Achiev(request);
ControlLine ctrLine = new ControlLine();
Vector listKpiAchiev = new Vector(1,1);

/*switch statement */
iErrCode = ctrlKPI_Employee_Achiev.action(iCommand , oidEmpAchiev);
/* end switch*/

KPI_Employee_Achiev kpiEmpAchiev = ctrlKPI_Employee_Achiev.getdKPI_Employee_Achiev();
msgString =  ctrlKPI_Employee_Achiev.getMessage();

Vector vectPict = new Vector(1,1);
vectPict.add(""+oidEmpAchiev);
...
function cmdUpload(){
	...
	document.frm_upload_pict.action="upload_achiev_proof_process.jsp";
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td> <font color="#FF6600" face="Arial"><strong> <!-- #BeginEditable "contenttitle" -->Employee 
                  &gt; KPI Achievment<!-- #EndEditable --> </strong></font> </td>
              </tr>
              <tr> 
                <td> 
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            <td valign="top"> <!-- #BeginEditable "content" --> 
                              <form name="frm_upload_pict" method ="post" enctype="multipart/form-data" action="">
								...
								<input type="hidden" name="oid_emp_achiev" value="<%=oidEmpAchiev%>">
                                                ...
                                                <td height="8"  colspan="3"> 
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <% if(oidEmpAchiev != 0){
                                                            ...
                                                            try{
                                                                 kPI_Employee_Achiev = PstKPI_Employee_Achiev.fetchExc(oidEmpAchiev);
                                                            }catch(Exception exc){
