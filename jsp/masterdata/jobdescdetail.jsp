                                                                        ...
                                                                        <table border="0" cellspacing="2" cellpadding="2" width="50%">
                                                                            ...
                                                                            <tr align="left" valign="top">
                                                                                ...
                                                                                <td width="83%">
                                                                                    ...
                                                                                    %>
                                                                                    <%= ControlCombo.draw(frmJobDesc.fieldNames[FrmJobDesc.FRM_FIELD_REPEAT_TYPE], "formElemen", null, ""+jobDesc.getRepeatType(), rep_value, rep_key,"")%>
                                                                                </td>
                                                                            </tr>
                                                                            <tr align="left" valign="top">
                                                                                <td valign="top" width="17%">
                                                                            ...
                                                                            <tr align="left" valign="top">
                                                                                <td valign="top" width="17%">
                                                                                    End Date</td>
                                                                                <td width="83%">
                                                                                    <%=ControlDate.drawDateWithStyle(frmJobDesc.fieldNames[FrmJobDesc.FRM_FIELD_END_DATETIME], jobDesc.getEndDatetime() != null ? jobDesc.getEndDatetime() : new Date(), 2, -5, "formElemen", " onkeydown=\"javascript:fnTrapKD()\"") + ctrTimeEnd%>
