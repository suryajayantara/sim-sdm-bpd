...
function cmdUpload(oidContact, className){
        window.open("<%=approot%>/system/dataupload/data_upload.jsp?object_id="+oidContact+"&classname="+className, null, "height=800,width=800,status=yes,toolbar=no,menubar=no,location=center,scrollbars=yes");
}
                  ...
                  <td colspan="3"  valign="top"  > 
                    <%
							...
							String scancel = "javascript:cmdEdit('"+oidContactList+"')";
                                                        String supload = "javascript:cmdUpload('"+oidContactList+"')";
                                                        String strUploadComp = "Upload";
							...
							ctrLine.setConfirmDelCaption(strDeleteComp);
                                                        ctrLine.setAddCaption(strUploadComp);
