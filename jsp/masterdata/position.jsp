    ...
    public String drawList(Vector objectClass, long positionId, I_Atendance attdConfig) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if (position.getDescription().length()>2){
                rowx.add("<a class=\"btn\" href=\"javascript:cmdOpenDesc('"+position.getOID()+"')\">View Description</a>");
            } else {
                rowx.add("-");
            }
                                              ...
                                              <tr align="left" valign="top"> 
                                                <td height="14" valign="middle" colspan="3" class="listtitle">
                                                    <div class="title_part">
                                                        Position List&nbsp;
                                                        <input id="input" type="text" name="search_position" value="<%=searchPosition%>" placeholder="cari posisi..." size="70" />
                                              ...
                                              <tr> 
                                                <td valign="top">
                                                  <table border="0" cellspacing="2" cellpadding="2" width="100%">
                                                    ...
                                                    <%}%>
                                                    <tr align="left" valign="top"> 
                                                      <td valign="top" width="10%">Position Group</td>
                                                      <td width="1%">:</td>
                                                      <td width="89%"> 
                                                      <%
                                                        Vector posGroupKey = new Vector(1,1);
                                                        Vector posGroupValue = new Vector(1,1);
                                                        Vector listPosGroup = PstPositionGroup.listAll(); 
                                                        posGroupKey.add("SELECT");
                                                        posGroupValue.add("0");	
                                                        for(int idx=0; idx < listPosGroup.size();idx++){
                                                            PositionGroup positionGroup = (PositionGroup) listPosGroup.get(idx);																						
                                                             posGroupKey.add(""+positionGroup.getPositionGroupName());
                                                             posGroupValue.add(""+positionGroup.getOID());														
                                                        }
                                                      
                                                        out.println(ControlCombo.draw(frmPosition.fieldNames[frmPosition.FRM_FIELD_POSITION_GROUP_ID], "formElemen", null, ""+position.getPositionGroupId(), posGroupValue, posGroupKey));
                                                    %>
                                                      </td> 
