...
<%    int iCommand = FRMQueryString.requestCommand(request);
    ...
    String oid_ass_main[] = FRMQueryString.requestStringValues(request, "HR_ASS_FORM_MAIN_ID_CHILD");
...
//int vectSize = PstAssessmentFormMain.getCountDetail(start,recordToGet, whereClause , orderClause);
 ...
 /* get record to display */
    ...
    if (iCommand == Command.SAVE) {
        ...
        PstAssessmentFormMainPosition.deleteByAssFormMainId(oidAssessmentFormMain);
        if (oid_position != null) {
            for (int uu = 0; uu < oid_position.length; uu++) {
                AssessmentFormMainPosition objAssessmentFormMainPosition = new AssessmentFormMainPosition();
                objAssessmentFormMainPosition.setAssFormMainId(oidAssessmentFormMain);
                objAssessmentFormMainPosition.setPositionId(Long.parseLong(oid_position[uu]));
                PstAssessmentFormMainPosition.insertExc(objAssessmentFormMainPosition);
            }
        }
        
        PstAssessmentFormLink.deleteByAssFormMainId(oidAssessmentFormMain);
        if (oid_ass_main != null) {
            for (int uu = 0; uu < oid_ass_main.length; uu++) {
                AssessmentFormLink objAssessmentFormLink = new AssessmentFormLink();
                objAssessmentFormLink.setHrAssFormMainIdParent(oidAssessmentFormMain);
                objAssessmentFormLink.setHrAssFormMainIdChild(Long.parseLong(oid_ass_main[uu]));
                PstAssessmentFormLink.insertExc(objAssessmentFormLink);
            }
        }
    }
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        <td height="100%"> 
                                                                                                            <table border="0" cellspacing="2" cellpadding="2" width="50%">
                                                                                                                ...
                                                                                                                <%
                                                                                                                    String[] listSelectedPosition = null;
                                                                                                                    Vector listPostionValue = new Vector();
                                                                                                                    Vector listPositionKey = new Vector();
                                                                                                                    //get data position
                                                                                                                    Vector listPosition = PstPosition.list(0, 0, "", "");
                                                                                                                    String whereClausePosition = " " + PstAssessmentFormMainPosition.fieldNames[PstKpiGroupPosition.FLD_KPI_GROUP_ID] + " = " + assessmentFormMain.getOID();
                                                                                                                    Hashtable listMapPosition = PstAssessmentFormMainPosition.listHashTable(0, 0, whereClausePosition, "");
                                                                                                                    listSelectedPosition = new String[listMapPosition.size()];
                                                                                                                    if (listPosition.size() > 0) {
                                                                                                                        ...
                                                                                                                        for (int xu = 0; xu < listPosition.size(); xu++) {
                                                                                                                            ...
                                                                                                                            if (listMapPosition.containsKey(objPosition.getOID())) {
                                                                                                                                listSelectedPosition[idxSelected] = "" + objPosition.getOID();
                                                                                                                                idxSelected++;
                                                                                                                            }
                                                                                                                            listPostionValue.add("" + objPosition.getOID());
                                                                                                                            listPositionKey.add("" + objPosition.getPosition());
                                                                                                                        }
                                                                                                                    }
...
%>
                                                                                                                <tr align="left" valign="top"> 
                                                                                                                    <td valign="top" width="17%"> 
                                                                                                                        Position</td>
                                                                                                                    <td width="83%">
                                                                                                                        <%=ControlCombo.drawStringArraySelected("position", "chosen-select", null, listSelectedPosition, listPositionKey, listPostionValue, null, attTag)%>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                ...
                                                                                                                <tr align="left" valign="top"> 
                                                                                                                    ...
                                                                                                                    <td width="83%" nowrap> 
                                                                                                                        <%
                                                                                                                            ...
                                                                                                                            Vector fr_key = new Vector(1, 1);
                                                                                                                            Vector vAssFormMain = PstAssessmentFormMain.list(0, 0, "ASS_FORM_MAIN_ID != " + oidAssessmentFormMain, "");
                                                                                                                            String[] assOID = new String[vAssFormMain.size()];
                                                                                                                            for (int i = 0; i < vAssFormMain.size(); i++) {
                                                                                                                                AssessmentFormMain fm = (AssessmentFormMain) vAssFormMain.get(i);
                                                                                                                                fr_value.add(String.valueOf(fm.getOID()));
                                                                                                                                fr_key.add(fm.getTitle());
                                                                                                                                
                                                                                                                                Vector vAssessmentFormLink = PstAssessmentFormLink.list(0, 1, 
                                                                                                                                        "HR_ASS_FORM_MAIN_ID_PARENT = " + oidAssessmentFormMain + " AND HR_ASS_FORM_MAIN_ID_CHILD = " + fm.getOID(), 
                                                                                                                                        ""
                                                                                                                                );
                                                                                                                                if(vAssessmentFormLink.size() > 0){
                                                                                                                                    assOID[i] = "" + fm.getOID();
                                                                                                                                }
                                                                                                                            }
                                                                                                                            
                                                                                                                            String tagAttr = "data-placeholder=\"\" style=\" tabindex=\"4\" multiple";
