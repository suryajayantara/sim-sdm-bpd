...
<%    int iCommand = FRMQueryString.requestCommand(request);
    ...
    long childId = FRMQueryString.requestLong(request, "childId");
...
<html><!-- #BeginTemplate "/Templates/main.dwt" -->
                                                                                                                    ...
                                                                                                                    <td width="83%">
                                                                                                                        <%
                                                                                                                            ...
                                                                                                                            if(assessmentFormSection.getAssFormSectionIdChild() > 0){
                                                                                                                                childOID = assessmentFormSection.getAssFormSectionIdChild();
                                                                                                                            } else {
                                                                                                                                childOID = childId;
                                                                                                                            }
                                                                                                                        %>
                                                                                                                        <%= ControlCombo.draw(FrmAssessmentFormSection.fieldNames[frmAssessmentFormSection.FRM_ASS_FORM_SECTION_ID_CHILD], "formElemen", "-Pilih-", "" + childId, childValue, childKey, "id='child-section'")%>
                                                                                                                    </td>
                                                                                                                </tr>
    ...
    <script language="JavaScript">
        ...
        let select = document.querySelector("#child-section");
        select.addEventListener('change', (event) => {
            ...
            // Buat objek URLSearchParams dari URL saat ini
            let params = new URLSearchParams(currentUrl.search);

            // Tambahkan parameter baru ke objek URLSearchParams
            params.set("childId", selectedValue);

            // Tambahkan objek URLSearchParams ke URL saat ini
            currentUrl.search = params;

            // Gunakan URL yang diperbarui untuk melakukan navigasi ke halaman yang sama dengan parameter yang ditambahkan
