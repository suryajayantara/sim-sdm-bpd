...
function cmdAddText(ObjectName,oidDoc,ObjectStatusfield){
        window.open("EmpDocumentDetailObject.jsp?ObjectName="+ObjectName+"&oidDoc="+oidDoc+"&ObjectStatusfield="+ObjectStatusfield+"&formName=frmEmpDoc&empPathId=<%=frmEmpDoc.fieldNames[frmEmpDoc.FRM_FIELD_EMPLOYEE_ID]%>", null, "height=550,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");       
}
                                              ...
                                              <tr align="left" valign="top"> 
                                                <td colspan="3"cen >
                                                  <table width="80%" align="center" border="1"  cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td width="37%"><a href="javascript:cmdAction()" class="command">ACTION</a> <a href="javascript:cmdPrint('<%=oidEmpDoc%>')" class="command">PRINT PDF</a> || <a href="javascript:cmdExpense('<%=oidEmpDoc%>')" class="command">EXPENSE</a> </td>
                                                    </tr>
                                                  </table> 
                                                </td>
                                              </tr>
                                                  ...
                                                  <table width="80%" align="center" border="1"  cellspacing="0" cellpadding="0">
                                                    <tr>
                                                      <td width="37%">
                                                       ...
                                                       <% 
                                                       String whereClause1 = PstDocMasterAction.fieldNames[PstDocMasterAction.FLD_DOC_MASTER_ID]+" = "+DocMasterId;
                                                       listDocMasterAction = PstDocMasterAction.list(0, 0, whereClause1, "");
                                                        ...
                                                        %>  
                                                          ...
                                                          <a href="javascript:cmdAction()" class="command">ACTION</a> 
