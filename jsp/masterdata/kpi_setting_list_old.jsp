...
//                                            untuk fungsi selected
                ...
                <tr>
                    ...
                    <a href="javascript:cmdAdd()" style="color:#FFF;" class="btn-add">Tambah Kpi Setting Baru</a>
                </div>
            </div>
        </div>
        ...
        <div class="box">
                        ...
                        for (int i=0; i<listKpiSetting.size(); i++){
                            ...
                            <tr>
                             ...
                             <%
                                ...
                                <td style="background-color: #FFF;">
                                <a href="javascript:cmdEdit('<%=kpiSettingList.getOID()%>')" style="color: #FFF;" class="btn-edit">Edit</a> ||
				<a href="javascript:cmdDelete('<%=kpiSettingList.getOID()%>')" style="color: #FFF;" class="btn-delete">Delete</a>
                                </td>
                            </tr>
                            <%
                        }
                ...
                <!--tabel ini akan muncul ketika user memilih atau searching KPI setting-->
		<div>&nbsp;</div>
                Sasaran Kinerja
                         <table class="tblStyle" style="width: 100%;">
                              <tr>
                              ...
                              <tr>
                              <td rowspan="2"> 1 </td>
                                <td rowspan="2">meningkatnya pendapatan</td>
                                <td>1.1</td>
                                <td>Sasaran kinerja</td>
                                <td>Full Cascade</td>
                                <td>Rp</td>
                                <td>
                                <a href="javascript:cmdEditSettingTarget" style="color: #FFF;" class="btn-edit">Edit</a>
                                </td>
                                <td>30%</td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                              <td>2</td>
                                <td>meningkatnya pendapatan</td>
                                <td>2.1</td>
                                <td>Sasaran kinerja</td>
                                <td>Full Cascade</td>
                                <td>Rp</td>
                                <td>
                                <a href="../masterdata/kpi_setting_target.jsp"style="color: #FFF;" class="btn-edit">Edit</a>
                                </td>
                                <td>30%</td>
                              </tr>

                              <tr>
                              <td class="title_tbl" colspan="7">
                              <center>total</center>
                              </td>
                              <td>
                              90%
