...
<%!    public String drawListTrainingFile(Vector objectClass, long trainingID) {
    ...
    public String drawListTrainingFileOnlyView(Vector objectClass, long trainingID) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            Vector rowx = new Vector();
			rowx.add(trainingFile.getTrainingTitle());
...
if (iCommand == Command.SUBMIT) {
    ...
    response.sendRedirect("training_budget.jsp?command="+Command.EDIT+"&oid_training="+oidTraining);
...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function loadList(training_name) {
                ...
                xmlhttp.open("GET", "training_budget_ajax.jsp?command=<%=Command.LIST%>&training_name=" + training_name +"&type_name=0", true);
                xmlhttp.send();
            ...
            function loadByType(type_name) {
                ...
                xmlhttp.open("GET", "training_budget_ajax.jsp?command=<%=Command.LIST%>&type_name=" + type_name, true);
                xmlhttp.send();
            }
            ...
            function cmdListFirst(start){                
                ...
                xmlhttp.open("GET", "training_budget_ajax.jsp?training_name=0&command=" + <%=Command.FIRST%> + "&start="+start, true);
                xmlhttp.send();
            }
            ...
            function cmdListPrev(start){
                ...
                xmlhttp.open("GET", "training_budget_ajax.jsp?training_name=0&command=" + <%=Command.PREV%> + "&start="+start, true);
                xmlhttp.send();
            }
            ...
            function cmdListNext(start){
                ...
                xmlhttp.open("GET", "training_budget_ajax.jsp?training_name=0&command=" + <%=Command.NEXT%> + "&start="+start, true);
                xmlhttp.send();
            }
            ...
            function cmdListLast(start){
                ...
                xmlhttp.open("GET", "training_budget_ajax.jsp?training_name=0&command=" + <%=Command.LAST%> + "&start="+start, true);
                xmlhttp.send();
            }
            
            function cmdViewDate(){
                var thn = document.getElementById("training_thn").value;
                ...
                if(thn != ""){
                    ...
                    xmlhttp.open("GET", "training_budget_ajax.jsp?command=<%=Command.LIST%>&training_thn=" + thn +"&training_name=0&type_name=0", true);
                    xmlhttp.send();
                    document.getElementById("save").style.visibility="hidden";
                    document.getElementById("training_name").style.visibility='visible';
                    document.getElementById("type_name").style.visibility='visible';
                } else {
                    alert("Isikan Tahun");
                }
            ...
            function cmdAdd(){
                ...
                document.frmtraining.action="training_budget.jsp";
                ...
                if(thn != ""){
                    ...
                    xmlhttp.open("GET", "training_budget_ajax.jsp?command=<%=Command.ADD%>&training_thn=" + thn +"&training_name=0&type_name=0", true);
                    xmlhttp.send();
                } else {
            ...
            function cmdSave(){
                var vectSize = document.getElementById("vectSize").value;
                
                var allData = "";
                for(var i = 0; i < parseInt(vectSize); i++){
                    
                    var oid = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_BUDGET_ID]%>_"+i).value;
                    var year = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_BUDGET_YEAR]%>_"+i).value;
                    var trainId = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_ID]%>_"+i).value;
                    var duration = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_BUDGET_DURATION]%>_"+i).value;
                    var freq = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_BUDGET_FREQUENCY]%>_"+i).value;
                    var bacth = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_BUDGET_BATCH]%>_"+i).value;
                    var amount = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_BUDGET_AMOUNT]%>_"+i).value;
                    var costBatch = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_BUDGET_COST_BATCH]%>_"+i).value;
                    var tot = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_BUDGET_TOTAL]%>_"+i).value;
                    var locTypeId = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_LOCATION_TYPE_ID]%>_"+i).value;
                    var areaId = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_AREA_ID]%>_"+i).value;
                    var desc = document.getElementById("<%=FrmTrainingBudget.fieldNames[FrmTrainingBudget.FRM_FIELD_TRAINING_BUDGET_DESC]%>_"+i).value;
                    //alert(parseInt(vectSize));
                    //if(i == parseInt(vectSize)-1){
                        //alert(allData);
                    allData = oid+","+year+","+trainId+","+duration+","+freq+","+bacth+","+amount+","+costBatch+","+tot+","+locTypeId+","+areaId+","+desc;
                    //}else{
                        //alert(allData);
                      //  allData = allData + (oid+","+year+","+trainId+","+duration+","+freq+","+bacth+","+amount+","+costBatch+","+tot+","+locTypeId+","+areaId+","+desc+";");
                    //}
                    var xmlhttp = new XMLHttpRequest();
                    xmlhttp.onreadystatechange = function() {
                        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    ...
                    xmlhttp.open("GET", "training_budget_ajax.jsp?command=<%=Command.SAVE%>&data=" + allData, true);
                    xmlhttp.send();
                }
                ...
                if(thn != ""){
                    ...
                    xmlhttp.open("GET", "training_budget_ajax.jsp?command=<!--%=Command.SAVE%-->&training_thn=" + thn +"&training_name=0&type_name=0", true);
                    xmlhttp.send();
                } else {
                    document.getElementById("alert").style.visibility='visible';
                }*/
    ...
    <body> <!--onload="prepare()"-->
        ...
        <div class="content-main">
            ...
            <input id="training_thn" type="text" style="padding:6px 7px" name="training_thn" placeholder="Ex: 2016" size="5" />-->
            <input id="training_thn" type="text" style="padding:6px 7px" name="training_thn" placeholder="Masukkan Tahun Anggaran, Ex: 2016" size="35" />
            <a class="btn" style="color:#FFF" href="javascript:cmdViewDate()">Tampilkan</a>
            <a class="btn" style="color:#FFF" href="javascript:cmdAdd()">Tambah Anggaran</a>
            <a id="save" class="btn" style="color:#FFF; visibility: hidden" href="javascript:cmdSave()">Simpan Anggaran</a>
            <div>&nbsp;</div>
            <div>
                <span id="alert" style="background-color: #FF6666; color: white; padding:6px 7px; visibility: hidden;">Tahun anggaran belum dimasukan.</span>
            </div>
            <input id="training_name" type="text" style="padding:6px 7px; visibility: hidden" name="training_name" onkeyup="loadList(this.value)" placeholder="Searching..." size="70" /> 
            <select id="type_name" name="type_name" style="padding:4px 7px; visibility: hidden" onchange="loadByType(this.value)">
