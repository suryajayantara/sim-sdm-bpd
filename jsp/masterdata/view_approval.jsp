...
%>
<%
    long kpiTargetId = FRMQueryString.requestLong(request, "target_id");
    ...
    try {
        kpiTarget = PstKpiTarget.fetchExc(kpiTargetId);
        empId = kpiTarget.getAuthorId();
        approval1 = kpiTarget.getApproval1();
        approval2 = kpiTarget.getApproval2();
        approval3 = kpiTarget.getApproval3();
        approval4 = kpiTarget.getApproval4();
        approval5 = kpiTarget.getApproval5();
        approval6 = kpiTarget.getApproval6();
...
<%
    if (approval1 != 0){
        if (lastApproval == 1 && kpiTarget.getStatusDoc()== 5){
            %>
        ...
        if (approval2 != 0){
            if (lastApproval == 2 && kpiTarget.getStatusDoc() == 5){
                %>
            ...
            if (approval3 != 0){
                if (lastApproval == 3 && kpiTarget.getStatusDoc() == 5){
                    %>
                ...
                if (approval4 != 0){
                    if (lastApproval == 4 && kpiTarget.getStatusDoc() == 5){
                        %>
                    ...
                    if (approval5 != 0){
                        if (lastApproval == 5 && kpiTarget.getStatusDoc() == 5){
                            %>
                        ...
                        if (approval6 != 0){
                            if (lastApproval == 6 && kpiTarget.getStatusDoc() == 5){
                                %>
                        ...
                        } else if (kpiTarget.getStatusDoc() == 0 || kpiTarget.getStatusDoc() == 1) {
                            %>
