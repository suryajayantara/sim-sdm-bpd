                                          ...
                                          <td height="8" valign="middle" colspan="3"> 
                                            ...
                                            <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                              ...
                                              */
                                              ...
                                              <tr> 
                                                  <td width="21%">Durasi Kerja</td>
                                                  <td width="79%"> 
                                                     <input type="text" name="<%=FrmScheduleSymbol.fieldNames[FrmScheduleSymbol.FRM_FIELD_WORK_DURATION] %>"  value="<%=scheduleSymbol.getWorkDuration()%>" class="elemenForm">
                                                  </td>
                                                </tr>
                                              <!--for special leave-->
                                              <tr id="tableSpecialLeave">
                                                ...
                                                <tr> 
                                                  <td width="21%">Show on User Leave Form</td>
                                                    <td width="10%"> 
                                                        <%  String checkNo = "";
                                                            String checkYes = "";
                                                            if (scheduleSymbol.getShowOnLeave() == 0){
                                                                checkNo = "checked";
                                                            } else {
                                                                checkYes = "checked";
                                                            }
                                                        %>
                                                      <input type="radio" name="<%=FrmScheduleSymbol.fieldNames[FrmScheduleSymbol.FRM_FIELD_SHOW_ON_USER_LEAVE] %>" value="0" style="border-color:'#DDDDDD'" <%=checkNo%>>&nbsp;No
                                                      <input type="radio" name="<%=FrmScheduleSymbol.fieldNames[FrmScheduleSymbol.FRM_FIELD_SHOW_ON_USER_LEAVE] %>" value="1" style="border-color:'#DDDDDD'" <%=checkYes%>>&nbsp;Yes
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td width="21%">Report Type </td>
                                                    <td width="79%">
                                                    <%
                                                        Vector reportTypeValue = new Vector(1,1);
                                                        Vector reportTypeKey = new Vector(1,1);
                                                        String reportTypeSelect = String.valueOf(scheduleSymbol.getReportType());
                                                        for (int i=0; i < PstScheduleSymbol.fieldNamesReport.length; i++){
                                                            reportTypeKey.add(PstScheduleSymbol.fieldNamesReport[i]);
                                                            reportTypeValue.add(String.valueOf(i));
                                                        }
                                                    %>
                                                    <%= ControlCombo.draw(FrmScheduleSymbol.fieldNames[FrmScheduleSymbol.FRM_FIELD_REPORT_TYPE],null, reportTypeSelect, reportTypeValue, reportTypeKey) %>  <%=frmScheduleSymbol.getErrorMsg(FrmScheduleSymbol.FRM_FIELD_SCHEDULE_CATEGORY_ID)%></td>
                                                </tr>
												<tr> 
                                                  <td width="21%">Perhitungan Uang Makan</td>
                                                  <td width="79%">
                                                    <%
                                                        Vector uangMakanValue = new Vector(1,1);
                                                        Vector uangMakanKey = new Vector(1,1);
                                                        String uangMakanSelect = String.valueOf(scheduleSymbol.getPerhitunganUangMakan());
                                                        for (int i=0; i < PstScheduleSymbol.fieldNamesUangMakan.length; i++){
                                                            uangMakanKey.add(PstScheduleSymbol.fieldNamesUangMakan[i]);
                                                            uangMakanValue.add(String.valueOf(i));
                                                        }
                                                    %>
                                                    <%= ControlCombo.draw(FrmScheduleSymbol.fieldNames[FrmScheduleSymbol.FRM_FIELD_PERHITUNGAN_UANG_MAKAN],null, uangMakanSelect, uangMakanValue, uangMakanKey) %>  <%=frmScheduleSymbol.getErrorMsg(FrmScheduleSymbol.FRM_FIELD_PERHITUNGAN_UANG_MAKAN)%></td>
                                                  </td>
                                                </tr>
                                                <tr> 
                                                  <td width="21%">Show Present on Weekends and Holiday</td>
                                                    <td width="10%"> 
                                                        <%  String checkNo1 = "";
                                                            String checkYes1 = "";
                                                            if (scheduleSymbol.getShowPresent() == 0){
                                                                checkNo1 = "checked";
                                                            } else {
                                                                checkYes1 = "checked";
                                                            }
                                                        %>
                                                      <input type="radio" name="<%=FrmScheduleSymbol.fieldNames[FrmScheduleSymbol.FRM_FIELD_SHOW_PRESENT_ON_WEEKEND] %>" value="0" style="border-color:'#DDDDDD'" <%=checkNo1%>>&nbsp;No
                                                      <input type="radio" name="<%=FrmScheduleSymbol.fieldNames[FrmScheduleSymbol.FRM_FIELD_SHOW_PRESENT_ON_WEEKEND] %>" value="1" style="border-color:'#DDDDDD'" <%=checkYes1%>>&nbsp;Yes
                                                    </td>
                                                </tr>
                                            <%
                                            }//end check show
