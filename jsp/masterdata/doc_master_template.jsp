         ...
         <tr   align="center" valign="top" style="display: block;" > 
                                                <td colspan="3"cen >
                                                  <table width="80%" align="center" border="0"  cellspacing="0" cellpadding="0" style="background-color: white; ">
                                                    <tr>
                                                        <td width="86%">You may downloaded format example here</td>
                                       
                                                        <td width="37%" ><a href="download/formula_Example.doc"><button id="btn" href="download/formula_Example.doc">DOWNLOAD</button></a></td>
                                                    </tr>
                                                  </table> 
                                                </td>
                                              </tr>
