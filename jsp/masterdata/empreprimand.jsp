...
<%!    public String drawList(Vector objectClass, long reprimandId) {
        ...
        ctrlist.addHeader("Jangka Waktu", "10%");
        ctrlist.addHeader("Satuan", "10%");
        ctrlist.addHeader("Show in CV", "10%");
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add("" + reprimand.getValidUntil());
            rowx.add("" + PstReprimand.namaSatuanValidUntil[reprimand.getSatuanValidUntil()]);
            rowx.add("" + PstReprimand.nameConfigShowInCV[reprimand.getShowInCV()]);
                ...
                function showObjectForMenu(){
                 ...
                 function loadValidUntil(iCommand) {
                    ...
                    var warnDate = year+"-"+month+"-"+date;
                        ...
                        xmlhttp.open("GET", "reprimand_ajax_valid_until.jsp?oidWarningLevel=\""+oidWarningLevel+"\"&warningDate=" + warnDate+"&iCommand="+iCommand+"&oidWarning="+oidWarning , true);
                        xmlhttp.send();
                }
        </SCRIPT>
        <!-- #EndEditable -->
                                                                                                ...
                                                                                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                                                                    ...
                                                                                                    <tr align="left" valign="top">
                                                                                                        ...
                                                                                                        <td height="21" colspan="2" width="92%">
                                                                                                            <input type="text" name="<%=frmReprimand.fieldNames[FrmReprimand.FRM_FIELD_REPRIMAND_DESC]%>"  value="<%= reprimand.getReprimandDesc()%>" class="formElemen"  size="40"> * <%= frmReprimand.getErrorMsg(FrmReprimand.FRM_FIELD_REPRIMAND_DESC)%>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr align="left" valign="top">
                                                                                                        <td height="21" valign="top" width="1%">&nbsp;</td>
                                                                                                    ...
                                                                                                    <tr align="left" valign="top">
                                                                                                        <td height="21" valign="top" width="1%">&nbsp;</td>
                                                                                                        <td height="21" valign="top" width="7%">Jangka Waktu</td>
                                                                                                        <td height="21" colspan="2" width="92%">
                                                                                                            <input type="text" name="<%=frmReprimand.fieldNames[FrmReprimand.FRM_FIELD_VALID_UNTIL]%>"  value="<%= "" + reprimand.getValidUntil()%>" class="formElemen" size="40">
                                                                                                            * <%= frmReprimand.getErrorMsg(FrmWarning.FRM_FIELD_VALID_UNTIL)%>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                     <tr align="left" valign="top">
                                                                                                        <td height="21" valign="top" width="1%">&nbsp;</td>
                                                                                                        <td height="21" valign="top" width="7%">Satuan</td>
                                                                                                        <td height="21" colspan="2" width="92%">
                                                                                                            <select name="<%=frmReprimand.fieldNames[FrmReprimand.FRM_FIELD_SATUAN_VALID_UNTIL]%>">
                                                                                                                <%
                                                                                                                    for(int xy = 0 ; xy < PstReprimand.namaSatuanValidUntil.length; xy++ ){
                                                                                                                        String selected = "";
                                                                                                                        if(reprimand.getSatuanValidUntil()>=0){
                                                                                                                            if(reprimand.getSatuanValidUntil() == xy){
                                                                                                                                selected = "selected";
                                                                                                                            }else{
                                                                                                                                 selected = "";
                                                                                                                            }
                                                                                                                        ...
                                                                                                                        <option value="<%=xy%>" <%=selected%>><%=PstReprimand.namaSatuanValidUntil[xy]%></option>
                                                                                                                        <%
                                                                                                                    } 
                                                                                                                %> 
                                                                                                            </select>
                                                                                                            * <%= frmReprimand.getErrorMsg(FrmWarning.FRM_FIELD_WARN_POINT)%>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr align="left" valign="top">
                                                                                                        <td height="21" valign="top" width="1%">&nbsp;</td>
                                                                                                        <td height="21" valign="top" width="7%">Show In CV</td>
                                                                                                        <td height="21" colspan="2" width="92%">
                                                                                                            <select name="<%=frmReprimand.fieldNames[FrmReprimand.FRM_FIELD_SHOW_IN_CV]%>">
                                                                                                                <%
                                                                                                                    for(int xy = 0 ; xy < PstReprimand.nameConfigShowInCV.length; xy++ ){
                                                                                                                        String selected = "";
                                                                                                                        if(reprimand.getShowInCV()>=0){
                                                                                                                            if(reprimand.getShowInCV()== xy){
                                                                                                                                selected = "selected";
                                                                                                                            }else{
                                                                                                                                 selected = "";
                                                                                                                            }
                                                                                                                        ...
                                                                                                                        <option value="<%=xy%>" <%=selected%>><%=PstReprimand.nameConfigShowInCV[xy]%></option>
                                                                                                                        <%
                                                                                                                    } 
                                                                                                                %> 
                                                                                                            </select>
