    ...
    <td style="background-color: <%= bgColor %>">
        <%
         if (listtemplate.size() > 0){
             DocMasterTemplate docMasterTemplate = (DocMasterTemplate) listtemplate.get(0);
			 ...
			 <a href="javascript:cmdSign('<%= docMstr.getOID() %>')" class="btn-small" style="color: #575757;">Sign</a>
             <a href="javascript:cmdAction('<%= docMstr.getOID() %>')" class="btn-small" style="color: #575757;">Action</a>
			 <a href="javascript:cmdUserMapping('<%= docMstr.getOID() %>')" class="btn-small" style="color: #575757;">User Mapping</a>
            <%if(docMasterTemplate.getText_template().contains("${TRAINNER2-LISTDOCEXPENSE-COMPONENT-ADD}")){%>
                <a href="javascript:cmdPayCompMapping('<%= docMstr.getOID() %>')" class="btn-small" style="color: #575757;">Component Mapping</a>
            <%}%>
             <%
        } else {
            %>
