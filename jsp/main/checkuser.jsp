...
boolean privViewAllDivision =userSession.checkPrivilege(AppObjInfo.composeCode(appObjCode, AppObjInfo.COMMAND_VIEW_ALL_DIVISION));
boolean privViewDivGroup = userSession.checkPrivilege(AppObjInfo.composeCode(appObjCode, AppObjInfo.COMMAND_VIEW_DIVISION_GROUP));
boolean privViewOnlyWithSearch = userSession.checkPrivilege(AppObjInfo.composeCode(appObjCode, AppObjInfo.COMMAND_VIEW_ONLY_WITH_SEARCH));
/*System.out.println("=====================");
