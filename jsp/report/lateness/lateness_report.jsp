...
<%!    /**
     ...
     * @return
     * @created by gadnyana edited by Edhy on August 18, 2004
     */
    public Vector cekLateEmployee(Date timeIn, Date timeInSchedule, Date timeOut, Date timeOutSchedule) //public String cekLateEmployee(Date timeIn, Date timeInSchedule,Date timeOut,Date timeOutSchedule,
     ...
     * @param listLate
     * @param dtSch
     * @return created by gadnyana
     */
//update by satrya 2012-10-04
    public Vector drawList(Vector listLate, Date selectedDateFrom, Date selectedTo, Vector listPresencePersonalInOut) //public Vector drawList(Vector listLate, Date dtSch)         
    {
        ...
        ctrlist.addHeader("No", "1%", "2", "");
        ctrlist.addHeader("Date", "2%", "2", "");
        ctrlist.addHeader("Payroll", "3%", "2", "");
        ctrlist.addHeader("Employee", "10%", "2", "");
        ctrlist.addHeader("Symbol", "2%", "2", "");
        ctrlist.addHeader("Schedule", "4%", "2", "");
        ctrlist.addHeader("Actual", "6%", "", "2");
        ctrlist.addHeader("Late", "6%", "", "2");
        ...
        if (listLate != null && listLate.size() > 0) {
           ...
           // String formTime = cekLateEmployee(timeIn1st, latenessDaily.getSchldIn());
                    ...
                    rowx.add("" + num);
                    pres.add("" + num);
                    rowx.add(Formater.formatDate(latenessDaily.getSelectedDate(), "EE,dd/MM/yyyy"));
                    pres.add(Formater.formatDate(latenessDaily.getSelectedDate(), "EE,dd/MM/yyyy"));
                    rowx.add(latenessDaily.getEmpNum());
                    pres.add(latenessDaily.getEmpNum());
                    rowx.add(latenessDaily.getEmpName());
                    pres.add(latenessDaily.getEmpName());
                    rowx.add(latenessDaily.getSchldSymbol());
                    pres.add(latenessDaily.getSchldSymbol());
                    if (schIn == null) {
                        sSchIn = "~";
                    } else {
             ...
             //rowx.add(timeIn1st != null?Formater.formatTimeLocale(timeIn1st):""); pres.add(timeIn1st != null?Formater.formatTimeLocale(timeIn1st):"");
                    ...
                    rowx.add(formTime + "/" + formTimeOut + "/" + formTimeBO + "/" + formTimeBi);
                    pres.add(formTime + "/" + formTimeOut + "/" + formTimeBO + "/" + formTimeBi);
                    ...
                    pres.add(scheduleSymbol.getSymbol());
                    ...
                    rowx.add(timeIn2st != null ? Formater.formatTimeLocale(timeIn2st) : "");
                    pres.add(timeIn2st != null ? Formater.formatTimeLocale(timeIn2st) : "");
            ...
            //rowx.add(formTimeIn +"/"+ formTimeOut +"/"+ formTimeBO +"/"+formTimeBi); pres.add(formTimeIn +"/"+ formTimeOut +"/"+ formTimeBO +"/"+formTimeBi);
                ...
                rowxPdf.add(sActIn);
                rowxPdf.add(sActOut);
                rowxPdf.add(formTime);
                rowxPdf.add(formTimeBi);
                if (!formTime.equals(".")) {
...
//Date date = FRMQueryString.requestDate(request,"date");
    ...
    String lateStat = FRMQueryString.requestString(request, "STAT_1");
    String earlyStat = FRMQueryString.requestString(request, "STAT_2");
//update by satrya 2012-10-03
    ...
    if (iCommand == Command.LIST) {
        ...
        listLateness = SessEmployeeLateness.listLatenessDaily(oidDepartment, oidCompany, oidDivision, selectedDateFrom, selectedDateTo, oidSection, empNum.trim(), fullName.trim(), lateStat, earlyStat);
...
%>
                                                                                            ...
                                                                                            <td width="5%" align="left" nowrap valign="top"><div align="right">Status </div></td>
                                                                                            <td width="59%" nowrap="nowrap">: 
                                                                                                <table>
                                                                                                    <tr>
                                                                                                        <td nowrap>
                                                                                                            <input type="checkbox" name="STAT_1"  value="<%=PstEmpSchedule.strPresenceStatusIdx[1]%>"  />
                                                                                                            <%=PstEmpSchedule.strPresenceStatus[1]%> &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <td nowrap>
                                                                                                            <input type="checkbox" name="STAT_2" value="<%=PstEmpSchedule.strPresenceStatusIdx[5]%>"  />
                                                                                                            <%=PstEmpSchedule.strPresenceStatus[5]%> &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
