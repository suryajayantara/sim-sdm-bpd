                                        ...
                                        <input type="hidden" name="prev_command" value="<%=prevCommand%>">
                                          ...
                                          <td width="86%"> : 
                                            <%
                                                  ...
                                                  Vector listDept = PstDepartment.list(0, 0, PstDepartment.TBL_HR_DEPARTMENT + "." + PstDepartment.fieldNames[PstDepartment.FLD_VALID_STATUS] + " = 1", PstDepartment.fieldNames[PstDepartment.FLD_DEPARTMENT]);
                                        ...
                                        <tr> 
                                          ...
                                          <td width="86%"> : 
                                            <%
                                                  ...
                                                  String filter = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID] + "=" + srcEmpRace.getDepartmentId() + " AND " + PstSection.fieldNames[PstSection.FLD_VALID_STATUS] + " = 1";
