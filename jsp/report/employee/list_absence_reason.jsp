                                                                                            ...
                                                                                            <td width="86%"> : 
                                                                                                <%
                                                                                                    ...
                                                                                                    /*deptKey.add(" ALL DEPARTMET");
                                                                                                     deptValue.add("0");*/
                                                                                                    Vector listDept = PstDepartment.list(0, 0, PstDepartment.TBL_HR_DEPARTMENT + "." + PstDepartment.fieldNames[PstDepartment.FLD_VALID_STATUS] + " = 1", "DEPARTMENT");
                                                                                        ...
                                                                                        <tr> 
                                                                                            ...
                                                                                            <td width="86%"> : 
                                                                                                <%
                                                                                                    ...
                                                                                                    secKey.add(" ALL ");
                                                                                                    secValue.add("0");
                                                                                                    Vector listSec = PstSection.list(0, 0, PstSection.fieldNames[PstSection.FLD_VALID_STATUS] + " = 1", "SECTION");
