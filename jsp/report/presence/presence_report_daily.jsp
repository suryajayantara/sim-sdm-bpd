...
<%
    ...
    if (sectionOfLoginUser.getOID() != 0){
...
<%!    int DATA_NULL = 0;
    ...
    public Vector drawList(JspWriter outObj, int iCommand, Vector listAttendanceRecordDailly, Vector listPresencePersonalInOut, Vector listOvertimeDaily, HolidaysTable holidaysTable, Date selectDateFrom, Date selectDateTo, String fullName, String empNum, boolean privUpdatePresence, int start, int showOvertime, boolean isHRDLogin, I_Atendance attdConfig, Vector vOvertimeDetail, boolean DepAdmin, AppUser appUserSess) {
        ...
        if (listAttendanceRecordDailly != null && listAttendanceRecordDailly.size() > 0) {
            ...
            if (listAttendanceRecordDailly != null && listAttendanceRecordDailly.size() > 0) {
                ...
                try {
                    ...
                    /**
                     * untuk melakukan settingan jika statusnya full day atau
                     * jam-jam'an
                *
                     */
                    ...
                    String oidcutiPenting = String.valueOf(PstSystemProperty.getValueByName("OID_CUTI_PENTING"));
                    ...
                    for (int i = 0; i < listAttendanceRecordDailly.size(); i++) {
                        ...
                        /**
                         * update by satrya untuk menampilkan AL,LL, DP,etc
               *
                         */
                        long oidLeave = 0;
                        String sSymbolLeave = "";
                        ...
                        if (listLeaveAplication != null && listLeaveAplication.size() > 0) {
                            ...
                            try {
                                for (int j = 0; j < listLeaveAplication.size(); j++) {
                                    ...
                                    String sSymbolLeaveX ="";
                                    if (leaveOidSym.getTypeLeaveCategory() == 1 ){
                                        sSymbolLeaveX = (PstScheduleSymbol.getScheduleSymbol(Long.parseLong(oidChildBirth)));
                                    } else if (leaveOidSym.getTypeLeaveCategory() == 2 ){ 
                                        sSymbolLeaveX = (PstScheduleSymbol.getScheduleSymbol(Long.parseLong(oidcutiPenting)));
                                    }else {
                                        sSymbolLeaveX = (String.valueOf(leaveOidSym.getLeaveSymbol()));
                                    }
                        ...
                        long leaveOID = 0;
                        try {
                            leaveStatus = PstLeaveApplication.getLeaveFormStatus(lEmpId, dtSchldIn1st, dtSchldOut1st, presenceReportDaily.getScheduleId1());
                            leaveOID = PstLeaveApplication.getOIDLeave(lEmpId, dtSchldIn1st, dtSchldOut1st);
                        } catch (Exception ex) {
                            System.out.println("Leave leave Status" + ex);
                        }
                        
                        boolean isSPJ = PstEmpDoc.isScheduleSPJ(""+presenceReportDaily.getScheduleId1());
                        long oidEmpDoc = 0;
                        String cmdEmpDoc = "";
                        if (isSPJ){
                            oidEmpDoc = PstEmpDoc.getDocOidByDate(presenceReportDaily.getSelectedDate(), lEmpId);
                            cmdEmpDoc = "<a href=javascript:cmdViewDoc('" + oidEmpDoc + "')><font color=\"#00000\"> [View Doc]</font></a>";
                        }
                        ...
                        Date dtSchldIn2nd = null;//(Date) presenceReportDaily.getScheduleIn2nd();
                        Date dtSchldOut2nd = null;//(Date) presenceReportDaily.getScheduleOut2nd();
                        Date dtActualIn2nd = null;//(Date) presenceReportDaily.getActualIn2nd();
                        Date dtActualOut2nd = null;//(Date) presenceReportDaily.getActualOut2nd();
                        ///update by satrya 2012-07-23
                ...
                /*long diffBo = 0L;
                            ...
                            for (int bIdx = 0; bIdx < listPresencePersonalInOut.size(); bIdx++) {
                                ...
                                if (presenceBreak.getEmployeeId() == presenceReportDaily.getEmpId() && presenceBreak.getPresenceDatetime() != null
                                    ...
                                    if (presenceBreak.getStatus() == Presence.STATUS_OUT_ON_DUTY) {
                                        ...
                                        hashCekTanggalSamaBreak.put(presenceBreak.getPresenceDatetime(), true);
                                        bIn = bIn + "D:" + "" + Formater.formatDate(presenceBreak.getPresenceDatetime(), "HH:mm") + "<br>";
                                        bInPdf = bInPdf + "D:" + Formater.formatDate(presenceBreak.getPresenceDatetime(), "d/M/yy") + " " + Formater.formatDate(presenceBreak.getPresenceDatetime(), "HH:mm") + "<br>";
                                    ...
                                    if (presenceBreak.getStatus() == Presence.STATUS_OUT_PERSONAL) {
                                        ...
                                        hashCekTanggalSamaBreak.put(presenceBreak.getPresenceDatetime(), true);
                                        bOut = bOut + "D:" + "" + Formater.formatDate(presenceBreak.getPresenceDatetime(), "HH:mm") + "<br>";
                                        bOutPdf = bOutPdf + "D:" + Formater.formatDate(presenceBreak.getPresenceDatetime(), "d/M/yy") + " " + Formater.formatDate(presenceBreak.getPresenceDatetime(), "HH:mm") + "<br>";
                                        dBout = dBout + "D:" + Formater.formatDate(presenceBreak.getPresenceDatetime(), "HH:mm");
                                        ispreBreakOutsdhdiambil = false;
                                        listPresencePersonalInOut.remove(bIdx);
                                        ...
                                        if (vLisOverlapCuti != null && vLisOverlapCuti.size() > 0) {
                                            for (int idxcuti = 0; idxcuti < vLisOverlapCuti.size(); idxcuti++) {
                                                ...
                                                if (leaveCheckTaken.getTakenDate() != null && dtBreakOut != null
                                                    ...
                                                    bOut = bOut + "P:" + "<font color=\"#FF0000\">" + Formater.formatDate(dtBreakOut, "HH:mm") + "</font><br>";
                                                    bOutPdf = bOutPdf + "P:" + Formater.formatDate(dtBreakOut, "d/M/yy") + "<font color=\"#FF0000\">" + Formater.formatDate(dtBreakOut, "HH:mm") + "</font><br>";
                                                    dBout = dBout + "P:" + "" + Formater.formatDate(dtBreakOut, "HH:mm") + "";
                                                } else {
                                                    hashCekTanggalSamaBreak.put(dtBreakOut, true);
                                                    bOut = bOut + "P:" + "" + Formater.formatDate(dtBreakOut, "HH:mm") + "<br>";
                                                    bOutPdf = bOutPdf + "P:" + Formater.formatDate(dtBreakOut, "d/M/yy") + "" + Formater.formatDate(dtBreakOut, "HH:mm") + "<br>";
                                                    dBout = dBout + "P:" + "" + Formater.formatDate(dtBreakOut, "HH:mm") + "";
                                                }
                                                ...
                                                if (dtSchEmpScheduleBIn != null && dtBreakIn != null
                                                    ...
                                                    bIn = bIn + "P:" + "<font color=\"#FF0000\">" + Formater.formatDate(dtBreakIn, "HH:mm") + "</font><br>";
                                                    bInPdf = bInPdf + "P:" + Formater.formatDate(dtBreakIn, "d/M/yy") + "<font color=\"#FF0000\">" + Formater.formatDate(dtBreakIn, "HH:mm") + "</font><br>";
                                                    dBin = dBin + "P:" + "" + Formater.formatDate(dtBreakIn, "HH:mm") + "";

                                                } else {
                                                    hashCekTanggalSamaBreak.put(dtBreakIn, true);
                                                    bIn = bIn + "P:" + "<br>" + Formater.formatDate(dtBreakIn, "HH:mm") + "<br><br>";
                                                    bInPdf = bInPdf + "P:" + Formater.formatDate(dtBreakIn, "d/M/yy") + "<br>" + Formater.formatDate(dtBreakIn, "HH:mm") + "<br><br>";
                                                    dBin = dBin + "P:" + "" + Formater.formatDate(dtBreakIn, "HH:mm") + "";
                                                }
                                            ...
                                            if (preBreakInX != 0 && (hashCekTanggalSamaBreak.size() == 0 || !hashCekTanggalSamaBreak.containsKey(dtBreakIn))) {
                                                if (preBreakInX > dtSchEmpScheduleBIn.getTime()) {
                                                    ...
                                                    hashCekTanggalSamaBreak.put(dtBreakIn, true);
                                                    dBin = dBin + "P:" + "" + Formater.formatDate(dtBreakIn, "HH:mm") + "";
                                                    bIn = bIn + "P:" + "<br>" + Formater.formatDate(dtBreakIn, "HH:mm") + "<br>";
                                                    bInPdf = bInPdf + "P:" + Formater.formatDate(dtBreakIn, "d/M/yy") + "<br>" + Formater.formatDate(dtBreakIn, "HH:mm") + "<br>";
                                                }
                                            }
                                        }
                            ...
                            if (strSchldSymbol1 != null && strSchldSymbol1.length() > 0) {
                                ...
                                if (Al_oid != presenceReportDaily.getScheduleId1() && LL_oid != presenceReportDaily.getScheduleId1() && DP_oid != presenceReportDaily.getScheduleId1()) {
                                    if (iLeaveMinuteEnable != 1) {
                                        sSymbol = "<input type=\"hidden\"   id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\" /> "
                                                + "<p title =\"" + strSchINOut + "&nbsp;[" + sDtSchldBO1st + "&nbsp;" + sDtSchldBI1st + "] \">" + strSchldSymbol1.toUpperCase() + "</p>";
                                        ...
                                        if (sSymbolLeave != null && sSymbolLeave.length() > 0) {
                                            sSymbol = "<input type=\"hidden\"   id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\" /> "
                                                    + "<p title =\"" + strSchINOut + "&nbsp;[" + sDtSchldBO1st + "&nbsp;" + sDtSchldBI1st + "]\">" + strSchldSymbol1.toUpperCase() + "</p>" + " / <B> - " + sSymbolLeave + "</B>";// +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                        } else {
                                            sSymbol = "<input type=\"hidden\"   id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\" /> "
                                                    + "<p title =\"" + strSchINOut + "&nbsp;[" + sDtSchldBO1st + "&nbsp;" + sDtSchldBI1st + "]\">" + strSchldSymbol1.toUpperCase() + "</p>";//+"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                        }
                                    }
                                } else {
                                    if (iLeaveMinuteEnable != 1) {
                                ...
                                sSymbol = "<input type=\"hidden\"   id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\" /> "
                                        + "<p title =\"" + strSchINOut + "&nbsp;[00:00 &nbsp; 00:00]\">" + strSchldSymbol1.toUpperCase() + "</p>";
                            }
                        } else {
                           if (strSchldSymbol1 != null && strSchldSymbol1.length() > 0) {
                                ...
                                if (Al_oid != presenceReportDaily.getScheduleId1() && LL_oid != presenceReportDaily.getScheduleId1() && DP_oid != presenceReportDaily.getScheduleId1()) {
                                    if (iLeaveMinuteEnable != 1) {
                                        sSymbol = "<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"text\"   id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\"  size=\"3\" "
                                                + "title =\"" + strSchINOut + "&nbsp;[" + sDtSchldBO1st + "&nbsp;" + sDtSchldBI1st + "]\">";// +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                    ...
                                    if (iLeaveMinuteEnable != 1) {
                                        ...
                                        sSymbol = "<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"text\"  id=\"inputName\" name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1.toUpperCase() + "\"  size=\"3\" "
                                                + "                                         title =\"" + strSchINOut + "&nbsp;[" + sDtSchldBO1st + "&nbsp;" + sDtSchldBI1st + "]\">" + " / <B>" + sSymbolLeave + "</B>";//  +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                    }
                                }
                            } else {
                                //sSymbol ="<input onblur=\"javascript:checkSymbol(this)\" type=\"text\"  name=\"" + inputName + "_symbol\" value=\"" + strSchldSymbol1 + "\"  size=\"3\">";
                                ...
                                if (Al_oid != presenceReportDaily.getScheduleId2() && LL_oid != presenceReportDaily.getScheduleId2() && DP_oid != presenceReportDaily.getScheduleId2()) {
                                    if (iLeaveMinuteEnable != 1) {
                                        sSymbol2nd = "<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"text\"   id=\"inputName\" name=\"" + inputName2nd + "_symbol\" value=\"" + strSchldSymbol2.toUpperCase() + "\"  size=\"3\" "
                                                + "title =\"" + strScheduleDesc2nd + "&nbsp;[" + sDtSchldBO2nd + "&nbsp;" + sDtSchldBI2nd + "]\">";// +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";

                                    } else {
                                        if (sSymbolLeave != null && sSymbolLeave.length() > 0) {
                                            sSymbol2nd = "<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"text\"  id=\"inputName\" name=\"" + inputName2nd + "_symbol\" value=\"" + strSchldSymbol2.toUpperCase() + "\"  size=\"3\" "
                                                    + "title =\"" + strScheduleDesc2nd + "&nbsp;[" + sDtSchldBO2nd + "&nbsp;" + sDtSchldBI2nd + "]\">" + " / <B>" + sSymbolLeave + "</B>";// +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                        } else {
                                            sSymbol2nd = "<input class=\"masterTooltip\" onblur=\"javascript:checkSymbol(this)\" type=\"text\" id=\"inputName\" name=\"" + inputName2nd + "_symbol\" value=\"" + strSchldSymbol2.toUpperCase() + "\"  size=\"3\""
                                                    + "title =\"" + strScheduleDesc2nd + "&nbsp;[" + sDtSchldBO2nd + "&nbsp;" + sDtSchldBI2nd + "]\">";//+"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                        }
                        ...
                        if (presenceReportDaily.getScheduleId2() != 0) {
                            if (presenceReportDaily.getScheduleId2() == Al_oid && presenceReportDaily.getScheduleId2() != 0 || sSymbolLeave.equalsIgnoreCase("AL")) {
                                if (leaveStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                                    ...
                                    cmdLeaveSript2nd = "<a href=javascript:cmdEditLeave('" + presenceReportDaily.getEmpId() + "','" + leaveOID + "')><font color=\"#00000\"> [View]</font></a>";
                                } else {
                                    cmdLeaveSript2nd = "<a href=javascript:cmdEditLeave('" + presenceReportDaily.getEmpId() + "','" + leaveOID + "')><font color=\"#FF0000\"><blink>[Open]</<blink></font></a>";
                                }
                        ...
                        if (presenceReportDaily.getScheduleId1() != 0) {
                            ...
                            if (leaveStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {//presenceReportDaily.getScheduleId1() == Al_oid && presenceReportDaily.getScheduleId1() != 0 || (sSymbolLeave!=null && sSymbolLeave.length()>0)){
                                ...
                                if (leaveStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                                    //"<a href=\"javascript:cmdNewLeave('" +  presenceReportDaily.getEmpId() + "','" + lDatePresence + "');\"><center>New</center></a>";
                                    cmdLeaveSript = "<a href=javascript:cmdEditLeave('" + presenceReportDaily.getEmpId() + "','" + leaveOID + "')><font color=\"#00000\"> [View]</font></a>";
                                    if (listLeaveAplication != null && listLeaveAplication.size() > 0) {
                                        cmdLeaveSript = cmdLeaveSript + " <br><br> <a href=javascript:cmdNewLeave('" + presenceReportDaily.getEmpId() + "','" + lDatePresence + "')>[New]</a>";
                                    }
                                } else {
                                    cmdLeaveSript = "<a href=javascript:cmdEditLeave('" + presenceReportDaily.getEmpId() + "','" + leaveOID + "')><font color=\"#FF0000\"><blink>[Open]</<blink></font></a>";
                                    if (listLeaveAplication != null && listLeaveAplication.size() > 0) {
                                        cmdLeaveSript = cmdLeaveSript + " <br><br><a href=javascript:cmdNewLeave('" + presenceReportDaily.getEmpId() + "','" + lDatePresence + "')>[New]</a>";
                                    }
                                }
...
//loop untuk b-Out / B-In
                            ...
                            if (attdConfig != null && attdConfig.getConfigurasiReportScheduleDaily() == I_Atendance.CONFIGURASI_I_REPORT_DAILY_SCHEDULE_AND_CEK_BOX_ADA_DIBELAKANG) {
                                ...
                                //end duration
                                rowx.add(sSymbol + "&nbsp;"+ cmdEmpDoc + "<br>" + (cmdAddAttd.length() > 0 ? cmdAddAttd + " || " : "") + cmdEditAttendace + " || " + cmdEditAttendanceManual);
                                //untuk menampilkan status Leave
    ...
    /**
     * create by satrya 2013-11-27 Keterangan: user hanya bisa melihat attdance
            ...
            if (listAttendanceRecordDailly != null && listAttendanceRecordDailly.size() > 0) {
                ...
                try {
                    ...
                    *
                     ...
                     * untuk cek apakah department house kipping perlu dtp
                     * insentif
                    *
                     */
                    int iPropInsentifLevel = 0;//hanya cuti full day jika fullDayLeave = 0 
                            ...
                            for (int bIdx = 0; bIdx < listPresencePersonalInOut.size(); bIdx++) {
                                ...
                                if (presenceBreak.getEmployeeId() == presenceReportDaily.getEmpId() && presenceBreak.getPresenceDatetime() != null
                                    ...
                                    if (presenceBreak.getStatus() == Presence.STATUS_OUT_ON_DUTY) {
                                        ...
                                        bOut = bOut + "D:" + Formater.formatDate(presenceBreak.getPresenceDatetime(), "HH:mm") + "<br>";
                                        bOutPdf = bOutPdf + "D:" + Formater.formatDate(presenceBreak.getPresenceDatetime(), "HH:mm") + Formater.formatDate(presenceBreak.getPresenceDatetime(), "HH:mm") + "<br>";
                                        ...
                                        if (vLisOverlapCuti != null && vLisOverlapCuti.size() > 0) {
                                            for (int idxcuti = 0; idxcuti < vLisOverlapCuti.size(); idxcuti++) {
                                                ...
                                                if (dtSchEmpScheduleBIn != null && dtBreakIn != null
                                                    ...
                                                    bIn = bIn + "P:" + Formater.formatDate(dtBreakIn, "HH:mm") + "<br>";
                                                    bInPdf = bInPdf + "P:" + Formater.formatDate(dtBreakIn, "d/M/yy") + " " + Formater.formatDate(dtBreakIn, "HH:mm") + "<br>";
                                                }
                        ...
                        if (strSchldSymbol1 != null && strSchldSymbol1.length() > 0) {
                            ...
                            if (Al_oid != presenceReportDaily.getScheduleId1() && LL_oid != presenceReportDaily.getScheduleId1() && DP_oid != presenceReportDaily.getScheduleId1()) {
                                if (iLeaveMinuteEnable != 1) {
                                    ...
                                    if (sSymbolLeave != null && sSymbolLeave.length() > 0) {
                                        sSymbol = "<p title =\"" + strSchINOut + "&nbsp;[" + sDtSchldBO1st + "&nbsp;" + sDtSchldBI1st + "]\">" + strSchldSymbol1.toUpperCase() + "</p>" + " / <B> - " + sSymbolLeave + "</B>";// +"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                    } else {
                                        sSymbol = "<p title =\"" + strSchINOut + "&nbsp;[" + sDtSchldBO1st + "&nbsp;" + sDtSchldBI1st + "]\">" + strSchldSymbol1.toUpperCase() + "</p>";//+"<a href=\"#\" id=\"clueTipBox\" class=\"clueTipBox\" title=\"Title Text|This box will open when text box get focus OR mouse hover on 'Hint' text.\">Hint</a>";
                                    }
                                }
                            } else {
                                if (iLeaveMinuteEnable != 1) {
...
// get data from form request
    ...
    long lDateSelected = FRMQueryString.requestLong(request, "lDate");
    if (lDateSelected > 0){
    ...
    String[] arrSymbol = FRMQueryString.requestStringValues(request, "hidden_symbolId");
    ...
    if (arrSymbol != null){
        for (int i=0; i < arrSymbol.length; i++){
            inSymbol = inSymbol + ","+ arrSymbol[i];
        }
        inSymbol = inSymbol.substring(1);
    }
...
//    long oidSection = FRMQueryString.requestLong(request, "section");
    ...
    if (appUserSess.getAdminStatus()==0){
        inCompany = ""+emplx.getCompanyId();
        if (!privViewAllDivision){
            inDivision = ""+emplx.getDivisionId();
   ...
   if (userGroupList != null && userGroupList.size() > 0) {
    ...
    String wh = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID] + " IN (" + inDepartment+")";
                    ...
                    if (source != null && source.length() > 0 && source.equalsIgnoreCase("analyzePresence")) {
                       ...
                       long oidph = PstSystemProperty.getPropertyLongbyName("OID_PUBLIC_HOLIDAY");
                         ...
                         */
                         ...
                         String sday = Formater.formatDate(dtSelect, "yyyy-MM-dd");
                         ...
                         if ( vctSchIDOff != null && vctSchIDOff.size() > 0 && vctSchIDOff.containsKey(""+oidSch1nd)){
...
//update by satrya 2013-04-3
    if (iCommand != Command.GOTO) {
         PayPeriod payPeriod = new PayPeriod();
            try{
                payPeriod = PstPayPeriod.getPayPeriodBySelectedDate(selectedDateFrom);
            }catch(Exception e){}
            
            if (payPeriod == null ){
                payPeriod = new PayPeriod();
            }
        vectSize = SessEmpSchedule.getCountSessEmpScheduleIn(sessEmpSchedule, inDepartment, selectedDateFrom, selectedDateTo, inSection, empNum, fullName, stsScheduleSel, stsPresenceSel, reason_sts, stsEmpCategorySel, statusResign, inCompany, inDivision, payPeriod.getStartDate(), payPeriod.getEndDate());
    }
    try {
        if (selectedDateFrom != null && selectedDateTo != null) {
            sessEmpSchedule.setInDepartment(inDepartment);
            ...
            sessEmpSchedule.setInSection(inSection);
            sessEmpSchedule.setReasonSts(reason_sts);
            //update by satrya 2013-12-03
            sessEmpSchedule.setInCompany(inCompany);
            sessEmpSchedule.setInDivision(inDivision);
...
//vectListAL = SessLeaveManagement.listSummaryAlStockInt(srcLeaveManagement, start, recordToGet); 
        ...
        if (sessEmpSchedule != null) {
            listAttendanceRecordDailly = SessEmpSchedule.listEmpPresenceDailyIn(sessEmpSchedule.getInDepartment(), sessEmpSchedule.getFromDate(), sessEmpSchedule.getToDate(),
                    sessEmpSchedule.getInSection(), sessEmpSchedule.getEmpNum().trim(), sessEmpSchedule.getEmpFullName().trim(),
                    sessEmpSchedule.getStatus1(), sessEmpSchedule == null && sessEmpSchedule.getStart() == 0 ? start : sessEmpSchedule.getStart(), recordToGet, stsPresenceSel, sessEmpSchedule.getReasonSts(), stsEmpCategorySel, statusResign, sessEmpSchedule.getInCompany(), sessEmpSchedule.getInDivision(), 0 , inSymbol);


        } else {
            listAttendanceRecordDailly = SessEmpSchedule.listEmpPresenceDailyIn(inDepartment, selectedDateFrom, selectedDateTo, inSection, empNum, fullName, stsScheduleSel, start, recordToGet, stsPresenceSel, reason_sts, stsEmpCategorySel, statusResign, inCompany, inDivision, 0 , inSymbol);
        }
...
//      , sessEmpSchedule.getFromDate(), sessEmpSchedule.getToDate(), sessEmpSchedule.getSection(), sessEmpSchedule.getEmpNum().trim());
            listPresencePersonalInOut = PstPresence.listIn(0, 0, order, sessEmpSchedule.getInDepartment(), sessEmpSchedule.getEmpFullName().trim(), sessEmpSchedule.getFromDate(), sessEmpSchedule.getToDate(), sessEmpSchedule.getInSection(), sessEmpSchedule.getEmpNum().trim(), stsPresenceSel, stsEmpCategorySel, statusResign, sessEmpSchedule.getInCompany(), sessEmpSchedule.getInDivision());//di tambahkan stsPresenceSel
...
//  selectedDateFrom, selectedDateTo, oidSection, empNum.trim());
            ...
            listPresencePersonalInOut = PstPresence.listIn(0, 0, order, inDepartment, fullName.trim(),  selectedDateFrom, selectedDateTo, inSection, empNum.trim(), stsPresenceSel, stsEmpCategorySel, statusResign, inCompany, inDivision);
        }
//update by satrya 2012-09-13
        if (showOvertime == 0) {
            if (sessEmpSchedule != null) {
                listOvertimeDaily = PstOvertimeDetail.listOvertimeIn(0, 0, sessEmpSchedule.getInDepartment(), sessEmpSchedule.getEmpFullName().trim(),
                        sessEmpSchedule.getFromDate(), sessEmpSchedule.getToDate(), sessEmpSchedule.getInSection(), sessEmpSchedule.getEmpNum().trim(), "", stsPresenceSel, sessEmpSchedule.getInCompany(), sessEmpSchedule.getInDivision());

                vOvertimeDetail = PstOvertimeDetail.listOvertimeDetailIn(0, 0, sessEmpSchedule.getInDepartment(), sessEmpSchedule.getEmpFullName().trim(),
                        sessEmpSchedule.getFromDate(), sessEmpSchedule.getToDate(), sessEmpSchedule.getInSection(), sessEmpSchedule.getEmpNum().trim(), "", stsPresenceSel, sessEmpSchedule.getInCompany(), sessEmpSchedule.getInDivision());
            } else {
                listOvertimeDaily = PstOvertimeDetail.listOvertimeIn(0, 0, inDepartment, fullName.trim(),
                        selectedDateFrom, selectedDateTo, inSection, empNum.trim(), "", stsPresenceSel, inSection, inDivision);
...
tmt_url_640 = "presence_report_daily_20130522.jsp";
    ...
    self.location.replace(tmt_url_640);
            ...
            <%}
                    ...
                    function cmdViewDoc(oid){
                        window.open("<%=approot%>/employee/document/EmpDocumentDetails.jsp?EmpDocument_oid="+oid);
                    ...
                    function cmdNewLeave(employeeId, requestDateDaily){            
                        ...
                        var linkPage = "<%=approot%>/employee/leave/leave_app_form.jsp?employee_id="+employeeId+"&requestDateDaily="+requestDateDaily; 
                    ...
                    function cmdEditLeave(employeeId, leaveId){            
                        ...
                        var linkPage = "<%=approot%>/employee/leave/leave_list_emp.jsp?source=presence&employee_id="+employeeId+"&leaveid="+leaveId;  
                    ...
                    function cmdSendEmail(){
                        ...
                        document.frpresence.command.value="";
                        document.frpresence.source.value="";
                        //document.frpresence.start.value=0; 
                        document.frpresence.action="editPenerima.jsp";
                        document.frpresence.target = "_blank";
                        document.frpresence.submit();
                }
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="30%" nowrap="nowrap">:
                                                                                                <input class="masterTooltip" placeholder="Type Employee Number.." type="text" size="40" name="emp_number"  value="<%= sessEmpSchedule != null && sessEmpSchedule.getEmpNum() != null ? sessEmpSchedule.getEmpNum() : empNum%>" title="You can Input Payroll Number more than one, ex-sample : 1111,2222" class="elemenForm" onKeyDown="javascript:fnTrapKD()" <%=strDisableNum%> >
                                                                                            </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="30%" nowrap="nowrap">:
                                                                                                <select name="hidden_companyId" id="company" class="chosen-select" data-placeholder='Select Company...' multiple onchange="javascript:cmdUpdateDiv()" <%= strDisable %> style='width:60%' >
<!--                                                                                                    <option value="0">-select-</option>-->
                                                                                                ...
                                                                                                if (strDisable.length()>0){
                                                                                                    %>
                                                                                                    <input type="hidden" name="hidden_companyId" id="company" value="<%= inCompany %>" />
                                                                                                    <%
                                                                                                }
                                                                                                %>
                                                                                            </td>
                                                                                            ...
                                                                                            <td width="59%" nowrap="nowrap">:
                                                                                                ...
                                                                                                %>
                                                                                                <select name="hidden_divisionId" id="division" class="chosen-select" data-placeholder='Select Division...' multiple onchange="javascript:cmdUpdateDep()" <%= strDisable %> style='width:80%'>
                                                                                                    <!--<option value="0">-select-</option>-->
                                                                                                    <%
                                                                                                    if(!inCompany.equals("")){
                                                                                                        ...
                                                                                                        if (listDivision != null && listDivision.size()>0){
                                                                                                            for(int i=0; i<listDivision.size(); i++){
                                                                                                                ...
                                                                                                                if (arrDivision != null){
                                                                                                                    boolean selected = Arrays.asList(arrDivision).contains(""+divisi.getOID());
                                                                                                                    if (selected){
                                                                                                ...
                                                                                                if (strDisable.length()>0){
                                                                                                    %>
                                                                                                    <input type="hidden" name="hidden_divisionId" id="division" value="<%= inDivision %>" />
                                                                                                    <%
                                                                                                }
                                                                                                %>
                                                                                            </td>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="30%" nowrap="nowrap">:
                                                                                                <select name="department" id="department" class="chosen-select" data-placeholder='Select Department...' multiple onchange="javascript:cmdUpdatePos()" style='width:60%'>
                                                                                                <!--<option value="0">-select-</option>-->
                                                                                                <%
                                                                                                if (!inDivision.equals("")){
                                                                                                    Vector listDepart = PstDepartment.listDepartmentVer1In(0, 0, inCompany , inDivision);
                                                                                                    if (listDepart != null && listDepart.size()>0){
                                                                                                        for(int i=0; i<listDepart.size(); i++){
                                                                                                            Department depart = (Department)listDepart.get(i);
                                                                                                            if (arrDepartment != null){
                                                                                                                boolean selected = Arrays.asList(arrDepartment).contains(""+depart.getOID());
                                                                                                                if (selected){
                                                                                            ...
                                                                                            <td width="59%" nowrap="nowrap">:
                                                                                                <select name="section" id="section" class="chosen-select" data-placeholder='Select Section...' multiple style='width:80%'>
                                                                                                    <!--<option value="0">-select-</option>-->
                                                                                                    <%
                                                                                                    if (!inDepartment.equals("")){
                                                                                                        String whereSection = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID]+" IN ("+inDepartment+") AND " + PstSection.fieldNames[PstSection.FLD_VALID_STATUS]+"= 1";
                                                                                                        ...
                                                                                                        if (listSection != null && listSection.size()>0){
                                                                                                            for(int i=0; i<listSection.size(); i++){
                                                                                                                ...
                                                                                                                if (arrSection != null){
                                                                                                                    boolean selected = Arrays.asList(arrSection).contains(""+section.getOID());
                                                                                                                    if (selected){
...
%>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            %>
                                                                                            <td width="5%" align="right" nowrap><div align="left">Symbol </div></td>
                                                                                            <td>:
                                                                                                <%
                                                                                                     if (appUserSess.getAdminStatus()==0){
                                                                                                        inCompany = ""+emplx.getCompanyId();
                                                                                                ...
                                                                                                %>
                                                                                                <select name="hidden_symbolId" id="symbol" class="chosen-select" data-placeholder='Select Symbol...' multiple onchange="javascript:cmdUpdateDep()" <%= strDisable %> style='width:80%'>
                                                                                                    <%
                                                                                                        Vector<ScheduleSymbol> listSymbol = PstScheduleSymbol.list(0,0, "" , "");
                                                                                                        for (ScheduleSymbol symbol : listSymbol) {
                                                                                                            boolean selected = false;
                                                                                                            if (arrSymbol != null){
                                                                                                                selected = Arrays.asList(arrSymbol).contains(""+symbol.getOID());
                                                                                                            }
                                                                                                            out.print("<option " + (selected ? "selected":"") + " value='" + symbol.getOID() + "'>" + symbol.getSymbol() + "</option>");
                                                                                                        }
                                                                                                    %>
                                                                                                </select>
                                                                                            </td>
                                                                                            ...
                                                                                            <td width="30%">
                                                                                                <table border="0" cellspacing="0" cellpadding="0" width="137">
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="94" class="command" nowrap><a href="javascript:cmdView()">View Presence</a></td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                        </tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><table width="18%" border="0" cellspacing="1" cellpadding="1">
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td width="15%"><a href="javascript:cmdSendEmail()"><img src="<%=approot%>/images/excel.png" width="24" height="24" border="0"></a></td>
