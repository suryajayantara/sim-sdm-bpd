                ...
                startPeriodPresence = startPeriodPresence - 1;
                {
                    ...
                    for (int isch = 0; isch < empSchedules.size(); isch++) {
                        ...
                        if (schldSymbol != null && schldSymbol.length() > 0) {
                            ...
                            if (dateActualIn != null && dateActualOut != null) {
                                ...
                                if (strDuration != null && strDuration.length() > 0) {
                                    totalPresence += 1;
                                                    ...
                                                    //strDuration = ""+schldSymbol; UPDATED BY DEWOK 20190411, SYMBOL DAN DURASI JAM DI MUNCULKAN KEDUANYA, AGAR TAU KALO ADA YG LEMBUR
                            ...
                            //UPDATED BY DEWOK 20190411, SYMBOL DAN DURASI JAM DI MUNCULKAN KEDUANYA, AGAR TAU KALO ADA YG LEMBUR
                            rowxMonth.add("<b style='color: blue'>" + schldSymbol + "</b> " + strDuration);
                                                            ...
                                                            <tr> 
                                                                <td valign="top"> 
                                                                  ...
                                                                  //update by satrya 2013-08-13
                                                                                                    ...
                                                                                                    if (oidDivision != 0) {
                                                                                                        if (whereComp != null && whereComp.length() > 0) {
                                                                                                            whereComp = "(" + whereComp + ") AND d." + PstDivision.fieldNames[PstDivision.FLD_DIVISION_ID] + "=" + oidDivision + " AND d." + PstDivision.fieldNames[PstDivision.FLD_VALID_STATUS] + " = 1";
                                                                                                        }
