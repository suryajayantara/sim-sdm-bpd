...
<%  
    ...
    /* update : add field custom | 2017-03-02 */
    String[] fieldCustom = FRMQueryString.requestStringValues(request, "field_custom");
    ...
    /* update : show_tbl_custom_field | 2017-03-01 */
    int showTblCustomField = FRMQueryString.requestInt(request, "show_tbl_custom_field");
    ...
    if (commandCustom != null && commandCustom.length() > 0){
        ...
        if (commandCustom.equals("save_custom_field")){
            if (fieldCustom != null && fieldCustom.length > 0){
                for(int c=0; c<fieldCustom.length; c++){
                    try {
                        CustomFieldMaster dataField = PstCustomFieldMaster.fetchExc(Long.valueOf(fieldCustom[c]));
                        customRptConfig.setRptConfigTableGroup(PstCustomFieldMaster.TBL_CUSTOM_FIELD_MASTER);
                        customRptConfig.setRptConfigTableName(PstCustomFieldMaster.TBL_CUSTOM_FIELD_MASTER);
                        customRptConfig.setRptConfigFieldName(String.valueOf(dataField.getOID()));
                        customRptConfig.setRptConfigFieldHeader(dataField.getFieldName());
                        customRptConfig.setRptConfigFieldType(1);
                        customRptConfig.setRptConfigDataType(4);
                        customRptConfig.setRptConfigDataGroup(0);
                        customRptConfig.setRptMainId(oidCustom);
                        PstCustomRptConfig.insertExc(customRptConfig);
                    } catch(Exception e){
        ...
        /* update add no rekening kredit | 2017-03-07 */
        if (commandCustom.equals("rekening_kredit")){
            try {
                customRptConfig.setRptConfigTableGroup("pay_config_potongan");
                customRptConfig.setRptConfigTableName("pay_config_potongan");
                customRptConfig.setRptConfigFieldName("no_rekening");
                customRptConfig.setRptConfigFieldHeader("No. Rekening");
                customRptConfig.setRptConfigFieldType(1);
                customRptConfig.setRptConfigDataType(5); /* keyword 5*/
                customRptConfig.setRptConfigDataGroup(0);
                customRptConfig.setRptMainId(oidCustom);
                PstCustomRptConfig.insertExc(customRptConfig);
            } catch(Exception e){
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function showFields(id){
                ...
                document.<%=FrmCustomRptConfig.FRM_NAME_CUSTOM_RPT_CONFIG%>.show_tbl_custom_field.value = "0";
                getCmd();
            }
            ...
            function showCustomField(){
                ...
                document.<%=FrmCustomRptConfig.FRM_NAME_CUSTOM_RPT_CONFIG%>.show_table_data_list.value = "0";
                document.<%=FrmCustomRptConfig.FRM_NAME_CUSTOM_RPT_CONFIG%>.show_table_component.value = "0";
                document.<%=FrmCustomRptConfig.FRM_NAME_CUSTOM_RPT_CONFIG%>.show_tbl_custom_field.value = "1";
                getCmd();
            }
            function addCustomField(){
                document.<%=FrmCustomRptConfig.FRM_NAME_CUSTOM_RPT_CONFIG%>.command_custom.value = "save_custom_field";
                document.<%=FrmCustomRptConfig.FRM_NAME_CUSTOM_RPT_CONFIG%>.show_tbl_custom_field.value = "0";
                getCmd();
            }
            ...
            function addNoRekenging(){
                document.<%=FrmCustomRptConfig.FRM_NAME_CUSTOM_RPT_CONFIG%>.command_custom.value = "rekening_kredit";
                getCmd();
            }
        </script>
    </head>
                                    ...
                                    <tr>
                                            <td style="background-color:#EEE;" valign="top">
                                                <form name="<%=FrmCustomRptConfig.FRM_NAME_CUSTOM_RPT_CONFIG%>" method="POST" action="">
                                                    ...
                                                    <input type="hidden" name="show_tbl_custom_field" value="<%=showTblCustomField%>" />
                                            <table style="padding:9px; border:1px solid #00CCFF;" <%=garisContent%> width="100%" border="0" cellspacing="1" cellpadding="1" class="tablecolor">
                                                <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td border="1" valign="top">
                                                                    <table id="part">
                                                                        ...
                                                                        <tr>
                                                                            <td><button id="btn" onclick="showCustomField()">Custom Field</button></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td valign="top">
                                                                                <table id="tbl1">
                                                                                    <%
                                                                                    whereComp = " RPT_CONFIG_DATA_TYPE = 4 AND RPT_CONFIG_DATA_GROUP = 0 AND RPT_MAIN_ID = "+oidCustom+" ";
                                                                                    tdColor = "";              
                                                                                    listComp = PstCustomRptConfig.list(0, 0, whereComp, "");
                                                                                    if (listComp !=null && listComp.size()>0){
                                                                                        for(int j=0; j<listComp.size(); j++){
                                                                                            CustomRptConfig dataField = (CustomRptConfig)listComp.get(j);
                                                                        ...
                                                                        <tr>
                                                                            <td><button id="btn" onclick="addNoRekenging()">Add No.Rekening Kredit</button></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td valign="top">
                                                                                <table id="tbl1">
                                                                                    <%
                                                                                    whereComp = " RPT_CONFIG_DATA_TYPE = 5 AND RPT_CONFIG_DATA_GROUP = 0 AND RPT_MAIN_ID = "+oidCustom+" ";
                                                                                    tdColor = "";              
                                                                                    listComp = PstCustomRptConfig.list(0, 0, whereComp, "");
                                                                                    if (listComp !=null && listComp.size()>0){
                                                                                        CustomRptConfig dataField = (CustomRptConfig)listComp.get(0);
                                                    ...
                                                    <td valign="top">
                                                        ...
                                                        <% }
                                                        if (showTblCustomField == 1){
                                                        %>
                                                        <table id="tableDisplay">
                                                            <tr>
                                                                <th>Choose Custom Field</th>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <table>
                                                                    <%
                                                                        Vector listCustomField = PstCustomFieldMaster.list(0, 0, "", "");
                                                                        if (listCustomField != null && listCustomField.size()>0){
                                                                            for(int i=0; i<listCustomField.size(); i++){
                                                                                CustomFieldMaster fields = (CustomFieldMaster)listCustomField.get(i);
                                                                                %>
                                                                                <tr>
                                                                                    <td>
                                                                                        <input type="checkbox" name="field_custom" value="<%=fields.getOID()%>" /><%= fields.getFieldName() %>
                                                                                    </td>
                                                                                </tr>
                                                                                <%
                                                                            }
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <button id="btn2" onclick="addCustomField()">Add</button>
                                                                    <button id="btn2" onclick="closeCustomField()">Close</button>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <%
