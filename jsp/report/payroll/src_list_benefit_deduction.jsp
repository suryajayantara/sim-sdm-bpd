                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td width="59%" nowrap="nowrap">:
                                                                                                <%
                                                                                                    ...
                                                                                                    if (listBenefitDeduction.getCompanyId() != 0) {
                                                                                                        whereComp = "(" + (whereComp != null && whereComp.length() == 0 ? "1=1" : whereComp) + ") AND " + PstCompany.fieldNames[PstCompany.FLD_COMPANY_ID] + "=" + listBenefitDeduction.getCompanyId() + " AND d." + PstDepartment.fieldNames[PstDepartment.FLD_VALID_STATUS] + " = 1";
                                                                                        ...
                                                                                        <tr> 
                                                                                                ...
                                                                                                <%
                                                                                                    ...
                                                                                                    if (processDependOnUserDept) {
                                                                                                        if (emplx.getOID() > 0) {
                                                                                                            ...
                                                                                                            if (isHRDLogin || isEdpLogin || isGeneralManager || isDirector) {
                                                                                                                String strWhere = PstDepartment.TBL_HR_DEPARTMENT + "." + PstDepartment.fieldNames[PstDepartment.FLD_DIVISION_ID] + "=" + listBenefitDeduction.getDivisionId() + " AND " + PstDepartment.TBL_HR_DEPARTMENT + "." + PstDepartment.fieldNames[PstDepartment.FLD_VALID_STATUS] + " = 1";
                                                                                                                dept_value.add("0");
                                                                                                                dept_key.add("select ...");
                                                                                            ...
                                                                                            <td width="59%" nowrap="nowrap">:
                                                                                                <%
                                                                                                    ...
                                                                                                    String secWhere = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID] + "=" + listBenefitDeduction.getDeptId() + " AND " + PstSection.fieldNames[PstSection.FLD_VALID_STATUS] + " = 1";
