...
<%!
    ...
    public String drawList(Vector objectClass, int adminStatus, String appGroupString) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if(!appGroupString.equals("Admin Cabang")){
...
<%  
    ...
    if (appUserSess.getAdminStatus() == 0){
        whereClause = PstCustomRptMain.fieldNames[PstCustomRptMain.FLD_RPT_MAIN_FULL_ACCESS] + " = 1" ;
    }
                                            ...
                                            <table style="padding:21px; border:1px solid #00CCFF;" <%=garisContent%> width="100%" border="0" cellspacing="1" cellpadding="1" class="tablecolor">
                                                    ...
                                                    <td valign="top">
                                                        ...
                                                        <form name="<%=FrmCustomRptMain.FRM_NAME_CUSTOM_RPT_MAIN%>" method="POST" action="">
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td valign="top" id="tdForm"><strong>Full Access</strong></th>
                                                                    <td valign="top" id="tdForm">
                                                                        <%
                                                                        if (customRptMain.getRptMainFullAccess()==0){
                                                                            %>
                                                                            <input type="radio" name="<%=FrmCustomRptMain.fieldNames[FrmCustomRptMain.FRM_FIELD_RPT_MAIN_FULL_ACCESS]%>" value="0" checked="checked" />No
                                                                            <input type="radio" name="<%=FrmCustomRptMain.fieldNames[FrmCustomRptMain.FRM_FIELD_RPT_MAIN_FULL_ACCESS]%>" value="1" />Yes
                                                                            <%
                                                                        } else {
                                                                            %>
                                                                            <input type="radio" name="<%=FrmCustomRptMain.fieldNames[FrmCustomRptMain.FRM_FIELD_RPT_MAIN_FULL_ACCESS]%>" value="0" />No
                                                                            <input type="radio" name="<%=FrmCustomRptMain.fieldNames[FrmCustomRptMain.FRM_FIELD_RPT_MAIN_FULL_ACCESS]%>" value="1" checked="checked" />Yes
                                                                            <%
                                                                        }
                                                                        %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>&nbsp;</div>
                                                        <%=drawList(listCustomRptMain, appUserSess.getAdminStatus(),appGroupStr)%>
                                                    </td>
                                                    <div> 
                                                    <%
                                                        int cmd = 0;
