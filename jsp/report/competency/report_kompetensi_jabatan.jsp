<%-- 
    Document   : report_kompetensi_jabatan
    Created on : Jun 24, 2021, 11:26:18 AM
    Author     : Utk
--%>
<%-- 
...
function cmdGetTraining(oidType){
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Laporan Kompetensi <strong style="color:#333;"> / </strong> Daftar Kompetensi <strong style="color:#333;"> / </strong>Pencarian</span>
        </div>
        <div class="content-main">
            <form name="frm" method="post" action="">
                ...
                <div class="box">
                    <div id="title-box">Pencarian Daftar Kompetensi</div>
                    <table width="100%">
                        <tr>
                            <td valign="top" width="40%">
                                ...
                                <div id="divinput">
                                 ...
                                 <div class="caption">
                                    <%=dictionaryD.getWord(I_Dictionary.COMPETENCY)%>
                                </div>
                                <div id="divinput">
                                    <%

                                        Vector compentency_value = new Vector(1, 1);
                                        Vector compentency_key = new Vector(1, 1);
                                        
                                        Vector listCompentency  = new Vector();
                                        String placeHolderCompentency = "";
                                        String multipleCompentency = "";
                                    ...
                                    %>
                                        <%= ControlCombo.drawStringArraySelected("competency_id", "chosen-select", null, oidDiv, div_key, div_value, null, multipleDiv+" "+placeHolder+" style='width:80%' id='division'") %> 
                                </div>
                            </td>
