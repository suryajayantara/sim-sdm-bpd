...
<div id="tabs26">
    <ul class="menu3">
        ...
        <% } %>
        <!-- Karyawan -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_EMPLOYEE)){ %>
        ...
        <% } %>
        <!-- Penggajian -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_PAYROLL)){ %>
        <li><a href="<%=approot%>/menuaplikasi/home.jsp?menu=payroll.jsp"><span><img width="46" src="<%=approot%>/menustylesheet/icon/money.png" /></span></a><strong><% if (appLanguageMenu == 0){%>Remunerasi<%}else{%>Payroll<%}%></strong></li>
        <% } %>
        <!-- Kandidat -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_CANDIDATE)){ %>
        ...
        <% } %>
        <!-- Kompetensi -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_COMPETENCY)){ %>
        ...
        <% } %>
        <!-- Manajemen Performa -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_PERFORMA)){ %>
        <li><a href="<%=approot%>/menuaplikasi/home.jsp?menu=performance.jsp"><span><img width="46" src="<%=approot%>/menustylesheet/icon/daya.png" /></span></a><strong><% if (appLanguageMenu == 0){%>Kinerja<%}else{%>Kinerja<%}%></strong></li>
        <% } %>
        <!-- Kinerja Karyawan -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_KINERJA)){ %>
        <li><a href="<%=approot%>/menuaplikasi/home.jsp?menu=kinerja.jsp"><span><img width="46" src="<%=approot%>/menustylesheet/icon/kinerja1.png" /></span></a><strong><% if (appLanguageMenu == 0){%>Penilaian<%}else{%>Penilaian<%}%></strong></li>
        <% } %>
        <!-- Surat Tugas dan Surat Keputusan -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_DOCUMENT)){ %>
        ...
        <% } %>
        <!-- Absensi -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_ABSENT)){ %>
        ...
        <% } %>
        <!-- Lembur -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_OVERTIME)){ %>
        ...
        <% } %>
        <!-- Cuti -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_LEAVE)){ %>
        ...
        <li><a href="<%=approot%>/menuaplikasi/home.jsp?menu=teguran.jsp"><span><img width="46" src="<%=approot%>/menustylesheet/icon/warning.png" /></span></a><strong><% if (appLanguageMenu == 0){%>Sanksi <br> dan Pembinaan<%}else{%>Warning and Reprimand<%}%></strong></li>
        <% } %>
        <!-- Laporan -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_REPORT)){ %>
        ...
        <li><a href="http://192.168.170.2/dimata_system_help/menu_x.jsp"><span><img width="46" src="<%=approot%>/menustylesheet/icon/help.png" /></span></a><strong><% if (appLanguageMenu == 0){%>Help<%}else{%>Help<%}%></strong></li>
