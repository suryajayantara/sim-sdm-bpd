...
<html><!-- #BeginTemplate "/Templates/main.dwt" -->
    <head>
		...
		window.open("<%=approot%>/servlet/com.dimata.harisma.report.EmployeeListXLS");
            ...
            function cmdGoToApproval(){
                document.frm.action="employee/leave/cuti_approval.jsp";	
                document.frm.submit();
            }
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td height="8" width="100%" class="comment"><span class="comment">  
                                                                                               <% 
                                                                                                  ...
                                                                                                  ScheduleSymbol scheduleSymbolTod = new ScheduleSymbol();
                                                                                                  ScheduleSymbol scheduleSymbolNext = new ScheduleSymbol();
                                                                                                  try {
                                                                                                     scheduleSymbolTod = PstEmpSchedule.getDailyFirstSchedule(tDate, (userSession.getEmployee().getOID()));
                                                                                                     scheduleSymbolNext = PstEmpSchedule.getDailyFirstSchedule(nextDate, (userSession.getEmployee().getOID()));
                                                                                                  } catch (Exception e){}
                                                                                                  
                                                                                               %>
                                                                                               SCHEDULE : Today : <%=scheduleSymbolTod.getSymbol()%> ; Tomorrow : <%=scheduleSymbolNext.getSymbol()%>
                                                                                            </td>
                                                                                        </tr>
                                                                                         <tr> 
                                                                                            <td height="8" width="100%" class="comment"><span class="comment">                                                
            ...
            if (!NonViewBirthday) {
                ...
                if ((listEmpBirthday != null) && (listEmpBirthday.size() > 0)) {%>
                                                                                    ...
                                                                                    <%}%>
                                                                                        ...
                                                                                        %>
                                                                                        <%
                                                                                            int leaveNotif = PstLeaveApplication.getLeaveNotification(emplx.getOID(), emplx.getDivisionId(), "");
                                                                                            if (leaveNotif != 0){
                                                                                        %>
                                                                                        <tr>
                                                                                            <td><div style="padding:9px 0px;">Pemberitahuan: <a style="color:#FFF; background-color: #CF5353; padding: 5px;" href="javascript:cmdGoToApproval()"><%= leaveNotif %> Orang Cuti</a></div></td>
                                                                                        </tr>
                                                                                        <%  } %>
                                                                                        <%
                                                                                        ...
                                                                                        %>
                                                                                            <div style="padding:9px 0px;">Pemberitahuan: <a style="color:#FFF; background-color: #CF5353; padding: 5px;" href="javascript:cmdGoToApproval()"><%= leaveNotifCancel %> Orang Membatalkan Cuti</a></div>
                                                                                        <%  } %>
                                                                                        <%
                                                                                        if ( privViewChangePinNPasword) {
                                                                                        %>
