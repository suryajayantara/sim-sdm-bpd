                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr> 
						              ...
						              <table width="100%" border="0" cellpadding="2" cellspacing="2" bgcolor="#00FF00">
                                        ...
                                        <tr> 
                                          <td width="13%" valign="top">Division</td>
                                          <td width="1%" valign="top">:</td>
                                          <td width="86%" valign="top"> 
											...
											div_key.add("All Division ...");                                                          
											 Vector  listDiv = PstDivision.list(0, 0, PstDivision.fieldNames[PstDivision.FLD_VALID_STATUS] + " = " + PstDivision.VALID_ACTIVE, " DIVISION ");                                                        
                                        ...
                                        <tr> 
                                          ...
                                          <td width="86%" valign="top"> 
											...
											dept_key.add("All Department ...");  
                                                                                        String where = ""; 
                                                                                        if (lDivisionOid > 0){
                                                                                            where = " hr_department."+PstDepartment.fieldNames[PstDepartment.FLD_DIVISION_ID]+" = "+lDivisionOid + " AND " + PstDepartment.TBL_HR_DEPARTMENT + "." + PstDepartment.fieldNames[PstDepartment.FLD_VALID_STATUS] + " = " + PstDepartment.VALID_ACTIVE;
                                                                                        } 
