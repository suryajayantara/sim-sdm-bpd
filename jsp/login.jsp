...
System.out.println("Exception"+except);
    ...
    if (iCommand == CMD_LOGIN || (machineLogin == 1) ) {
        ...
        /* add by Hendra | 2017-01-06 */
        String kaptchaReceived = FRMQueryString.requestString(request, "kaptcha");
        ...
        dologin = userSess.doLogin(loginID,  EncryptMD5.getMD5(passwd), session, kaptchaReceived);
...
<%
            ...
            if (listEmployee != null && listEmployee.size() > 0) {
                ...
                listAppUser = PstAppUser.listFullObj(0, 0, "EMPLOYEE_ID='"+objemployee.getOID()+"'", "");
                
                if (listAppUser.size() < 1) {
                dologin = userSess.doLogin("Employee", EncryptMD5.getMD5("dsj2009") , session, kaptchaReceived);
                ...
                /*===============================================*/
                        ...
                        dologin = userSess.doLogin(appUser.getLoginId(), appUser.getPassword(), session, kaptchaReceived);
                        appUser.setFullName("Employee");
                    //priska 20150607
                       session.putValue("APPLICATION_LANGUAGE", String.valueOf(appLanguage));
                       session.putValue("LOGIN_NAME", "Employee");
                        String strLang = "";
                        if(session.getValue("APPLICATION_LANGUAGE")!=null){
                                strLang = String.valueOf(session.getValue("APPLICATION_LANGUAGE"));
            }
    ...
    int useCaptcha = 0;
    try{
        useCaptcha = Integer.valueOf(PstSystemProperty.getValueByName("USE_CAPTCHA"));
    } catch(Exception exc){
        System.out.println(" PstSystemProperty.getValueByName(\"USE_CAPTCHA\") "+ exc);
    }
...
<html>
    ...
    <body bgcolor="#F5F5F5" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/login_images/button_f2.jpg');window.status=''">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%" bgcolor="#FFFFFF">
            ...
            <tr>
                <td valign="middle" align="left">
                    <form name="frmLogin" action="" onsubmit="window.status=''" method="post">
                                ...
                                <td valign="top">
                                    <div class="content">
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div style="position:relative;">
                                                        <div class="btn btn-success" style="position:absolute;top:0;right:0;z-index: 1;" id="reloadImage">
                                                            <img src="<%= approot %>/imgstyle/reload.JPG" width="50%" />
                                                        </div>
                                            ...
                                            <tr>
                                                <td valign="center" style="padding-right: 7px; color: #575757"><strong>Captcha</strong></td>
                                                <td valign="center">
                                                    <input type="text" id="kaptcha" name="kaptcha" value="" placeholder="Captcha / Kode Keamanan" size="35" class="login password-field"/>
      ...
      <td height="20" valign="top" align="center">
          <img src="imgcompany/dimata_system_logo.png" height="45"/>&nbsp;
          <img src="imgcompany/harismaFlat.gif" height="57"/> 
      </td>
  </tr>
  <tr>
      <td>&nbsp;</td>
  ...
  <tr> 
    ...
    <td height="30" valign="top" align="center">
        <div style="color: #575757">Copyrights Dimata IT Solutions : Version 4.1 ( Build : 2019.03.04.02 )</div>
       <div style="color: #575757">PT. Dimata Sora Jayate</div>
<div style="color: #575757">
Hotline: +628 123 771 0011   office hour: +62 361 499029 | 482431 </div>
<div style="color: #575757">
  Online Chat gtalk : salesdsj@gmail.com

  Contact us : marketing@dimata.com </div>
       <div><a href="www.dimata.com">www.dimata.com</a></div>
    </td>
  </tr>
                        </table>
...
<script type="text/javascript">
	...
	$('#reloadImage').click(function () {
	    ...
	    $("#kaptchaImage").hide()
	      .attr('src', '<%= approot %>/Kaptcha.jpg?' + Math.floor(Math.random()*100) )
	      .fadeIn(); 
