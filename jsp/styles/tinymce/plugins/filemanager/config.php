<?php include '../../../../../config/config-url.php';?>
<?php
...
$base_url="localhost:8080/Hairisma20160730/"; //url base of site if you want only relative url leave empty
$upload_dir = '../imgupload/'; // path from base_url to upload base dir
$current_path = '../imgupload/'; // relative path from filemanager folder to upload files folder
