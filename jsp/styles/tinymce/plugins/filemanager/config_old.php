...
$upload_dir = '/astaga/images/source/'; // path from base_url to upload base dir
$current_path = '../../../../../images/source/'; // relative path from filemanager folder to upload files folder
