                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <form name="frm" method="post" action="">
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td colspan="2" style="padding:15px 9px;">
                                                                ...
                                                                <tr>
                                                                    <td valign="top">
                                                                        <table class="tblStyle">
                                                                            <tr>
                                                                                <td valign="top">Diminta oleh</td>
                                                                                <input type="hidden" name="<%=frmCandidateMain.fieldNames[FrmCandidateMain.FRM_FIELD_REQUESTED_BY]%>"  value="<%=requestby%>" />
                                                                                <td valign="top">
                                                                                    <input type="text" id="browse" name="requestview" size="50" value="<%=getEmployeeName(requestby)%>" />
                                                                                    <input type="hidden" name="requestby" size="40" value="<%=requestby%>" />
                                                                                    &nbsp;<a id="btn1" href="javascript:cmdRequestBy()">Browse</a>
                                                                                </td>
                                                                            </tr>
                                                                            <!--
                                                                            <tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td valign="top"><input type="text" name="<%=frmCandidateMain.fieldNames[FrmCandidateMain.FRM_FIELD_DUE_DATE]%>" id="datepicker1" value="<%= candidateMain.getDueDate()==null?strDateNow:candidateMain.getDueDate() %>" /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td valign="top">Date of Request</td>
                                                                                <td valign="top"><input type="text" name="<%=frmCandidateMain.fieldNames[FrmCandidateMain.FRM_FIELD_DATE_OF_REQUEST]%>" id="datepicker2" value="<%= candidateMain.getDateOfRequest()==null? strDateNow:candidateMain.getDateOfRequest() %>" /></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="2">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" style="border-top:1px solid #DDD; padding: 21px 8px">
                                                                        <a style="color:#FFF" href="javascript:cmdSave()" class="btn">Save</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
