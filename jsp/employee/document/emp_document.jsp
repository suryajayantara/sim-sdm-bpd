<%-- 
    ...
    Created on : Jun 8, 2016, 10:35:23 AM
    ...
    <head>
        ...
        <script type="text/javascript">
           function loadList(doc_master, doc_title, doc_num, command, start, divisi, fromDate, toDate) {
                document.getElementById("list-data").innerHTML = "<div class='meter animate'><span style='width: 100%'><span style='text-align: center; color: white'>Mencari Data...</span></span></div>";
            ...
            function cmdCancel(){
             ...
             function cmdAskCancelApprove(oid){
                Swal.fire({
                title: 'Are you sure?',
                ...
                if (result.isConfirmed) {
                    cmdCancelApprove(oid);
                  Swal.fire(
                    'Canceled!',
                    'Your doc has been canceled.',
                    'success'
                  )
                }
              })
    ...
    <body onload="pageLoad()">
        ...
        <div class="content-main">
            <form name="frm" method="post" action="">
                ...
                <% if (iCommand != Command.ADD && iCommand != Command.EDIT){ %>
                    <div class="box">
                        <div id="box-title">Pencarian Dokumen</div>
                        <div id="box-content">
                            <table>
                                <tr>
                                    <td><strong>Master Dokumen</strong></td>
                                    <td>
                                        <select name="doc_master_src" id="doc_master_src" class="chosen-select">
                                            <option value="0">-SELECT-</option>
                                            <%
                                            for (int i = 0; i < listDocMaster.size(); i++) {
                                                DocMaster docMaster = (DocMaster) listDocMaster.get(i);
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="doc_title_src" id="doc_title_src" size="57" value=""></td>
                                </tr>
                                <tr>
                                    <td><strong>Nomor Dokumen</strong></td>
                                    <td><input type="text"  name="doc_num_src" id="doc_num_src" size="57" value=""></td>
                                </tr>
                                <tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="date_from" id="date_from" class="datepicker" /> <strong>To</strong> <input type="text" name="date_to" id="date_to" class="datepicker" />
									</td>
								</tr>
                                <tr>
                                    <td><strong>Urutkan</strong></td>
                                    <td>
                                        <select name="sort_by" id="sort_by">
                                            <option value="<%= PstEmpDoc.fieldNames[PstEmpDoc.FLD_DATE_OF_ISSUE] %> DESC">Tanggal Berlaku</option>
                                            <option value="<%= PstEmpDoc.fieldNames[PstEmpDoc.FLD_REQUEST_DATE] %> DESC">Tanggal Dokumen</option>
                                            <option value="<%= PstEmpDoc.fieldNames[PstEmpDoc.FLD_DOC_MASTER_ID] %>">Master Dokumen</option>
                                            <option value="<%= PstEmpDoc.fieldNames[PstEmpDoc.FLD_DOC_TITLE] %>">Judul Dokumen</option>
                                            <option value="<%= PstEmpDoc.fieldNames[PstEmpDoc.FLD_DOC_NUMBER] %>">Nomor Dokumen</option>
                                            <option value="<%= PstEmpDoc.fieldNames[PstEmpDoc.FLD_DIVISION_ID] %>">Satuan Kerja</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                ...
                <div class="box">
                    <div id="box-title">Daftar Dokumen</div>
                    <div id="box-content">
                        <% if (privAdd){ %>
                        <a href="javascript:cmdAdd()" class="btn" style="color:#FFF;">Tambah Data</a>
                        <% } %>
                        <div>&nbsp;</div>
                        <% if (iCommand == Command.ASK){ %>
                        <div id="confirm">
                            Are you sure? 
                            <a href="javascript:cmdDelete('<%= oidEmpDoc %>')" id="btn-confirm">Yes</a> | 
