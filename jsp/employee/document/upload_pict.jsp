...
String whereClause = PstEmpDoc.fieldNames[PstEmpDoc.FLD_EMP_DOC_ID]+ " = "+oidEmpDoc;
String orderClause = PstEmpDoc.fieldNames[PstEmpDoc.FLD_DOC_TITLE];
...
session.putValue("SELECTED_PHOTO_SESSION", oidEmpDoc);
System.out.println("vectPict.........."+oidEmpDoc);
%>
...
function cmdUpload(){
	...
	document.frm_upload_pict.action="upload_emp_doc.jsp";
                                                ...
                                                <td height="8"  colspan="3"> 
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <% if(oidEmpDoc != 0){
                                                            ...
                                                            try{
                                                                 objEmpDoc = PstEmpDoc.fetchExc(oidEmpDoc);
                                                            }catch(Exception exc){
                                                                 objEmpDoc = new EmpDoc();
                                                            }
                                                      %>
                                                    <tr align="left" valign="top"> 
                                                      <td height="14" valign="middle" colspan="3" class="listedittitle"> 
                                                        <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                                          <tr> 
                                                            <td width="17%"><strong>Number </strong>
                                                               </td>
                                                            <td width="2%">:</td>
                                                            <td width="81%"><strong><%=objEmpDoc.getDoc_number()%></strong></td>
                                                          </tr>
                                                          <tr> 
                                                            <td width="17%"><strong>Title</strong></td>
                                                            <td width="2%">:</td>
                                                            <td width="81%"><strong><%=objEmpDoc.getDoc_title()%></strong></td>
                                                          </tr>
                                                        </table>
                                                      </td>
                                                    </tr>
