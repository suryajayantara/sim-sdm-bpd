                                                                                 ...
                                                                                 <form name="frmEmpDocField" method="post" action="">
                                                                                    ...
                                                                                    <% if (ObjectClass.equals("ALLFIELD")){ %>
                                                                                            ...
                                                                                            <% if (ObjectStatusfield.equals("DATE")){ %>
                                                                                                ...
                                                                                                <%=ControlDate.drawDateWithStyle(frmEmpDocField.fieldNames[frmEmpDocField.FRM_FIELD_VALUE_DATE], dateF == null ? new Date() : dateF, 1, -150, "formElemen")%>     
                                                                                            <% } %>
                                                                                    <% } %>
                                                                                    ...
                                                                                    <%
                                                                                        if(iErrCode ==  CtrlEmpDocField.RSLT_FORM_DATE_OUT_OF_RANGE && iCommand == Command.SAVE){
                                                                                    %>
                                                                                      <div>&nbsp;</div>
                                                                                        <div style="background-color:#FACACA; color:#3D7587; padding: 7px 9px;">
                                                                                           Gagal Tersimpan - Tanggal yang dipilih diluar periode saat ini
                                                                                        </div>
                                                                                    <%
                                                                                        }else if(iErrCode ==  CtrlEmpDocField.RSLT_OK && iCommand == Command.SAVE){
                                                                                    %>
                                                                                        <div>&nbsp;</div>
