...
<!DOCTYPE html>
<%
    String docTitle = (String) session.getValue("doc_title");
    Long docId = (Long) session.getValue("doc_id");
    DocExcel docExcel = new DocExcel();
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Process Import Excel - Document</title>
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Document <strong style="color:#333;"> / </strong> Import Process <%=docTitle%></span>
            <a style="color:#F5F5F5" class="btn-small" href="javascript:cmdBack('<%=docId%>')">Back</a>
        </div>
        <div class="content-main">
            <form name="frm" action=""><input type="hidden" name="EmpDocument_oid" value="<%=docId%>" /></form>
            <%
            String test = docExcel.processImportExcel(docId, docTitle, config, request, response);
            %>
            <%= test %>
        </div>
