...
<%!
...

	{
		...
		ctrlist.addHeader("No","");
                ctrlist.addHeader("Doc Master","");
                ctrlist.addHeader("Doc Title","");
                ctrlist.addHeader("Request Date ","");
                ctrlist.addHeader("Doc Number ","");
		ctrlist.addHeader("Issue Date","");
                /*
		ctrlist.addHeader("Plan Process From","6%");
		ctrlist.addHeader("Plan Process To","6%");
		ctrlist.addHeader("Real Process From","6%");
                ctrlist.addHeader("Real Process To","6%");
                */
//                ctrlist.addHeader("Objectives","30%");
                ctrlist.addHeader("Details","7%");
		ctrlist.addHeader("Geo Address","10%");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			 ...
			 if(index == i && (iCommand == Command.EDIT || iCommand == Command.ASK)){
				...
				rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[FrmEmpDoc.FRM_FIELD_REQUEST_DATE]+"\" class=\"mydate\" value=\""+empDoc.getRequest_date()+"\" />");
				...
				rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[FrmEmpDoc.FRM_FIELD_DATE_OF_ISSUE]+"\" class=\"mydate\" value=\""+empDoc.getDate_of_issue()+"\" />");
                                /*
  ...
  //                              rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[FrmEmpDoc.FRM_FIELD_OBJECTIVES] +"\" value=\""+empDoc.getObjectives()+"\" class=\"elemenForm\"> * ");
				...
				//rowx.add("<button id=\"btn\" onclick=\"cmdEditDetail2('"+String.valueOf(empDoc.getOID())+"')\">Edit Detail</button> <input type=\"hidden\" name=\""+frmObject.fieldNames[FrmEmpDoc.FRM_FIELD_DETAILS] +"\" value=\""+empDoc.getDetails()+"\" class=\"elemenForm\"> * ");
    ...
    //                            rowx.add(""+ empDoc.getObjectives());
				...
				//rowx.add("<button id=\"btn\" onclick=\"cmdEditDetail2('"+String.valueOf(empDoc.getOID())+"')\">Edit Detail</button>");
				rowx.add(""+ geo);
                               // rowx.add(" - ");
			} 
		...
		if(iCommand == Command.ADD || (iCommand == Command.SAVE && frmObject.errorSize() > 0)){ 
				...
				rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[FrmEmpDoc.FRM_FIELD_REQUEST_DATE]+"\" class=\"mydate\" value=\""+objEntity.getRequest_date()+"\" /> *"+ frmObject.getErrorMsg(frmObject.FRM_FIELD_REQUEST_DATE));
				...
				rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[FrmEmpDoc.FRM_FIELD_DATE_OF_ISSUE]+"\" class=\"mydate\" value=\""+objEntity.getDate_of_issue()+"\" />");
                                /*
...
int docStatus = FRMQueryString.requestInt(request, "docStatus");
...
sEmpDoc.setDocStatus(docStatus);
...
int vectSize = 0;
//if ((iCommand == Command.LIST) || (iCommand == Command.EDIT) || (iCommand == Command.ASK) || (iCommand == Command.SAVE) || (iCommand == Command.DELETE)){
    //vectSize = PstEmpDoc.getCount(whereClause);
    vectSize = PstEmpDoc.listSpecialCount(start,recordToGet, whereClause , orderClause,sEmpDoc);
//}
...
function cmdTemplate(EmpDocId){
	window.open("EmpDocTemplate.jsp?EmpDocId="+EmpDocId+"", null, "height=550,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");       
}
function cmdExpense(EmpDocId){
	window.open("EmpDocExpense.jsp?EmpDocId="+EmpDocId+"", null, "height=550,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");       
}
...
function cmdEditDetail1(EmpDocument_oid){
	window.open("EmpDocumentDetails.jsp?EmpDocument_oid="+EmpDocument_oid+"", null, "height=550,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");       
}
function cmdEditDetail2(EmpDocument_oid){
	window.open("EmpDocumentDetails.jsp?EmpDocument_oid="+EmpDocument_oid);       
}
        ...
        <tr> 
          <td height="20">
		    <font color="#FF6600" face="Arial"><strong>
			  <!-- #BeginEditable "contenttitle" -->Document 
                  &gt; EmpDoc<!-- #EndEditable --> 
            </strong></font>
	      </td>
        </tr>
				      ...
				      <input type="hidden" name="EmpDocument_oid" value="<%=oidEmpDoc%>">
                                      ...
                                      <tr> 
                                        ...
                                        <tr> 
                                          ...
                                          <td  nowrap="nowrap">Doc Status    : </td><td>   
                                            <%
                                            ...
                                            %>
                                            <%=ControlCombo.draw("docStatus", null, "" + docStatus, val_status, key_status)%> 
                                        </td>
                                          ...
                                          <td height="8"  colspan="3"> 
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">                                              
                                              ...
                                              <tr align="left" valign="top"> 
                                                ...
                                                <% //if (((iCommand == Command.LIST) || (iCommand == Command.EDIT)|| (iCommand == Command.ASK) || (iCommand == Command.ADD) || (iCommand == Command.SAVE) || (iCommand == Command.DELETE)) && ((listEmpDoc.size()) != 0 || (iCommand == Command.ADD) )){%>
							    ...
							    %>
								 ...
								 %>
                                        ...
                                        <% if((iCommand == Command.LIST) || (iCommand == Command.ASK) || (iCommand == Command.EDIT) || (iCommand == Command.ADD)|| (iCommand == Command.SAVE) || (iCommand == Command.DELETE)){%>
                                        <tr align="left" valign="top" > 
