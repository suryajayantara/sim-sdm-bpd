			...
			for (int i = 0; i < objectClass.size(); i++) {
				...
				try{
					...
					trn = new Training();
                                ...
                                String where = PstTrainingDept.fieldNames[PstTrainingDept.FLD_TRAINING_ID] + " IN (" + inData+")";                              
                                    ...
                                    <tr> 
                                        ...
                                        <%
                                         ...
                                         else if(typ == PRIV_GENERAL)
                                         {
                                             ...
                                             listPlanning = (Vector)PstTrainingActivityPlan.listTrainingByDeptMapping(0, date);
