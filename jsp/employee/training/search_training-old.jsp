...
<%
    ...
    long posOID = FRMQueryString.requestLong(request, FrmSrcTraining.fieldNames[FrmSrcTraining.FRM_FIELD_POSITION]);
    ...
    srcTraining.setPositionId(posOID);
                                                ...
                                                <td width="97%"> 
                                                  <table border="0" cellspacing="2" cellpadding="2" width="72%">
                                                      <tr>
                                                          ...
                                                          <td>
                                                              <select name="<%=frmSrcTraining.fieldNames[FrmSrcTraining.FRM_FIELD_DIVISION]%>">
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="83%"> 
                                                        ...
                                                        %>
                                                        <%= ControlCombo.draw(frmSrcTraining.fieldNames[FrmSrcTraining.FRM_FIELD_DEPARTMENT],"formElemen",null, ""+srcTraining.getDepartmentId(), dept_value, dept_key, " onChange=\"javascript:cmdRefresh()\"") %> 
                                                      </td>
                                                    </tr>   
                                                    <tr>
                                                        <td width="17%" nowrap> 
                                                        ...
                                                        <td width="83%">
                                                            <select name="<%=frmSrcTraining.fieldNames[FrmSrcTraining.FRM_FIELD_POSITION]%>">
                                                                <option value="0">-SELECT-</option>
                                                                <%
                                                                String orderPos = PstPosition.fieldNames[PstPosition.FLD_POSITION]+"";
                                                                Vector listPosition = PstPosition.list(0, 0, "", orderPos);
                                                                if (listPosition != null && listPosition.size()>0){
                                                                    for(int i=0; i<listPosition.size(); i++){
                                                                        Position posisi = (Position)listPosition.get(i);
                                                                        %>
