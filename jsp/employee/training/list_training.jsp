...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_TRAINING_SEARCH, AppObjInfo.OBJ_MENU_TRAINING_SEARCH);%>
...
<%!
    public String drawList(Vector objectClass, int orderNum){
            ...
            /*
            * Untuk kebutuhan di BPD maka Department saya ganti dengan Division 
...
<%
    ...
    String divisionName = "-";
    try {
        Division divisi = PstDivision.fetchExc(srcTraining.getDivisionId());
    ...
    try{
        pos = PstPosition.fetchExc(srcTraining.getPositionId());
    } catch(Exception e) {
                                  ...
                                  <td valign="top"> <!-- #BeginEditable "content" --> 
                                    <form name="frm_employee" method="post" action="">
                                      ...
                                      <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                        ...
                                        <tr> 
                                          <td width="15%"><b>&nbsp;<%=dictionaryD.getWord(I_Dictionary.DIVISION) %></b></td>
                                          <td width="2%"><b>:</b></td>
                                          <td width="83%"><b><%=divisionName.toUpperCase()%></b></td>
                                        </tr>
                                        <tr> 
                                          <td width="15%"><b>&nbsp;<%=dictionaryD.getWord(I_Dictionary.DEPARTMENT) %></b></td>
                                          <td width="2%"><b>:</b></td>
                                          <td width="83%"><b><%=department.getDepartment().toUpperCase()%></b></td>
                                        </tr>
                                        <tr> 
                                          <td width="15%"><b>&nbsp;<%=dictionaryD.getWord(I_Dictionary.POSITION) %></b></td>
                                          <td width="2%"><b>:</b></td>
                                          <td width="83%"><b><%=pos.getPosition().toUpperCase()%></b></td>
                                        </tr>
                                        <tr> 
