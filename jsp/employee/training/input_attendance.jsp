...
<%!
    public String drawList(Vector employee, TrainingActivityPlan trainPlan, long oidTrainingPlan, long oidReal,  long oidDepartment, int hours){
        ...
        ctrlist.addHeader("Point (0-100)","5%");
        ctrlist.addHeader("Remark","5%");
        ...
        Hashtable hashAttendancePoint = new Hashtable();
        Hashtable hashAttendanceMark = new Hashtable();
        ...
        if(listAttendance != null && listAttendance.size() > 0) {
            ...
            while(enumAttendance.hasMoreElements()) {
                ...
                hashAttendancePoint.put(String.valueOf(list.getEmployeeId()), String.valueOf(list.getPoint()));
                hashAttendanceMark.put(String.valueOf(list.getEmployeeId()), String.valueOf(list.getRemark()));
        ...
        for(int i=0; i<employee.size(); i++) {
            ...
            if(hashAttendance.get(String.valueOf(emp.getOID())) != null) {      
                ...
                String point = ""+(String.valueOf(hashAttendancePoint.get(String.valueOf(emp.getOID()))));
                rowx.add("<input type='text' name='txtHour" + i + "' value='" + hour + "' onchange='javascript:checkValue(\"" + hour + "\",\"" + i + "\")'>");
                rowx.add("<input "+ (oidReal ==0 ? "readonly" : "") + " type='text' name='txtPoint" + i + "' value='" + point +  "' "+  "id='txtPoint" +  i + "' " +  
            ...
            // if not, display hours based on planning
                ...
                rowx.add("<input "+ (oidReal ==0 ? "readonly" : "") + " type='text' name='txtPoint" +  i + "' value='" + 0 + "' "+  "id='txtPoint" +  i + "' " +  
                       " onchange=\"javascript:checkRange('txtPoint"+ i+"',0,100);\" >");
                
            }
            
            
            //add by eri yudi 2020-07-17
            // if employee is in attendance hash, display checked
            if(hashAttendance.get(String.valueOf(emp.getOID())) != null) { 
                String mark = ""+(String.valueOf(hashAttendanceMark.get(String.valueOf(emp.getOID()))));
                rowx.add("<input type='text' name='txtMark" + i + "' value='"+mark+"' >");
            }else{
                rowx.add("<input type='text' name='txtMark" + i + "' value='' >");
            }
            //end add by eri yudi 
...
<% 
        ...
        long oidReal = FRMQueryString.requestLong(request, "actualId");
	...
	function MM_swapImgRestore() { //v3.0
        ...
        <% if((iCommand == Command.SAVE)) {
            ...
            for(int i=0; i<totalAttendances; i++) {                
                ...
                String point = FRMQueryString.requestString(request, "txtPoint" + i);
                String mark = FRMQueryString.requestString(request, "txtMark" + i);
                long loid = 0;
                int ihour = 0;
                int iPoint =0;
                String iMark = "";
                ...
                if(ihour != 0) {
                    ...
                    TrainingAttendancePlan trainAttendanceReturn = new TrainingAttendancePlan (); 
                    if(!mark.isEmpty()){
                    ctrlAttendance.updateAttendanceAndMark(Command.SAVE, loid, ihour, iPoint,mark, oidPlan, trainAttendanceReturn,oidReal);
                    }else{
                    ctrlAttendance.updateAttendance(Command.SAVE, loid, ihour, iPoint, oidPlan, trainAttendanceReturn,oidReal);
                    }
                }
                else {
                    ...
                    try{
                        ...
                        if(listAttendance == null){
                            ctrlAttendance.updateAttendance(Command.DELETE, loid, ihour, oidPlan,oidReal);
...
<body bgcolor="#FFFFFF" text="#000000" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <form name="frm_inputattendance" method="post" action="">
        ...
        <input type="hidden" name="actualId" value="<%=oidReal%>">
                                ...
                                <tr align="left" valign="top"> 
                                    ...
                                    <tr align="left" valign="top"> 
                                        <td height="22" valign="middle"> 
                                            <%= drawList(listEmployee, trainPlan, oidPlan, oidReal, srcEmployee.getDepartment(), hours) %>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
