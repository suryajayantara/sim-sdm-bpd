<%-- 
    Document   : training_activities_plan
    Created on : Jan 15, 2016, 3:54:24 PM
    Author     : Dimata 007
--%>
...
<% int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_TRAINING, AppObjInfo.G2_TRAINING_PLAN, AppObjInfo.OBJ_MENU_TRAINING_PLAN);%>
...
<html>
    <head>
        ...
        <title>Training Activities Plan</title>
        <style type="text/css">
        ...
        <script type="text/javascript">
            ...
            function loadList() {
                ...
                xmlhttp.open("GET", "plan-list-ajax.jsp?command=<%=Command.FIRST%>&bulan=" + bulan +"&tahun=" + tahun, true);
                xmlhttp.send();
    ...
    <body>
        ...
        <div class="content-main">
            ...
            <div>&nbsp;</div>
            <div>
                <a style="color:#FFF" class="btn" href="javascript:loadList()">View Plan (General)</a>&nbsp;
