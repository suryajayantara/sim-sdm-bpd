...
<script language="JavaScript">
    ...
    function cmdAddNew() {
		...
		document.frm_trainer.command.value="<%=Command.FIRST%>";
                document.frm_trainer.prev_command.value="<%=Command.FIRST%>";	
		document.frm_trainer.action="input_trainer.jsp";
		document.frm_trainer.submit();
	}

	function cmdListPrev(){
		document.frm_trainer.command.value="<%=Command.PREV%>";
                document.frm_trainer.prev_command.value="<%=Command.PREV%>";
		document.frm_trainer.action="input_trainer.jsp";
		document.frm_trainer.submit();
	}

	function cmdListNext(){
		document.frm_trainer.command.value="<%=Command.NEXT%>";
                document.frm_trainer.prev_command.value="<%=Command.NEXT%>";
		document.frm_trainer.action="input_trainer.jsp";
		document.frm_trainer.submit();
	}

	function cmdListLast(){
		document.frm_trainer.command.value="<%=Command.LAST%>";
                document.frm_trainer.prev_command.value="<%=Command.LAST%>";
		document.frm_trainer.action="input_trainer.jsp";
		document.frm_trainer.submit();
	}
