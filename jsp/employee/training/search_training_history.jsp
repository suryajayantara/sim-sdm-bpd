...
function cmdSearch() {
    ...
    var strUrl = "list_training_history.jsp";
...
function cmdPrint(){
    window.open("<%=approot%>/servlet/com.dimata.harisma.report.TrainingHistoryPdf?company_id="+document.getElementById("company").value
    ...
    <body onload="pageLoad()">
        ...
        <div id="menu_utama">
            <span id="menu_title">Pelatihan <strong style="color:#333;"> / </strong>Sejarah Pelatihan</span>
        </div>
        <div class="content-main">
            <form name="frm" method="post" action="">
                <table width="100%">
                    <tr>
                        <td valign="top" width="30%" style="position:fixed">
                            ...
                            <a href="javascript:cmdPrint()" class="btn" style="color:#FFF;">Print PDF</a>
                            <div>&nbsp;</div>
                        </td>
                        <td valign="top" width="70%">
                            <div style="font-size: 12px; font-weight: bold; padding: 3px 5px; border-left: 1px solid #007fba;">Daftar hasil pencarian</div>
                            <div>&nbsp;</div>
