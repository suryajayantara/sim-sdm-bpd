...
<%
	...
	boolean needSavingApproval = FRMQueryString.requestBoolean(request,"needSavingApproval");
       ...
       // long approvalId = FRMQueryString.requestLong(request, "manager_id");
        ...
        int approvalType = 0;
        try{
          approvalType = Integer.valueOf(PstSystemProperty.getValueByName("APPROVAL_TYPE"));
        } catch(Exception exc){
	...
	ControlLine ctrLine = new ControlLine();
        ...
        ///Approval
        int finApproval = PstAppraisalMain.getMaxApp(appraisalMain.getEmployeeId(), leaveConfig, appraisalMain);                    
        ...
        if (oidApprover != 0) {
                ...
                switch (indexApproval) {
                    case 1:
                        appraisalMain.setApproval1Id(oidApprover);
                        appraisalMain.setTimeApproval1(approvalDates);
                    ...
                    break;
                    case 2:
                        appraisalMain.setApproval2Id(oidApprover);
                        appraisalMain.setTimeApproval2(approvalDates);
                    ...
                    break;
                    case 3:
                        appraisalMain.setApproval3Id(oidApprover);
                        appraisalMain.setTimeApproval3(approvalDates);
                    ...
                    break;
                    case 4:
                        appraisalMain.setApproval4Id(oidApprover);
                        appraisalMain.setTimeApproval4(approvalDates);
                    ...
                    break;
                    case 5:
                        appraisalMain.setApproval5Id(oidApprover);
                        appraisalMain.setTimeApproval5(approvalDates);
                    ...
                    break;
                    case 6:
                        appraisalMain.setApproval6Id(oidApprover);
                        appraisalMain.setTimeApproval6(approvalDates);
...
int maxApproval = PstAppraisalMain.getMaxApp(appraisalMain.getEmployeeId(), leaveConfig, appraisalMain);        
...
function chkApproval(index)
            {
                var empApprovalSelected = 0;
                if(index==1){
                    empApprovalSelected = document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.<%=FrmAppraisalMain.fieldNames[FrmAppraisalMain.FRM_FIELD_APPROVAL_1_ID]%>.value;
                }
                if(index==2){
                    empApprovalSelected = document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.<%=FrmAppraisalMain.fieldNames[FrmAppraisalMain.FRM_FIELD_APPROVAL_2_ID]%>.value;
                }
                if(index==3){
                    empApprovalSelected = document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.<%=FrmAppraisalMain.fieldNames[FrmAppraisalMain.FRM_FIELD_APPROVAL_3_ID]%>.value;
                }
                if(index==4){
                    empApprovalSelected = document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.<%=FrmAppraisalMain.fieldNames[FrmAppraisalMain.FRM_FIELD_APPROVAL_4_ID]%>.value;
                }
                if(index==5){
                    empApprovalSelected = document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.<%=FrmAppraisalMain.fieldNames[FrmAppraisalMain.FRM_FIELD_APPROVAL_5_ID]%>.value;
                }
                if(index==6){
                    empApprovalSelected = document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.<%=FrmAppraisalMain.fieldNames[FrmAppraisalMain.FRM_FIELD_APPROVAL_6_ID]%>.value;
                }
                ...
                if(empApprovalSelected != 0)
                {
                    ...
                    document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.indexApproval.value=index;
                    document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.indexMain.value=1;
                    document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.oidApprover.value=empApprovalSelected;
                    
                    document.<%=FrmAppraisalMain.FRM_APPRAISAL_MAIN%>.action="<%=approot%>/employee/appraisalnew/appraisal_approval.jsp?oidApprover="+empApprovalSelected+"&indexMain="+1+"&indexApproval="+index+"&command=<%=String.valueOf(Command.LIST)%>&<%=FrmAppraisalMain.fieldNames[FrmAppraisalMain.FRM_FIELD_APP_MAIN_ID]%>=<%=oidAppraisalMain%>";
                                            ...
                                            <table  width="100%" border="0" cellspacing="1" cellpadding="1">
                                                ...
                                                <tr>
                                                    <td><br><br><br>
                                                        ...
                                                        if ((appraisalMain.getOID () != 0) && (appraisalMain.getEmployeeId() != 0) && (maxApproval == I_Leave.LEAVE_APPROVE_1 || maxApproval == I_Leave.LEAVE_APPROVE_2 || maxApproval == I_Leave.LEAVE_APPROVE_3 || maxApproval == I_Leave.LEAVE_APPROVE_4 || maxApproval == I_Leave.LEAVE_APPROVE_5 || maxApproval == I_Leave.LEAVE_APPROVE_6)) {
                                                                        //deptHead = true;

                                                                        Employee employeeObj = new Employee();
                                                                try {
                                                                    employeeObj = PstEmployee.fetchExc(appraisalMain.getEmployeeId());
                                                                ...
                                                                int incIndexApp = 1;
                                                                long oidEmpDinamis = appraisalMain.getEmployeeId();
                                                                for (int xx = minLevel; xx <= maxLevel; xx++) {
                                                                    Vector listEmpApproval = leaveConfig.getApprovalEmployeeTopLinkByLevel(oidEmpDinamis, 7, xx, "");
                                                                ...
                                                                <%
                                                                    if (appraisalMain.getOID() != 0) {
                                                                            ...
                                                                            String selectedApproval = "" + PstAppraisalMain.getApproveOidByApprovalIndex(appraisalMain, incIndexApp);
                                                                            ...
                                                                            String strAttribute = "class=\"formElemen\" onChange=\"javascript:chkApproval(" + incIndexApp + ")\"";
                                                                            //cek Index Complete
                                                                            boolean indexComplete = false;

                                                                            indexComplete = PstAppraisalMain.cekApproval(appraisalMain, incIndexApp);

                                                                            String appFrm = PstAppraisalMain.getApproveFrmByApprovalIndex(appraisalMain, incIndexApp);
                                                                    ...
                                                                    session.putValue("APPRAISAL", vctSession);
                                                                    incIndexApp++;
                                                                    }
                                                        ...
                                                        if ((appraisalMain.getOID () != 0) && (appraisalMain.getEmployeeId() != 0) && (maxApproval == I_Leave.LEAVE_APPROVE_1 || maxApproval == I_Leave.LEAVE_APPROVE_2 || maxApproval == I_Leave.LEAVE_APPROVE_3 || maxApproval == I_Leave.LEAVE_APPROVE_4 || maxApproval == I_Leave.LEAVE_APPROVE_5 || maxApproval == I_Leave.LEAVE_APPROVE_6)) {
                                                                ...
                                                                %>
                                                                                <td align="center"  valign="bottom">
                                                                <% //update by priska
                                                                    Date appDate = PstAppraisalMain.getApproveDateByApprovalIndex(appraisalMain, incIndexApp);
                                                                    String appFrmDate = PstAppraisalMain.getApproveFrmDateByApprovalIndex(appraisalMain, incIndexApp);
