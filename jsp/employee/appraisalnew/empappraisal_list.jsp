		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			rowx.add(""+appraisalMain.getScoreAverage());
                        ...
                        if(appraisalMain.getApproval6Id() > 0){
                            ...
                            if(appraisalMain.getOID()>0){
                                try{
                                    divHead = PstEmployee.fetchExc(appraisalMain.getApproval6Id());
                                }catch(Exception ex){}
                            }
                            rowx.add("Yes ("+divHead.getFullName()+")");
                        } else if(appraisalMain.getApproval5Id() > 0){
                            Employee divHead = new Employee();
                            if(appraisalMain.getOID()>0){
                                try{
                                    divHead = PstEmployee.fetchExc(appraisalMain.getApproval5Id());
                                }catch(Exception ex){}
                            }
                            rowx.add("Yes ("+divHead.getFullName()+")");
                        } else if(appraisalMain.getApproval4Id() > 0){
                            Employee divHead = new Employee();
                            if(appraisalMain.getOID()>0){
                                try{
                                    divHead = PstEmployee.fetchExc(appraisalMain.getApproval4Id());
                                }catch(Exception ex){}
                            }
                            rowx.add("Yes ("+divHead.getFullName()+")");
                        } else if(appraisalMain.getApproval3Id() > 0){
                            Employee divHead = new Employee();
                            if(appraisalMain.getOID()>0){
                                try{
                                    divHead = PstEmployee.fetchExc(appraisalMain.getApproval3Id());
                                }catch(Exception ex){}
                            }
                            rowx.add("Yes ("+divHead.getFullName()+")");
                        } else if(appraisalMain.getApproval2Id() > 0){
                            Employee divHead = new Employee();
                            if(appraisalMain.getOID()>0){
                                try{
                                    divHead = PstEmployee.fetchExc(appraisalMain.getApproval2Id());
                                }catch(Exception ex){}
                            }
                            rowx.add("Yes ("+divHead.getFullName()+")");
                        } else if(appraisalMain.getApproval1Id() > 0){
                            Employee divHead = new Employee();
                            if(appraisalMain.getOID()>0){
                                try{
                                    divHead = PstEmployee.fetchExc(appraisalMain.getApproval1Id());
                                }catch(Exception ex){}
                            }
                            rowx.add("Yes ("+divHead.getFullName()+")");
                        } else{
