...
/* OBJ Databank Personal Data sudah dideklarasikan di atas*/
...
<html>
        ...
        async function cmdSwal(){
           const { value: formValues } = await Swal.fire({
            ...
            html:
              ...
              '<label for="warning"> Sanksi </label><br>'+
      
              '<input type="checkbox" id="reprimand" name="reprimand" value="1" checked>' +
              '<label for="reprimand"> Pembinaan </label><br>'+
          ...
          if (formValues) {
           ...
           function cmdBrowseDoc(type){
                newWindow=window.open("employee_doc_select.jsp?jenisSK="+type,"EmpList", "height=600,width=500,status=yes,toolbar=no,menubar=no,location=center,scrollbars=yes");
                newWindow.focus();
            }
            //}
            //-->
	...
	<script src="<%=approot%>/javascripts/datepicker/jquery.ui.datepicker.js"></script>
        ...
        <script>
        function pageLoad(entity, userId){ 
            $(".mydate").datepicker({ dateFormat: "yy-mm-dd" }); 
            loadMessageLog(entity, userId);
        } 
	</script>
    </head>
    <body onload="pageLoad('Employee','123')">
                                ...
                                <table align="center">
                                    <tr>
                                        <td valign="top"> <!-- Left Side -->
                                            <div class="box">
                                                <div id="box_title"> <%=dictionaryD.getWord(I_Dictionary.BASIC_INFORMATION)%> </div>
                                                <div style="color:#0099FF;font-style: italic;">*) entry required</div>
                                                <table>
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.PAYROLL)%></td>
                                                        <td valign="middle">
                                                            <%
                                                                ...
                                                                if(attdConfig != null && attdConfig.getConfigurasiInputEmpNum() == I_Atendance.CONFIGURATION_II_GENERATE_AUTOMATIC_EMPLOYEE_NUMBER){
                                                                 ...
                                                                 <% } else {
                                                                    if (appUserSess.getAdminStatus()==0){
                                                                        ...
                                                                        <input type="text" name="emp-num" <%= disableElmt %> value="<%=employee.getEmployeeNum()%>">
                                                                        <%
                                                                    } else {
                                                                        %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.FULL_NAME)%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.NAME_ON_CARD)%></td>
                                                        <td valign="middle">
                                                        <input type="text" size="45" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_NAME_ON_CARD]%>" value="<%=employee.getNameCard()%>" class="formElemen">
                                                        * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_NAME_ON_CARD)%>        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=(ClientName.equals("QUEEN_TANDOOR")?"Temporary Address":dictionaryD.getWord(I_Dictionary.ADDRESS))%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.PERMANENT_ADDRESS)%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.ZIP_CODE)%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Telephone / HP</td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.EMERGENCY_PHONE)%> / <%=dictionaryD.getWord("PERSON_NAME")%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.EMERGENCY_ADDRESS)%></td>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.GENDER)%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.PLACE_OF_BIRTH)%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.DATE_OF_BIRTH)%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="middle" id="caption">Shio</td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Element</td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.RELIGION)%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("MARITAL_STATUS_FOR_HR")%></td>
                                                        <td valign="middle">
                                                            <%
                                                            if (appUserSess.getAdminStatus()==0){
                                                                %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("BLOOD_TYPE")%></td>
                                                        <td valign="middle">
                                                        <%
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("RACE")%></td>
                                                        <td valign="middle">
                                                            <%
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Nationality</td>
                                                        <td valign="middle">
                                                            <%
                                                            Vector nat_key = new Vector();
                                                            Vector nat_value = new Vector();
                                                            nat_key.add("-select-");
                                                            nat_value.add(""+0);
                                                            Vector listNationality = PstNationality.list(0, 0, "", PstNationality.fieldNames[PstNationality.FLD_NATIONALITY_NAME]);

                                                            for (int i = 0; i < listNationality.size(); i++) {
                                                                Nationality nationality = (Nationality) listNationality.get(i);
                                                                nat_key.add(nationality.getNationalityName());
                                                                nat_value.add(String.valueOf(nationality.getOID()));
                                                            }

                                                            out.println(ControlCombo.draw(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_NATIONALITY], "formElemen", null, "" + employee.getNationalityId(), nat_value, nat_key));
                                                            %>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("BARCODE_NUM")%></td>
                                                        <td valign="middle">
                                                            <%
                                                            if (appUserSess.getAdminStatus()==0){
                                                                disableElmt = " disabled=\"disabled\" ";
                                                                %>
                                                                <input  type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_BARCODE_NUMBER]%>" title=" If Employe is a Daily Worker (DL)  please replace 'DL-' with '12' ,for  example 'DL-333' become to '12333'.     If Employe's  Status  'Resigned'  please input the barcode number, barcode number is unique for example -R(BarcodeNumb/PinNumber)" value="<%=(employee.getBarcodeNumber() != null ? employee.getBarcodeNumber() : "")%>" class="formElemen">
                                                                <input  type="text" <%= disableElmt %> name="barcode_inp" title=" If Employe is a Daily Worker (DL)  please replace 'DL-' with '12' ,for  example 'DL-333' become to '12333'.     If Employe's  Status  'Resigned'  please input the barcode number, barcode number is unique for example -R(BarcodeNumb/PinNumber)" value="<%=(employee.getBarcodeNumber() != null ? employee.getBarcodeNumber() : "")%>" class="formElemen">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.ID_CARD_NO)%></td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("VALID_TO")%></td>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Email</td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr align="left" valign="top">
                                                        <td valign="middle" id="caption">Payroll Group </td>
                                                        <td <th valign="middle">
                                            ...
                                            <div class="box">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td valign="middle" id="caption">IQ</td>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">EQ</td>
                                            ...
                                            <div class="box">
                                                <table>
                                                    <tr>
                                                        <td valign="middle" id="caption">No Rekening</td>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">NPWP</td>
                                            ...
                                            <!-- Medicat Information->
                                            <!-- Untuk sementara di hidde, blm dibutuhkan di BPD
                                            <div class="box">
                                            ...
                                            <div class="box">
                                                <div id="box_title"><%=dictionaryD.getWord("DEFAULT_SCHEDULE")%></div>
                                                  ...
                                                  <table>
                                                   ...
                                                   <%
                                                   if (privUpdate == true && appUserSess.getAdminStatus()==1){
                                                       %>
                                        ...
                                        <td valign="top"><!-- Right Side -->
                                            <div class="box">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.COMPANY)%></td>
                                                        <td valign="middle">
                                                        <%
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("company_inp", "formElemen", null, "" + (employee.getCompanyId()!=0?employee.getCompanyId():companyId), comp_value, comp_key, disableElmt + "onChange=\"javascript:cmdUpdateDiv()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_COMPANY_ID)%> <% if (employee.getResigned() != PstEmployee.YES_RESIGN) {%> <% if (!ClientName.equals("BPD")){ %><a href="javascript:cmdEmpMutation('<=oidEmployee>')" class="command" style="text-decoration:none">  Employee Mutation Form</a><% } %><%}%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.DIVISION)%></td>
                                                        <td valign="middle">
                                                            <%
                                                                ...
                                                                //update by satrya 2013-09-07
                                                                   div_key.add("-select-");
                                                                    div_value.add("0");
                                                                    String strWhere = PstDivision.fieldNames[PstDivision.FLD_COMPANY_ID] + "=" +  "" + (employee.getCompanyId()) +" AND "+PstDivision.fieldNames[PstDivision.FLD_VALID_STATUS]+ " = "+PstDivision.VALID_ACTIVE ;//oidCompany; 
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("division_inp", "formElemen", null, "" + (employee.getDivisionId()), div_value, div_key, disableElmt + "onChange=\"javascript:cmdUpdateDep()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_DIVISION_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.DEPARTMENT)%></td>
                                                        <td valign="middle">
                                                        <%
                                                        ...
                                                        dept_key.add("-select-");
                                                        dept_value.add("0");
                                                        String strWhereDept = PstDepartment.TBL_HR_DEPARTMENT+"."+PstDepartment.fieldNames[PstDepartment.FLD_DIVISION_ID] + " = " + "" + employee.getDivisionId() + " AND "+PstDepartment.TBL_HR_DEPARTMENT+"."+PstDepartment.fieldNames[PstDepartment.FLD_VALID_STATUS]+" = "+PstDepartment.VALID_ACTIVE; //oidDivision;
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("department_inp", "formElemen", null, "" + (employee.getDepartmentId()), dept_value, dept_key, disableElmt + "onChange=\"javascript:cmdUpdateSec()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_DEPARTMENT_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("SECTION")%></td>
                                                        <td valign="middle">
                                                        <%
                                                            ...
                                                            sec_key.add("- select -");
                                                                sec_value.add("0");
                                                                String strWhereSec = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID] + "=" + employee.getDepartmentId()+" AND "+PstSection.fieldNames[PstSection.FLD_VALID_STATUS]+" = "+PstSection.VALID_ACTIVE;
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("section_inp", "formElemen", null, "" + (employee.getSectionId()), sec_value, sec_key, disableElmt + "onChange=\"javascript:cmdUpdatePos()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_SECTION_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.EMPLOYEE)%> <%=dictionaryD.getWord("CATEGORY")%></td>
                                                        <td valign="middle">
                                                        <%
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("emp_category_inp", null, "" + employee.getEmpCategoryId(), ctg_value, ctg_key, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_EMP_CATEGORY_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Level</td>
                                                        <td valign="middle">
                                                        <%
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("level_inp", "formElemen", null, "" + employee.getLevelId(), lvl_value, lvl_key, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_LEVEL_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("grade_level_inp", "formElemen", null, "" + employee.getGradeLevelId(), gd_value, gd_key, disableElmt)%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.POSITION)%></td>
                                                        <td valign="middle">
                                                        <%
                                                            ...
                                                            if (employee.getDivisionId() != 0){
                                                                Vector listPstPosDiv = PstPositionDivision.list(0, 0, PstPositionDivision.fieldNames[PstPositionDivision.FLD_DIVISION_ID]+"="+employee.getDivisionId(), "");
                                                                String wherePosDiv = "";
                                                                if (listPstPosDiv != null && listPstPosDiv.size()>0){
                                                                    for(int i=0; i<listPstPosDiv.size(); i++){
                                                                        PositionDivision posDiv = (PositionDivision)listPstPosDiv.get(i);
                                                                        wherePosDiv += posDiv.getPositionId()+", ";
                                                                    }
                                                                    wherePosDiv += "0";
                                                                    String where1 = PstPosition.fieldNames[PstPosition.FLD_POSITION_ID]+" IN("+wherePosDiv+")";
                                                                    listPos = PstPosition.list(0, 0, where1, " POSITION ");
                                                                } else {
                                                                    listPos = PstPosition.list(0, 0, "", " POSITION ");
                                                                }
                                                            ...
                                                            if ((employee.getDivisionId() != 0)&&(employee.getDepartmentId() != 0)){
                                                                Vector listPosDept = PstPositionDepartment.list(0, 0, PstPositionDepartment.fieldNames[PstPositionDepartment.FLD_DEPARTMENT_ID]+"="+employee.getDepartmentId(), "");
                                                                String wherePosDept = "";
                                                                if (listPosDept != null && listPosDept.size()>0){
                                                                    for(int i=0; i<listPosDept.size(); i++){
                                                                        ...
                                                                        wherePosDept += posDept.getPositionId()+", ";
                                                                    }
                                                                    wherePosDept += "0";
                                                                    String where2 = PstPosition.fieldNames[PstPosition.FLD_POSITION_ID]+" IN("+wherePosDept+")";
                                                                    listPos = PstPosition.list(0, 0, where2, " POSITION ");
                                                                } else {
                                                                    listPos = PstPosition.list(0, 0, "", " POSITION ");
                                                                }
                                                            } else {
                                                            ...
                                                            if ((employee.getDivisionId() != 0)&&(employee.getDepartmentId() != 0)&&(employee.getSectionId() != 0)){
                                                                Vector listPosSec = PstPositionSection.list(0, 0, PstPositionSection.fieldNames[PstPositionSection.FLD_SECTION_ID]+"="+employee.getSectionId(), "");
                                                                String wherePosSec = "";
                                                                if (listPosSec != null && listPosSec.size()>0){
                                                                    for(int i=0; i<listPosSec.size(); i++){
                                                                        ...
                                                                        wherePosSec += posSec.getPositionId()+", ";
                                                                    }
                                                                    wherePosSec += "0";
                                                                    String where3 = PstPosition.fieldNames[PstPosition.FLD_POSITION_ID]+" IN("+wherePosSec+")";
                                                                    listPos = PstPosition.list(0, 0, where3, " POSITION ");
                                                                } else {
                                                                    listPos = PstPosition.list(0, 0, "", " POSITION ");
                                                                }
                                                            } else {
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("position_inp", "formElemen", null, "" + employee.getPositionId(), pos_value, pos_key, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_POSITION_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.CAREER_TYPE)%></td>
                                                        <td valign="middle">
                                                            <select name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_HISTORY_TYPE]%>" <%= disableElmt %>>
                                                                    
                                                          
                                                                <%
                                                                for(int t=0; t<PstCareerPath.historyType.length; t++){
                                                                    if (employee.getHistoryType() == t){
                                                                        %>
                                                            ...
                                                            <%
                                                            if (disableElmt.length()>0){
                                                                %>
                                                                <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_HISTORY_TYPE]%>" value="<%= employee.getHistoryType() %>" />
                                                                <%
                                                            }
                                                            %>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.CAREER_GROUP)%></td>
                                                        <td valign="middle">
                                                            <select name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_HISTORY_GROUP]%>" <%= disableElmt %>>
                                                                <%
                                                                for(int g=0; g<PstCareerPath.historyGroup.length; g++){
                                                                    if (employee.getHistoryGroup() == g){
                                                                        %>
                                                            ...
                                                            if (disableElmt.length()>0){
                                                                %>
                                                                <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_HISTORY_GROUP]%>" value="<%= employee.getHistoryGroup() %>" />
                                                                <%
                                                            }
                                                            %>
                                                        </td>
                                                ...
                                                <table>
                                                    ...
                                                    <td  valign="middle">
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("wa_company_inp", "formElemen", null, "" + (employee.getWorkassigncompanyId()!=0?employee.getWorkassigncompanyId():companyId!=0?companyId:employee.getCompanyId()), wa_comp_value, wa_comp_key, disableElmt + "onChange=\"javascript:cmdUpdateDiv()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_WORK_ASSIGN_COMPANY_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                       ...
                                                       <td  valign="middle">
                                                            <%
                                                                ...
                                                                //update by satrya 2013-09-07
                                                                    ...
                                                                    String strWherewadiv = PstDivision.fieldNames[PstDivision.FLD_COMPANY_ID] + "='"+xWACompany+"'" + " AND " + PstDivision.fieldNames[PstDivision.FLD_VALID_STATUS]+ " = "+PstDivision.VALID_ACTIVE ;//oidCompany; 
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("wa_division_inp", "formElemen", null, "" + (employee.getWorkassigndivisionId()!=0?employee.getWorkassigndivisionId():wadivisionId!=0?wadivisionId:employee.getDivisionId()), wa_div_value, wa_div_key, disableElmt + "onChange=\"javascript:cmdUpdateDep()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_WORK_ASSIGN_DIVISION_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  valign="middle">
                                                                ...
                                                                String strWherewaDept = PstDepartment.TBL_HR_DEPARTMENT+"."+PstDepartment.fieldNames[PstDepartment.FLD_DIVISION_ID] + "=" + WAdivision + " AND "+PstDepartment.TBL_HR_DEPARTMENT+"."+PstDepartment.fieldNames[PstDepartment.FLD_VALID_STATUS]+" = "+PstDepartment.VALID_ACTIVE ; //oidDivision;
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("wa_department_inp", "formElemen", null, "" + (employee.getWorkassigndepartmentId()!=0?employee.getWorkassigndepartmentId():wadepartementId!=0?wadepartementId:employee.getDepartmentId()), wa_dept_value, wa_dept_key, disableElmt + "onChange=\"javascript:cmdUpdateSec()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_WORK_ASSIGN_DEPARTMENT_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  valign="middle">
                                                             <%
                                                                ...
                                                                Vector wa_sec_key = new Vector(1, 1);
                                                                    ...
                                                                    String strWherewaSec = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID] + "=" + WAdepartment + " AND "+PstSection.fieldNames[PstSection.FLD_VALID_STATUS]+" = "+PstSection.VALID_ACTIVE;
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%= ControlCombo.draw("wa_section_inp", "formElemen", null, "" + (employee.getWorkassignsectionId()!=0?employee.getWorkassignsectionId():employee.getSectionId()), wa_sec_value, wa_sec_key, disableElmt)%>  <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_WORK_ASSIGN_SECTION_ID)%>
                                                        <%
                                                        } else {
                                                            %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            ...
                                                            <%=  ControlCombo.draw("wa_position_inp", "formElemen", null, "" + employee.getWorkassignpositionId(), pos_value, pos_key, disableElmt) %> * <%= frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_WORK_ASSIGN_POSITION_ID) %>
                                                        <%
                                                        } else {
                                                            %>
                                                            <%=  ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_WORK_ASSIGN_POSITION_ID], "formElemen", null, "" + employee.getWorkassignpositionId(), pos_value, pos_key, "") %> * <%= frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_WORK_ASSIGN_POSITION_ID) %>
                                                            <%
                                                        }
                                                        %>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            disableElmt = " disabled=\"disabled\" ";
                                                            %>
                                                            <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_PROVIDER_ID]%>" value="<%=employee.getProviderID()%>" />
                                                            <%=  ControlCombo.draw("provider_inp", "formElemen", null, "" + (employee.getProviderID()!=0?employee.getProviderID():employee.getProviderID()), provValue, provKey, disableElmt) %> * <%= frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_PROVIDER_ID) %>
                                                        <%
                                                        } else {
                                                            %>
                                            ...
                                            <div class="box">
                                                <table>
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("COMMENCING_DATE")%></td>
                                                        <td valign="middle">
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            disableElmt = " disabled=\"disabled\" ";
                                                            %>
                                                            <%=ControlDate.drawDate(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_COMMENCING_DATE], employee.getCommencingDate() == null ? new Date() : employee.getCommencingDate(), "MMM", "formElemen", ",", ",", 40, -100, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_COMMENCING_DATE)%>
                                                        <%
                                                        } else {
                                                            %>
                                                            <%=ControlDate.drawDate(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_COMMENCING_DATE], employee.getCommencingDate() == null ? new Date() : employee.getCommencingDate(), "MMM", "formElemen", ",", ",", 40, -100, "")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_COMMENCING_DATE)%>
                                                            <%
                                                        }
                                                        if (disableElmt.length()>0){
                                                            %>
                                                            <input type="hidden" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_COMMENCING_DATE_STR]%>" value="<%=employee.getCommencingDate()%>" />
                                                            <%
                                                        }
                                                        %>    
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("PROBATION_END_DATE")%></td>
                                                        <td valign="middle">
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            disableElmt = " disabled=\"disabled\" ";
                                                            %>
                                                            <input type="hidden" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_PROBATION_END_DATE_STR]%>" value="<%=employee.getProbationEndDate()%>" />
                                                            <%=ControlDate.drawDate("probation_enddate", employee.getProbationEndDate() == null ? null : employee.getProbationEndDate(), "MMM", "formElemen", ",", ",", 10, -50, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_PROBATION_END_DATE)%>
                                                        <%
                                                        } else {
                                                            %>
                                                            <%=ControlDate.drawDate(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_PROBATION_END_DATE], employee.getProbationEndDate() == null ? null : employee.getProbationEndDate(), "MMM", "formElemen", ",", ",", 10, -50, "")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_PROBATION_END_DATE)%>
                                                            <%
                                                        }
                                                        %> 
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("LOCKER")%></td>
                                                        <td valign="middle">
                                                        <%
                                            ...
                                            <div class="box">
                                                <table >
                                                    <tr>
                                                        <td valign="middle" id="caption">No. BPJS Ketenaga Kerjaan</td>
                                                        <td valign="middle"><input type="text" autocomplete="off" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_ASTEK_NUM]%>" value="<%=employee.getAstekNum()%>" class="formElemen"></td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="middle" id="caption">BPJS Ketenaga Kerjaan</td>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">No. BPJS Kesehatan </td>
                                                        <td valign="middle"><input type="text" autocomplete="off" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_BPJS_NO]%>" value="<%=employee.getBpjs_no()!=null? employee.getBpjs_no():""%>" class="formElemen"></td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("DATE")%> BPJS Kesehatan</td>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Member of BPJS Kesehatan</td>
                                                        <td valign="middle">
                                                     ...
                                                     <tr>
                                                        <td valign="middle" id="caption">Member of BPJS Ketenagakerjaan</td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Status Pensiun Program</td>
                                                        <td valign="middle">
                                                            <%
                                                            if (appUserSess.getAdminStatus()==0){
                                                                %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Start Date Program Pensiun (Mulai diangkat)</td>
                                                        <td valign="middle">
                                                            <%
                                                            if (appUserSess.getAdminStatus()==0){
                                                                disableElmt = " disabled=\"disabled\" ";
                                                                %>
                                                                <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_START_DATE_PENSIUN_STR]%>" value="<%=employee.getStartDatePensiun()%>" />
                                                                <%=ControlDate.drawDate("start_date_pensiun_inp", employee.getStartDatePensiun() == null ? employee.getStartDatePensiun() : employee.getStartDatePensiun(), "MMM", "formElemen", ",", ",", 5, -77, disableElmt)%>
                                                                <%
                                                            } else {
                                                                 %>
                                                                 <%=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_START_DATE_PENSIUN], employee.getStartDatePensiun(), 5, -77, "formElemen")%>
                                                                 <%
                                                            }
                                                            %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Dana Pendidikan</td>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Kadiv Mapping</td>
                                                        <td valign="middle"><a href="javascript:cmdViewKadiv('<%=oidEmployee%>')">Add Or View Kadiv Outlet</a></td>
                                                    </tr>
                                                    <%}%>
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.EMPLOYEE)%> PIN</td>
                                                        <td valign="middle">
                                                            <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_EMP_DOC_ID]%>" value="<%=(employee.getEmpDocId() != 0 ? employee.getEmpDocId() : 0)%>" class="formElemen">
                                                            <%
                                                            if (appUserSess.getAdminStatus()==0){
                                                                %>
                                                                <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_EMP_PIN]%>" value="<%=(employee.getEmpPin() != null ? employee.getEmpPin() : "")%>" />
                                                                <input type="password" disabled="disabled" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_EMP_PIN]%>" value="<%=(employee.getEmpPin() != null ? employee.getEmpPin() : "")%>" autocomplete="new-password" class="formElemen">
                                                                         * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_EMP_PIN)%>&nbsp;
                                                                <%
                                                            } else {
                                                                %>
                                                                <input type="password"  name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_EMP_PIN]%>" value="<%=(employee.getEmpPin() != null ? employee.getEmpPin() : "")%>" autocomplete="new-password" class="formElemen">
                                                                         * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_EMP_PIN)%>&nbsp;
                                                                <%
                                                            }
                                                            %>
                                                    ...
                                                    %>
                                                    <tr>
                                                   <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.LOCATION)%></td>
                                                   <td valign="middle">      
                                                   <%
                                                   ...
                                                   <tr>
                                                        <td  valign="middle" id="caption">
                                                        <%=dictionaryD.getWord(I_Dictionary.ENDED_CONTRACT)%>
                                                        </td>
                                                        <td  valign="middle">
                                                        ...
                                                        if (appUserSess.getAdminStatus()==0){
                                                            disableElmt = " disabled=\"disabled\" ";
                                                            %>
                                                            <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_END_CONTRACT_STR]%>" value="<%=employee.getEnd_contract()%>" />
                                                            <%=ControlDate.drawDate("end_contract_inp", employee.getEnd_contract() == null ? employee.getEnd_contract() : employee.getEnd_contract(), "MMM", "formElemen", ",", ",", 0, 30, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_END_CONTRACT)%>
                                                        <%
                                                        } else {
                                                            %>
                                                            <%=ControlDate.drawDate(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_END_CONTRACT], employee.getEnd_contract() == null ? employee.getEnd_contract() : employee.getEnd_contract(), "MMM", "formElemen", ",", ",", 0, 30, "")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_END_CONTRACT)%>
                                                            <%
                                                        }
                                                        %>   
                                                        </td>        
                                            ...
                                            <!-- Untuk sementara saya off kan, belum digunakan di BPD
                                            <div class="box">
                                            ...
                                            <div class="box">
                                                <div id="box_title"><%=dictionaryD.getWord(I_Dictionary.RESIGNATION)%></div>
                                                <table>
                                                    
                                                     <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.RESIGNED_STATUS)%></td>
                                                        <td valign="middle">
                                                            <%
                                                            if (appUserSess.getAdminStatus()==0){
                                                                %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord("RESIGNED_DATE")%></td>
                                                        <td valign="middle">
                                                            <%
                                                            if (appUserSess.getAdminStatus()==0){
                                                                disableElmt = " disabled=\"disabled\" ";
                                                                %>
                                                                <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_RESIGNED_DATE_STR]%>" value="<%=employee.getResignedDate()%>" />
                                                                <%=ControlDate.drawDate("resign_date_inp", employee.getResignedDate() == null ? employee.getResignedDate() : employee.getResignedDate(), "MMM", "formElemen", ",", ",", +5, -10, disableElmt)%> 
                                                                <%
                                                            } else {
                                                                %>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.RESIGNED_REASON)%></td>
                                                        <td valign="middle">
                                                            <%
                                                            if (appUserSess.getAdminStatus()==0){
                                                                %>
                                                                <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_RESIGNED_REASON_ID]%>" value="<%=employee.getResignedReasonId()%>" />
                                                                Tidak Dapat di-Setting
                                                                <%                                                                
                                                            } else {
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=dictionaryD.getWord(I_Dictionary.RESIGNED_DESCRIPTION)%></td>
                                                        <td valign="middle">
                                                            <%
                                                            if (appUserSess.getAdminStatus()==0){
                                                                %>
                                                                <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_RESIGNED_DESC]%>" value="<%=employee.getResignedDesc()%>" />
                                                                <textarea name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_RESIGNED_DESC]%>" disabled="disabled" class="formElemen" rows="2" cols="30"><%=employee.getResignedDesc()%></textarea>
                                                                <%
                                                            } else {
                                                                %>
                                            ...
                                            <!-- Utk sementara saya off dulu fitur HOD ini, karena blm dibutuhkan di BPD
                                            <div class="box">
                                            ...
                                            %>
                                            <div class="box">
                                                <div id="box_title">Informasi Surat Keputusan (SK)</div>
                                                <table>
                                                    <tr>
                                                        <td valign="middle" id="caption">NKK</td>
                                                        <td valign="middle">
                                                            <input type="text"  <%= disableElmt %> name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_NKK]%>" value="<%=employee.getNkk() %>" />
                                                            <%
                                                            if (disableElmt.length()>0){
                                                                %>
                                                                <input type="hidden"  name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_NKK]%>" value="<%=employee.getNkk() %>" />
                                                                <%
                                                            }
                                                            %>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td valign="middle" id="caption">Nomor SK Jabatan</td>
                                                        <td valign="middle">
                                                            <input type="text" <%= disableElmt %> id="jabatanNo" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SK_NOMOR]%>" value="<%=employee.getSkNomor() %>" />
                                                            <%
                                                            if (disableElmt.length()>0){
                                                                %>
                                                                <input type="hidden" id="jabatanNoHidden" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SK_NOMOR]%>" value="<%=employee.getSkNomor() %>" />
                                                                <%
                                                            }
                                                            %>
                                                        </td>
                                                        <td>
                                                            <a href="javascript:cmdBrowseDoc(1)" class="btn-small" style="color:#FFF">Pilih Dokumen SK Jabatan</a>
                                                        </td>
                                                    </tr>
                                                    <!-- if (employee.getSkTanggal() != null){ -->
                                                    <tr>
                                                        <td valign="middle" id="caption">Tanggal SK Jabatan</td>
                                                        <td valign="middle">
                                                            <input type="text" <%= disableElmt %> id="jabatanTgl" class="mydate" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SK_TANGGAL]%>" value="<%= employee.getSkTanggal() %>" />
                                                            <%
                                                            if (disableElmt.length()>0){
                                                                %>
                                                                <input type="hidden" id="jabatanTglHidden" class="mydate" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SK_TANGGAL]%>" value="<%= employee.getSkTanggal() %>" />
                                                                <%
                                                            }
                                                            %>
                                                        </td>
                                                    ...
                                                    <!-- } -->
                                                    <tr>
                                                        <td valign="middle" id="caption">Nomor SK Grade</td>
                                                        <td valign="middle">
                                                            <input type="text" <%= disableElmt %> id="gradeNo" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SK_NOMOR_GRADE]%>" value="<%=employee.getSkNomorGrade() %>" />
                                                            <%
                                                            if (disableElmt.length()>0){
                                                                %>
                                                                <input type="hidden" id="gradeNoHidden" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SK_NOMOR_GRADE]%>" value="<%=employee.getSkNomorGrade() %>" />
                                                                <%
                                                            }
                                                            %>
                                                        </td>
                                                        <td>
                                                            <a href="javascript:cmdBrowseDoc(2)" class="btn-small" style="color:#FFF">Pilih Dokumen SK Grade</a>
                                                        </td>
                                                    </tr>
                                                    <!-- if (employee.getSkTanggal() != null){ -->
                                                    <tr>
                                                        <td valign="middle" id="caption">Tanggal SK Grade</td>
                                                        <td valign="middle">
                                                            <input type="text" <%= disableElmt %> id="gradeTgl" class="mydate" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SK_TANGGAL_GRADE]%>" value="<%= employee.getSkTanggalGrade() %>" />
                                                            <%
                                                            if (disableElmt.length()>0){
                                                                %>
                                                                <input type="hidden" class="mydate" id="gradeTglHidden" name="<%=frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SK_TANGGAL_GRADE]%>" value="<%= employee.getSkTanggalGrade() %>" />
                                                                <%
                                                            }
                                                            %>
                                                        </td>
                                            ...
                                            <div class="box">
                                                ...
                                                <table>
                                                    ...
                                                    for(int c=0; c<listCustom.size(); c++){
                                                        ...
                                                        if (custom.getFullAccess() == 0 && appUserSess.getAdminStatus()==0){
                                                            custDisable = " disabled=\"disabled\" ";
                                                        } else {
                                                            custDisable = "";
                                                        }
                                                        switch(custom.getInputType()){
                                                            case 0: input = "<input type=\"text\" "+custDisable+" name=\"input0\" size=\"50\" value=\""+valueInput+"\" />";
                                                                    if (custDisable.length() > 3){
                                                                        input += "<input type=\"hidden\" name=\"input0\" size=\"50\" value=\""+valueInput+"\" />";
                                                                    }
                                                                    ...
                                                                    break;
                                                            case 1: input = "<textarea name=\"input1\">"+valueInput+"</textarea>";
                                                            ...
                                                            case 3: input = custom.getDataList();
                                                                    ...
                                                                    break;
                                                            case 4: input = "<input type=\"text\" "+custDisable+" class=\"mydate\" name=\"input4\" value=\""+valueInput+"\" />";
                                                                    if (custDisable.length() > 3){
                                                                        input += "<input type=\"hidden\" name=\"input4\" value=\""+valueInput+"\" />";
                                                                    }
                                                                    ...
                                                                    break;
                                                            case 5: input = "<input type=\"text\" "+custDisable+" class=\"mydate\" name=\"input5\" />";
                                                                    if (custDisable.length() > 3){
                                                                        input += "<input type=\"hidden\" name=\"input5\" value=\""+valueInput+"\" />";
                                                                    }
                                                    ...
                                                    %>
                                                    <tr>
                                                        <td valign="middle" id="caption"><%=custom.getFieldName()%></td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                                ...
                                                                <button id="btn" onclick="cmdSaveCustom('<%=employee.getOID()%>')">Save data custom</button>
                                                ...
                                                <tr>
                                                    <td> <table cellpadding="0" cellspacing="0" border="0">
                                                            <tr>
                                                                ...
                                                                <td width="4"><img src="<%=approot%>/images/spacer.gif" width="4" height="4"></td>
                                                                <td nowrap><a href="javascript:cmdSwal()" class="command" style="text-decoration:none">Print Employee</a></td>
                                                                ...
                                                                <td width="4"><img src="<%=approot%>/images/spacer.gif" width="4" height="4"></td>
                                                                <td nowrap><a href="javascript:cmdPrintXLS()" class="command" style="text-decoration:none">Export to Excel</a></td>
                                                                <%}%>
                                                            </tr>
                                                        </table>
                                                    </td>
