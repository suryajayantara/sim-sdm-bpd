                                        ...
                                        <td valign="top"> <!-- Left Side -->
                                            <div class="box">
                                                ...
                                                <table>
                                                                ...
                                                                if(attdConfig != null && attdConfig.getConfigurasiInputEmpNum() == I_Atendance.CONFIGURATION_II_GENERATE_AUTOMATIC_EMPLOYEE_NUMBER){
                                                                 ...
                                                                 <% } else {
                                                                    if (appUserSess.getAdminStatus()==0){
                                                                        disableElmt = " disabled=\"disabled\" ";
                                                                        %>
                                                                        <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_EMPLOYEE_NUM]%>" value="<%=employee.getEmployeeNum()%>" class="formElemen">
                                                                        <input type="text" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_EMPLOYEE_NUM]%>" <%= disableElmt %> value="<%=employee.getEmployeeNum()%>" class="formElemen">
                                                                        <%
                                                                    } else {
                                                                        %>
                                                    ...
                                                    <tr>
                                                        <th valign="middle"><%=(ClientName.equals("QUEEN_TANDOOR")?"Temporary Address":dictionaryD.getWord(I_Dictionary.ADDRESS))%></th>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="middle">
                                                            ...
                                                            if (appUserSess.getAdminStatus()==0){
                                                                ...
                                                                <input  type="text" <%= disableElmt %> name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_BARCODE_NUMBER]%>" title=" If Employe is a Daily Worker (DL)  please replace 'DL-' with '12' ,for  example 'DL-333' become to '12333'.     If Employe's  Status  'Resigned'  please input the barcode number, barcode number is unique for example -R(BarcodeNumb/PinNumber)" value="<%=(employee.getBarcodeNumber() != null ? employee.getBarcodeNumber() : "")%>" class="formElemen">
                                        ...
                                        <td valign="top"><!-- Right Side -->
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="middle">
                                                            ...
                                                            <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_DIVISION_ID], "formElemen", null, "" + (employee.getDivisionId()), div_value, div_key, disableElmt + "onChange=\"javascript:cmdUpdateDep()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_DIVISION_ID)%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        %> 
                                                            ...
                                                            <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_DEPARTMENT_ID], "formElemen", null, "" + (employee.getDepartmentId()), dept_value, dept_key, disableElmt + "onChange=\"javascript:cmdUpdateSec()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_DEPARTMENT_ID)%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SECTION_ID]%>" value="<%=employee.getSectionId()%>" />
                                                            <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_SECTION_ID], "formElemen", null, "" + (employee.getSectionId()), sec_value, sec_key, disableElmt + "onChange=\"javascript:cmdUpdatePos()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_SECTION_ID)%>  
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <input type="hidden" name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_EMP_CATEGORY_ID]%>" value="<%=employee.getEmpCategoryId()%>" />
                                                            <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_EMP_CATEGORY_ID], null, "" + employee.getEmpCategoryId(), ctg_value, ctg_key, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_EMP_CATEGORY_ID)%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        %> 
                                                            ...
                                                            <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_LEVEL_ID], "formElemen", null, "" + employee.getLevelId(), lvl_value, lvl_key, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_LEVEL_ID)%>
                                                        <%
                                                        int SetGrade = 1;
                                                        try{
                                                        ...
                                                        <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_GRADE_LEVEL_ID], "formElemen", null, "" + employee.getGradeLevelId(), gd_value, gd_key, disableElmt)%> 
                                                        <% } %>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        %> 
                                                            ...
                                                            <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_POSITION_ID], "formElemen", null, "" + employee.getPositionId(), pos_value, pos_key, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_POSITION_ID)%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="middle">Career Type</th>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <th valign="middle">Career Group</th>
                                                        <td valign="middle">
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td  valign="middle">
                                                            ...
                                                            <input type="hidden" name="" value="" />
                                                            <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_WORK_ASSIGN_DIVISION_ID], "formElemen", null, "" + (employee.getWorkassigndivisionId()!=0?employee.getWorkassigndivisionId():wadivisionId!=0?wadivisionId:employee.getDivisionId()), wa_div_value, wa_div_key, disableElmt + "onChange=\"javascript:cmdUpdateDep()\"")%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_WORK_ASSIGN_DIVISION_ID)%> 
                                                       </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td  valign="middle">
                                                            ...
                                                            %>
                                                            <input type="hidden" name="" value="" />
                                                             <%= ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_WORK_ASSIGN_SECTION_ID], "formElemen", null, "" + (employee.getWorkassignsectionId()!=0?employee.getWorkassignsectionId():employee.getSectionId()), wa_sec_value, wa_sec_key, disableElmt)%>  <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_WORK_ASSIGN_SECTION_ID)%>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td  width="46%"  valign="middle">
                                                            ...
                                                            %>
                                                            <input type="hidden" name="" value="" />
                                                            <%=  ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_WORK_ASSIGN_POSITION_ID], "formElemen", null, "" + employee.getWorkassignpositionId(), pos_value, pos_key, disableElmt) %> * <%= frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_WORK_ASSIGN_POSITION_ID) %>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th  width="58%"  valign="middle" nowrap>
                                                        ...
                                                        <td  width="46%"  valign="middle">
                                                            ...
                                                            %>
                                                            <input type="hidden" name="" value="" />
                                                            <%=  ControlCombo.draw(FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_PROVIDER_ID], "formElemen", null, "" + (employee.getProviderID()!=0?employee.getProviderID():employee.getProviderID()), provValue, provKey, disableElmt) %> * <%= frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_PROVIDER_ID) %>
                                                       </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div class="box">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td valign="middle"><%=ControlDate.drawDate(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_COMMENCING_DATE], employee.getCommencingDate() == null ? new Date() : employee.getCommencingDate(), "MMM", "formElemen", ",", ",", 40, -100, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_COMMENCING_DATE)%></td>
                                                    </tr>
                                                    <tr>
                                                        <th valign="middle"><%=dictionaryD.getWord("PROBATION_END_DATE")%></th>
                                                        <td valign="middle"><%=ControlDate.drawDate(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_PROBATION_END_DATE], employee.getProbationEndDate() == null ? null : employee.getProbationEndDate(), "MMM", "formElemen", ",", ",", 10, -50, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_PROBATION_END_DATE)%></td>
                                                    </tr>
                                            ...
                                            <div class="box">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <th valign="middle">Status Pensiun Program</th>
                                                        <td valign="middle">
                                                    ...
                                                    <tr>
                                                        <th valign="middle">Start Date Program Pensiun (Mulai diangkat)</th>
                                                        <td valign="middle"><%=ControlDate.drawDateWithStyle(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_START_DATE_PENSIUN], employee.getStartDatePensiun(), 5, -77, "formElemen")%></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="middle">
                                                            ...
                                                            <input type="password" <%= disableElmt %> name="<%=FrmEmployee.fieldNames[FrmEmployee.FRM_FIELD_EMP_PIN]%>" value="<%=(employee.getEmpPin() != null ? employee.getEmpPin() : "")%>" autocomplete="new-password" class="formElemen">
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td  valign="middle">
                                                            <%=ControlDate.drawDate(frmEmployee.fieldNames[FrmEmployee.FRM_FIELD_END_CONTRACT], employee.getEnd_contract() == null ? employee.getEnd_contract() : employee.getEnd_contract(), "MMM", "formElemen", ",", ",", 0, 30, disableElmt)%> * <%=frmEmployee.getErrorMsg(FrmEmployee.FRM_FIELD_END_CONTRACT)%>
                                                        </td>        
                                                   </tr>
                                                </table>
                                            </div>
                                            ...
                                            <div class="box">
                                                ...
                                                <table>
                                                     ...
                                                     <tr>
                                                        <th valign="middle">Resign Status</th>
                                                        <td valign="middle">
                                                ...
                                                <tr>
                                                    <td> <table cellpadding="0" cellspacing="0" border="0">
                                                            <tr>
                                                                ...
                                                                <td width="4"><img src="<%=approot%>/images/spacer.gif" width="4" height="4"></td>
                                                                <td nowrap><a href="javascript:cmdPrint()" class="command" style="text-decoration:none">Print Employee</a></td>
