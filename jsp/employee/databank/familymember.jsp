...
//variable declaration
            ...
            if (iCommand == Command.SAVE) {
                for (int i = 0; i < 50; i++) {
                    long oid = FRMQueryString.requestLong(request, FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_FAMILY_MEMBER_ID] + "_" + i);
                    ...
                    String birthPlace = FRMQueryString.requestString(request, FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_BIRTH_PLACE] + "_" + i);
                    ...
                    famMember.setBirtPlace(birthPlace);
...
//switch statement //
    iErrCode = ctrlFamilyMember.action(iCommand, oidEmployee, vctMember, request, emplx.getFullName(), appUserIdSess, oidFamilyMember);//oidFamilyMember, oidEmployee);
// end switch
    FrmFamilyMember FrmFamilyMember = ctrlFamilyMember.getForm();
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function fnTrapKD(){
                ...
                function cmdExportExcel(oid){
                 
                    var linkPage = "<%=approot%>/report/employee/export_excel/laporan_pihak_terkait_xls.jsp?employee_id="+oid;    
    ...
    <body>
        ...
        <div class="navbar">
            <ul style="margin-left: 97px">
                ...
                %>
                <li class="active"> <%=dictionaryD.getWord(I_Dictionary.FAMILY_MEMBER) %> </li>
        ...
        <div class="content-main">
            <form name="FrmFamilyMember" method="post" action="">
                ...
                <% } %>
                <%
                if (ctrlFamilyMember.getMessage().length() > 0){
                    %>
                    <div class="alert-box notice-success">
                        <%=ctrlFamilyMember.getMessage()%>
                    </div>
                    <%
                }
                %>
                <div class="content" >
                    ...
                    <table cellspacing="1" cellpadding="1" class="tblStyle">
                        <tr>
                            ...
                            <td valign="top" class="title_tbl">
                              <div align="center"><b>Guaranted / Num Asuransi Kesehatan </b></div>

                            </td>
                            <td valign="top" class="title_tbl">
                                <div align="center"><strong>Tempat / Tgl Lahir</strong></div>
                            </td>
<!--                            <td valign="top" class="title_tbl">
...
<!--                            <td valign="top" class="title_tbl">
                        ...
                        %>
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <input type="hidden" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_FAMILY_MEMBER_ID]%>_<%=idx%>"  value="<%= famX.getOID()%>" class="elemenForm" size="30">
                      ...
                      <% }%>
                                ...
                                <%  Vector relationX_value = new Vector(1, 1);
                                    ...
                                    <td valign="top">
                                        <input type="checkbox" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_GUARANTEED]%>_<%=idx%>" value="1" <%if (famX.getGuaranteed()) {%>checked<%}%> size="20">
                                        Yes <br> 
                                        <input type="text" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_BPJS_NUM]%>_<%=idx%>"  value="<%= famX.getBpjsNum() %>" class="elemenForm" size="20">
                                    </td>
                                    <td valign="top">
                                        <input type="text" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_BIRTH_PLACE]%>_<%=idx%>" value="<%= famX.getBirtPlace()%>" />
                                        <%=ControlDate.drawDateEmpty(FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_BIRTH_DATE] + "_"+idx, famX.getBirthDate(), "formElemen", 0, -115)%>
                                        <br>
                    ...
                    <div>
                        <a href="javascript:cmdExportExcel('<%=oidEmployee%>')" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1003','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image1003" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Export to Excel">Export to Excel</a>
                    </div>
                </div>
