...
<script type="text/javascript">
    function loadDivision(str) {
        if (str.length == 0) { 
            ...
            xmlhttp.open("GET", "structure_org_ajax.jsp?comp_id=" + str, true);
            xmlhttp.send();
        }
    }
    ...
    function loadDepartment(comp_id, divisi_id) {
        if ((comp_id.length == 0)&&(divisi_id.length == 0)) { 
            ...
            xmlhttp.open("GET", "structure_org_ajax.jsp?comp_id="+comp_id+"&divisi_id=" + divisi_id, true);
            xmlhttp.send();
        }
    }
    ...
    function loadSection(comp_id, divisi_id, depart_id) {
        if ((comp_id.length == 0)&&(divisi_id.length == 0)&&(depart_id.length == 0)) { 
            ...
            xmlhttp.open("GET", "structure_org_ajax.jsp?comp_id="+comp_id+"&divisi_id=" + divisi_id +"&department_id="+depart_id, true);
            xmlhttp.send();
        }
    }
</script>
                                   ...
                                   /*Vector company_value = new Vector(1, 1);
                                    ...
                                    if(oidHistoryComp==0){
                                        oidHistoryComp = careerPath.getCompanyId();
                                                                                                                                    ...
                                                                                                                                    %>
<%= ControlCombo.draw(frmCareerPath.fieldNames[FrmCareerPath.FRM_FIELD_COMPANY_ID], "formElemen", null,""+(careerPath.getCompanyId()!=0?careerPath.getCompanyId():oidHistoryComp), company_value, company_key,"onChange=\"javascript:loadDivision(this.value)\"")%>  
