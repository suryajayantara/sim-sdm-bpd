...
<%
    ...
    int point = SessTraining.getTrainingDuration(FRMQueryString.requestString(request, "training_point"));
    ...
    iErrCode = ctrlTrainingHistory.action(iCommand, oidTrainingHistory, request, emplx.getFullName(), appUserIdSess, 0,100);
    ...
    if(iCommand == Command.GOTO) {
        ...
        try {
            ...
            trainingHistory.setPoint(point);
        }
        catch(Exception e) {}         
     }
        ...
        <div class="content-main">
            <form name="fredit" method="post" action="">
                ...
                <div class="content-title">
                    <div id="title-large">Riwayat Training</div>
                ...
                <div class="content">
                    ...
                    <table>
                        <tr>
                            <td valign="top">
                                <div id="confirm">
                                    <strong><%=dictionaryD.getWord(I_Dictionary.ARE_YOU_SURE_TO_DELETE_ITEM
                                   )%></strong> &nbsp;
                                    <button id="btn-confirm" onclick="javascript:cmdConfirmDelete('<%=oidTrainingHistory%>')"><%=dictionaryD.getWord(I_Dictionary.YES)%></button>
                    ...
                    <%}%>
                    <%
                    if (ctrlTrainingHistory.getMessage().length() > 0){
                        %>
                        <div class="alert-box notice-success">
                            <%=ctrlTrainingHistory.getMessage()%>
                        </div>
                        <%
                    }
                    %>
                            ...
                            <td valign="top">
                                <div class="form-style">
                                    ...
                                    <div class="form-content">
                                        ...
                                        <div>
                                            <p>
                                                <a class="btn-small" style="color: #FFF" href="javascript:cmdTraining()">Pilih Program Training</a>&nbsp;
                                                <a class="btn-small" style="color: #FFF" href="javascript:cmdActual()">Pilih Dari Kegiatan Training</a>
                                            </p>
                                        </div>
                                        <div id="div_input">
                                        ...
                                        <div id="caption"><%=dictionaryD.getWord(I_Dictionary.START_DATE)%> - <%=dictionaryD.getWord(I_Dictionary.END_DATE)%></div>
                                        <div id="div_input">
                                            <%
                                        ...
                                        <div id="caption"><%=dictionaryD.getWord(I_Dictionary.START_TIME)%> - <%=dictionaryD.getWord(I_Dictionary.END_TIME)%></div>
                                        <div id="div_input">
                                        ...
                                        <div id="caption"><%=dictionaryD.getWord(I_Dictionary.DURATION)%></div>
                                        <div id="div_input">
                                        ...
                                        <div id="caption"><%=dictionaryD.getWord(I_Dictionary.REMARK)%></div>
                                        <div id="div_input">
                                            <textarea name="<%= FrmTrainingHistory.fieldNames[FrmTrainingHistory.FRM_FIELD_REMARK] %>"><%=trainingHistory.getRemark() %></textarea>
                                        </div>
                                        <div id="caption"><%=dictionaryD.getWord(I_Dictionary.POINT)%></div>
                                        <div id="div_input">
                                            <input type="text"  id="<%= FrmTrainingHistory.fieldNames[FrmTrainingHistory.FRM_FIELD_POINT] %>" name="<%= FrmTrainingHistory.fieldNames[FrmTrainingHistory.FRM_FIELD_POINT] %>" onchange="javascript:checkRange('<%=FrmTrainingHistory.fieldNames[FrmTrainingHistory.FRM_FIELD_POINT] %>',0,100);" value="<%= trainingHistory.getPoint() %>" /> (0-100)
                                        </div>
