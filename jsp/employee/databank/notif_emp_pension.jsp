<%-- 
    Document   : notif_emp_pension
    Created on : Jun 24, 2020, 3:06:33 PM
    Author     : Utk
--%>
...
<%
    ...
    try{
     int lenghtDay = PstNotification.checkLenghtNotifByUser(userid,PstNotification.NOTIF_KARYAWAN_PENSIUN);
...
<html>
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Employee Pension</span>
        </div>
                ...
                <table class="tblStyle">
                    ...
                    <%
                      for (int i=0; i<listPensiun.size(); i++){
                          ...
                          int no = 0;
                           if((usia == (usiaPensiun - 1) && bedaHari > 0) || (usia == usiaPensiun && bedaHari == 0)){
