...
<%!    
    ...
    public String drawList(Vector objectClass, long workHistoryNowId, I_Dictionary dictionaryD, int historyType1, int historyType2) {
        String output = "";
    ...
    <head>
		...
		function cmdDetail2(oid){
            ...
            function cmdDetailDocument(EmpDocument_oid){
                    window.open("<%=approot%>/masterdata/EmpDocumentDetailsEditor.jsp?EmpDocument_oid="+EmpDocument_oid+"&fromCareerPath=1");       
            }
            function cmdHapus(){
    ...
    <body onload="pageLoad()">
        ...
        <div class="content-main">
            <form name="frmcareerpath" method ="post" action="careerpath.jsp">
                ...
                <div class="content">
                    <p style="margin-top: 2px"><a style="color:#FFF" class="btn" href="javascript:cmdAdd()">Tambah Data</button></a>
                    <div id="box_delete">
                    <table>
                        <tr>
                            <td valign="top">
                    ...
                    <table class="tblStyle">
                        ...
                        <%= drawList(listCareerPath, iCommand == Command.SAVE ? careerPath.getOID() : oidCareerPath, dictionaryD, PstCareerPath.CAREER_TYPE, PstCareerPath.PEJABAT_SEMENTARA_TYPE) %>
                        <% } %>
                        <%
                        ...
                        <%= drawList(listCareerPath, iCommand == Command.SAVE ? careerPath.getOID() : oidCareerPath, dictionaryD, PstCareerPath.PELAKSANA_TUGAS_TYPE, PstCareerPath.DETASIR_TYPE) %>
                        <tr>
