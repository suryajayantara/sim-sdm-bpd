...
<%
	...
	String whereClauseGrade = PstCareerPath.fieldNames[PstCareerPath.FLD_EMPLOYEE_ID] + " = " + oidEmployee + " AND ("+ PstCareerPath.fieldNames[PstCareerPath.FLD_HISTORY_GROUP] + " = " + PstCareerPath.RIWAYAT_GRADE + " OR "+PstCareerPath.fieldNames[PstCareerPath.FLD_HISTORY_GROUP] + " = " + PstCareerPath.RIWAYAT_CAREER_N_GRADE+")" ;
	...
	Vector listCareerPathGrade = new Vector(1, 1);
	...
	listCareerPathGrade = PstCareerPath.list(start, recordToGet, whereClauseGrade, orderClauseCareer);
...
<html>
    <head>
        ...
        <style type="text/css">
            .tblStyle {border-collapse: collapse;font-size: 11px;width:100%}
...
<script src="<%=approot%>/styles/select2/js/select2.min.js"></script>
<link href="<%=approot%>/styles/select2/css/select2.min.css" type="text/css" rel="stylesheet" />
<script>
    $(function() {
    ...
    $(document).ready(function() {
        $("#doc").select2({
            ...
            tags: [],
            ajax: {
                url: "<%=approot%>/employee/databank/ajax_emp_doc.jsp",
        ...
        <div class="content-main">
            <form name="frmcareerpath" method ="post" action="careerpath.jsp">
                ...
                <div class="content">
                    ...
                    <%
                    if (ctrlCareerPath.getMessage().length() > 0){
                        %>
                        <div class="alert-box notice-success">
                            <%=ctrlCareerPath.getMessage()%>
                        </div>
                        <%
                    }
                    %>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            ...
                                            <div class="divinput">
                                                ...
                                                <% if (careerPath.getTanggalSk() == null){ %>
                                                <span style="color:#E34949;">Tanggal SK Tidak boleh kosong, mohon diinput.</span>
                                                <% } %>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            ...
                                            <div class="divinput">
                                                <select name="<%= FrmCareerPath.fieldNames[FrmCareerPath.FRM_FIELD_EMP_DOC_ID] %>" id="doc" style="width: 100%">
                                                    <%
                                                        if (careerPath.getEmpDocId() > 0){
                                                            String docNumber = "";
                                                            try {
                                                                EmpDoc empDoc = PstEmpDoc.fetchExc(careerPath.getEmpDocId());
                                                                docNumber = empDoc.getDoc_number();
                                                            } catch (Exception exc){}
                                                            %>
                                                            <option value="<%=careerPath.getEmpDocId()%>"><%=docNumber%></option>
                                                            <%
                                                        } else {
                                                            %>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            ...
                                            <div class="divinput">
                                            <%= ControlDate.drawDateWithStyle(frmCareerPath.fieldNames[FrmCareerPath.FRM_FIELD_CONTRACT_FROM], careerPath.getContractFrom(), 10, -55, "formElemen")%> to

                                            <%= ControlDate.drawDateWithStyle(frmCareerPath.fieldNames[FrmCareerPath.FRM_FIELD_CONTRACT_TO], careerPath.getContractTo(), 10, -55, "formElemen")%> *
                   ...
                   <!--
					...
					<%
						String penugasanDetasir = PstCareerPath.drawRiwayatJabatanPenugasan(listCareerPath, PstCareerPath.DETASIR_TYPE, privUpdate, privDelete, ClientName);
						String penugasanPLT = PstCareerPath.drawRiwayatJabatanPenugasan(listCareerPath, PstCareerPath.PELAKSANA_TUGAS_TYPE, privUpdate, privDelete, ClientName);
						if (penugasanDetasir.length()>0 || penugasanPLT.length()>0){
					%>
                    <div class="table_scroll">
                        <table class="tblStyle">
                            <thead>
                    ...
                    <div class="table_scroll">
                        <table class="tblStyle">
                            ...
                            <%= PstCareerPath.drawGradeNow(employee, listCareerPathGrade, ClientName) %>
                        </table>
                    </div>
                </div>
            </form>
