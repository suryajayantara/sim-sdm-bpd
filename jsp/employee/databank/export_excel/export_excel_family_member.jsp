                ...
                <td colspan="2">
                    <table border="1" width="100%">
                        <% for (int idx=0; idx < vctMember.size(); idx++ ){ 
                            ...
                            String huruf = "";
                            if (relation.equals("Ayah")){
                                huruf = "a";
                            } else if (relation.equals("Ibu")){
                                huruf = "a";
                            } else if (relation.equals("Saudara Perempuan") || relation.equals("Saudara Laki-laki")){
                                huruf = "b";
                            } else if (relation.equals("Anak ke 1") || relation.equals("Anak ke 2") || relation.equals("Anak ke 3") || relation.equals("Anak ke 4") || relation.equals("Anak ke 5")) {
                                huruf = "e";
                            } else if (relation.equals("Pasangan") && famX.getSex() == 0){
                                huruf = "c";
                                relation = "Suami";
                            } else if (relation.equals("Pasangan") && famX.getSex() == 1){
                                huruf = "c";
                                relation = "Istri";
                            }
