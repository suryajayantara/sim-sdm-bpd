...
<%!
...

	{
		...
		ctrlist.addHeader("PAGE","");
                ...
                ctrlist.addHeader("DOCUMENT","15%","align='center'");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			rowx.add(String.valueOf(recordNo++));
                        ...
                        rowx.add("<a href=\"javascript:cmdDetailUp('"+empReprimand.getOID()+"','"+empReprimand.getClass().getName()+"')\">Detail</a>");
                        lstData.add(rowx);
    ...
    <head>
        ...
        <script language="JavaScript">
            ...
            function cmdDetailUp(oidEmpReprimant, className){
                window.open("<%=approot%>/system/dataupload/data_upload.jsp?object_id="+oidEmpReprimant+"&classname="+className+"&is_employee=1", null, "height=800,width=800,status=yes,toolbar=no,menubar=no,location=center,scrollbars=yes");
            }
