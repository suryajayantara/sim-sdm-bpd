...
<!-- Jsp Block -->
<%!
public String drawList(Vector objectClass, int st, I_Dictionary dictionaryD, boolean privViewOnlyWithSearch){
...
public String drawList2(Vector objectClass, int st, I_Dictionary dictionaryD, boolean privViewOnlyWithSearch){
	ControlList ctrlist = new ControlList();
	ctrlist.setAreaWidth("100%");
        ctrlist.setListStyle("tblStyle");
        ctrlist.setTitleStyle("title_tbl");
...
<script language="JavaScript">
	...
	function cmdPrintXLS(){
        ...
        function cmdSendEmail(){
		  ...
		  window.open("editPenerima.jsp", "Search",  "height=550,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
	}
	...
	function cmdEdit(oid){
		...
		document.frm_employee.command.value="<%=Command.EDIT%>";
		document.frm_employee.prev_command.value="<%=Command.EDIT%>";
		document.frm_employee.action="employee_view_new.jsp";
		document.frm_employee.submit();
	}
          ...
          <td height="20">
		    <font color="#FF6600" face="Arial"><strong>
			  <!-- #BeginEditable "contenttitle" --> 
                  <%=dictionaryD.getWord(I_Dictionary.EMPLOYEE)%> &gt; <%=dictionaryD.getWord(I_Dictionary.EMPLOYEE_SEARCH_RESULT)%><!-- #EndEditable --> 
            </strong></font>
	      </td>
        </tr>
        <tr> 
                                        ...
                                        <tr> 
                                          <td height="8" width="100%">
                                              ...
                                              if(searchSpecialQuery.getStylist()==0){%>
                                                <%=drawList(listEmployee, start,dictionaryD, privViewOnlyWithSearch)%>
                                              <%}else{%>
                                                <%=drawList2(listEmployee, start,dictionaryD, privViewOnlyWithSearch)%>
                                              <%}%>
