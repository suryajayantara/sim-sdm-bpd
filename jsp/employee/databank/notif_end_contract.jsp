...
<%
    ...
    Vector listEndContract = new Vector();
    try{
     int lenghtDay = PstNotification.checkLenghtNotifByUser(userid,notiftype);
        ...
        listEndContract = (Vector) PstEmployee.list(0, 0, whereClauseEndContract, "");
    }catch(Exception exc){
...
<html>
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">End Contract</span>
        </div>
        <div class="content-main">
            <form name="frm" method="post" action="">
                ...
                <% 
                    if (listEndContract != null && listEndContract.size()>0){
                %>
                <table class="tblStyle">
                    ...
                    <%
                      for (int i=0; i<listEndContract.size(); i++){
                          Employee employee = (Employee) listEndContract.get(i);
