                                                  ...
                                                  <table border="0" cellspacing="2" cellpadding="2" width="72%">
                                                    ...
                                                    <tr align="left" valign="top">
                                                      ...
                                                      <td width="83%"> 
                                                           ...
                                                           int SetHRD = 0 ;
                                                           //by Eri yudi 2020-09-23
                                                           long setDireksi = 0;
                                                           try {
                                                             SetHRD = Integer.valueOf(PstSystemProperty.getValueByName("OID_HRD_DEPARTMENT")); 
                                                             //add by Eri yudi 2020-09-23
                                                             setDireksi = Long.valueOf(PstSystemProperty.getValueByName("OID_DIREKSI_DEPARTMENT"));
                                                           } catch (Exception e){
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="83%"> 
                                                          ...
                                                          <%
                                                            ...
                                                            if (depOid==0 || depOid==SetHRD || depOid == setDireksi || privViewAllDivision ){
                                                                div_value.add("0");
                                                                div_key.add("select ...");
                                                            } else {
