        ...
        <form name="frmsrcemployee" method="post" action="" target="blank">
            ...
            <table cellspacing="2" cellpadding="2">
                <tr>
                    ...
                    <td valign="top" id="coloum_title">Kompetensi</td>
                    <td valign="top"></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <%
                            Vector cmp_value = new Vector(1, 1);
                            Vector cmp_key = new Vector(1, 1);
                            cmp_value.add("0");
                            cmp_key.add("...ALL...");
                            Vector listCompetency = PstCompetency.list(0, 0, "", " COMPETENCY_NAME ");
                            for (int i = 0; i < listCompetency.size(); i++) {
                                Competency competency = (Competency) listCompetency.get(i);
                                cmp_key.add(competency.getCompetencyName());
                                cmp_value.add(String.valueOf(competency.getOID()));
                            }
                        %>
                        <%= ControlCombo.draw(frmSrcSpecialEmployee.fieldNames[FrmSrcSpecialEmployee.FRM_FIELD_COMPETENCY_ID], "formElemen", null, "" + srcSpecialEmployee.getCompetencyId(), cmp_value, cmp_key, " size= 8 /*+  (listEmpCat!=null?listEmpCat.size()+1:0+1) +8*/ multiple onkeydown=\"javascript:fnTrapKD()\"")%>
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
