<%-- 
    Document   : notif_emp_training
    Created on : Jun 25, 2020, 8:41:15 AM
    Author     : Utk
--%>

<%-- 
    Document   : notif_emp_mbt
    Created on : Jun 24, 2020, 4:30:27 PM
    Author     : Utk
--%>
...
<%
    ...
    try{
     int lenghtDay = PstNotification.checkLenghtNotifByUser(userid,PstNotification.NOTIF_BEARKHIRNYA_SERTIFIKASI);
         listTrainingHistory  = (Vector) PstTrainingHistory.listNotifTrainingHistory(lenghtDay);
...
<html>
    <head>
        ...
        <title>Notif Employee MBT</title>
		...
		document.frm.action="training_view.jsp?employee_oid="+oid+"";
		document.frm.submit();
	}
        </script>
    </head>
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Employee MBT</span>
        </div>
            ...
            <form name="frm" method="post" action="">
                ...
                <table class="tblStyle">
                    ...
                    <tr>
                        ...
                        <td class="title_tbl">Training Title</td>
                        <td class="title_tbl">Trainer</td>
                        <td class="title_tbl">Start Date</td>
                        <td class="title_tbl">End Date</td>
                        <td class="title_tbl">Duration</td>
                        <td class="title_tbl">Masa Berlaku</td>
                        <td class="title_tbl">Action</td>
                    </tr>
                    <%
                      for (int i=0; i<listTrainingHistory.size(); i++){
                          try{
                          TrainingHistory trainingHistory = (TrainingHistory) listTrainingHistory.get(i);
                          Training training = (Training) PstTraining.fetchExc(trainingHistory.getTrainingId());
                          Employee employee = (Employee) PstEmployee.fetchExc(trainingHistory.getEmployeeId());
                    ...
                    %>    
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: #FFF;"><%=trainingHistory.getTrainingProgram()%></td>
                                    <td style="background-color: #FFF;"><%=trainingHistory.getTrainingTitle()%></td>
                                    <td style="background-color: #FFF;"><%=trainingHistory.getTrainer()%></td>
                                    <td style="background-color: #FFF;"><%=trainingHistory.getStartDate()%></td>
                                    <td style="background-color: #FFF;"><%=trainingHistory.getEndDate()%></td>
                                    <td style="background-color: #FFF;"><%=trainingHistory.getDuration()%></td>
                                    <td style="background-color: #FFF;"><%=training.getMasaBerlaku()%> Bulan</td>
