...
>>>>>>> 1.4
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            rowx.add(""+empScheduleChange.getStatusDoc());
            ...
            rowx.add(""+empScheduleChange.getOriginalScheduleId());
            rowx.add(""+empScheduleChange.getNewChangeDate());
            rowx.add(""+empScheduleChange.getNewChangeScheduleId());
