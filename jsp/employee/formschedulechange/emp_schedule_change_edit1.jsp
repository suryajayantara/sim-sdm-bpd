...
<html><!-- #BeginTemplate "/Templates/main.dwt" -->
	...
	document.frmEmpScheduleChange.action="documentApproval.jsp?oidApprover="+empId+"&oidEmpScheduleChange="+oidEmpScheduleChange+"&approvedLevel="+approvedLevel;
	document.frmEmpScheduleChange.submit(); 
        ...
        document.frmEmpScheduleChange.submit(); 
            ...
            function cmdAdd(){
                document.frmEmpScheduleChange.hidden_empScheduleChange_id.value="0";
            ...
            function cmdAsk(oidEmpScheduleChange){
                document.frmEmpScheduleChange.hidden_empScheduleChange_id.value=oidEmpScheduleChange;
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td width="35%" colspan="2">
                                                            ...
                                                            <tr>
                                                              ...
                                                              <td width="80%"> : <input style="width: 40%; border: none;" type="text" name="Outlet" value="<%=locationOri.getName()%>" class="elemenForm"></td>
                                                              </tr>
                                                            <tr>
                                                              <td height="20%">&nbsp;</td>
...
<<<<<<< emp_schedule_change_edit.jsp
                                                              <table class="tblStyle"   width="100%" height="40%" style="border-collapse: collapse; margin-top: 5px; font-size: 11px; padding: 0;" cellpadding="0" cellspacing="0" border="1">
=======
...
=======
                                                                    <% long scheduleIdOri = PstEmpSchedule.getSchedule(empScheduleChange.getOriginalDate().getDate(), empScheduleChange.getApplicantEmployeeId(), empScheduleChange.getOriginalDate()); 
                                                                        String symbolOri = PstScheduleSymbol.getScheduleSymbol(scheduleIdOri);
                                                                       long scheduleIdExc = PstEmpSchedule.getSchedule(empScheduleChange.getNewChangeDate().getDate(), empScheduleChange.getExchangeEmployeeId(), empScheduleChange.getNewChangeDate()); 
                                                                        String symbolExc = PstScheduleSymbol.getScheduleSymbol(scheduleIdExc);
                                                                     %>
                                                                    <td>: <%=ControlCombo.draw(frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_ORIGINAL_SCHEDULE_ID], "formElemen", null, "" + (empScheduleChange.getOriginalScheduleId() != 0 ? empScheduleChange.getOriginalScheduleId() : scheduleIdOri ), sym_value, sym_key)%><%=symbolOri.equals("") ? "schedule di tanggal ini belum di ada" : "schedule asli "+symbolOri%></td>
>>>>>>> 1.4
                                                                    <td>Shift</td>
                                                              ...
                                                              <table width="100%" height="40%" style="border-collapse: collapse;font-size: 11px;" cellpadding="0" cellspacing="0" border="0">
                                                                      ...
                                                                      if (empScheduleChange.getStatusDoc() == 1 && empScheduleChange.getApprovalLevel1Id() != 0){
                                                                      ...
                                                                      <tr>
                                                                        ...
                                                                        <td><%=empScheduleChange.getApprovalDateLevel2() == null ? "-" : empScheduleChange.getApprovalDateLevel2() %></td>
                                                                      </tr>
                                                                      <tr>
