	...
	try
	{
		...
		userName = objAppUser.getLoginId();
                ...
                if (emplx.getOID() == oidApprover ){
                    ...
                    userPass = objAppUser.getPassword();
                }	
	}
	catch(Exception e)
	{
                  ...
                  <td width="315" valign="top"> 
                    <table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="#52BAFF">
                      ...
                      <tr valign="middle"> 
                        ...
                        <td width="222"> 
                          <input type="password" name="pass_wd" size="20" value="<%=userPass%>" onKeyDown="javascript:fnTrapKD()">
                          
                        </td>
                      </tr>
                      <% if (approvedLevel > 2) {%>
                      <tr valign="middle"> 
                        <td nowrap height="15" width="89">Note</td>
                        <td width="222"> 
