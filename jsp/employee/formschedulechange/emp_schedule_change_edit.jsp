...
<html><!-- #BeginTemplate "/Templates/main.dwt" -->
    <head>
        ...
        function cmdSearchEmpExchange(positionId){
            
        var nilai = document.frmEmpScheduleChange.EMP_POSITION_ID.value;
        window.open("<%=approot%>/employee/formschedulechange/searchschedulechange_exc.jsp?formName=frmEmpScheduleChange&empPathId=<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_EXCHANGE_EMPLOYEE_ID]%>&FRM_FIELD_POSITION="+nilai , null, "height=550,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");           
        }
	...
	document.frmEmpScheduleChange.submit(); 
        ...
        document.frmEmpScheduleChange.submit(); 
            ...
            function cmdView(oidEmpScheduleChange){
                //document.frmEmpScheduleChange.oidEmpScheduleChange.value=oidEmpScheduleChange;
                //document.frmEmpScheduleChange.command.value="<%=Command.EDIT%>";
                //document.frmEmpScheduleChange.prev_command.value="<%=prevCommand%>";
                //document.frmEmpScheduleChange.action="emp_schedule_change_view.jsp";
                //document.frmEmpScheduleChange.submit();
                window.open("emp_schedule_change_view.jsp?oidEmpScheduleChange=<%=oidEmpScheduleChange%>&command=<%=Command.EDIT%>", null, "height=550,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");           
            }
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr align="center" valign="top"> 
                                          <td height="8"  colspan="3"> 
                                            ...
                                            %>    
                                                <%
                                                Vector val_personal_Type = new Vector(1,1);
                                                Vector key_personal_Type = new Vector(1,1);
                                                val_personal_Type.add("0") ;
                                                key_personal_Type.add("Personal");
                                                val_personal_Type.add("1");
                                                key_personal_Type.add("Management");
                                                
                                                Hashtable personalType = new Hashtable();
                                                personalType.put("0","Personal") ;
                                                personalType.put("1","Management") ;
                                            %>  
                                           <%
                                           ...
                                           if (employeeExc != null && empScheduleChange.getExchangeEmployeeId() != 0 ){
                                            ...
                                            <table width="80%" border="0" cellspacing="0" cellpadding="0">                                              
                                              ...
                                              <tr id="formula" width="50%" align="center" height="870" valign="top"  >
                                                <td  >
                                                    <div>
                                                        ...
                                                        <tr>
                                                          ...
                                                          <td width="35%" colspan="2">
                                                            ...
                                                            <tr>
                                                             ...
                                                             <tr>
                                                              <td width="20%">Date</td>
                                                              <td width="80%">: <%= empScheduleChange.getDateOfRequestDatetime() == null ? new Date() : empScheduleChange.getDateOfRequestDatetime()%> </td>
                                                             </tr>
                                                             <% } else {%>
                                                             <tr>
                                                              <td width="20%">Date</td>
                                                        ...
                                                        <tr>
                                                          <td height="30%" colspan="4" style="border:#000; border-bottom:medium" >
                                                                ...
                                                                <tr>
                                                                      <td width="20%">&nbsp;</td>
                                                                      <td width="40%" style="text-align: center;">Applicant (Karyawan Ybs) <input type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_APPLICANT_EMPLOYEE_ID]%>" value="<%=empScheduleChange.getApplicantEmployeeId()%>" class=\"formElemen\" ></td>
                                                                      <td width="40%" style="text-align: center;">Exchange With (Yang diajak Menukar) <input type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_EXCHANGE_EMPLOYEE_ID]%>" value="<%=empScheduleChange.getExchangeEmployeeId()%>" class=\"formElemen\" ></td>
                                                                </tr>   
                                                                <% } else { %>
                                                                <tr>
                                                                      <td width="20%">&nbsp;</td>
                                                                      ...
                                                                      <td width="40%" style="text-align: center;">Exchange With (Yang diajak Menukar) <input type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_EXCHANGE_EMPLOYEE_ID]%>" value="<%=empScheduleChange.getExchangeEmployeeId()%>" class=\"formElemen\" ><a href="javascript:cmdSearchEmpExchange('<%=positionOri.getOID()%>')">Add Employee</a></td>
                                                                </tr>
                                                                <% } %> 
                                                                  ...
                                                                  <table class="tblStyle"   width="100%" height="40%" style="border-collapse: collapse;font-size: 11px;" cellpadding="0" cellspacing="0" border="1">
                                                                      ...
                                                                      <td width="40%">: <input style="width: 90%; border: none;" type="text" name="EMP_DEPARTMENT" value="<%=departmentOri.getDepartment()%>" disabled="" class="elemenForm"></td>
                                                                      <td width="40%">: <input style="width: 90%; border: none;" type="text" name="EMP_DEPARTMENT_EXC" value="<%=departmentExc.getDepartment()%>" disabled="" class="elemenForm"></td>
                                                                    </tr>
                                                                      <tr>
                                                                        ...
                                                                        <td>:
                                                                          <% 
                                                                            ...
                                                                            String nilaiK = "";
                                                                            nilaiK =  empScheduleChange.getTypeOfForm() ==1 ? "Shift" : "Off" ;
                                                                            %>
                                                                            <% if  (empScheduleChange.getApprovalDateLevel1() != null && empScheduleChange.getApprovalDateLevel2() != null && empScheduleChange.getApprovalDateApplicant() != null && empScheduleChange.getApprovalDateExchange() != null ){ %>
                                                                      ...
                                                                      <tr>
                                                                        ...
                                                                        <td>: <input style="width: 90%; border: none;" type="text" name="EMP_NUMBER" value="<%=employeeOri.getEmployeeNum()%>" disabled="" class="elemenForm"></td>
                                                                        <td>: <input style="width: 90%; border: none;" type="text" name="EMP_NUMBER_EXC" value="<%=employeeExc.getEmployeeNum()%>" disabled="" class="elemenForm"></td>

                                                                      </tr>
                                                                      <tr>

                                                                        <td height="15%">Name(Nama)</td>
                                                                        <td>: <input style="width: 90%; border: none;" type="text" name="EMP_FULLNAME" value="<%=employeeOri.getFullName()%>" disabled="" class="elemenForm"></td>
                                                                        <td>: <input style="width: 90%; border: none;" type="text" name="EMP_FULLNAME_EXC" value="<%=employeeExc.getFullName()%>" disabled="" class="elemenForm"></td>

                                                                      </tr>
                                                                      <tr>
                                                                      <td height="15%">Position (Position)</td>
                                                                      <td>: <input style="width: 90%; border: none;" type="text" name="EMP_POSITION" value="<%=positionOri.getPosition()%>" disabled="" class="elemenForm"><input style="width: 90%; border: none;" type="hidden" name="EMP_POSITION_ID" value="<%=positionOri.getOID() %>" class="elemenForm"></td>
                                                                      <td>: <input style="width: 90%; border: none;" type="text" name="EMP_POSITION_EXC" value="<%=positionExc.getPosition()%>" disabled="" class="elemenForm"></td>
                                                              ...
                                                              <table class="tblStyle"   width="100%" height="50%" style="border-collapse: collapse; margin-top: 5px; font-size: 11px; padding: 0;" cellpadding="0" cellspacing="0" border="1">
                                                               ...
                                                               <% if  (empScheduleChange.getApprovalDateLevel1() != null && empScheduleChange.getApprovalDateLevel2() != null && empScheduleChange.getApprovalDateApplicant() != null && empScheduleChange.getApprovalDateExchange() != null ){ %>
                                                                  ...
                                                                  <tr>
                                                                    <td>Tgl</td>
                                                                    <td width="40%">: <%= empScheduleChange.getOriginalDate() == null ? new Date() : empScheduleChange.getOriginalDate()%></td>
                                                                    <td width="10%">Tgl</td>
                                                                    <td width="40%">: <%= empScheduleChange.getNewChangeDate() == null ? new Date() : empScheduleChange.getNewChangeDate()%></td>
                                                                  </tr>
                                                               <% } else { %>
                                                                   <% if (empScheduleChange.getTypeOfForm() == 1){ %>
                                                                      <tr>
                                                                        ...
                                                                        <td width="10%">Tgl</td>
                                                                        <td width="40%">: <%=ControlDate.drawDateWithStyle(frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_NEW_CHANGE_DATE], empScheduleChange.getNewChangeDate() == null ? new Date() : empScheduleChange.getOriginalDate(), 0, -150, "disabled" )%> * <%=frmEmpScheduleChange.getErrorMsg(frmEmpScheduleChange.FRM_FIELD_NEW_CHANGE_DATE)%></td>
                                                                      </tr>
                                                                   <% } else { %>
                                                                     <tr>
                                                                        <td>Tgl</td>
                                                               ...
                                                               <% } %>
                                                                  <tr>
                                                                    ...
                                                                    <% long scheduleIdOri = 0 ;
                                                                       ...
                                                                       String symbolOriReal = "";
                                                                       String symbolExcReal = "";
                                                                       if (empScheduleChange.getOriginalScheduleId() == 0){
                                                                           empScheduleChange.setOriginalScheduleId(scheduleIdOri);
                                                                       }
                                                                       if (empScheduleChange.getNewChangeScheduleId() == 0){
                                                                           empScheduleChange.setNewChangeScheduleId(scheduleIdExc);
                                                                       }
                                                                           
                                                                       if (scheduleIdOri != 0 && scheduleIdExc != 0 ){
                                                                        symbolOriReal = PstScheduleSymbol.getScheduleSymbol(scheduleIdOri);
                                                                        symbolExcReal = PstScheduleSymbol.getScheduleSymbol(scheduleIdExc);
                                                                           
                                                                        symbolOri = PstScheduleSymbol.getScheduleSymbol(empScheduleChange.getOriginalScheduleId());
                                                                        symbolExc = PstScheduleSymbol.getScheduleSymbol(empScheduleChange.getNewChangeScheduleId());
                                                                       }
                                                                       %>
                                                                   <% if (empScheduleChange.getStatusDoc() >= 2 ) { %>
                                                                    <td>Shift</td>
                                                                    <td>: schedule saat ini <%=symbolOriReal%> sebelumnya <%=symbolExc%> <input  type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_ORIGINAL_SCHEDULE_ID]%>" value="<%=empScheduleChange.getOriginalScheduleId() %>" class="elemenForm"></td>

                                                                    <td>Shift</td>
                                                                    <td>: schedule saat ini <%=symbolExcReal%> sebelumnya <%=symbolOri%> <input  type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_NEW_CHANGE_SCHEDULE_ID]%>" value="<%=empScheduleChange.getNewChangeScheduleId() %>" class="elemenForm"></td>

                                                                    <% } else { %> 

                                                                    <td>Shift</td>
                                                                    <td>: schedule saat ini <%=symbolOriReal%> setelah perubahan <%=symbolOri%><input  type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_ORIGINAL_SCHEDULE_ID]%>" value="<%=empScheduleChange.getOriginalScheduleId() %>" class="elemenForm"><%//=ControlCombo.draw(frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_ORIGINAL_SCHEDULE_ID], "formElemen", null, "" + (empScheduleChange.getOriginalScheduleId() != 0 ? empScheduleChange.getOriginalScheduleId() : scheduleIdOri ), sym_value, sym_key,"disabled")%><%=symbolOriReal.equals("") ? "schedule di tanggal ini belum di ada" : "schedule asli "+symbolOriReal%></td>

                                                                    <td>Shift</td>
                                                                    <td>: schedule saat ini <%=symbolExcReal%> setelah perubahan <%=symbolExc%><input  type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_NEW_CHANGE_SCHEDULE_ID]%>" value="<%=empScheduleChange.getNewChangeScheduleId() %>" class="elemenForm"> <%//=ControlCombo.draw(frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_NEW_CHANGE_SCHEDULE_ID], "formElemen", null, "" + (empScheduleChange.getNewChangeScheduleId()!= 0 ? empScheduleChange.getNewChangeScheduleId() : scheduleIdExc ), sym_value, sym_key,"disabled")%><%=symbolExcReal.equals("") ? "schedule di tanggal ini belum di ada" : "schedule asli "+symbolExcReal%></td>
                                                                   <% } %>
                                                                  </tr>
                                                                 <!-- <tr>
                                                                    <td>Off</td>
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td >: <%=empScheduleChange.getRemark()%></td>
                                                                    <td width="10%">Remark</td>
                                                                    <td >: <%=empScheduleChange.getRemark2()%></td>
                                                                  </tr>   
                                                                  <%}else{%>
                                                                  <tr>
                                                                    <td width="10%">Remark</td>
                                                                    <td >: <input style="width: 97%;" type="text" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_REMARK]%>" value="<%=empScheduleChange.getRemark()%>" class="elemenForm">* <%=frmEmpScheduleChange.getErrorMsgModif(frmEmpScheduleChange.FRM_FIELD_REMARK)%></td>
                                                                    <td width="10%">Remark</td>
                                                                    <td >: <input style="width: 97%;" type="text" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_REMARK2]%>" value="<%=empScheduleChange.getRemark2()%>" class="elemenForm">* <%=frmEmpScheduleChange.getErrorMsgModif(frmEmpScheduleChange.FRM_FIELD_REMARK2)%></td>
                                                                  </tr>
                                                                  <%}%>
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    if ((empScheduleChange.getApplicantEmployeeId()!= 0) && (periodApplicant != null) ) {
                                                                    ...
                                                                    %>
                                                                    <td >: <%=(nilaiApplicantAsApplicant + nilaiApplicantAsExchange)%></td>
                                                                    <td width="10%">Document #</td>
                                                                    <%
                                                                    ...
                                                                    %>
                                                                    <td >: <%=(nilaiExchangeAsApplicant + nilaiExchangeAsExchange)%></td>
                                                              ...
                                                              <table width="100%" height="40%" style="border-collapse: collapse;font-size: 11px;" cellpadding="0" cellspacing="0" border="0">
                                                                   ...
                                                                   //   if (empScheduleChange.getStatusDoc() == 1 ){
                                                                      ...
                                                                      <tr>
                                                                         <td>&nbsp;</td>
                                                                         <td>&nbsp;</td>
                                                                         <td><input type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_APPROVAL_LEVEL1_NOTE]%>" value="<%=empScheduleChange.getApprovalLevel1Note() == null ? "-" : empScheduleChange.getApprovalLevel1Note()%>" class="elemenForm"><%=empScheduleChange.getApprovalLevel1Note() == null ? "-" : empScheduleChange.getApprovalLevel1Note()%></td>
                                                                         <td><input type="hidden" name="<%=frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_APPROVAL_LEVEL2_NOTE]%>" value="<%=empScheduleChange.getApprovalLevel2Note() == null ? "-" : empScheduleChange.getApprovalLevel2Note()%>" class="elemenForm"><%=empScheduleChange.getApprovalLevel2Note() == null ? "-" : empScheduleChange.getApprovalLevel2Note()%></td>
                                                    ...
                                                    <div>
                                                        <table width="80%" height="50%" border="0">
                                                            <tr>
                                                              ...
                                                              <td width="10%" >Type</td>
                                                              <% if  (empScheduleChange.getApprovalDateLevel1() != null && empScheduleChange.getApprovalDateLevel2() != null && empScheduleChange.getApprovalDateApplicant() != null && empScheduleChange.getApprovalDateExchange() != null ){ %>
                                                              <td width="20%" >: Form Schedule Change - <%=personalType.get("" + empScheduleChange.getPersonalType())%></td>
                                                              <% } else { %>
                                                              <td width="20%" >: Form Schedule Change - <%=ControlCombo.draw(frmEmpScheduleChange.fieldNames[frmEmpScheduleChange.FRM_FIELD_PERSONAL_TYPE], "formElemen", null, "" + empScheduleChange.getPersonalType(), val_personal_Type, key_personal_Type)%></td>
                                                              <% } %>
                                                            </tr>
                                                        </table>
                                                      </div>
                                                    ...
                                                    <div>
                                                        <table width="80%" height="50%" border="0">
                                                            <tr>
                                                                ...
                                                                <% } %>
                                                                   <button id="btn" onclick="cmdView('<%=oidEmpScheduleChange%>')">View</button>-<button id="btn" onclick="cmdBack()">List</button>-
                                                                   <%if ( iCommand == Command.ASK ) { %>
                                                                   yakin akan dihapus?
                                                                   <button id="btn1" onclick="cmdConfirmDelete('<%=oidEmpScheduleChange%>')">Yes</button>-  
                                                                   <button id="btn1" onclick="cmdCancel('<%=oidEmpScheduleChange%>')">No</button>  
                                                                   <% } else { %>
                                                                   <button id="btn" onclick="cmdAsk('<%=oidEmpScheduleChange%>')">Delete</button>  
                                                                   <% } %> 
                                                                   <% if (iCommand == Command.SAVE){ %>
                                                                   <%=FRMMessage.getMessage(iErrCode) %>
                                                                   <% } %>
                                                            </tr>
                                                        </table>
                                                      </div>
