...
<%
    ...
    long FRM_FIELD_POSITION = FRMQueryString.requestLong(request,"FRM_FIELD_POSITION");
...
<%
            ...
            if(isHRDLogin || isEdpLogin || isGeneralManager){
							...
							//pos_key.add("all position ...");   
                                                        //cari position groupnya;
                                                        Position positionByGroupPos = new Position();
                                                        try{
                                                         positionByGroupPos = PstPosition.fetchExc(FRM_FIELD_POSITION);   
                                                        } catch(Exception e){}
                                                        
                                                        String wherePos = PstPosition.fieldNames[PstPosition.FLD_POSITION_GROUP_ID] + " = " + positionByGroupPos.getPositionGroupId() ;
							Vector listPos = PstPosition.list(0, 0, wherePos, " POSITION ");
						...
						%>
                                              ...
                                              <tr> 
                                                ...
                                                <td width="80%"> 
                                                  ...
                                                  <% } else {%>
                                                  TIDAK ADA POSITION GROUP YANG SESUAI...
                                                  <% } %>
