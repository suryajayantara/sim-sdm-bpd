...
<%!
	...
	if(objectList!=null && objectList.size()>0) {
            ...
            ctrlist.addHeader(listTitles[8],"8%");    
            ctrlist.addHeader(listTitles[9],"20%");    
...
if (iCommand == Command.LIST) {
        ...
        Vector listRSession = SessEmpReprimand.getEmployeeReprimand(srcReprimand, 0, 0);
        try {
...
<script language="JavaScript">
	...
	function cmdEdit(oid){
        ...
        function cmdListView(oid){
            ...
            document.frm_warning.command.value="<%=Command.LIST%>";
            document.frm_warning.start.value=0;
            document.frm_warning.action="../databank/reprimand_view.jsp";
            document.frm_warning.submit();
	}
        // mchen
		    				  ...
		    				  <!-- #BeginEditable "content" --> 
                                    <form name="frm_warning" method="post" action="">
                                      ...
                                      <table border="0" width="100%">
                                        ...
                                        <tr> 
                                          <td height="8" width="100%"><%=drawList(listReprimand, listTitles,start,appUserSess1)%></td>
                                        </tr>                                        
                                      </table>                                                                                                                                                                                              
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
