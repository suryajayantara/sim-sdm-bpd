...
<%!
    ...
    public String drawList(Vector objectList, String[] listTitles, int start, AppUser appUserSess) 
    {
	if(objectList!=null && objectList.size()>0) {
            ...
            ctrlist.addHeader(listTitles[5],"8%");
            ctrlist.addHeader(listTitles[6],"8%");
            ctrlist.addHeader(listTitles[7],"8%"); 
            ctrlist.addHeader(listTitles[8],"15%");    
            ctrlist.addHeader(listTitles[9],"8%"); 
            ctrlist.addHeader(listTitles[10],"8%"); 
            ...
            if (appUserSess.getAdminStatus()==1){
                ...
                ctrlist.setLinkPrefix("javascript:cmdListView('");
                ctrlist.setLinkSufix("')");
            }
            ctrlist.reset();	
            ...
            for(int i=0; i<objectList.size(); i++) {                
                ...
                String warnLevel = "";
                try {
                    Warning warning = PstWarning.fetchExc(wrn.getWarnLevelId());
                    warnLevel = warning.getWarnDesc();
                } catch (Exception exc){}
...
AppUser appUserSess1 = userSession.getAppUser();
...
if (iCommand == Command.LIST) {
        ...
        Vector listRWarning = SessEmpWarning.getEmployeeWarning(srcWarning, 0, 0);
    try {
...
<script language="JavaScript">
	...
	function cmdEdit(oid){
        ...
        function cmdListView(oid){
            document.frm_warning.employee_oid.value=oid;
            document.frm_warning.action="../databank/warning_view.jsp";
            document.frm_warning.submit();
	}
                                  ...
                                  <!-- #BeginEditable "content" --> 
                                    <form name="frm_warning" method="post" action="">
                                      ...
                                      <table border="0" width="100%">
                                        ...
                                        <tr> 
                                          <td height="8" width="100%"><%=drawList(listWarning, listTitles, start, appUserSess)%></td>
                                        </tr>                                        
                                      </table>                                                                                                                                                                                              
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <%
