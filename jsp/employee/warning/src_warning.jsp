                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="83%"> 
                                                        <% 
                                                            ...
                                                            String strWhereDep = "hr_department.DIVISION_ID="+srcWarning.getDivisionId() + " AND " + PstDepartment.TBL_HR_DEPARTMENT + "." + PstDepartment.fieldNames[PstDepartment.FLD_VALID_STATUS] + " = " + PstDepartment.VALID_ACTIVE;
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="83%"> 
                                                        <% 
                                                            ...
                                                            String strWhereSec = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID]+"="+srcWarning.getDepartmentId() + " AND " + PstSection.fieldNames[PstSection.FLD_VALID_STATUS] + " = " + PstSection.VALID_ACTIVE;
