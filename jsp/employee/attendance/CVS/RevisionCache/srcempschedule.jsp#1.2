                                                        ...
                                                        <%= ControlCombo.draw(frmSrcEmpSchedule.fieldNames[FrmSrcEmpSchedule.FRM_FIELD_SCHEDULE], null, selectValue, schedule_value, schedule_key) %> 
                                                                                                                ...
                                                                                                                */
                                                                                                                ...
                                                                                                                // List Division
                                                                                                                    ...
                                                                                                                    String whereDivision = "COMPANY_ID = "+companyId + " AND " + PstDivision.fieldNames[PstDivision.FLD_VALID_STATUS] + " = " + PstDivision.VALID_ACTIVE;
                                                                                                                    div_value.add("0");
                                                                                                                    div_key.add("-select-");
                                                                                                                    String div_selected = "";
                                                                                                                // List Department
                                                                                                                        ...
                                                                                                                        <%
                                                                                                                            ...
                                                                                                                            if ((!(isHRDLogin || isEdpLogin || isGeneralManager || isDirector)) && (ClientName.equals("PEPITO")))  {
                                                                                                                                        ...
                                                                                                                                        section_k = new Vector();
                                                                                                                                            section_v.add("0");
                                                                                                                                            section_k.add("select");
                                                                                                                                        String whe = PstSection.TBL_HR_SECTION +"."+PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID] + " = " +emplx.getDepartmentId() + " AND " + PstSection.fieldNames[PstSection.FLD_VALID_STATUS] + " = " + PstSection.VALID_ACTIVE;
