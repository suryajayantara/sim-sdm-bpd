...
{	
	...
	ctrlist.setHeaderStyle("listgentitle");
        ...
        ctrlist.dataFormat("PERIOD","","center","center");
        ctrlist.dataFormat("EMPLOYEE","","center","center");
	...
	if(SystemProperty.SYS_PROP_SCHEDULE_PERIOD != SystemProperty.TYPE_SCHEDULE_PERIOD_A_MONTH_FULL)
	{		
		ctrlist.addHeader("21","");
		ctrlist.addHeader("22","");
		ctrlist.addHeader("23","");
		ctrlist.addHeader("24","");
		ctrlist.addHeader("25","");
		ctrlist.addHeader("26","");
		ctrlist.addHeader("27","");
		ctrlist.addHeader("28","");
		ctrlist.addHeader("29","");
		ctrlist.addHeader("30","");
		ctrlist.addHeader("31","");
		ctrlist.addHeader("1","");
		ctrlist.addHeader("2","");
		ctrlist.addHeader("3","");
		ctrlist.addHeader("4","");
		...
		ctrlist.addHeader("11","");
		ctrlist.addHeader("12","");
		ctrlist.addHeader("13","");
		ctrlist.addHeader("14","");
		ctrlist.addHeader("15","");
		ctrlist.addHeader("16","");
		ctrlist.addHeader("17","");
		ctrlist.addHeader("18","");
		ctrlist.addHeader("19","");				
	...
	for (int i = 0; i < objectClass.size(); i++) 
	{
		...
		Vector rowx = new Vector();
                if (privUpdate == true){
                    rowx.add("<input type=\"hidden\" name=\"size\" value=\""+empSchedule.getOID()+ "\">"+"<input type=\"hidden\" name=\"emp_schedule_id_"+i+"\" value=\""+empSchedule.getOID()+ "\"><a href=\"javascript:cmdEdit('"+empSchedule.getOID()+"')\">"+period.getPeriod()+"</a>");
                } else {
