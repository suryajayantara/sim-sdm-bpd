...
long hrApprover = FRMQueryString.requestLong (request, "hrApprover");
    ...
    switch(indexApproval){
        case 1: 
            %>
                ...
                <jsp:param name="hrApprover" value="<%=hrApprover%>" />
  ...
  <tr>
    <td valign="middle" align="left">
      <form name="frm_leave_application" action="" onsubmit="window.status=''">
        ...
        <input type="hidden" name="hrApprover" value="<%=hrApprover%>">
