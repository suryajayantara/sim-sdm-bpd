                ...
                switch (indexApproval) {
                    ...
                    case 11:
                        ...
                        if (objLeaveApplication.getDocStatus() == 1) {
                            ...
                            if (objLeaveApplication.getEmployeeId() != 0 && (isHrdApprovalX == 1)) {
                                    ...
                                    <tr> 
                                        <td valign="top"> 
                                            <table width="100%" border="0" bgcolor="#E0EDF0">
                                                ...
                                                <!--Exc Prod-->
                                                <%
                                                    if (objLeaveApplication.getOID() != 0 && (isHrdApproval == 1) && (maxApproval == I_Leave.LEAVE_APPROVE_2 || maxApproval == I_Leave.LEAVE_APPROVE_3 || maxApproval == I_Leave.LEAVE_APPROVE_4 || maxApproval == I_Leave.LEAVE_APPROVE_5 || maxApproval == I_Leave.LEAVE_APPROVE_6)) {
                                                        HRDMan = true;
                                                %>
                                                <tr>
