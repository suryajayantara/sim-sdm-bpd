...
//end sementara                                                                                                          
        ...
        if(result != null && result.size() > 0){
            ...
            for(int idx = 0 ; idx < result.size() ; idx++){
                ...
                String entDate = Formater.formatDate(leaveAlNoStockClosingList.getCommancingDate(),"yyyy-MM-dd");
                ...
                Date commencingPlus1Years = null;
                Date todayDate = new Date();
                if (ClientName.equals("PEPITO") || ClientName.equals("MINIMART") ){
                    commencingPlus1Years = (Date) leaveAlNoStockClosingList.getCommancingDate().clone();
                    commencingPlus1Years.setYear(commencingPlus1Years.getYear()+1);
                }
                
                //if (empCategory.getEntitleLeave() == PstEmpCategory.ENTITLE_YES && leaveAlNoStockClosingList.getCommancingDate() != null && todayDate.after(commencingPlus1Years)){
                if (empCategory.getEntitleLeave() == PstEmpCategory.ENTITLE_YES && leaveAlNoStockClosingList.getCommancingDate() != null ){
