...
<%!    static final int LEAVE_TYPE_APPLICATION = 0;
 ...
 int useTimeForAL = (int) PstSystemProperty.getPropertyLongbyName("LEAVE_AL_TIME");
 int useTimeForLL = (int) PstSystemProperty.getPropertyLongbyName("LEAVE_LL_TIME");
 int useTimeForSL = (int) PstSystemProperty.getPropertyLongbyName("LEAVE_SL_TIME"); 
 int useTimeForDP = (int) PstSystemProperty.getPropertyLongbyName("LEAVE_DP_TIME"); 
    /*
    ...
    public Vector drawListAnnualLeave(Vector vListAl, Vector vectorAlStockTaken, int indexAlGet, long oidEmployee, long oidLeave, int docStatus, java.util.Date requestDate, AlStockTaken alStockTaken) {
        ...
        ctrlist.addHeader("Jenis Cuti.", "10%");
        ctrlist.addHeader("Total Stok", "5%");
        ctrlist.addHeader("Digunakan", "5%");
        ctrlist.addHeader("Sisa Stok", "10%");
        ctrlist.addHeader("Akan Digunakan", "10%");
        ctrlist.addHeader("Stok Tersedia", "10%");
        ctrlist.addHeader("Pengajuan", "10%");
        ctrlist.addHeader("Tanggal Mulai", "10%");
        ctrlist.addHeader("Tanggal Berakhir", "10%");
        ...
        if (vectorAlStockTaken.size() > 0) {
            ...
            for (indexAl = 1; indexAl <= vectorAlStockTaken.size(); indexAl++) {
                ...
                if (indexAl == 1) {
                    ...
                    rowx.add("" + i);
                    if (stsAlAktf == false) {
                        rowx.add("<font color=FF0000>Cuti Tahunan (Cuti Expired)</font>");
                    } else {
                        rowx.add("Cuti Tahunan");
                    }
            ...
            for (indexLl = 1; indexLl <= vectorLlStockTaken.size(); indexLl++) {
                ...
                if (indexLl == 1) {
                    ...
                    if (dtaLLExpired == true) {
                        rowx.add("<font color=ff0000>Cuti Besar</font>");
                    } else {
                        rowx.add("Cuti Besar");
                    }
    ...
    public Vector drawListSpecialUnpaidLeave(Vector vectorSpecialStockTaken, LeaveApplication objLeaveApplication, long oidLeave, int indexSpecialget, int docStatus, java.util.Date requestDate, int stsKaryawan, int typeForm) {
        ...
        ctrlist.addHeader("No", "5%");
        ctrlist.addHeader("Jenis Cuti.", "15%");
        ctrlist.addHeader("Cuti Khusus", "15%");
        ctrlist.addHeader("Pengajuan", "15%");
        ctrlist.addHeader("Tanggal Mulai", "20%");
        ctrlist.addHeader("Tanggal Berakhir", "20%");
        ctrlist.addHeader("Action", "10%");
        ...
        if (vectorSpecialStockTaken.size() > 0) {
            ...
            if (statusEditSpecial == false) {
                ...
                if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                    ...
                    rowx.add("" + ControlDatePopupTaken + "<br>" + ctrTimeStart);
                }
                if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                    rowx.add("");
                } else {
                    rowx.add("" + ControlDatePopupFinnish + "<br>" + ctrTimeEnd);
                }//end
    ...
    public Vector drawListDPLeave(Vector vListAl, Vector vectorDpStockTaken, long oidEmployee, long oidLeave, int indexDpGet, int docStatus, java.util.Date requestDate, int iCommand) {
        ...
        if (vectorDpStockTaken.size() > 0) {
            ...
            if (docStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                ...
                rowx.add(leaveConfig != null && leaveConfig.getConfigurationLeaveApprovall() == I_Leave.LEAVE_CONFIG_REQUEST_DP_TAKEN_YES_LONG ? "" + ControlDatePopupTaken + ctrTimeStart + " to " + ControlDatePopupFinnishDate + " " + ctrTimeEnd + cekboxFullDay : "" + ControlDatePopupTaken + ctrTimeStart + " to " + ctrTimeEnd + " " + ControlDatePopupFinnishDate);
            }//end
...
//update by satrya 2012-07-25
    ...
    Vector listHRMan1 = ileaveConfig.listSDMApproval(objLeaveApplication.getEmployeeId());
    //Vector listHRMan = leaveConfig.getApprovalEmployeeTopLink(objLeaveApplication.getDepHeadApproval(), 3);
    long hrApprover = 0;
    if (listHRMan1 != null && listHRMan1.size() > 0) {

        for (int i = 0; i < listHRMan1.size(); i++) {
            Employee objEmp = (Employee) listHRMan1.get(i);
            hrApprover =  objEmp.getOID();
        }
    ...
    if (objLeaveApplication.getOID() == 0) {
        ...
        if (leaveType == LEAVE_TYPE_APPLICATION) {
            ...
            int maxApproval1 = PstLeaveApplication.getMaxApp(objLeaveApplication.getEmployeeId(), leaveConfig1, objLeaveApplication);

            int isHrdApprovalX = 0;
            ...
            try {
                ...
                dv = PstDivision.fetchExc(objEmployee.getDivisionId());
                isHrdApprovalX = level.getHr_approval();
            } catch (Exception e) {
            }
            ...
            if (oidApprover != 0) {
                switch (indexApproval) {
                    case 1:
                        objLeaveApplication.setApproval_1(oidApprover);
                        ...
                        objLeave.setApproval_1(oidApprover);
                        //updatre by satrya 2012-08-02
                        objLeave.setApproval_1_date(objLeaveApplication.getApproval_1_date() == null ? new Date() : objLeaveApplication.getApproval_1_date());//objLeaveApplication.getDepHeadApproveDate());
                        ...
                        // if doc status Draft
                        maxApproval1 = PstLeaveApplication.getMaxApp(objLeaveApplication.getEmployeeId(), leaveConfig1, objLeaveApplication);

                        if (divTypeHrdApproval == dv.getDivisionTypeId() && objEmployee.getDepartmentId() != hr_department && hrApprover != oidApprover){
                            maxApproval1 = maxApproval1 + 1;
                        }
                        
                        if (objLeaveApplication.getDocStatus() == 1) {

                            if ((objLeaveApplication.getEmployeeId() != 0) && (maxApproval1 == I_Leave.LEAVE_APPROVE_1) && (isHrdApprovalX == 0)) {
                                if (objLeaveApplication.getApproval_1() != 0) {
                                    stsDokApprov1 = true;
                        ...
                        if (objLeaveApplication.getDocStatus() == 1) {
                            if ((objLeaveApplication.getEmployeeId() != 0)) {
                                if (objLeaveApplication.getApproval_1() != 0) {
                        ...
                        break;
                    case 2:
                        objLeaveApplication.setApproval_2(oidApprover);
                        ...
                        objLeave2.setApproval_2(oidApprover);
                        //updatre by satrya 2012-08-02
                        objLeave2.setApproval_2_date(objLeaveApplication.getApproval_2_date() == null ? new Date() : objLeaveApplication.getApproval_2_date());//objLeaveApplication.getDepHeadApproveDate());
                        ...
                        if (objLeaveApplication.getDocStatus() == 1) {
                            ...
                            if ((objLeaveApplication.getEmployeeId() != 0) && (maxApproval1 == I_Leave.LEAVE_APPROVE_2) && (isHrdApprovalX == 0)) {
                                if (objLeaveApplication.getApproval_2() != 0) {
                                    stsDokApprov2 = true;
                                    objLeaveApplication.setDocStatus(PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED);
                                }
                            }
                        ...
                        break;
                    case 3:
                        objLeaveApplication.setApproval_3(oidApprover);
                        ...
                        objLeave3.setApproval_3(oidApprover);
                        objLeave3.setApproval_3_date(objLeaveApplication.getApproval_3_date() == null ? new Date() : objLeaveApplication.getApproval_3_date());//objLeaveApplication.getDepHeadApproveDate());
                        ...
                        if (objLeaveApplication.getDocStatus() == 1) {
                            ...
                            if ((objLeaveApplication.getEmployeeId() != 0) && (maxApproval1 == I_Leave.LEAVE_APPROVE_3) && (isHrdApprovalX == 0)) {
                                if (objLeaveApplication.getApproval_3() != 0) {
                                    stsDokApprov3 = true;
                                    objLeaveApplication.setDocStatus(PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED);
                                }
                            }
                        ...
                        break;
                    case 4:
                        objLeaveApplication.setApproval_4(oidApprover);
                        LeaveApplication objLeave4 = new LeaveApplication();


                        boolean stsDokApprov4 = false;

                        try {
                            objLeave4 = PstLeaveApplication.fetchExc(objLeaveApplication.getOID());
                        } catch (Exception E) {
                            System.out.println("Exception " + E.toString());
                        }
                        objLeave4.setApproval_4(oidApprover);
                        objLeave4.setApproval_4_date(objLeaveApplication.getApproval_4_date() == null ? new Date() : objLeaveApplication.getApproval_4_date());//objLeaveApplication.getDepHeadApproveDate());

                        if (stsDokApprov4 == true) {
                            objLeave4.setDocStatus(PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED);
                        }

                        try {
                            PstLeaveApplication.updateScheduleLeave(objLeave4, stsDokApprov4);
                        } catch (Exception E) {
                            System.out.println("Exception " + E.toString());
                        }
                        ...
                        if (objLeaveApplication.getDocStatus() == 1) {
                            ...
                            if ((objLeaveApplication.getEmployeeId() != 0) && (maxApproval1 == I_Leave.LEAVE_APPROVE_4) && (isHrdApprovalX == 0)) {
                                if (objLeaveApplication.getApproval_4() != 0) {
                                    stsDokApprov4 = true;
                                    objLeaveApplication.setDocStatus(PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED);
                                }
                            }
                        ...
                        break;
                    case 5:
                        objLeaveApplication.setApproval_5(oidApprover);
                        LeaveApplication objLeave5 = new LeaveApplication();


                        boolean stsDokApprov5 = false;


                        try {
                            objLeave5 = PstLeaveApplication.fetchExc(objLeaveApplication.getOID());
                        } catch (Exception E) {
                            System.out.println("Exception " + E.toString());
                        }
                        objLeave5.setApproval_5(oidApprover);
                        objLeave5.setApproval_5_date(objLeaveApplication.getApproval_5_date() == null ? new Date() : objLeaveApplication.getApproval_5_date());//objLeaveApplication.getDepHeadApproveDate());

                        if (stsDokApprov5 == true) {
                            objLeave5.setDocStatus(PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED);
                        }

                        try {
                            PstLeaveApplication.updateScheduleLeave(objLeave5, stsDokApprov5);
                        } catch (Exception E) {
                            System.out.println("Exception " + E.toString());
                        }
                        ...
                        if (objLeaveApplication.getDocStatus() == 1) {
                            ...
                            if ((objLeaveApplication.getEmployeeId() != 0) && (maxApproval1 == I_Leave.LEAVE_APPROVE_5) && (isHrdApprovalX == 0)) {
                                if (objLeaveApplication.getApproval_5() != 0) {
                                    stsDokApprov5 = true;
                                    objLeaveApplication.setDocStatus(PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED);
                                }
                            }
                        ...
                        break;
                    case 6:
                        objLeaveApplication.setApproval_6(oidApprover);
                        LeaveApplication objLeave6 = new LeaveApplication();


                        boolean stsDokApprov6 = false;


                        try {
                            objLeave6 = PstLeaveApplication.fetchExc(objLeaveApplication.getOID());
                        } catch (Exception E) {
                            System.out.println("Exception " + E.toString());
                        }
                        objLeave6.setApproval_6(oidApprover);
                        objLeave6.setApproval_6_date(objLeaveApplication.getApproval_6_date() == null ? new Date() : objLeaveApplication.getApproval_6_date());//objLeaveApplication.getDepHeadApproveDate());

                        if (stsDokApprov6 == true) {
                            objLeave6.setDocStatus(PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED);
                        }

                        try {
                            PstLeaveApplication.updateScheduleLeave(objLeave6, stsDokApprov6);
                        } catch (Exception E) {
                            System.out.println("Exception " + E.toString());
                        }
                        ...
                        if (objLeaveApplication.getDocStatus() == 1) {
                            ...
                            if ((objLeaveApplication.getEmployeeId() != 0) && (maxApproval1 == I_Leave.LEAVE_APPROVE_6) && (isHrdApprovalX == 0)) {
                                if (objLeaveApplication.getApproval_6() != 0) {
                                    stsDokApprov5 = true;
                                    objLeaveApplication.setDocStatus(PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED);
                                }
                            }
                    ...
                    case 11:
                        ...
                        LeaveApplication objLeave11 = new LeaveApplication();


                        boolean stsDokApprov11 = false;

                        // if doc status Draft
                        if (objLeaveApplication.getDocStatus() == 1) {

                            if (objLeaveApplication.getEmployeeId() != 0 && (divTypeHrdApproval == dv.getDivisionTypeId())) {
                        ...
                        try {
                            objLeave11 = PstLeaveApplication.fetchExc(objLeaveApplication.getOID());
                        } catch (Exception E) {
                            System.out.println("Exception " + E.toString());
                        }
                        objLeave11.setHrManApproval(oidApprover);
                        objLeave11.setHrManApproveDate(objLeaveApplication.getHrManApproveDate() == null ? new Date() : objLeaveApplication.getHrManApproveDate());//objLeaveApplication.getDepHeadApproveDate());

                        if (stsDokApprov11 == true) {
                            objLeave11.setDocStatus(PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED);
                        }

                        try {
                            PstLeaveApplication.updateScheduleLeave(objLeave11, stsDokApprov11);
                        } catch (Exception E) {
                            System.out.println("Exception " + E.toString());
                        }
                        break;
...
//update by satrya
    ...
    if (leaveType == LEAVE_TYPE_AL) {
        ...
        errMsgALPenting = ctrlAlStockTaken.getMessagePenting();
    ...
    int maxApproval = PstLeaveApplication.getMaxApp(objEmployee.getOID(), leaveConfig, objLeaveApplication);

    int isHrdApproval = 0;
    Level level = new Level();
    try {
        level = PstLevel.fetchExc(objEmployee.getLevelId());
        isHrdApproval = level.getHr_approval();
    } catch (Exception e) {
    }
    ...
    <head>    
        ...
        <script language="JavaScript">
            ...
            <%=ControlDatePopup.writeDateCaller("frm_leave_application", FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_SUBMISSION_DATE])%>
                    ...
                    function getApproval_1_date(){
            <%=ControlDatePopup.writeDateCaller("frm_leave_application", FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_1_DATE])%>
                    }
                    function getApproval_2_date(){
            <%=ControlDatePopup.writeDateCaller("frm_leave_application", FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_2_DATE])%>
                    }
                    function getApproval_3_date(){
            <%=ControlDatePopup.writeDateCaller("frm_leave_application", FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_3_DATE])%>
                    }
                    function getApproval_4_date(){
            <%=ControlDatePopup.writeDateCaller("frm_leave_application", FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_4_DATE])%>
                    }
                    function getApproval_5_date(){
            <%=ControlDatePopup.writeDateCaller("frm_leave_application", FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_5_DATE])%>
                    }
                    function getApproval_6_date(){
            <%=ControlDatePopup.writeDateCaller("frm_leave_application", FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_1_DATE])%>
                    }
                    ...
                    /*function cmdBackExcuse()
        {
                ...
                document.frm_leave_application.submit();
                    ...
                    function checkApproval(index)
                    {
                        ...
                        if(index==1){
                            empApprovalSelected = document.frm_leave_application.<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_1]%>.value;
                        }
                        if(index==2){
                            empApprovalSelected = document.frm_leave_application.<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_2]%>.value;
                        }
                        if(index==3){
                            empApprovalSelected = document.frm_leave_application.<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_3]%>.value;
                        }
                        if(index==4){
                            empApprovalSelected = document.frm_leave_application.<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_4]%>.value;
                        }
                        if(index==5){
                            empApprovalSelected = document.frm_leave_application.<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_5]%>.value;
                        }
                        if(index==6){
                            empApprovalSelected = document.frm_leave_application.<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_APPROVAL_6]%>.value;
                        }
                        if(index==11){
                    ...
                    function cmdPrint()
                    { 
                        pathUrl = "<%=approot%>/LeaveForm?oidLeaveApplication=<%=objLeaveApplication.getOID()%>&approot=<%=approot%>&TYPE_FORM_LEAVE=<%=type_form%>";
                        window.open(pathUrl);
                    }
                                                                        ...
                                                                        <tr>                     
                                                                            <td valign="top">
                                                                                ...
                                                                                <form name="frm_leave_application" method="post" action="">                            
                                                                                    ...
                                                                                    <input type="hidden" name="hrApprover" value="0">
                                                                                    ...
                                                                                    <table width="100%" align="center">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <%
                                                                                                String AL_Allowance = "";
                                                                                                String LL_Allowance = "";
                                                                                                String direksiApprovalNo = "";
                                                                                                String direksiApprovalYes = "";
                                                                                                ...
                                                                                                if (objLeaveApplication.getDireksiApproval() == 0){
                                                                                                    direksiApprovalNo = "checked";
                                                                                                }
                                                                                                if (objLeaveApplication.getDireksiApproval() == 1){
                                                                                                    direksiApprovalYes = "checked";
                                                                                                }
                                                                                            %>
                                                                                            <td>Approval Direksi </td>
                                                                                            <td>:</td>
                                                                                            <td>
                                                                                                    <input type="radio" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_DIREKSI_APPROVAL]%>" value="0" <%=direksiApprovalNo %> > No
                                                                                                    <input type="radio" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_DIREKSI_APPROVAL]%>" value="1" <%=direksiApprovalYes %> > Yes
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>&nbsp;</td>
                                                                                             ...
                                                                                             <%
                                                                                                String typeLeaveCatNone = "";
                                                                                                String typeLeaveCatHamil = "";
                                                                                                String typeLeaveCatPenting = "checked";
                                                                                                String typeLeaveCatAL = "";
                                                                                                String typeLeaveCatLL = "";
                                                                                                
                                                                                                
                                                                                                
                                                                                                if (objLeaveApplication.getOID() != 0 &&  objLeaveApplication.getTypeLeaveCategory() == 0) {
                                                                                                    typeLeaveCatNone = "checked";
                                                                                                    typeLeaveCatPenting = "";
                                                                                                } else if (objLeaveApplication.getTypeLeaveCategory() == 1) {
                                                                                                    typeLeaveCatHamil = "checked";
                                                                                                    typeLeaveCatPenting = "";
                                                                                                } else if (objLeaveApplication.getTypeLeaveCategory() == 2) {
                                                                                                    typeLeaveCatPenting = "checked";
                                                                                                } else if (objLeaveApplication.getTypeLeaveCategory() == 3) {
                                                                                                    typeLeaveCatAL = "checked";
                                                                                                    typeLeaveCatPenting = "";
                                                                                                } else if (objLeaveApplication.getTypeLeaveCategory() == 4) {
                                                                                                    typeLeaveCatLL = "checked";
                                                                                                    typeLeaveCatPenting = "";
                                                                                                }
                                                                                            %>
                                                                                            <td colspan="3">
                                                                                                    <input type="radio" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_TYPE_LEAVE_CATEGORY]%>" value="0" <%=typeLeaveCatNone %> > None
                                                                                                    <input type="radio" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_TYPE_LEAVE_CATEGORY]%>" value="1" <%=typeLeaveCatHamil %> > Cuti Hamil
                                                                                                    <input type="radio" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_TYPE_LEAVE_CATEGORY]%>" value="2" <%=typeLeaveCatPenting %> > Cuti Penting <br>
                                                                                                    <input type="radio" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_TYPE_LEAVE_CATEGORY]%>" value="3" <%=typeLeaveCatAL %> > Cuti Tahunan 
                                                                                                    <input type="radio" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_TYPE_LEAVE_CATEGORY]%>" value="4" <%=typeLeaveCatLL %> > Cuti Besar                                                                                            
                                                                                            </td>
...
%>   
                                                                                        <tr>
                                                                                            <td class="msgerror">
                                                                                                ...
                                                                                                Message : <%=errMsgALPenting + ":" + errorAl%><%//=errorAl%></font>         
                                                                                            </td>
                                                                                            <%
                                                                                                }
                                                                                                float alTaken = 0;
                                                                                                if (objLeaveApplication.getTypeLeaveCategory() == 2 && vectorAlStockTaken.size() > 0) {

                                                                                                    for (indexAl = 1; indexAl <= vectorAlStockTaken.size(); indexAl++) {
                                                                                                        objAlStockTaken = (AlStockTaken) vectorAlStockTaken.get(indexAl - 1);
                                                                                                        alTaken = alTaken + objAlStockTaken.getTakenQty();
                                                                                                    }
                                                                                                    if (alTaken > 2) {
                                                                                            %> 
                                                                                        <tr>
                                                                                            <td class="msgerror">
                                                                                                ...
                                                                                                Warning : Anda Mengambil Cuti Penting Lebih Dari 2 Hari</font>                            
                                                                                            </td>
                                                                                        </tr>
                                                                                        <% }
                                                                                                }%>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <% int useDP = 1;
                                                                                                    ...
                                                                                                    if (objLeaveApplication != null && objLeaveApplication.getOID() != 0 && (objLeaveApplication.getTypeFormLeave() == 0 && repItemLeaveAndDp.getStatusKaryawan() != 0) && type_form == PstLeaveApplication.LEAVE_APPLICATION && useDP == 1) {
                                                                                                        //update by satrya 2013-04-11
                                                                                                        // if(objLeaveApplication!=null && objLeaveApplication.getOID()!=0 ){
                                                                                                        try {
                                                                                                            //update by satrya 2012-07-31
...
%>   
                                                                                                ...
                                                                                                <table width="100%" bgcolor="#E0EDF0">
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td width="75%">
                                                                                                            ...
                                                                                                            <% } else {
                                                                                                                    out.println("<B>" + objLeaveApplication.getLeaveReason() + "</B>");
                                                                                                                }%>
                                                                                                        </td>
                                                                                                    </tr>                           
                                                                                                    <tr>
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td valign="top"> 
                                                                                                <%
                                                                                                    if (objLeaveApplication.getDocStatus() == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT) {
                                                                                                %><blink>To view approval form, please set document status to TO BE APPROVED</<blink><%                                } else {
                                                                                                            ...
                                                                                                            <td valign="top"> 
                                                                                                                <table width="100%" border="0" bgcolor="#E0EDF0">
                                                                                                                    ...
                                                                                                                    <%
                                                                                                                        ...
                                                                                                                        if ((objLeaveApplication.getOID() != 0) && (maxApproval == I_Leave.LEAVE_APPROVE_1 || maxApproval == I_Leave.LEAVE_APPROVE_2 || maxApproval == I_Leave.LEAVE_APPROVE_3 || maxApproval == I_Leave.LEAVE_APPROVE_4 || maxApproval == I_Leave.LEAVE_APPROVE_5 || maxApproval == I_Leave.LEAVE_APPROVE_6)) {
                                                                                                                            //deptHead = true;

                                                                                                                            Employee employeeObj = new Employee();
                                                                                                                            try {
                                                                                                                                employeeObj = PstEmployee.fetchExc(objLeaveApplication.getEmployeeId());
                                                                                                                            } catch (Exception e) {
                                                                                                                            }
                                                                                                                            ...
                                                                                                                            int incIndexApp = 1;
                                                                                                                            long oidEmpDinamis = objLeaveApplication.getEmployeeId();
                                                                                                                            int jenisCuti = objLeaveApplication.getTypeLeaveCategory();
                                                                                                                            int qty = Math.round(objAlStockTaken.getTakenQty());
                                                                                                                            ...
                                                                                                                            if (status.equals("") && jenisCuti == 2 && qty > 2){
                                                                                                                                status = "direksi approval";
                                                                                                                            }
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td width="60%">
                                                                                                                            <b>
                                                                                                                                <%
                                                                                                                                    ...
                                                                                                                                    if ((iErrCode == 0||iErrCode == 5) && objLeaveApplication.getOID() != 0) {
                                                                                                                                        if ((objLeaveApplication.getDocStatus() == PstLeaveApplication.FLD_STATUS_APPlICATION_TO_BE_APPROVE
                                                                                                                                            ...
                                                                                                                                            if (listEmpApproval != null && listEmpApproval.size() > 0) {
                                                                                                                                                ...
                                                                                                                                                for (int i = 0; i < listEmpApproval.size(); i++) {
                                                                                                                                                    ...
                                                                                                                                                    //cek atasan cuti atau tidak
                                                                                                                                                    int empApprovalStatus = leaveConfig.getApprovalEmployeeLeaveStatus(objEmp.getOID());
                                                                                                                                                    if (empApprovalStatus == 1){
                                                                                                                                                        Vector listEmpReplacement = leaveConfig.getApprovalEmployeeReplacement(oidEmpDinamis, objEmp.getOID(), xx, 3);
                                                                                                                                                        if (listEmpReplacement.size() > 0){
                                                                                                                                                            for (int x=0; x < listEmpReplacement.size(); x ++){
                                                                                                                                                                ...
                                                                                                                                                                divHeadKey.add(objEmpReplacement.getFullName());
                                                                                                                                                                divHeadValue.add("" + objEmpReplacement.getOID());
                                                                                                                                                            }
                                                                                                                                                        }
                                                                                                                                                    } else {
                                                                                                                                            ...
                                                                                                                                            String selectedApproval = "" + PstLeaveApplication.getApproveOidByApprovalIndex(objLeaveApplication, incIndexApp);

                                                                                                                                            if (PstLeaveApplication.getApproveOidByApprovalIndex(objLeaveApplication, incIndexApp) != 0) {
                                                                                                                                                oidEmpDinamis = PstLeaveApplication.getApproveOidByApprovalIndex(objLeaveApplication, incIndexApp);
                                                                                                                                                if (listEmpApproval.size() > 0 ){
                                                                                                                                            ...
                                                                                                                                            String strAttribute = "class=\"formElemen\" onChange=\"javascript:checkApproval(" + incIndexApp + ")\"";
                                                                                                                                            //cek Index Complete
                                                                                                                                            boolean indexComplete = false;

                                                                                                                                            indexComplete = PstLeaveApplication.cekApproval(objLeaveApplication, incIndexApp);

                                                                                                                                            String appFrm = PstLeaveApplication.getApproveFrmByApprovalIndex(objLeaveApplication, incIndexApp);
                                                                                                                                            ...
                                                                                                                                            try {
                                                                                                                                                ...
                                                                                                                                                String ecx = PstLeaveApplication.getObjEmployeeByApprovalIndex(objLeaveApplication, incIndexApp);
                                                                                                                                                if (PstLeaveApplication.getApproveOidByApprovalIndex(objLeaveApplication, incIndexApp) != 0) {
                                                                                                                                                    oidEmpDinamis = PstLeaveApplication.getApproveOidByApprovalIndex(objLeaveApplication, incIndexApp);
                                                                                                                                                    if (listEmpApproval.size() > 0 ){
                                                                                                                                                        Employee objEmp = (Employee) listEmpApproval.get(0);
                                                                                                                        ...
                                                                                                                        <td width="23%" ><b>
                                                                                                                                <% //update by priska
                                                                                                                                    ...
                                                                                                                                    Date appDate = PstLeaveApplication.getApproveDateByApprovalIndex(objLeaveApplication, incIndexApp);
                                                                                                                                    String appFrmDate = PstLeaveApplication.getApproveFrmDateByApprovalIndex(objLeaveApplication, incIndexApp);
                                                                                                                                    if (objLeaveApplication.getDocStatus() == PstLeaveApplication.FLD_STATUS_APPlICATION_TO_BE_APPROVE || objLeaveApplication.getDocStatus() == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT) {
                                                                                                                    ...
                                                                                                                    <%
                                                                                                                            ...
                                                                                                                            if (objLeaveApplication.getApproval_6() > 0 ){
                                                                                                                                approval = 6;
                                                                                                                            } else if (objLeaveApplication.getApproval_5() > 0 ){
                                                                                                                                approval = 5;
                                                                                                                            } else if (objLeaveApplication.getApproval_4() > 0 ){
                                                                                                                                approval = 4;
                                                                                                                            } else if (objLeaveApplication.getApproval_3() > 0 ){
                                                                                                                                approval = 3;
                                                                                                                            } else if (objLeaveApplication.getApproval_2() > 0 ){
                                                                                                                                approval = 2;
                                                                                                                            } else if (objLeaveApplication.getApproval_1() > 0 ){
                                                                                                                                approval = 1;
                                                                                                                            }
                                                                                                                            
                                                                                                                            boolean needHrApproval = true;
                                                                                                                            if (objLeaveApplication.getApproval_6() == hrApprover ){
                                                                                                                                needHrApproval = false;
                                                                                                                            } else if (objLeaveApplication.getApproval_5() == hrApprover ){
                                                                                                                                needHrApproval = false;
                                                                                                                            } else if (objLeaveApplication.getApproval_4() == hrApprover ){
                                                                                                                                needHrApproval = false;
                                                                                                                            } else if (objLeaveApplication.getApproval_3() == hrApprover){
                                                                                                                                needHrApproval = false;
                                                                                                                            } else if (objLeaveApplication.getApproval_2() == hrApprover ){
                                                                                                                                needHrApproval = false;
                                                                                                                            } else if (objLeaveApplication.getApproval_1() == hrApprover ){
                                                                                                                                needHrApproval = false;
                                                                                                                            }
                                                                                                                    
                                                                                                                            int maxApproval1 = PstLeaveApplication.getMaxApp(objLeaveApplication.getEmployeeId(), leaveConfig, objLeaveApplication);
                                                                                                                            if (objLeaveApplication.getOID() != 0 && (div.getDivisionTypeId() == divTypeHrdApproval && objEmployee.getDepartmentId() != hr_department) && (approval == maxApproval1) && needHrApproval) {
                                                                                                                            HRDMan = true;
                                                                                                                    %>
                                                                                                                    <tr>
                                                                                                                        <td width="15%" >SDM Approved by</td >
                                                                                                                        <td width="2%" >:</td>
                                                                                                                        <td width="60%" ><b>
                                                                                                                                <%
                                                                                                                                    if ((iErrCode == 0 || iErrCode == 5 ) && objLeaveApplication.getOID() != 0) {
                                                                                                                                        if (objLeaveApplication.getDocStatus() != PstLeaveApplication.FLD_STATUS_APPlICATION_EXECUTED) {
                                                                                                                                            ...
                                                                                                                                            if (deptHead == true) {
                                                                                                                                                ...
                                                                                                                                                if (objLeaveApplication.getDepHeadApproval() == 0) {
                                                                                                                                                    ...
                                                                                                                                                    divHeadKey.add("Select SDM");
                                                                                                                                                    divHeadValue.add("0");

                                                                                                                                                    selectedApproval = "" + objLeaveApplication.getHrManApproval();


                                                                                                                                                    Vector listHRMan = leaveConfig.listSDMApproval(objLeaveApplication.getEmployeeId());
                                                                                                                                                    //Vector listHRMan = leaveConfig.getApprovalEmployeeTopLink(objLeaveApplication.getDepHeadApproval(), 3);
                                                                                                                                            ...
                                                                                                                                            String strAttribute = "class=\"formElemen\" onChange=\"javascript:checkApproval(11)\"";
                                                                                                                    ...
                                                                                                                    <% } else if (objLeaveApplication.getHrManApproval() > 0 ){ %>
                                                                                                                    <tr>
                                                                                                                        <td width="15%" >SDM Approved by</td >
                                                                                                                        <td width="2%" >:</td>
                                                                                                                        <td width="60%" ><b>
                                                                                                                        <%
                                                                                                                            Employee hrApproval = new Employee();
                                                                                                                            try {
                                                                                                                                hrApproval = PstEmployee.fetchExc(objLeaveApplication.getHrManApproval());
                                                                                                                            } catch (Exception exc){
                                                                                                                                
                                                                                                                            }
                                                                                                                        %>
                                                                                                                        <%= hrApproval.getFullName()%>
                                                                                                                        </b></td>
                                                                                                                        <td width="23%" ><b>
                                                                                                                                <%=Formater.formatDate(objLeaveApplication.getHrManApproveDate(), "MMMM dd, yyyy")%>
                                                                                                                            </b></td>
                                                                                                                    </tr>
                                                                                                                    <% } %>
                                                                                                                </table>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <table>
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <% //update by satrya 2012-07-27
                                                                                                                        Date today = new Date();
                                                                                                                        Date maxDate = PstLeaveApplication.getMaxDateFromLeave(objLeaveApplication.getOID());
                                                                                                                        if (isHRDLogin && (objLeaveApplication.getDocStatus() != PstLeaveApplication.FLD_STATUS_APPlICATION_CANCELED)
                                                                                                                                ...
                                                                                                                                && (objLeaveApplication.getDocStatus() == PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED) && (maxDate == null ? false : today.after(maxDate))) {
                                                                                                                    if ( privPrint ) {%>
