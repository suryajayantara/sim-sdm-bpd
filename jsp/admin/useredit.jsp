                                          ...
                                          <tr>
                                              ...
                                              <td valign="top">
                                                  <%
                                                   ...
                                                   for (int i = 0; i < PstAppUser.adminValue.length; i++) {
                                                    String strTypeCheck = "";
                                                    if (appUser.getAdminStatus() == PstAppUser.adminValue[i]) {
                                                        strTypeCheck = "checked";
                                                    }
                                                    %> <input type="radio" name="<%=frmAppUser.fieldNames[frmAppUser.FRM_ADMIN_STATUS]%>" value="<%=PstAppUser.adminValue[i]%>" <%=strTypeCheck%> style="border:'none'" />
                                                    <%=PstAppUser.adminKey[i]%>
                                                <%}%>
                                              </td>
                                          </tr>
                                        <tr> 
