...
<html>
    <head>
        ...
        function cmdGoToApproval(category, oidcshedule){
            ...
            document.frm.leaveCategory.value=category;
            document.frm.schSymbol.value=oidcshedule;
            document.frm.submit();
        }
		function cmdGoToApprovalKpi(){
            document.frm.action="masterdata/approval.jsp";
            document.frm.submit();
        }
        function cmdGoToApproveCancel(){
            document.frm.action="employee/leave/cuti_cancel_approval.jsp";	
            document.frm.submit();
        }
        ...
        function prepare() {
                ...
                xmlhttp.onreadystatechange = function() {
                        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                                document.getElementById("notif-container").innerHTML = xmlhttp.responseText;
                        }
                };
                strUrl = "notification-ajax.jsp";
