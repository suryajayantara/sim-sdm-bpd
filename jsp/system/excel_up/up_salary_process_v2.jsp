...
// String.valueOf(cell.getNumericCellValue());
	                        ...
	                        //result.addElement(value);
                              ...
                              <% if(cell!=null && cell.getCellType() != HSSFCell.CELL_TYPE_NUMERIC) { %> 
                                    ...
                                    if (incCell == 3){
                                        String whereClause = PstPaySlip.fieldNames[PstPaySlip.FLD_EMPLOYEE_ID]+"="+employee.getOID();
                                        whereClause += " AND "+PstPaySlip.fieldNames[PstPaySlip.FLD_PERIOD_ID]+"="+payPeriod.getOID();
