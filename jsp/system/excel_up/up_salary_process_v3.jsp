<%-- 
    Document   : up_salary_process_v3
    Created on : Jun 30, 2016, 2:23:31 PM
    Author     : Dimata 007
--%>

<%@page import="com.dimata.harisma.session.payroll.ProcessImportExcel"%>
...
<html>
    <head>
        ...
        <title>Process Import Data</title>
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Payroll <strong style="color:#333;"> / </strong>Process Import Data Penggajian</span>
        </div>
        <div class="content-main">
            <%
            ProcessImportExcel procImpExc = new ProcessImportExcel();/////
            JspWriter output = pageContext.getOut();
            procImpExc.drawImportResult(payPeriod, payPeriod.getPeriod(), config, request, response, output, empDivisionId, sdmDivisionOid);
            %>
            <!-- output -->
        </div>
