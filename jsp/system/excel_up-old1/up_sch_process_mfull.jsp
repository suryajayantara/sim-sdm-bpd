...
if(iCommand == Command.SAVE)
{
	...
	else
	{
		...
		for(int e=0; e<employeeId.length; e++)
		{
			...
			int intAlStockAmount = Integer.parseInt(""+objPstAlStockManagement.getAlStockAmountPerEmployee(Long.parseLong(""+employeeId[e])));

			// get total LL stock per this employee
			PstLLStockManagement objPstLLStockManagement = new PstLLStockManagement();
			int intLlStockAmount = Integer.parseInt(""+objPstLLStockManagement.getLlStockAmountPerEmployee(Long.parseLong(""+employeeId[e])));
