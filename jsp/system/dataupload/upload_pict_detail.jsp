...
long oidDetail = FRMQueryString.requestLong(request, "detail_oid");
...
String whereClause = PstDataUploadDetail.fieldNames[PstDataUploadDetail.FLD_DATA_MAIN_ID]+ " = "+oidMain;
...
/*switch statement */
iErrCode = ctrlDataUploadDetail.action(iCommand , oidDetail);
/* end switch*/
