...
<%!    public String drawList(int iCommand, Vector objectClass, FrmOvertimeDetail frmObject, OvertimeDetail objEntity, 
        ...
        ctrlist.addHeader("Lembur Normal","7%");
        ctrlist.addHeader("Late Approval","7%");
        ...
        if (objectClass != null && objectClass.size() > 0) {
            ...
            for (int i = 0; i < objectClass.size(); i++) {
                ...
                if ((index == i) && (iCommand == Command.EDIT || iCommand == Command.ASK)) {
                    ...
                    Date startDate = overtimeDetail.getDateFrom() == null ? overtime.getRequestDate() : overtimeDetail.getDateFrom();
                    Date endDate = overtimeDetail.getDateTo() == null ? overtime.getRequestDate() : overtimeDetail.getDateTo();
                    SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_NOW);
                    String strDtNow = sdf.format(startDate);
                    String strDtEnd = sdf.format(endDate);
                    ...
                    rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_DATE_FROM]+"\" id=\"datetimepicker\" value=\""+strDtNow+"\" />");
                    ...
                    rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[frmObject.FRM_FIELD_DATE_TO]+"\" id=\"datetimepicker2\" value=\""+strDtEnd+"\" />");
                    ...
                    if(loginByHRD || ClientName.equals("BPD")){
                        if(overtime!=null && overtime.getRestTimeStart()!=null){
                           ...
                           // rowx.add("-");
                            rowx.add("<input type=\"text\" name=\"" + frmObject.fieldNames[FrmOvertimeDetail.FRM_FIELD_REST_TIME_HR] + "\" value=\"" + overtimeDetail.getRestTimeinHr() + "\" class=\"formElemen\" size=\"5\">"); 
                         }
                      } else {
                        if(overtime!=null && overtime.getRestTimeStart()!=null){
                    ...
                    rowx.add(ControlCombo.draw(frmObject.fieldNames[FrmOvertimeDetail.FRM_FIELD_NORMAL_OVERTIME], null, "" + overtimeDetail.getNormalOvertime(), OvertimeDetail.getNormalOvtByVal(), OvertimeDetail.getNormalOvtByKey()));
                    rowx.add(ControlCombo.draw(frmObject.fieldNames[FrmOvertimeDetail.FRM_FIELD_LATE_APPROVAL], null, "" + overtimeDetail.getLateApproval(), OvertimeDetail.getLateApprovalByVal(), OvertimeDetail.getLateApprovalByKey()));
                    ...
                    rowx.add(Formater.formatTimeLocale(overtimeDetail.getDateFrom(), "dd-MM-yyyy HH:mm"));
                    //rowx.add(startTime);
                    rowx.add(Formater.formatTimeLocale(overtimeDetail.getDateTo(), "dd-MM-yyyy HH:mm"));
                    //rowx.add(endTime);
                    ...
                    rowx.add(OvertimeDetail.normalOvtKey[overtimeDetail.getNormalOvertime()]);      
                    rowx.add(overtimeDetail.lateAppKey[overtimeDetail.getLateApproval()]);
            ...
            if (iCommand == Command.ADD || (iCommand == Command.SAVE && frmObject.errorSize() > 0)) {
                ...
                String DATE_FORMAT_NOW = "yyyy-MM-dd HH:mm";
//                Date startDate = objEntity.getDateFrom() == null ? overtime.getRequestDate() : objEntity.getDateFrom();
//                Date endDate = objEntity.getDateTo() == null ? overtime.getRequestDate() : objEntity.getDateTo();
                Date startDate = overtime.getRequestDate();
                Date endDate = overtime.getRequestDate();
                SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT_NOW);
                String strDtNow = sdf.format(startDate);
                String strDtEnd = sdf.format(endDate);
                ...
                rowx.add(ControlCombo.draw(frmObject.fieldNames[FrmOvertimeDetail.FRM_FIELD_NORMAL_OVERTIME], null, "" + objEntity.getNormalOvertime(), OvertimeDetail.getNormalOvtByVal(), OvertimeDetail.getNormalOvtByKey()));
                rowx.add(ControlCombo.draw(frmObject.fieldNames[FrmOvertimeDetail.FRM_FIELD_LATE_APPROVAL], null, "" + objEntity.getLateApproval(), OvertimeDetail.getLateApprovalByVal(), OvertimeDetail.getLateApprovalByKey()));                               
...
<%
            ...
            String reqDate = FRMQueryString.requestString(request, FrmOvertime.fieldNames[FrmOvertime.FRM_FIELD_REQ_DATE]);
        ...
        <script language="JavaScript">
            ...
            function cmdCheck(){          
                ...
                newWindow = window.open("src_ovemployee.jsp?formName=frmovdetail&empPathId=<%=FrmOvertimeDetail.fieldNames[FrmOvertimeDetail.FRM_FIELD_EMPLOYEE_ID]%>&command=<%=Command.FIRST%>&"+strpay+
                    "&<%=FrmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_DEPARTMENT]%>=<%=oidDepartment%>"+"&<%=FrmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_SECTION]%>=<%=oidSection%>"+
                    "&<%=FrmOvertime.fieldNames[FrmOvertime.FRM_FIELD_REQ_DATE]%>=<%=reqDate%>"+"&overtime_oid=<%=oidOvertime%>"
		...
		<td style="background-color:<%=bgColorContent%>; ">
			<table width="100%" border="0" cellspacing="1" cellpadding="1" >
												...
												<table width="100%" cellspacing="1" cellpadding="1"  onclick="Javascript:editOvertime()" >
													<tr>
														<td width="100" height="20">Req. Date</td>
                                                                                                                <input type="hidden" name="<%=FrmOvertime.fieldNames[FrmOvertime.FRM_FIELD_REQ_DATE]%>" value="<%=Formater.formatDate(overtime.getRequestDate(), "yyyy-MM-dd")%>">
                                                                                                                <%if(!valHideInfo.equals("1")){%>
														<td width="400" height="20"> <%=Formater.formatDate(overtime.getRequestDate(), "dd MMMM yyyy hh:mm")%>
                                                                                                                    <%}else{%>
														<td width="400" height="20"> <%=Formater.formatDate(overtime.getRequestDate(), "dd MMMM yyyy")%>
                                                                                                                    <%}%>
                ...
                <td width="100" height="20">Jenis Lembur</td>
                        <td width="400" height="20">
                            <%= ControlCombo.draw(FrmOvertime.fieldNames[FrmOvertime.FRM_FIELD_OVERTIME_TYPE], "formElemen", null, "" + overtime.getOvertimeType(), overtime.getNormalOvtByVal(), overtime.getNormalOvtByKey(), "disabled=\"true\" onkeydown=\"javascript:fnTrapKD()\"")%>
                        </td>
													</tr>
													<tr>
                                                                                        ...
                                                                                        <%
                                                                                          ...
                                                                                          if (overtime!=null && overtime.getRequestId()!=0){
                                                                                              if (overtime.getApproval1Id() != 0) {
                                                                                                approver = PstEmployee.fetchExc(overtime.getApproval1Id());
                                                                                                out.println(approver.getFullName());
                                                                                              }
                                                                                              if (overtime.getApproval2Id() != 0) {
                                                                                                approver = PstEmployee.fetchExc(overtime.getApproval2Id());
                                                                                                out.println(approver.getFullName());
                                                                                              }
                                                                                              if (overtime.getApproval3Id() != 0) {
                                                                                                approver = PstEmployee.fetchExc(overtime.getApproval3Id());
                                                                                                out.println(approver.getFullName());
                                                                                              }
                                                                                              if (overtime.getApproval4Id() != 0) {
                                                                                                approver = PstEmployee.fetchExc(overtime.getApproval4Id());
                                                                                                out.println(approver.getFullName());
                                                                                              }
                                                                                              if (overtime.getApproval5Id() != 0) {
                                                                                                approver = PstEmployee.fetchExc(overtime.getApproval5Id());
                                                                                                out.println(approver.getFullName());
                                                                                              }
                                                                                              if (overtime.getApproval6Id() != 0) {
                                                                                                approver = PstEmployee.fetchExc(overtime.getApproval6Id());
                                                                                                out.println(approver.getFullName());
                                                                                              }
                                                                                          } else {
                                                                                              out.println(" - ");
