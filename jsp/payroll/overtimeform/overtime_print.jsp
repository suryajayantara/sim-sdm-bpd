                ...
                rowx = new Vector();
                 {
                    ...
                    if (listAttendanceRecordDailly.size() > 0){
                        for (int j = 0; j < listAttendanceRecordDailly.size(); j++) { 
                            PresenceReportDaily presenceReportDaily = (PresenceReportDaily) listAttendanceRecordDailly.get(j);
							...
							<td width="100%" height="20">
								<table width="100%" cellspacing="1" cellpadding="1">
									...
									<tr>
										...
										<td width="30%" height="20" align="center">Approved by,<br><%=overtime.getTimeApproval1()!=null?Formater.formatDate(overtime.getTimeApproval1(), "MMMM dd, yyyy"):"-"%></td>
                                                                                <% if (overtime.getApproval2Id() != 0) { %>
                                                                                    <td width="30%" height="20" align="center">Approved by,<br><%=overtime.getTimeApproval2()!=null?Formater.formatDate(overtime.getTimeApproval2(), "MMMM dd, yyyy"):"-"%></td>
                                                                                <% } %>
                                                                                <% if (overtime.getApproval3Id() != 0) { %>
                                                                                    <td width="30%" height="20" align="center">Approved by,<br><%=overtime.getTimeApproval3()!=null?Formater.formatDate(overtime.getTimeApproval3(), "MMMM dd, yyyy"):"-"%></td>
                                                                                <% } %>
										<td width="5%" height="20" ></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="30%" height="20" align="center">
											<%
                                                                                          if( overtime!=null && overtime.getApproval1Id()!=0) {
                                                                                              Employee aprv = PstEmployee.fetchExc(overtime.getApproval1Id());
										...
										<td width="30%" height="20" align="center">
											<%
                                                                                          if( overtime!=null && overtime.getApproval2Id()!=0) {
                                                                                              Employee aprv = PstEmployee.fetchExc(overtime.getApproval2Id());
                                                                                              out.println(aprv.getFullName());
											...
											%>                                                                                         
                                                                                ...
                                                                                <td width="30%" height="20" align="center">
											<%
                                                                                          if( overtime!=null && overtime.getApproval3Id()!=0) {
                                                                                              Employee aprv = PstEmployee.fetchExc(overtime.getApproval3Id());
                                                                                              out.println(aprv.getFullName());
