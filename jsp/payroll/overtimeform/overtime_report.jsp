...
<%!
 ...
 String valHideInfo = PstSystemProperty.getValueByName("HIDE_INFORMATION_OVERTIME_PROCESS");
    ...
    public Double getOvIdx(long oid, double realDur, int typeOfDay) {
        ...
        if(ovtIdx.size() > 0){
            for(int i = 0; i < ovtIdx.size(); i++){
                ...
                } else if (typeOfDay == PstOvt_Type.END_OF_YEAR){
					if (realDur <= ovt_Idx.getHour_to() && realDur >= ovt_Idx.getHour_from()){
						result = ovt_Idx.getOvt_idx();
						break;
					}
				} else {
...
String overtimeStart = PstSystemProperty.getValueByName("OVERTIME_ROUND_START");
String overtimeTo = PstSystemProperty.getValueByName("OVERTIME_ROUND_TO");
long overStartL = Long.parseLong(overtimeStart);
    ...
    <head>
        ...
        <SCRIPT language=JavaScript>
           ...
           function cmdBack(){
             ...
             function cmdViewPresence(empNum, lDate){
                 var linkPage = "<%=approot%>/report/presence/presence_report_daily.jsp?emp_number="+empNum+"&lDate="+lDate+"&command=<%=(Command.LIST)%>"; 
                 var newWin = window.open(linkPage,"Overtime","height=700,width=990,status=yes,toolbar=yes,menubar=no,resizable=yes,scrollbars=yes,location=yes");  			
               //window.open("<%//=approot%>/report/presence/overtime_set_manually.jsp?command=<%//=(Command.EDIT)%>&"+employeeId+"&"+oidDetailOT+"&lDateFrom="+lDateFrom, null, "height=600,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");
                    newWin.focus();
             }
                                                ...
                                                <%}%>
                                                 ...
                                                 /* String sectionName="";
                                                  ...
                                                  <tr >
                                                    ...
                                                    <td class="listgentitle" width="6%" align="center">Level</td>
                                                    ...
                                                    <td class="listgentitle" align="center" width="3%">Rest(h) </td>
                                                    <td class="listgentitle" align="center" width="3%">Paid Duration </td>
                                                    ...
                                                    <%}%>
                                                    <td class="listgentitle" align="center" width="6%">Lembur Normal</td>
                                             ...
                                             ;       if(whereClauseStat.length()>0){
                                                  ...
                                                  <tr>
                                                    <%if(d==0){
                                                        ...
                                                        Level levelEmp = new Level();
                                                        try {
                                                            levelEmp = PstLevel.fetchExc(emp.getLevelId());
                                                        } catch (Exception exc){}
                                                        %>
                                                    <td width="2%"  bgcolor="#666666">&nbsp;</td>
                                                    ...
                                                    <td class="listgensell" rowspan="1<% //listEmpTime.size()%>"><%=(levelEmp!=null? levelEmp.getLevel():"")  %></td><!--colspan sejumlah employee time-->
                                                    <%} else {%>
                                                        <td width="2%"  bgcolor="#666666">&nbsp;</td>
                                                    ...
                                                    double totIdx = 0.0;
                                                    int overType = 0;
                                                    Date dtActualInlst = null;
                                                    Date dtActualOut1st = null;
                                                    %>
                                                  ...
                                                  <!-- update by devin 2014-02-20  -->
                                                    ...
                                                    <%listAttendanceRecordDailly = SessEmpSchedule.listEmpPresenceDaily(0, empTime.getDateFrom(), empTime.getDateTo(), 0, emp.getEmployeeNum(), emp.getFullName(), "", 0, 0,null,0,"",0,0,0);
                                                    ...
                                                    if(listAttendanceRecordDailly != null && listAttendanceRecordDailly.size() > 0){
                                                        //for (int j = 0; j < listAttendanceRecordDailly.size(); j++) { 
															...
															overType = getOvertimeType(empTime.getDateFrom(), emp.getReligionId());
                                                            dtActualInlst  = (Date) presenceReportDaily.getActualIn1st();
                                                            dtActualOut1st = (Date) presenceReportDaily.getActualOut1st();
                                                            if (dtActualOut1st != null && empTime.getDateFrom() != null) {
																if (empTime.getDateTo().before(dtActualOut1st)){
																	dtActualOut1st = empTime.getDateTo();
																}
                                                                strDiffOut1st = getDiffOut(empTime.getDateFrom(), dtActualOut1st, overToL, overType);
                                                                if(!strDiffOut1st.equals("") && !strDiffOut1st.equals(null)){
                                                                    jmlhDuration = Double.valueOf(strDiffOut1st);
                                                                }
                                                            }
                                                            if (dtActualInlst != null && empTime.getDateFrom() != null) {
                                                                if (empTime.getDateFrom().before(dtActualInlst)){
                                                                    strDiffOut1st = getDiffOut(dtActualInlst,dtActualOut1st, overToL, overType);
                                                                    if (!strDiffOut1st.equals("") && !strDiffOut1st.equals(null)){
                                                                    ...
                                                                    %><td class="listgensell" align="center" ><%=dtActualInlst!=null /*&& empTime.getStatus()==4 */ ? Formater.formatDate(dtActualInlst, "dd-MM-yyyy / HH:mm"):"" %></td><%
                                                                } else {
                                                                    %><td class="listgensell" align="center" ><%=Formater.formatDate(empTime.getDateFrom(), "dd-MM-yyyy / HH:mm")%><!--%=empTime.getRealDateFrom()!=null /*&& empTime.getStatus()==4*/ ? Formater.formatDate(empTime.getRealDateFrom(), "dd-MM-yyyy / HH:mm"):"" %--></td><%
                                                                }
                                                            }
                                                             else {
                                                            ...
                                                            if (dtActualInlst == null || dtActualOut1st == null){
                                                                jmlhDuration = 0;
                                                            }
                                                        %>
                                                            <td class="listgensell" align="center" ><%=dtActualOut1st!=null /*&& empTime.getStatus()==4 */ ? Formater.formatDate(dtActualOut1st, "dd-MM-yyyy / HH:mm"):"-" %></td>
                                                            <td class="listgensell" align="center" ><%=jmlhDuration%></td> 
                                                        <%//}
														}else{%>
                                                            <td class="listgensell" align="center" ></td>
                                                            <td class="listgensell" align="center" >0</td> 
                                                        <%}%>
                                                    ...
                                                    <%}%>
                                                     <%
                                                        ...
                                                        try{
                                                            employee = PstEmployee.fetchExc(empTime.getEmployeeId());
                                                        } catch (Exception exc){
                                                            
                                                        }
                                                    %>
                                                    <td class="listgensell" align="center" ><%= /*empTime.getStatus()==4 ?*/  Formater.formatNumber((empTime.getRestTimeinHr() != 0 ? empTime.getRestTimeinHr() : 0) ,"#,###.##") %><br><a href ="javascript:cmdViewPresence('<%=employee.getEmployeeNum()+"','"+empTime.getDateFrom().getTime()%>')">View</a></td>
                                                    <input type="hidden"  name="<%=(FrmOvertimeDetail.fieldNames[FrmOvertimeDetail.FRM_FIELD_REST_TIME_HR]+"_"+empTime.getOID())%>" value="<%=empTime.getRestTimeinHr() %>"/>
                                                    ...
                                                    <!--</td>-->
                                                      ...
                                                      if (durasi > jmlhDuration){
                                                          paidDuration = jmlhDuration - empTime.getRestTimeinHr();
                                                      } else {
                                                          paidDuration = durasi - empTime.getRestTimeinHr();
                                                      }
...
//                                                        double durKurRest = 0.0;
                                                        ...
                                                        if ((empTime.getNormalOvertime() == 0 || overType == PstOvt_Type.END_OF_YEAR) && paidDuration > maxDuration && maxDuration != 0.0){
                                                            paidDuration = maxDuration;
                                                        } 

                                                      %>                                                                                                                                                                 
                                                      <td class="listgensell" align="center" ><%=Formater.formatNumber(paidDuration,"#,###.##")%></td>  
                                                    <%
                                                    if(paidDuration != 0 && (empTime.getStatus() == I_DocStatus.DOCUMENT_STATUS_FINAL || empTime.getStatus() == I_DocStatus.DOCUMENT_STATUS_PROCEED) && dtActualOut1st != null){
                                                        
                                                        if(iCommand==Command.SAVE || iSearchAndCalculate==Command.SAVE){
                                                            try{
                                                                

                                                                totIdx = getOvIdx(emp.getOID(), paidDuration, overType);
                                                                
                                                                empTime.setTot_Idx(totIdx);
                                                                empTime.setTotDuration(paidDuration);
                                                                empTime.setStatus(I_DocStatus.DOCUMENT_STATUS_PROCEED);
                                                                if(empTime.getPay_slip_id() == 0){
                                                                    Vector paySlip = PstPaySlip.srcPaySlipByPeriod(empTime.getEmployeeId(), Formater.formatDate(empTime.getDateFrom(), "yyyy-MM-dd"));
                                                                    for (int j = 0; j < paySlip.size(); j++) { 
                                                                        PaySlip paySlipEnt = (PaySlip) paySlip.get(j);
                                                                        empTime.setPay_slip_id(paySlipEnt.getOID());
                                                                        double sumOvPs = paySlipEnt.getOvertimeIdxByForm() + totIdx;
                                                                        paySlipEnt.setOvertimeIdxByForm(sumOvPs);
                                                                        
                                                                        PstPaySlip.updateExc(paySlipEnt);
                                                                    }
                                                                }
                                                                PstOvertimeDetail.updateExc(empTime);                                                             
                                                            }catch(Exception exc){ 
                                                    ...
                                                    %>
                                                    <td class="listgensell" align="center" ><%= /*empTime.getStatus()==4 ?*/  Formater.formatNumber((empTime.getTot_Idx() != 0 ? empTime.getTot_Idx() : totIdx) ,"#,###.##") %></td>
                                                    <%if(!valHideInfo.equals("1")){%>
                                                ...
                                                <%    if(loginByHRD){                                                        
                                                    ...
                                                    <%
                                                        String normalOvt = "";
                                                        if (empTime.getNormalOvertime() == 0){
                                                            normalOvt = "Yes";
                                                        } else {
                                                            normalOvt = "No";
                                                        }
                                                    %>
                                                    <td class="listgensell" align="center" ><%=normalOvt%></td>
                                                    <td class="listgensell" align="center" ><%=I_DocStatus.fieldDocumentStatus[empTime.getStatus()]%></td>
                                                  </tr>
                                                  <%
                                                  
                                                  totalEmp=(totalEmp)+(durasi);
                                                  realTotalEmp=(realTotalEmp)+(jmlhDuration);                                                 
                                                  totalEmpOvIdex =  totalEmpOvIdex + empTime.getTot_Idx();                                                   
                                                  totalDep=(totalDep)+(durasi);
                                                  realTotalDep=(realTotalDep)+(realTotalEmp);
                                                  totalPaid = (totalPaid)+(paidDuration);
                                                  //update by devin 2014-02-20
                                                  ...
                                                  totalRest += empTime.getRestTimeinHr();
                                                  %>
                                                  <%}%>
                                                  ...
                                                  <tr >
                                                    ...
                                                    <td  class="listgensell"align="center" 
                                                        style="font-weight: bold"><%=Formater.formatNumber(totalRest,"#,###.##")%></td>
                                                    <td  class="listgensell"align="center" 
                                                        style="font-weight: bold"><%=Formater.formatNumber(totalPaid,"#,###.##")%></td>
                                                    <td  class="listgensell" align="center" 
