                                                                                                            ...
                                                                                                            <table border="0" cellspacing="2" cellpadding="2" width="72%">
                                                                                                                ...
                                                                                                                <tr align="left" valign="top">
                                                                                                                    ...
                                                                                                                    <td width="83%"> <%
                                                                                                                        ...
                                                                                                                        whereDivision = whereDivision.isEmpty() ? " AND " + PstDivision.fieldNames[PstDivision.FLD_VALID_STATUS] + " = " + PstDivision.VALID_ACTIVE : PstDivision.fieldNames[PstDivision.FLD_VALID_STATUS] + " = " + PstDivision.VALID_ACTIVE;
                                                                                                                ...
                                                                                                                <tr align="left" valign="top">
                                                                                                                    ...
                                                                                                                    <td width="83%"> <%
                                                                                                                        ...
                                                                                                                        if (processDependOnUserDept) {
                                                                                                                            if (emplx.getOID() > 0) {
                                                                                                                                if (isHRDLogin || isEdpLogin || isGeneralManager) {
                                                                                                                                    String strWhere = PstDepartment.TBL_HR_DEPARTMENT + "." + PstDepartment.fieldNames[PstDepartment.FLD_DIVISION_ID] + "=" + oidDivision + " AND " + PstDepartment.TBL_HR_DEPARTMENT + "." + PstDepartment.fieldNames[PstDepartment.FLD_VALID_STATUS] + " = " + PstDepartment.VALID_ACTIVE;
                                                                                                                                    dept_value.add("0");
                                                                                                                                    dept_key.add("select ...");
                                                                                                                ...
                                                                                                                <tr align="left" valign="top">
                                                                                                                    ...
                                                                                                                    <td width="83%"> <%
                                                                                                                        ...
                                                                                                                        String strWhereSec = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID] + "=" + oidDepartment + " AND " + PstSection.fieldNames[PstSection.FLD_VALID_STATUS] + " = " + PstSection.VALID_ACTIVE;
