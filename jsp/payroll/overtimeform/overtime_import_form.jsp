<%-- 
    Document   : overtime_import_form
    Created on : Feb 21, 2017, 10:50:10 PM
    Author     : mchen
--%>
...
<%
    ...
    session.putValue("OVERTIME_OID", oidOvertime); 
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Import file overtime</title>
        ...
        <script type="text/javascript">
            function cmdDownload(){
                window.open("<%=approot%>/imgdoc/detail_lembur.xls" , null);
            }
        </script>
    </head>
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Import file karyawan lembur</span>
        </div>
        <div class="content-main">
            <form name="form1" method="post" action="overtime_import_process.jsp" enctype="multipart/form-data">
