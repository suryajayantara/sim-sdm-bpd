            ...
            if (iCommand == Command.PRINT) { // ngak dipakai ya ??? by Kartika
                ...
                if (aksiCommand == 0) {
                   ...
                   // Vector list = new Vector();
                    ...
                    Vector listPayslipId = new Vector();
                     for (int i = 0; i < listEmpPaySlip.size(); i++) {
                        //listDfGjPrintBenefit = new Vector();
                        try {
                            oidEmployee = FRMQueryString.requestLong(request, "print" + i + ""); // row yang dicheked
                       ...
                       if (!s_payslip_id.equals("") && !s_payslip_id.equals("0") ){
                           listPayslipId.add(Long.valueOf(s_payslip_id));
                       } 
                    }
                   if(listEmpId!=null && listEmpId.size()>0){
                    listEmpPaySlip = SessEmployee.listEmpPaySlipByPayslipId(listPayslipId, periodeId, -1, bIncResign);
                   }
                }
...
<!-- JSP Block -->
<%!
	public String drawList(Vector objectClass,long employeeId,long periodId,long paySlipId,CurrencyType currencyType, I_Dictionary dictionaryD) 
	{
		...
		ctrlist.addHeader(dictionaryD.getWord(I_Dictionary.BENEFIT),"50%");
		ctrlist.addHeader(dictionaryD.getWord(I_Dictionary.VALUE),"50%");
...
%>
<%!
	public String drawListDeduction(Vector objectClass,long employeeId,long periodId,long paySlipId,String codeTax_count,CurrencyType currencyType, I_Dictionary dictionaryD)
	{
		ControlList ctrlist = new ControlList();
		ctrlist.setAreaWidth("100%");
		ctrlist.setListStyle("listgen");
		...
		ctrlist.setCellStyle("listgensell");
		ctrlist.setHeaderStyle("listgentitle");
		ctrlist.addHeader(dictionaryD.getWord(I_Dictionary.DEDUCTION),"50%");
		ctrlist.addHeader(dictionaryD.getWord(I_Dictionary.VALUE),"50%");
		//ctrlist.addHeader(" ","0%");
		ctrlist.setLinkRow(0);
		ctrlist.setLinkSufix("");
                              ...
                              <table width="100%" border="0" cellspacing="1" cellpadding="1" >
                                <tr> 
                                  <td valign="top">                                        										 	
                                      ...
                                      int payslipOT = 0;
                                      try{
                                        String strSlip=PstSystemProperty.getValueByName("MODEL_PAYSLIP");
                                        if(strSlip!=null){
                                            MODEL_PAYSLIP = Integer.parseInt(strSlip);
                                        }
                                        if (MODEL_PAYSLIP == PaySlip.MODEL_BANK){
                                            MODEL_PAYSLIP = PaySlip.MODEL_UP_DOWN;
                                        }
                                              ...
                                              <tr> 
                                                <td width="50%">
                                                    <table width="100%" height="23" border="0">
                                                      <tr>
                                                            <td width="100%" valign="top"><%=drawList(listPaySalary,employeeId,periodId,paySlipId,currencyType,dictionaryD)%></td>
                                                      </tr>
                                                    </table>												</td>
                                                <td  valign="top" width="50%">
                                                    <table width="100%" border="0">
                                                      <tr>
                                                            <td width="100%" valign="top"><%=drawListDeduction(listPayDeduction,employeeId,periodId,paySlipId,codeTax_count,currencyType,dictionaryD)%></td>
                                                      </tr>
                                                    </table>												</td>
                                              </tr>
                                            </table>
...
<table width="800" border="0" cellspacing="1" cellpadding="1">									                                                                                           
                                              ...
                                              <tr> 
                                                <td width="50%" valign="top">
                                                    <table width="100%" height="23" border="0">
                                                      ...
                                                      <tr>
                                                        <td valign="top"><table width="100%" cellspacing="1" cellpadding="1">
                                                          <tr>
                                                            <td width="24%"><%=dictionaryD.getWord(I_Dictionary.PERIODE)%></td>
                                                            <td width="3%">:</td>
                                                  ...
                                                  <% out.println(detailSlipYN==1?" / "+Formater.formatTimeLocale(endDatePeriod,"dd-MM-yyyy"):"");%>
                                                          ...
                                                          <tr>
                                                            <td><%=dictionaryD.getWord(I_Dictionary.FULL_NAME)%> </td>
                                                            <td>:</td>
                                                            <td><font color="#006666"><%=employeeName%></font></td>
                                                          </tr>
                                                          <tr>
                                                            <td><%=dictionaryD.getWord(I_Dictionary.EMP_NUMBER)%> </td>
                                                            <td>&nbsp;</td>
                                                 ...
                                                 <%=dictionaryD.getWord(I_Dictionary.DIVISION)%> </td>
                                                          ...
                                                          <tr>
                                                            <td><%=dictionaryD.getWord(I_Dictionary.GRADE_LEVEL)%> </td>
                                                            <td>:</td>
                                                            <td><font color="#006666"><%=grade%></font></td>
                                                          </tr>
                                                          <tr>
                                                            <td><%=dictionaryD.getWord(I_Dictionary.COMMENCING_DATE)%> </td>
                                                            <td>:</td>
                                                            <td><font color="#006666"><%=Formater.formatTimeLocale(commDate,"dd-MM-yyyy") %></font></td>
                                                          </tr>
                                                          <tr>
                                                            <td><%=dictionaryD.getWord(I_Dictionary.NO_REKENING)%> </td>
                                                            <td>:</td>
                                                            <td><%=bankAcc%></td>
                                                          </tr>
                                                          <tr>
                            ...
                            <table width="100%" border="0">
                                              ...
                                              %>
                                                    ...
                                                    %>
                                                    <td width="25%" bgcolor="#FFFFFF"><span class="style2"><b><%=dictionaryD.getWord(I_Dictionary.TOTAL_TAKE_HOME_PAY)%></b></span></td>
