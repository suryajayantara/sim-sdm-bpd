...
<%
            ...
            //PayPeriod newpayPayPeriod = new PayPeriod(); 
            //try{
            //    newpayPayPeriod = PstPayPeriod.fetchExc(periodeId);
            //}catch(Exception e ){}
            //int countJumlahPaySlip = PstPaySlip.getJumlahPayslip(504404614967777118l, newpayPayPeriod);
%>
<%
...
<%!
	public String drawList(Vector objectClass,long employeeId,long periodId,long paySlipId,CurrencyType currencyType) 
	{
		...
		ctrlist.addHeader("PENDAPATAN","50%");
		ctrlist.addHeader(" NILAI ","50%");
                                            ...
                                            <% if(detailSlipYN==1) { %>
                                              ...
                                              <tr> 
                                                ...
                                                <td width="27%" nowrap><font color="#006666">: 
                                                  <% out.println((detailSlipYN==1? division+" / " : ""));%><%=division%></font></td>
                                              ...
                                              <%if(payslipOT==0){%>
                                               <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td width="25%" bgcolor="#FFFFFF"><span class="style2"><b>Jam Lembur / Idx Lembur / Uang Lembur / DP Lembur / Idx Adjustment <%=(privNote.length()>0?" / "+"note":"")%></b></span></td>
                                              ...
                                              <tr> 
                                                ...
                                                **/
                                                %></td>
                                                      ...
                                                      <tr>
                                                            <td width="100%" valign="top">Catatan : <%=note%></td>
                                                      </tr>
                                                </table>												</td>
                                                <td  valign="top" width="50%">
                                                    <table width="100%" border="0">
<tr>
                            ...
                            <table width="100%" border="0">
                                              ...
                                              %>
                                               ...
                                               <%if(payslipOT==0 && !clientName.equals("BPD")){%>
                                               <tr> <td colspan="5">`
                                               <table width="100%">
                                                    <tr>
                                                        <%String ov= otDuration +" / "+otPaidByTotal+" / "+otPaidBySalary+" / "+otPaidByDP+" / "+ovIdAdjustment+(privNote.length()>0?" / "+privNote:"");%>
                                                       ...
                                                       <%
                                                        ...
                                                        try {
                                                         ...
                                                         if (clientName.equals("BPD")){
                                                             if (division.equals("Masa Bebas Tugas")){
                                                                TaxCalculator.calcSalaryTaxBPDSecondSlip( employeeId, payPeriod, prevPeriod, pajak);                                                                                                                                                                                           
                                                             } else {
                                                                TaxCalculator.calcSalaryTaxBPD( employeeId, payPeriod, prevPeriod, pajak);                                                                                                                          
                                                             }
