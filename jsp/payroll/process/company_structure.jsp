...
/* Administrator Check */
    String strDisable = "";
    boolean privViewAllDivision = false;
    if (session.getValue("privViewAllDivision") != null){
        privViewAllDivision = (Boolean) session.getValue("privViewAllDivision");
    }
    if (appUserSess.getAdminStatus()==0 && !privViewAllDivision){
        strDisable = "disabled=\"disabled\"";
    }
    session.removeValue("privViewAllDivision");
%>
<div class="caption">
