<%-- 
    Document   : value_mapping_process
    Created on : Mar 15, 2016, 11:26:04 AM
    Author     : Dimata 007
--%>
...
<!DOCTYPE html>
<%
    String sessCompCode = (String) session.getValue("sess_comp_code");
    ValueMappingExcel valMappingExcel = new ValueMappingExcel();
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Process Import Excel - Value Mapping</title>
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Payroll <strong style="color:#333;"> / </strong>Value Mapping <strong style="color:#333;"> / </strong> Import Process <%=sessCompCode%></span>
            <a style="color:#F5F5F5" class="btn-small" href="javascript:cmdBack('<%=sessCompCode%>')">Back</a>
        </div>
        <div class="content-main">
            <form name="frm" action=""><input type="hidden" name="comp_code" value="<%=sessCompCode%>" /></form>
            <%
            String test = valMappingExcel.processImportExcel(sessCompCode, config, request, response);
            %>
            <%= test %>
        </div>
