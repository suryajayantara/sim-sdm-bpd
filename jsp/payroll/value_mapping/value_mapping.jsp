...
<%!
...

	{
		...
		int index = -1;
                    ...
                    status_key.add("Open");
                    status_value.add("0");
                    status_key.add("Closed");
                    status_value.add("1");
                    
                    Hashtable hStatus = new Hashtable();
                    hStatus.put("0", "Open");
                    hStatus.put("1", "Closed");
                    
                    Hashtable hSex = new Hashtable();
                    hSex.put("-1", "Select");
                    hSex.put("0", "Pria");
                    hSex.put("1", "Wanita");
		...
		for (int i = 0; i < objectClass.size(); i++) {
			 ...
			 if(index == i && (iCommand == Command.EDIT || iCommand == Command.ASK)){
                ...
                rowx.add(ControlDate.drawDateWithStyle(frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_START_DATE], objEntity.getStartdate(), 10, -70, "formElemen") +"*"+ frmObject.getErrorMsg(frmObject.FRM_FIELD_START_DATE));
                rowx.add(ControlDate.drawDateWithStyle(frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_END_DATE], objEntity.getEnddate(), 10, -70, "formElemen") +"*"+ frmObject.getErrorMsg(frmObject.FRM_FIELD_END_DATE));
                ...
                rowx.add(ControlCombo.draw(frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_SEX], "formElemen", null, String.valueOf(objEntity.getSex()), sex_value, sex_key, ""));
                rowx.add("<input type=\"text\" name=\"" + frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_VALUE] + "\" value=\"" + Formater.formatNumber(objEntity.getValue(),"") + "\" size=\"40\" class=\"elemenForm\">");
                rowx.add(ControlCombo.draw(frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_STATUS], "formElemen", null, String.valueOf(objEntity.getStatus()), status_value, status_key, ""));
                ...
                rowx.add(ControlDate.drawDateWithStyle(frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_START_DATE], value_Mapping.getStartdate(), 10, -70, "formElemen") +"*"+ frmObject.getErrorMsg(frmObject.FRM_FIELD_START_DATE));
                rowx.add(ControlDate.drawDateWithStyle(frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_END_DATE], value_Mapping.getEnddate(), 10, -70, "formElemen") +"*"+ frmObject.getErrorMsg(frmObject.FRM_FIELD_END_DATE));
                ...
                rowx.add(ControlCombo.draw(frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_SEX], "formElemen", null, String.valueOf(value_Mapping.getSex()), sex_value, sex_key, ""));
                rowx.add("<input type=\"text\" name=\"" + frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_VALUE] + "\" value=\"" + Formater.formatNumber(value_Mapping.getValue(),"") + "\" size=\"40\" class=\"elemenForm\">");
                rowx.add(ControlCombo.draw(frmObject.fieldNames[FrmValue_Mapping.FRM_FIELD_STATUS], "formElemen", null, String.valueOf(value_Mapping.getStatus()), status_value, status_key, ""));
                ...
                rowx.add("" + geo );
                rowx.add(""+ (hSex.get(""+value_Mapping.getSex())));
                rowx.add(""+Formater.formatNumber(value_Mapping.getValue(), ""));
                rowx.add(""+ (hStatus.get(""+value_Mapping.getStatus())));
                	} 
			lstData.add(rowx);
		}
...
if (listValue_Mapping  == null){
    ...
    int ssex = FRMQueryString.requestInt(request, FrmValue_Mapping.fieldNames[FrmValue_Mapping.FRM_FIELD_SEX]);
    
    int sstatus = FRMQueryString.requestInt(request, FrmValue_Mapping.fieldNames[FrmValue_Mapping.FRM_FIELD_STATUS]);
    ...
    if(iCommand==Command.GOTO){
                         ...
                         value_Mapping.setSex(ssex);
                         value_Mapping.setValue(svalue);//"VALUE"
                         value_Mapping.setStatus(sstatus);
...
function cmdCloseAllEndDate(compCode){
        window.open("../setup/closeValueMappingEndDate.jsp?compCode="+compCode, null, "height=550,width=600, status=yes,toolbar=no,menubar=no,location=no, scrollbars=yes");  
}
        ...
        <tr> 
          <td height="20">
		    <font color="#FF6600" face="Arial"><strong>
                        <!-- #BeginEditable "contenttitle" -->Masterdata &gt; Value Mapping
            </strong></font>
	      </td>
        </tr>
        <tr> 
                                              ...
                                              <tr align="left" valign="top"> 
                                                <td height="22" valign="middle" colspan="3"> 
                                                  <table cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <tr> 
                                                      <td><button id="btn" onclick="cmdCloseAllEndDate('<%=oidcompCode%>')">Close All End Date</button></td>
                                                    </tr>
                                                  </table>
                                                </td>
                                              </tr>
                                              ...
                                              <tr align="left" valign="top"> 
                                                <td height="22" valign="middle" colspan="3"> 
                                                  <table cellpadding="0" cellspacing="0" border="0">
                                                    ...
                                                    <tr>
                                                      <td><button id="btn" onclick="cmdAdd('<%=oidcompCode%>')">Add New</button></td>
                                                    </tr>
                                                  </table>
                                                </td>
                                              </tr>
