                                              ...
                                              <tr> 
                                                ...
                                                <td height="24" width="28%"> 
                                                  <%
													  ...
													  Vector listDivision = PstDivision.list(0, 0, PstDivision.fieldNames[PstDivision.FLD_VALID_STATUS] + " = " + PstDivision.VALID_ACTIVE, "DIVISION");										  
                                                ...
                                                <td height="24" width="4%" nowrap> 
                                                  <% 
															...
															Vector listSec = PstSection.list(0, 0, PstSection.fieldNames[PstSection.FLD_VALID_STATUS] + " = " + PstSection.VALID_ACTIVE, " SECTION ");
