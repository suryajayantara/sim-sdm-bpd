...
<% int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_PAYROLL, AppObjInfo.G2_PAYROLL_SETUP, AppObjInfo.OBJ_PAYROLL_BENEFIT_INPUT);%>
<%@ include file = "../../main/checkuser.jsp" %>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<%!
    public String drawList(Vector objectClass, long oidBenefitPeriod, boolean privUpdate, boolean privDelete) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {     
            ...
            rowx.add("" + no);
            if (privUpdate == true){
                rowx.add("<a href=\"javascript:cmdEdit('"+benefitPeriod.getOID()+"')\">"+benefitPeriod.getPeriodFrom()+"</a>");
            } else {
                                        ...
                                        <td style="background-color:#EEE;">
                                            ...
                                            <table style="padding:9px; border:1px solid #00CCFF;" <%=garisContent%> width="100%" border="0" cellspacing="1" cellpadding="1" class="tablecolor">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%=drawList(listBenefitPeriod, oidBenefitPeriod, privUpdate, privDelete)%>
                                                    </td>
