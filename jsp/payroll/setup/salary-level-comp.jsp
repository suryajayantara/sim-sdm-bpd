...
int vectSize = PstSalaryLevelDetail.getCountListComponent(salary_level,PstPayComponent.TYPE_BENEFIT, sCompCode, sCompName);
int vectSizeDeduction = PstSalaryLevelDetail.getCountListComponent(salary_level,PstPayComponent.TYPE_DEDUCTION, sCompCodeDed, sCompNameDed);
...
//untuk benefit
listSalaryLevelDetail = PstSalaryLevelDetail.listComponent(start,recordToGet,salary_level,PstPayComponent.TYPE_BENEFIT, sCompCode, sCompName);
//untuk deduction
listDeduction= PstSalaryLevelDetail.listComponent(startDeduction,recordToGet,salary_level,PstPayComponent.TYPE_DEDUCTION, sCompCodeDed, sCompNameDed);
...
/*function untuk mengubah judul buku dan harga sesuai dengan barang yang dipilih dalam combo box*/
	...
	function searchComponent(){
		document.frmSalaryLevelDetail.command.value="<%=Command.LIST%>";
