...
<% int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_PAYROLL, AppObjInfo.G2_PAYROLL_SETUP, AppObjInfo.OBJ_PAYROLL_BENEFIT_CONFIG);%>
<%@ include file = "../../main/checkuser.jsp" %>

<%!
    public String drawList(Vector objectClass, long oidBenefitConfig, boolean privUpdate, boolean privDelete) {
        ...
        for (int i = 0; i < objectClass.size(); i++) {     
            ...
            rowx.add("" + no);
            if (privUpdate == true){
                rowx.add("<a href=\"javascript:cmdEdit('"+benefitConfig.getOID()+"')\">"+benefitConfig.getPeriodFrom()+"</a>");
            } else {
 ...
 *                                                                                                 */
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <%=drawList(listBenefitConfig, oidBenefitConfig, privUpdate, privDelete)%>
                                                    </td>
