...
<!-- JSP Block -->
<%!    public String drawList(int iCommand, FrmSalaryLevel frmObject, SalaryLevel objEntity, Vector objectClass, long idSalaryLevel, boolean privUpdate) {
	String result = "";
			...
			rowx = new Vector();
				...
				//rowx.add("<a href='salary-level-comp.jsp?'>view details</a>");
                    ...
                    if (privUpdate == true){
                        ...
                        rowx.add(salaryLevel.getLevelCode());
                    }
                                  ...
                                  <td valign="top"> <!-- #BeginEditable "content" --> 
                                    <form name="frmSalaryLevel" method="post" action="">
                                      ...
                                      <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr> 
                                          <td>
										 <%=drawList(iCommand, frmSalaryLevel, salaryLevel, listSalaryLevel, oidSalaryLevel, privUpdate)%> 
										  </td>
                                        </tr>
										<% 
										  }catch(Exception exc){ 
