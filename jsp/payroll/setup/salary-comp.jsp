...
<%
            ...
            String sCompCode = FRMQueryString.requestString(request, "salary_comp_code");
            String sCompName = FRMQueryString.requestString(request, "salary_comp_name");
            String sCompCodeDed = FRMQueryString.requestString(request, "salary_comp_code_ded");
            String sCompNameDed = FRMQueryString.requestString(request, "salary_comp_name_ded");
            ...
            //Benefit
            if(sCompCode!=null && sCompCode.length()>0){
                whereClauseBenefit = whereClauseBenefit + " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_COMP_CODE] + " LIKE \"%" + sCompCode +"%\"";
            }

            if(sCompName!=null && sCompName.length()>0){
              if(sCompCode!=null && sCompCode.length()>0){
                       whereClauseBenefit = whereClauseBenefit + " OR ";
              }
                whereClauseBenefit = whereClauseBenefit + " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_COMP_NAME] + " LIKE \"%" + sCompName +"%\"" ;
            }
            
            
            //Deduction
            if(sCompCodeDed!=null && sCompCodeDed.length()>0){
                whereClauseDeduction = whereClauseDeduction + " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_COMP_CODE] + " LIKE \"%" + sCompCodeDed +"%\"";
            }

            if(sCompNameDed!=null && sCompNameDed.length()>0){
              if(sCompCodeDed!=null && sCompCodeDed.length()>0){
                       whereClauseDeduction = whereClauseDeduction + " OR ";
              }
                whereClauseDeduction = whereClauseDeduction + " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_COMP_NAME] + " LIKE \"%" + sCompNameDed +"%\"" ;
            }
            String orderClause = PstPayComponent.fieldNames[PstPayComponent.FLD_SORT_IDX] + "," + PstPayComponent.fieldNames[PstPayComponent.FLD_COMP_CODE];
...
<%!
    public String drawList(int iCommand, FrmPayComponent frmObject, PayComponent objEntity, Vector objectClass, long payComponentId, int status, boolean privUpdate) {
        ...
        ctrlist.addHeader("Add to Second Slip");
       ...
       // taxValue.add(PstPayComponent.taxItem[PstPayComponent.BONUS_THR]);
        ...
        taxValue.add(PstPayComponent.taxItem[PstPayComponent.POTONGAN_GAJI_MBT]);
        ...
        //Second Slip
        Vector scndSlipKey = new Vector();
        Vector scndSlipValue = new Vector();
        scndSlipKey.add(PstPayComponent.NO_SECOND_SLIP + "");
        scndSlipKey.add(PstPayComponent.YES_SECOND_SELIP + "");
        scndSlipValue.add(PstPayComponent.secondSlip[PstPayComponent.NO_SECOND_SLIP]);
        scndSlipValue.add(PstPayComponent.secondSlip[PstPayComponent.YES_SECOND_SELIP]);
       ...
       //update by priska 2015-03-12
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if (index == i && (iCommand == Command.EDIT || iCommand == Command.ASK)) {
                ...
                rowx.add("" + ControlCombo.draw(FrmPayComponent.fieldNames[FrmPayComponent.FRM_FIELD_SECOND_SLIP], "formElemen", null, "" + objEntity.getSecondSlip(), scndSlipKey, scndSlipValue));
                ...
                rowx.add(PstPayComponent.secondSlip[payComponent.getSecondSlip()]);
...
<%!    public String drawListDeduction(int iCommand, FrmPayComponent frmObject, PayComponent objEntity, Vector objectClass, long payComponentId, int status, boolean privUpdate) {
        ...
        taxKey.add(PstPayComponent.TUNJANGAN_MBT + "");        
        taxKey.add(PstPayComponent.BONUS_THR + "");
        taxKey.add(PstPayComponent.BONUS_THR_MBT + "");
        taxKey.add(PstPayComponent.POTONGAN_GAJI + "");
        taxKey.add(PstPayComponent.POTONGAN_GAJI_MBT+"");
        taxValue.add(PstPayComponent.taxItem[PstPayComponent.NO_TAX]);
        taxValue.add(PstPayComponent.taxItem[PstPayComponent.GAJI]);
        ...
        taxValue.add(PstPayComponent.taxItem[PstPayComponent.TUNJANGAN_MBT]);
        taxValue.add(PstPayComponent.taxItem[PstPayComponent.BONUS_THR]);
        taxValue.add(PstPayComponent.taxItem[PstPayComponent.BONUS_THR_MBT]);
        taxValue.add(PstPayComponent.taxItem[PstPayComponent.POTONGAN_GAJI]);
        taxValue.add(PstPayComponent.taxItem[PstPayComponent.POTONGAN_GAJI_MBT]);
        //Termasuk Tunjangan
        Vector tnjKey = new Vector();
        ...
        for (int i = 0; i < objectClass.size(); i++) {
            ...
            if (index == i && (iCommand == Command.EDIT || iCommand == Command.ASK)) {
                ...
                rowxD.add("" + ControlCombo.draw(FrmPayComponent.fieldNames[FrmPayComponent.FRM_FIELD_SECOND_SLIP], "formElemen", null, "" + objEntity.getSecondSlip(), scndSlipKey, scndSlipValue));
                ...
                rowxD.add(PstPayComponent.secondSlip[payComponent.getSecondSlip()]);
                if (privUpdate == true){
    ...
    <head>
        ...
        <SCRIPT language=JavaScript>
            function searchComponent(){
                document.frm_component.command.value="<%=Command.LIST%>";
           ...
           <%@include file="../../styletemplate/template_header.jsp" %>
                                                                                    ...
                                                                                    <tr> <td>
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">   
                                                                                                <tr align="left" valign="top"> 
                                                                                                    <td  align="left" height="14" valign="middle" colspan="2" class="listtitle"><div class="title_part">Benefit List</div>
                                                                                                        <div><input type="text" name="salary_comp_code" size="13" placeholder="Code" value="<%=sCompCode%>">|||<input type="text" name="salary_comp_name" placeholder="Benefit Name" size="22" value="<%=sCompName%>">|||<input type="button" id="btn" value="Search" onClick="javascript:searchComponent()" /></div>
                                                                                                        <div></div>
                                                                                                    </td>
                                                                                                </tr> 
                                                                                            </table>
            ...
            if ((iCommand != Command.ADD && iCommand != Command.ASK && iCommand != Command.EDIT) && (frmPayComponent.errorSize() < 1)) {
                ...
                if ((iCommand == Command.ADD) || (iCommand == Command.SAVE) && (frmPayComponent.errorSize() > 0) || (iCommand == Command.EDIT) || (iCommand == Command.ASK)) {%>
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td  align="left" height="14" valign="middle" colspan="2" class="listtitle"><div class="title_part">Deduction List</div> 
                                                                                            <div><input type="text" name="salary_comp_code_ded" size="13" placeholder="Code" value="<%=sCompCodeDed%>">|||<input type="text" name="salary_comp_name_ded" placeholder="Deduction Name" size="22" value="<%=sCompNameDed%>">|||<input type="button" id="btn" value="Search" onClick="javascript:searchComponent()" /></div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <%
            try {
