...
//======
    ...
    public static String drawStringArraySelectedOptGroup(String name, String style, String blankSel, String[] selectVal, Vector keys, Vector vals, Vector tooltip, String attTag) {
        if (name == null) {
            name = new String("cbbox");
        }
        if (style == null || style.length() == 0) {
        ...
        try {
            ...
            if (keys != null && keys.size() > 0 && vals != null && vals.size() > 0) {
                for (int i = 0; i < keys.size(); i++) {
                    ...
                    if (val.equals("-1")){
                        if (i==0){
                            htmlSelect = htmlSelect + "<optgroup label=\""+ key +"\">";
                        } else {
                            if (htmlSelect.contains("optgroup")){
                                htmlSelect = htmlSelect + "<optgroup label=\""+ key +"\">";
                            } else {
                                htmlSelect = htmlSelect + "</optgroup><optgroup label=\""+ key +"\">";
                            }
...
//update by satrya 2012-11-6
    ...
    public static String draw(String name, String blankSel, String selectVal, Vector keys, Vector vals, String attTag, String style, String onChangeFunction) {
        if (name == null) {
            name = new String("cbbox");
        }
        String s = "";
        String htmlSelect = "<select name=\"" + name + "\" id=\"" + name + "\" " + attTag + " class=\"" + style + "\"  onchange=\"" + onChangeFunction + "\">\n";
        boolean hasSel = false;
        if (blankSel != null) {
            htmlSelect = htmlSelect + "\t<option value=\"\" selected >" + blankSel + "</option>\n";
        }
