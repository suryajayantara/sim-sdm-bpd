...
public class SrcLeaveApp {
    ...
    /** Holds value of property toBeCancel. */
    private boolean toBeCanceled = true;
    
    /** Holds value of property declined. */
    ...
    private Vector arrJenisCuti = new Vector();
    ...
    public void setToBeCanceled(boolean toBeCanceled) {
	...
	public String[] getArrJenisCuti(int idx) {
         if(idx>=arrJenisCuti.size()){
            return null;
        }
        return (String[])arrJenisCuti.get(idx); 
    }
	
	public void addArrJenisCuti(String[]  arrJenisCuti) {
        this.arrJenisCuti.add(arrJenisCuti);
    }  
