...
public class PayInputPresence {
    ...
    private int totalIdt = 0;
    private int totalIpc = 0;
    ...
    /**
     * @return the totalRekapHk
     */
    public int getTotalRekapHk() {
        return totalRekapHk;
    }

    /**
     * @param totalRekapHk the totalRekapHk to set
     */
    public void setTotalRekapHk(int totalRekapHk) {
        this.totalRekapHk = totalRekapHk;
    }
     ...
     * @return the totalIdt
     */
    public int getTotalIdt() {
        return totalIdt;
    }

    /**
     * @param totalIdt the totalIdt to set
     */
    public void setTotalIdt(int totalIdt) {
        this.totalIdt = totalIdt;
    }

    /**
     * @return the totalIpc
     */
    public int getTotalIpc() {
        return totalIpc;
    }

    /**
     * @param totalIpc the totalIpc to set
     */
    public void setTotalIpc(int totalIpc) {
        this.totalIpc = totalIpc;
    }
}
