...
//                          sql = sql + " AND EMP."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_NUM] + " LIKE \"%"+payrolNum+"%\"";
    ...
    public static String getEmployeeIn(int limitStart,int recordToGet,  String order, String oidDepartement, String employeeName, Date fromDate, Date toDate , String oidSection, String payrolNum,Vector stsPresence){
		...
		try {
                        ...
                        if(!oidDepartement.equals(""))
                                sql = sql + " AND EMP." +PstEmployee.fieldNames[PstEmployee.FLD_DEPARTMENT_ID] + " IN \"("+oidDepartement+"\")";
...
//                          sql = sql + " AND EMP."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_NUM] + " LIKE \"%"+payrolNum+"%\"";
        ...
        public static String getEmployeeIn(int limitStart,int recordToGet,  String order, String oidDepartement, String employeeName, Date fromDate, Date toDate , String oidSection, String payrolNum,Vector stsPresence,String oidCompany,String oidDivision){
		...
		try {
                        ...
                        if(!oidCompany.equals("")){
                                sql = sql + " AND EMP." +PstEmployee.fieldNames[PstEmployee.FLD_COMPANY_ID] + "IN \"("+oidCompany+"\")";
                        }
                         //update by satrya 2013-11-03
                        if(!oidDivision.equals("")){
                                sql = sql + " AND EMP." +PstEmployee.fieldNames[PstEmployee.FLD_DIVISION_ID] + "IN \"("+oidDivision+"\")";
                        }
                        if(employeeName !=null && employeeName.length() > 0){
//                          sql = sql + " AND EMP."+PstEmployee.fieldNames[PstEmployee.FLD_FULL_NAME] + " LIKE \"%"+employeeName+"%\"";
                           Vector vectFullName = logicParser(employeeName);
...
//                          sql = sql + " AND EMP."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_NUM] + " LIKE \"%"+payrolNum+"%\"";
			...
			if(!oidSection.equals(""))
                            sql = sql + " AND " + PstSection.fieldNames[PstSection.FLD_SECTION_ID] + "IN \"("+oidSection+"\")";
...
//                          sql = sql + " AND EMP."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_NUM] + " LIKE \"%"+payrolNum+"%\"";
        ...
        public static Vector listIn(int limitStart,int recordToGet,  String order, String oidDepartement, String employeeName, Date fromDate, Date toDate , String oidSection, String payrolNum,Vector stStatus,String stsEmpCategorySel,int statusResign,String oidCompany,String oidDivision){
	//public static Vector list(int limitStart,int recordToGet,  String order, long oidDepartement, String employeeName, Date fromDate, Date toDate , long oidSection){
		Vector lists = new Vector(); 
             if(fromDate!=null && toDate!=null){   
		DBResultSet dbrs = null;
		try {
                        ...
                        if(!oidDepartement.equals(""))
                                sql = sql + " AND EMP." +PstDepartment.fieldNames[PstDepartment.FLD_DEPARTMENT_ID] + " IN \"("+oidDepartement+"\")";
                        if(employeeName !=null && employeeName.length() > 0){
//                          sql = sql + " AND EMP."+PstEmployee.fieldNames[PstEmployee.FLD_FULL_NAME] + " LIKE \"%"+employeeName+"%\"";
                           Vector vectFullName = logicParser(employeeName);
                           sql = sql + " AND ";
