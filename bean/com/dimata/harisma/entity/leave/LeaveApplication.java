...
public class LeaveApplication extends Entity
{
    ...
    private int typeLeaveCategory;
    private int direksiApproval;
    ...
    private long rep_approval_1 = 0;
    private long rep_approval_2 = 0;
    private long rep_approval_3 = 0;
    private long rep_approval_4 = 0;
    private long rep_approval_5 = 0;
    private long rep_approval_6 = 0;
    ...
    /**
     * @return the typeLeaveCategory
     */
    public int getTypeLeaveCategory() {
        return typeLeaveCategory;
    }

    /**
     * @param typeLeaveCategory the typeLeaveCategory to set
     */
    public void setTypeLeaveCategory(int typeLeaveCategory) {
        this.typeLeaveCategory = typeLeaveCategory;
    }

    /**
     * @return the direksiApproval
     */
    public int getDireksiApproval() {
        return direksiApproval;
    }

    /**
     * @param direksiApproval the direksiApproval to set
     */
    public void setDireksiApproval(int direksiApproval) {
        this.direksiApproval = direksiApproval;
    }

    /**
     * @return the rep_approval_1
     */
    public long getRep_approval_1() {
        return rep_approval_1;
    }

    /**
     * @param rep_approval_1 the rep_approval_1 to set
     */
    public void setRep_approval_1(long rep_approval_1) {
        this.rep_approval_1 = rep_approval_1;
    }

    /**
     * @return the rep_approval_2
     */
    public long getRep_approval_2() {
        return rep_approval_2;
    }

    /**
     * @param rep_approval_2 the rep_approval_2 to set
     */
    public void setRep_approval_2(long rep_approval_2) {
        this.rep_approval_2 = rep_approval_2;
    }

    /**
     * @return the rep_approval_3
     */
    public long getRep_approval_3() {
        return rep_approval_3;
    }

    /**
     * @param rep_approval_3 the rep_approval_3 to set
     */
    public void setRep_approval_3(long rep_approval_3) {
        this.rep_approval_3 = rep_approval_3;
    }

    /**
     * @return the rep_approval_4
     */
    public long getRep_approval_4() {
        return rep_approval_4;
    }

    /**
     * @param rep_approval_4 the rep_approval_4 to set
     */
    public void setRep_approval_4(long rep_approval_4) {
        this.rep_approval_4 = rep_approval_4;
    }

    /**
     * @return the rep_approval_5
     */
    public long getRep_approval_5() {
        return rep_approval_5;
    }

    /**
     * @param rep_approval_5 the rep_approval_5 to set
     */
    public void setRep_approval_5(long rep_approval_5) {
        this.rep_approval_5 = rep_approval_5;
    }

    /**
     * @return the rep_approval_6
     */
    public long getRep_approval_6() {
        return rep_approval_6;
    }

    /**
     * @param rep_approval_6 the rep_approval_6 to set
     */
    public void setRep_approval_6(long rep_approval_6) {
        this.rep_approval_6 = rep_approval_6;
    }
