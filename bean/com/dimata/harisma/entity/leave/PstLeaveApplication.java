...
public class PstLeaveApplication extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_TYPE_LEAVE_CATEGORY = 29;
    public static final int FLD_DIREKSI_APPROVAL = 30;
    public static final int FLD_REP_APPROVAL_1 = 31;
    public static final int FLD_REP_APPROVAL_2 = 32;
    public static final int FLD_REP_APPROVAL_3 = 33;
    public static final int FLD_REP_APPROVAL_4 = 34;
    public static final int FLD_REP_APPROVAL_5 = 35;
    public static final int FLD_REP_APPROVAL_6 = 36;
	public static final int FLD_PAY_SLIP_ID = 37;
        public static final int FLD_EMP_DOC_ID = 38;
    ...
    public static final int FLD_STATUS_APPlICATION_TO_BE_CANCEL = 5;
    public static final int FLD_STATUS_APPLICATION_DECLINED = 6;
    ...
    public static final int FLD_TYPE_LEAVE_CATEGORY_SPECIAL = 0;
    public static final int FLD_TYPE_LEAVE_CATEGORY_MATERNITY = 1;
    public static final int FLD_TYPE_LEAVE_CATEGORY_REGULAR = 2;
    public static final int FLD_TYPE_LEAVE_CATEGORY_ANNUAL = 3;
    public static final int FLD_TYPE_LEAVE_CATEGORY_LONG = 4;
    public static final String[] fieldTypeLeaveCategory = {
        "Cuti Khusus",
        "Cuti Hamil",
        "Cuti Penting",
        "Cuti Tahunan",
    ...
    public static LeaveApplication fetchExc(long oid) throws DBException {
        try {
            ...
            objLeaveApplication.setTypeLeaveCategory(objPstLeaveApplication.getInt(FLD_TYPE_LEAVE_CATEGORY));
            objLeaveApplication.setDireksiApproval(objPstLeaveApplication.getInt(FLD_DIREKSI_APPROVAL));
            objLeaveApplication.setRep_approval_1(objPstLeaveApplication.getLong(FLD_REP_APPROVAL_1));
            objLeaveApplication.setRep_approval_2(objPstLeaveApplication.getLong(FLD_REP_APPROVAL_2));
            objLeaveApplication.setRep_approval_3(objPstLeaveApplication.getLong(FLD_REP_APPROVAL_3));
            objLeaveApplication.setRep_approval_4(objPstLeaveApplication.getLong(FLD_REP_APPROVAL_4));
            objLeaveApplication.setRep_approval_5(objPstLeaveApplication.getLong(FLD_REP_APPROVAL_5));
            objLeaveApplication.setRep_approval_6(objPstLeaveApplication.getLong(FLD_REP_APPROVAL_6));
            objLeaveApplication.setPaySlipId(objPstLeaveApplication.getLong(FLD_PAY_SLIP_ID));
            objLeaveApplication.setEmpDocId(objPstLeaveApplication.getLong(FLD_EMP_DOC_ID));
    ...
    public static long updateExc(LeaveApplication objLeaveApplication) throws DBException {
        try {
            if (objLeaveApplication.getOID() != 0) {
                ...
                objPstLeaveApplication.setInt(FLD_TYPE_LEAVE_CATEGORY, objLeaveApplication.getTypeLeaveCategory());
                objPstLeaveApplication.setInt(FLD_DIREKSI_APPROVAL, objLeaveApplication.getDireksiApproval());
                objPstLeaveApplication.setLong(FLD_REP_APPROVAL_1, objLeaveApplication.getRep_approval_1());
                objPstLeaveApplication.setLong(FLD_REP_APPROVAL_2, objLeaveApplication.getRep_approval_2());
                objPstLeaveApplication.setLong(FLD_REP_APPROVAL_3, objLeaveApplication.getRep_approval_3());
                objPstLeaveApplication.setLong(FLD_REP_APPROVAL_4, objLeaveApplication.getRep_approval_4());
                objPstLeaveApplication.setLong(FLD_REP_APPROVAL_5, objLeaveApplication.getRep_approval_5());
                objPstLeaveApplication.setLong(FLD_REP_APPROVAL_6, objLeaveApplication.getRep_approval_6());
                objPstLeaveApplication.setLong(FLD_PAY_SLIP_ID, objLeaveApplication.getPaySlipId());
                objPstLeaveApplication.setLong(FLD_EMP_DOC_ID, objLeaveApplication.getEmpDocId());
    ...
    public static Vector listJoin(int limitStart, int recordToGet, String whereClause, String order) {
        ...
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT lv.* FROM `hr_leave_application` AS lv LEFT JOIN hr_emp_doc doc ON lv.`LEAVE_APPLICATION_ID` = doc.LEAVE_APPLICATION_ID "
                    ...
                    + "INNER JOIN `hr_employee` AS emp ON emp.`EMPLOYEE_ID` = lv.`EMPLOYEE_ID` ";;
            if (whereClause != null && whereClause.length() > 0) {
                sql = sql + " WHERE " + whereClause;
            }
            if (order != null && order.length() > 0) {
        ...
        try {
            if (dateFromLeave != null && dateToLeave != null) {
                String sql = " SELECT * FROM (SELECT AL." + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] + " AS TK "
                        ...
                        + " ,LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_TYPE_LEAVE_CATEGORY] + " "
                        ...
                        + " OR ( DP."+ PstDpStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateToLeave, "yyyy-MM-dd 00:00:00") + "\""
                        + " AND \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 23:00:00") + "\" )"
                        ...
                        + " OR ( LL."+ PstLlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateToLeave, "yyyy-MM-dd 00:00:00") + "\""
                        + " AND \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 23:00:00") + "\" )"
                        + ")"
                ...
                while (rs.next()) {
                    ...
                    obj.setTypeLeaveCategory(rs.getInt(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_TYPE_LEAVE_CATEGORY]));
    ...
    public static Vector listOid(long employeeId, Date dateLeave) {
        ...
        try {
            ...
            String sql = " SELECT * FROM (SELECT AL." + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] + " AS TK "
                    ...
                    //update by satrya 2013-03-01
                    + "("
                    + "(\"" + Formater.formatDate(dateLeave, "yyyy-MM-dd HH:mm:ss") + "\" > AL."
                    + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] + " AND AL."
                    + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_FINNISH_DATE] + " > \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd HH:mm:ss") + "\" ) "
                    + " OR ( AL."+ PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd 00:00:00") + "\""
                    + " AND \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd 23:00:00") + "\" )"
                    + ")"
                    + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = \"" + employeeId + "\" "
                    + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " != " + PstLeaveApplication.FLD_STATUS_APPlICATION_CANCELED
                    + " UNION SELECT DP." + PstDpStockTaken.fieldNames[PstDpStockTaken.FLD_TAKEN_DATE] + "  AS TK "
                    ...
                    + "("
                    + "(\"" + Formater.formatDate(dateLeave, "yyyy-MM-dd HH:mm:ss") + "\" > DP."
                    + PstDpStockTaken.fieldNames[PstDpStockTaken.FLD_TAKEN_DATE] + " AND DP." + PstDpStockTaken.fieldNames[PstDpStockTaken.FLD_TAKEN_FINNISH_DATE] + " > \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd HH:mm:ss") + "\")"
                    + " OR ( DP."+ PstDpStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd 00:00:00") + "\""
                    + " AND \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd 23:00:00") + "\" )"
                    + ")"
                    + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = \"" + employeeId + "\" "
                    + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " != " + PstLeaveApplication.FLD_STATUS_APPlICATION_CANCELED
                    ...
                    //update by satrya 2013-03-01
                    + "("
                    + "( \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd HH:mm:ss") + "\" > LL."
                    + PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_TAKEN_DATE] + " AND LL." + PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_TAKEN_FINNISH_DATE] + " > \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd HH:mm:ss") + "\")"
                    + " OR ( LL."+ PstLlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd 00:00:00") + "\""
                    + " AND \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd 23:00:00") + "\" )"
                    + ")"
                    + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = \"" + employeeId + "\" "
                    + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " != " + PstLeaveApplication.FLD_STATUS_APPlICATION_CANCELED
                    ...
                    + PstSpecialUnpaidLeaveTaken.fieldNames[PstSpecialUnpaidLeaveTaken.FLD_SCHEDULED_ID] + " = SYM." + PstScheduleSymbol.fieldNames[PstScheduleSymbol.FLD_SCHEDULE_ID]
                    + " WHERE "
                    //update by priska 2016-07-028
                    + " ((\"" + Formater.formatDate(dateLeave, "yyyy-MM-dd 00:00:00") + "\" > SU."
                    ...
                    + " OR ( SU."+ PstSpecialUnpaidLeaveTaken.fieldNames[PstSpecialUnpaidLeaveTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd 00:00:00") + "\""
                    + " AND \"" + Formater.formatDate(dateLeave, "yyyy-MM-dd 23:00:00") + "\" )"
                    + " )"
                    + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = \"" + employeeId + "\" "
                    + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " != " + PstLeaveApplication.FLD_STATUS_APPlICATION_CANCELED + ") AS T GROUP BY T.LEAVE_SYMBOL";
     ...
     */
    public static int getLeaveFormStatus(long employeeId, Date dateFromLeave, Date dateToLeave, long schedule) {
        //Vector lists = new Vector();
        int leaveFormStatus = -1;
        int countOff = Integer.valueOf(PstSystemProperty.getValueByName("DONT_COUNT_OFF_AS_LEAVE"));
        long off = Long.valueOf(PstSystemProperty.getValueByName("OID_DAY_OFF"));
        long ph = Long.valueOf(PstSystemProperty.getValueByName("OID_PUBLIC_HOLIDAY"));
        DBResultSet dbrs = null;
        try {
            if (dateFromLeave != null && dateToLeave != null) {
                String sql = "SELECT LA." + PstLeaveApplication.fieldNames[FLD_DOC_STATUS]+","
						+ " LA."+ PstLeaveApplication.fieldNames[FLD_TYPE_LEAVE_CATEGORY]+","
						+ " 0 "
                        + " FROM " + PstLeaveApplication.TBL_LEAVE_APPLICATION + " AS LA "
                        + " INNER JOIN  " + PstAlStockTaken.TBL_HR_AL_STOCK_TAKEN + " AS AL  "
                        + "ON ( AL." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID]
                        ...
                        //update by priska 2016-06-13
                        
                        + "("
                        + "(\"" + Formater.formatDate(dateToLeave, "yyyy-MM-dd 00:00:00") + "\" >= AL."
                        + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] + " AND AL."
                        + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_FINNISH_DATE] + " >= \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 00:00:00") + "\" ) "
                        + " OR ( AL."+ PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateToLeave, "yyyy-MM-dd 00:00:00") + "\""
                        + " AND \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 23:59:00") + "\" )"
                        + ")"
                        ...
                        + "("
                        + "(\"" + Formater.formatDate(dateToLeave, "yyyy-MM-dd 00:00:00") + "\" >= DP."
                        + PstDpStockTaken.fieldNames[PstDpStockTaken.FLD_TAKEN_DATE] + " AND DP." + PstDpStockTaken.fieldNames[PstDpStockTaken.FLD_TAKEN_FINNISH_DATE] + " >= \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 00:00:00") + "\")"
                        + " OR ( DP."+ PstDpStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateToLeave, "yyyy-MM-dd 00:00:00") + "\""
                        + " AND \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 23:59:00") + "\" )"
                        + ")"
                        + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = \"" + employeeId + "\" "
                        ...
                        //update by priska 2016-06-13
                        + "("
                        + "( \"" + Formater.formatDate(dateToLeave, "yyyy-MM-dd 00:00:00") + "\" >= LL."
                        + PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_TAKEN_DATE] + " AND LL." + PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_TAKEN_FINNISH_DATE] + " >= \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 00:00:00") + "\")"
                        + " OR ( LL."+ PstLlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateToLeave, "yyyy-MM-dd 00:00:00") + "\""
                        + " AND \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 23:59:00") + "\" )"
                        + ")"
                        + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = \"" + employeeId + "\" "
                        ...
                        + " UNION SELECT LA." + PstLeaveApplication.fieldNames[FLD_DOC_STATUS]+","
						+ " LA."+ PstLeaveApplication.fieldNames[FLD_TYPE_LEAVE_CATEGORY]+","
						+ " SU. "+PstSpecialUnpaidLeaveTaken.fieldNames[PstSpecialUnpaidLeaveTaken.FLD_SCHEDULED_ID]
                        + " FROM " + PstLeaveApplication.TBL_LEAVE_APPLICATION + " AS LA "
                        + " INNER JOIN " + PstSpecialUnpaidLeaveTaken.TBL_SPECIAL_UNPAID_LEAVE_TAKEN + " AS SU ON (LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID]
                        + "= SU." + PstSpecialUnpaidLeaveTaken.fieldNames[PstSpecialUnpaidLeaveTaken.FLD_LEAVE_APLICATION_ID] + ")"
...
//                       priska 20160613 
                        ...
                        + PstSpecialUnpaidLeaveTaken.fieldNames[PstSpecialUnpaidLeaveTaken.FLD_TAKEN_DATE] + " AND SU." + PstSpecialUnpaidLeaveTaken.fieldNames[PstSpecialUnpaidLeaveTaken.FLD_TAKEN_FINNISH_DATE] + " >= \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 00:00:00") + "\" ) "
                        + " OR ( SU."+ PstSpecialUnpaidLeaveTaken.fieldNames[PstSpecialUnpaidLeaveTaken.FLD_TAKEN_DATE] +" BETWEEN \"" + Formater.formatDate(dateToLeave, "yyyy-MM-dd 00:00:00") + "\""
                        + " AND \"" + Formater.formatDate(dateFromLeave, "yyyy-MM-dd 00:00:00") + "\" )"
                        + " )"
                        + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = \"" + employeeId + "\" "
                        + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " != " + PstLeaveApplication.FLD_STATUS_APPlICATION_CANCELED;
                ...
                while (rs.next()) {
					long oidSchedule = rs.getLong(3);
					int typeLeaveCategory = rs.getInt(PstLeaveApplication.fieldNames[FLD_TYPE_LEAVE_CATEGORY]);
					if (typeLeaveCategory == 0){
						if (oidSchedule > 0){
							try {
								ScheduleSymbol symbol = PstScheduleSymbol.fetchExc(oidSchedule);
								if (schedule == off || schedule == ph){
									if (symbol.getShowPresent() == 1){
					...
					} else if (typeLeaveCategory == 4 || typeLeaveCategory == 1){
                                                leaveFormStatus = rs.getInt(PstLeaveApplication.fieldNames[FLD_DOC_STATUS]);
						if (leaveFormStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT || leaveFormStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_TO_BE_APPROVE|| leaveFormStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_APPROVED) {
								return leaveFormStatus;                                
						}
    ...
    public static long getOIDLeave(long employeeId, Date dateFromLeave, Date dateToLeave) {
        //Vector lists = new Vector();
        long oid = 0;
        DBResultSet dbrs = null;
        try {
            if (dateFromLeave != null && dateToLeave != null) {
                String sql = "SELECT LA." + PstLeaveApplication.fieldNames[FLD_LEAVE_APPLICATION_ID]
                        + " FROM " + PstLeaveApplication.TBL_LEAVE_APPLICATION + " AS LA "
                        + " INNER JOIN  " + PstAlStockTaken.TBL_HR_AL_STOCK_TAKEN + " AS AL  "
                        + "ON ( AL." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID]
                        + " = LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + ")"
                        ...
                        + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = \"" + employeeId + "\" "
                        + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " != " + PstLeaveApplication.FLD_STATUS_APPlICATION_CANCELED
                        + " UNION SELECT LA." + PstLeaveApplication.fieldNames[FLD_LEAVE_APPLICATION_ID]
                        + " FROM " + PstLeaveApplication.TBL_LEAVE_APPLICATION + " AS LA "
                        + " INNER JOIN " + PstDpStockTaken.TBL_HR_DP_STOCK_TAKEN + "  AS DP ON (LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + " = DP." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + ")"
                        /*+ " WHERE \""+ dateLeave +"\" BETWEEN DATE(DP."+PstDpStockTaken.fieldNames[PstDpStockTaken.FLD_TAKEN_DATE]
                         + ") AND DATE(DP."+PstDpStockTaken.fieldNames[PstDpStockTaken.FLD_TAKEN_FINNISH_DATE] 
...
//                       priska 20160613 
                ...
                while (rs.next()) {
                   oid = rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID]);
                }
     ...
     * @return status doc tidak ada maka return -1 (New)
     */
    public static int cekLeaveAppFormStatus(long leaveApp) {
        //Vector lists = new Vector();
        int leaveFormStatus = -1;
        DBResultSet dbrs = null;
        try {
                String sql = "SELECT LA." + PstLeaveApplication.fieldNames[FLD_DOC_STATUS]
                        ...
                        + " = LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + ")"
                        + " WHERE "
                        + " LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + " = " + leaveApp 
                        + " AND LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " = " + PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT
                        + " UNION SELECT LA." + PstLeaveApplication.fieldNames[FLD_DOC_STATUS]
                        + " FROM " + PstLeaveApplication.TBL_LEAVE_APPLICATION + " AS LA "
                        + " INNER JOIN " + PstDpStockTaken.TBL_HR_DP_STOCK_TAKEN + "  AS DP ON (LA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + " = DP." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + ")"
                        + " WHERE "
                ...
                while (rs.next()) {
                    leaveFormStatus = rs.getInt(PstLeaveApplication.fieldNames[FLD_DOC_STATUS]);
                    if (leaveFormStatus == PstLeaveApplication.FLD_STATUS_APPlICATION_DRAFT) {
                        return leaveFormStatus;
                    }
                }
    ...
    private static void resultToObject(ResultSet rs, LeaveApplication objLeaveApplication) {
        try {
            ...
            objLeaveApplication.setAlAllowance(rs.getInt(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_AL_ALLOWANCE]));
            objLeaveApplication.setLlAllowance(rs.getInt(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LL_ALLOWANCE]));
            ...
            objLeaveApplication.setTypeLeaveCategory(rs.getInt(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_TYPE_LEAVE_CATEGORY]));
            objLeaveApplication.setDireksiApproval(rs.getInt(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DIREKSI_APPROVAL]));
            objLeaveApplication.setRep_approval_1(rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_REP_APPROVAL_1]));
            objLeaveApplication.setRep_approval_2(rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_REP_APPROVAL_2]));
            objLeaveApplication.setRep_approval_3(rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_REP_APPROVAL_3]));
            objLeaveApplication.setRep_approval_4(rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_REP_APPROVAL_4]));
            objLeaveApplication.setRep_approval_5(rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_REP_APPROVAL_5]));
            objLeaveApplication.setRep_approval_6(rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_REP_APPROVAL_6]));
            objLeaveApplication.setPaySlipId(rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_PAY_SLIP_ID]));
            objLeaveApplication.setEmpDocId(rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMP_DOC_ID]));
    ...
    public static int getMaxApp(long employeeId, I_Leave leaveConfig, LeaveApplication leaveApplication ){
        int max = 0;
          Employee employeeObj = new Employee();
            ...
            Vector listAlStockTaken = new Vector();
            String whereClause = PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_LEAVE_APPLICATION_ID] + " = " + leaveApplication.getOID();
            listAlStockTaken = PstAlStockTaken.list(0, 0, whereClause , "");
            int qty = 0;
            for (int i = 0 ; i < listAlStockTaken.size() ; i ++){
                AlStockTaken alStockTaken = (AlStockTaken)listAlStockTaken.get(i);
                qty = qty + Math.round(alStockTaken.getTakenQty());
            }
            ...
            int leaveType = leaveApplication.getTypeLeaveCategory();
            long employee = leaveApplication.getEmployeeId();
            ...
            try {
                ...
                oidLevel = com.dimata.system.entity.PstSystemProperty.getValueByName("OID_LEVEL_APPROVAL_DIREKSI");
            } catch (Exception exc){
                oidDireksi = 0;
                oidLevel = "0";
            }

            String[] array = oidLevel.split("\\,");
            Level lv = new Level();
            String status = "";
            
            if (leaveApplication.getDireksiApproval() == 1){
                status = "direksi approval";
            }
            
            for (int i = 0; i < array.length ; i++){
                if (employeeObj.getLevelId() == Long.parseLong(array[i]) ){
                    status = "direksi approval";
                }
            }
            
            if (status.equals("") && leaveType == 2 && qty > 2){
                status = "direksi approval";
            }
            
            for (int xx = minLevel; xx<=maxLevel; xx++ ){
            Vector listEmpCheck = new Vector();
            int approval = 0;
                    for (int nn = minLevel; nn <= maxLevel; nn++){
                        listEmpCheck = leaveConfig.getApprovalEmployeeTopLinkByLevel(oidEmpDinamis, 3, nn,status );
                        if (listEmpCheck.size() > 0){
                            approval = approval + 1;
                        }
                    } 
            Vector listEmpApproval = new Vector();    
            if (approval > 0){
                listEmpApproval = leaveConfig.getApprovalEmployeeTopLinkByLevel(oidEmpDinamis, 3, xx,status );
            } else {
                listEmpApproval = leaveConfig.getApprovalEmployeeTopLinkByLevelDivision(oidEmpDinamis, 3, xx,status );
            }
                if (listEmpApproval.size()>0){
                    if (PstLeaveApplication.getApproveOidByApprovalIndex(leaveApplication, incIndexApp) != 0){
                        ...
                        Employee objEmp = (Employee) listEmpApproval.get(0);
                        if (oidEmpDinamis != objEmp.getOID()){
                            oidEmpDinamis = objEmp.getOID();
                        }
                    }
                    max++;
                    incIndexApp++;
    ...
    public static Date getMaxDateFromLeave(long leaveAppId) {
        DBResultSet dbrs = null;
        Date date = null;
        try {
            String sql = " SELECT MAX(maxdate)FROM "
                    + " ( "
                    + " SELECT MAX(`TAKEN_FINNISH_DATE`) AS maxdate  FROM `hr_al_stock_taken` WHERE `LEAVE_APPLICATION_ID` = "+leaveAppId+" "
                    + " UNION "
                    + " SELECT MAX(`TAKEN_FINNISH_DATE`) AS maxdate FROM `hr_ll_stock_taken`   WHERE `LEAVE_APPLICATION_ID` = "+leaveAppId+" "
                    + " UNION "
                    + " SELECT MAX(`TAKEN_FINNISH_DATE`) AS maxdate FROM `hr_special_unpaid_leave_taken` WHERE `LEAVE_APPLICATION_ID` = "+leaveAppId+" "
                    + " UNION "
                    + " SELECT MAX(`TAKEN_FINNISH_DATE`) AS maxdate FROM `hr_dp_stock_taken` WHERE `LEAVE_APPLICATION_ID` = "+leaveAppId+" "
                    + " ) AS ma ";
...
//            System.out.println("vSynchLeaveAppDetailData.size() : " + vSynchLeaveAppDetailData.size());
    ...
    public static Hashtable<String, LeaveApplication> listEmployeeLeave(int limitStart, int recordToGet, String whereClause, String order){
        Hashtable<String, LeaveApplication> lists = new Hashtable();
        DBResultSet dbrs = null;
        try{
            String sql = " SELECT TLA.* FROM " + TBL_LEAVE_APPLICATION + " as TLA"
                    + " INNER JOIN " + PstEmployee.TBL_HR_EMPLOYEE + " as EMP"
                    + " on TLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + "="
            ...
            while (rs.next()) {
                ...
                resultToObject(rs, la);
                 lists.put(""+la.getEmployeeId(), la);
            }
            rs.close();
            return lists;
        } catch (Exception e) {
    ...
    /* leave application inner join hr employee */
    public static Vector listLeaveAppEmp(String whereAdd) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT hr_leave_application.LEAVE_APPLICATION_ID, " +
            "hr_leave_application.TYPE_LEAVE_CATEGORY, " +
            "hr_leave_application.LEAVE_REASON, " +
            "hr_employee.EMPLOYEE_NUM, " +
            "hr_employee.FULL_NAME, " +
            "hr_leave_application.SUBMISSION_DATE, "+
            "hr_employee.EMPLOYEE_ID, " +
            "hr_leave_application.APPROVAL_1, "+
            "hr_leave_application.APPROVAL_2, "+
            "hr_leave_application.APPROVAL_3, "+
            "hr_leave_application.APPROVAL_4, "+
            "hr_leave_application.APPROVAL_5, "+
            "hr_leave_application.APPROVAL_6 "+
            "FROM " + TBL_LEAVE_APPLICATION+ " "+
            "INNER JOIN hr_employee ON hr_employee.EMPLOYEE_ID=hr_leave_application.EMPLOYEE_ID "+
            "left JOIN hr_special_unpaid_leave_taken on `hr_leave_application`.`LEAVE_APPLICATION_ID` = hr_special_unpaid_leave_taken.`LEAVE_APPLICATION_ID` "+
            "left join `hr_al_stock_taken` al on al.`LEAVE_APPLICATION_ID` = `hr_leave_application`.`LEAVE_APPLICATION_ID` "+
            "left join `hr_ll_stock_taken` ll on ll.`LEAVE_APPLICATION_ID` = `hr_leave_application`.`LEAVE_APPLICATION_ID` "+
            "WHERE hr_leave_application.DOC_STATUS="+FLD_STATUS_APPlICATION_TO_BE_APPROVE+" "
                + " AND ("
                    + " al.`TAKEN_DATE` > DATE_ADD(CURDATE(), INTERVAL - 30 DAY)"
                    + " OR `hr_special_unpaid_leave_taken`.`TAKEN_DATE` > DATE_ADD(CURDATE(), INTERVAL - 30 DAY) "
                    + " OR ll.`TAKEN_DATE` > DATE_ADD(CURDATE(), INTERVAL - 30 DAY)"
                    + " OR `hr_leave_application`.`SUBMISSION_DATE` > DATE_ADD(CURDATE(), INTERVAL -30 DAY)) ";
            if (whereAdd.length()>0){
                sql += " AND "+whereAdd+" ";
            }
            sql += "ORDER BY hr_leave_application.SUBMISSION_DATE DESC";

            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                String [] data = new String[13];
                data[0] = ""+rs.getLong(PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID]);
                data[1] = ""+rs.getInt("TYPE_LEAVE_CATEGORY");
                data[2] = ""+rs.getString("LEAVE_REASON");
                data[3] = ""+rs.getString("EMPLOYEE_NUM");
                data[4] = ""+rs.getString("FULL_NAME");
                data[5] = ""+rs.getString("SUBMISSION_DATE");
                data[6] = ""+rs.getString("EMPLOYEE_ID");

                data[7] = ""+rs.getString("APPROVAL_1");
                data[8] = ""+rs.getString("APPROVAL_2");
                data[9] = ""+rs.getString("APPROVAL_3");
                data[10] = ""+rs.getString("APPROVAL_4");
                data[11] = ""+rs.getString("APPROVAL_5");
                data[12] = ""+rs.getString("APPROVAL_6");
...
/* leave application inner join hr employee */
    public static Vector listLeaveAppEmpCancel(String whereAdd) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT hr_leave_application.LEAVE_APPLICATION_ID, " +
            ...
            "FROM " + TBL_LEAVE_APPLICATION+ " "+
            "INNER JOIN hr_employee ON hr_employee.EMPLOYEE_ID=hr_leave_application.EMPLOYEE_ID "+
            "WHERE hr_leave_application.DOC_STATUS="+FLD_STATUS_APPlICATION_TO_BE_CANCEL+" ";
            if (whereAdd.length()>0){
                sql += " AND "+whereAdd+" ";
            }
            sql += "ORDER BY hr_leave_application.SUBMISSION_DATE DESC";
 ...
 +                 " BETWEEN START_DATE AND END_DATE "
    ...
    public static String getUpPositionIdReplacement(String positionId, long divisionId) {
        String upPositionId = "";
        if (positionId.length()==0){
            return "";
        }
 ...
 +                 " BETWEEN START_DATE AND END_DATE "
    ...
    public static int getToBeCancelNotif(long employeeId){
        int count = 0;
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT * FROM `hr_leave_application` ";
            sql += " WHERE (`APPROVAL_1` =  " + employeeId ;
            sql += " OR `APPROVAL_2` = "+ employeeId;
            sql += " OR `APPROVAL_3` = "+ employeeId;
            sql += " OR `APPROVAL_4` = "+ employeeId;
            sql += " OR `APPROVAL_5` = "+ employeeId;
            sql += " OR `APPROVAL_6` = "+ employeeId+") AND DOC_STATUS = 5";
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                long app1 = 0;
                ...
                app1 = rs.getLong("APPROVAL_1");
                app2 = rs.getLong("APPROVAL_2");
                app3 = rs.getLong("APPROVAL_3");
                app4 = rs.getLong("APPROVAL_4");
                app5 = rs.getLong("APPROVAL_5");
                app6 = rs.getLong("APPROVAL_6");
    ...
    public static int getLeaveNotification(long userLoggin, long divisionId, String whereAdd){
        int count = 0;
        Vector leaveAppList = listLeaveAppEmp(whereAdd);
        ...
        if (empId != 0){
            ...
            if(lvlEmp < maxApproval){
                ...
                if (listEmployeeDivisionTopLink.size() > 0){
                    for (int i=0; i < listEmployeeDivisionTopLink.size(); i++){
                        ...
                        if (empApprovalStatus == 1){
                            ...
                            if (listEmpReplacement.size() > 0){
                                ...
                                nilai = getApproval(emp.getOID(), userLoggin, divisionId, maxApproval, needHrApproval, empDivisionId);
                                break;
                            }
                        }
                        if (emp.getOID() != userLoggin){
                    ...
                    String upPosIdReplacement = getUpPositionIdReplacement(upPosId,empDivisionId);
                    ...
                    employeeId = getEmpIdByPositionId(upPosId, divisionId);
                    if (listEmployeeDivisionTopLink.size() > 0){
                        for (int i=0; i < listEmployeeDivisionTopLink.size(); i++){
                            Employee emp = (Employee) listEmployeeDivisionTopLink.get(i);
                            int empApprovalStatus = leaveConfig.getApprovalEmployeeLeaveStatus(emp.getOID());
    ...
    public static String getToBeCancelNotifFilter(long employeeId){
        String str = "";
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT * FROM `hr_leave_application` ";
            ...
            while (rs.next()) {
                ...
                if (app6 != 0){
                    if (app6 == employeeId){
                        String nilai = rs.getString("LEAVE_APPLICATION_ID");
                        if (!nilai.equals("0")){ 
                            str = str + nilai + ",";
                        }
                    }
    ...
    public static String getLeaveFilter(long userLoggin, long divisionId){
        String str = "";
        Vector leaveAppList = listLeaveAppEmp("");
        Employee emp = new Employee();
        int maxApproval = 0;
        boolean needHrApproval = false;
        String [] oidLevelDontNeedHrApproval = PstSystemProperty.getValueByNameWithStringNull("OID_LEVEL_DIDNT_NEED_SDM").split(",");
        if (leaveAppList != null && leaveAppList.size()>0){
            for (int i=0; i<leaveAppList.size(); i++){
                ...
                String nilai = getLeaveAppIdByApproval(oidEmp, userLoggin, divisionId, data[0], maxApproval, needHrApproval, emp.getDivisionId());
    ...
    public static String getLeaveAppIdByApproval(long empId, long userLoggin, long divisionId, String leaveId, int maxApproval, boolean needHrApproval, long empDivisionId){
        String nilai = "";
        Vector listEmployeeDivisionTopLink = new Vector();
        long oidDireksi = 0;
        long oidKomisaris = 0;
                    ...
                    for (int i =0; i < listEmployeeDivisionTopLink.size(); i++){
                        ...
                        if (empApprovalStatus == 1){
                            ...
                            if (listEmpReplacement.size() > 0){
                                ...
                                nilai = getLeaveAppIdByApproval(emp.getOID(), userLoggin, divisionId, leaveId, maxApproval, needHrApproval, empDivisionId);
                                break;
                            }
                        }
                        if (emp.getOID() != userLoggin){
    ...
    public static Vector listApproved(String whereClause) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT lv.* FROM " + TBL_LEAVE_APPLICATION +" AS lv ";
                    
//                    if (divisionId != 0){
//                        sql += " LEFT JOIN "+PstEmployee.TBL_HR_EMPLOYEE+" AS emp"
//                            + " ON lv."+PstLeaveApplication.fieldNames[FLD_EMPLOYEE_ID]+" = emp."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID];
//                    }
                    
                sql += " LEFT JOIN "+PstAlStockTaken.TBL_HR_AL_STOCK_TAKEN +" AS al "
                    + " ON lv."+fieldNames[FLD_LEAVE_APPLICATION_ID]+" = al."+PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_LEAVE_APPLICATION_ID]
                    + " LEFT JOIN "+PstLlStockTaken.TBL_HR_LL_STOCK_TAKEN +" AS ll "
                    + " ON lv."+fieldNames[FLD_LEAVE_APPLICATION_ID]+" = ll."+PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_LEAVE_APPLICATION_ID]
                    + " LEFT JOIN "+PstSpecialUnpaidLeaveTaken.TBL_SPECIAL_UNPAID_LEAVE_TAKEN +" AS sl "
                    + " ON lv."+fieldNames[FLD_LEAVE_APPLICATION_ID]+" = sl."+PstSpecialUnpaidLeaveTaken.fieldNames[PstSpecialUnpaidLeaveTaken.FLD_LEAVE_APLICATION_ID]
                    + " INNER JOIN "+PstEmployee.TBL_HR_EMPLOYEE+ " AS emp "
                    + " ON lv."+fieldNames[FLD_EMPLOYEE_ID]+" = emp."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID]    
                    + " WHERE ((sl."+PstSpecialUnpaidLeaveTaken.fieldNames[PstSpecialUnpaidLeaveTaken.FLD_TAKEN_DATE]+" <= NOW() )"
                    + " OR (al."+PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE]+" <= NOW())"
                    + " OR (ll."+PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_TAKEN_DATE]+" <= NOW())) ";
                    if (!whereClause.equals("")){
                        sql += " AND "+whereClause;
                    }
                sql +=  " ORDER BY lv.`SUBMISSION_DATE` DESC";
    ...
    public static boolean checkNeedHrApproval(long divisionId){
        boolean status = false;
        
        long divTypeHrdApproval = Long.parseLong(String.valueOf(PstSystemProperty.getPropertyLongbyName("OID_DIVISION_TYPE_HR_APPROVAL")));
        long sdmDivisionId = Long.parseLong(String.valueOf(PstSystemProperty.getPropertyLongbyName("OID_SDM_DIVISION")));
        ...
        if (divTypeHrdApproval == div.getDivisionTypeId() && divisionId != sdmDivisionId){
            status = true;
        }
    ...
    public static Vector listAnnualOrLongLeaveNoDoc(int tahun){
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT lv.*, emp.* FROM `hr_leave_application` lv "
                    + "LEFT JOIN `hr_emp_doc` doc "
                    + "ON lv.`LEAVE_APPLICATION_ID` = doc.`LEAVE_APPLICATION_ID` "
                    + "INNER JOIN hr_employee emp "
                    + "ON lv.EMPLOYEE_ID = emp.EMPLOYEE_ID "
                    + "WHERE `TYPE_LEAVE_CATEGORY` IN (1,3,4) AND doc.`LEAVE_APPLICATION_ID` IS NULL AND lv.doc_status IN (2,3) "
                    + "AND lv.SUBMISSION_DATE LIKE '%"+tahun+"%' AND lv.EMP_DOC_ID = 0";
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                Vector temp = new Vector();
                LeaveApplication leaveApplication = new LeaveApplication();
                resultToObject(rs, leaveApplication);
                temp.add(leaveApplication);
