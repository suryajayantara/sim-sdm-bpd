...
public interface I_Leave{
    ...
    public Vector getApprovalEmployeeTopLink(long employee_id, int typeOfLink);
            ...
            //priska menambahkan leave approval top link 20150807
    public Vector getApprovalEmployeeTopLinkByLevel(long employee_id, int typeOfLink,int levelPoint, String status);
    ...
    public Vector getApprovalEmployeeTopLinkByLevelDivision(long employee_id, int typeOfLink,int levelPoint, String status);
