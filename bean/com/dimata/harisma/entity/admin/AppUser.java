...
public class AppUser extends Entity {
    ...
    private int allDivisionAccess = 0;
    ...
    /**
     * @return the allDivisionAccess
     */
    public int getAllDivisionAccess() {
        return allDivisionAccess;
    }

    /**
     * @param allDivisionAccess the allDivisionAccess to set
     */
    public void setAllDivisionAccess(int allDivisionAccess) {
        this.allDivisionAccess = allDivisionAccess;
    }
}
