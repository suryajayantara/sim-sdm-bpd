...
public class AppObjInfo {
    ...
    public static final int COMMAND_VIEW_ALL_DIVISION = 11;
    public static final int COMMAND_VIEW_DIVISION_GROUP = 12;
    public static final int COMMAND_VIEW_ONLY_WITH_SEARCH = 13;
    public static final String[] strCommand = {
        ...
        "View All", "View Division Group", "View Only With Search"
    };
    ...
    public static final int G1_EMPLOYEE = 1;
        ...
        public static final int G2_LEAVE_APPLICATION = 8;
            ...
            public static final int OBJ_HISTORY_LEAVE_EMPLOYEE = 7;
    ...
    public static final int G1_REPORTS = 5;
        ...
        public static final int G2_PAYROLL_REPORT = 18;
            ...
            /* Update by Gunadi */
            public static final int OBJ_MEAL_ALLOWANCE_RPT = 11;
            public static final int OBJ_SPJ_REPORT = 12;
            public static final int OBJ_PERIODICAL_COMP_REPORT = 13;
    ...
    public static final int G1_MASTERDATA = 6;
        public static final int G2_MD_COMPANY = 0;
            ...
            public static final int OBJ_EMPLOYEE_AMOUNT = 11;
    ...
    public static final int G1_MENU_EMPLOYEE = 11;
        public static final int G2_MENU_DATABANK = 0;
            ...
            public static final int OBJ_MENU_MY_PROFILE = 1;
    ...
    public static final int G1_MENU_REPORTS = 12;
        ...
        public static final int G2_MENU_LEAVE_REPORT = 8;
            ...
            public static final int OBJ_MENU_LEAVE_REPORT = 6;
            public static final int OBJ_MENU_REKAP_CUTI = 7;
        ...
        public static final int G2_MENU_PAYROLL_REPORT = 12;
            ...
            public static final int OBJ_MENU_OVERTIME_RPT = 1;
        public static final int G2_REPORT_MENU = 13;
            public static final int OBJ_REPORT_MENU = 0;
        public static final int G2_MENU_SPECIFIC_REPORT = 14;
            public static final int OBJ_MENU_FAMILY_REPORT = 0;
            public static final int OBJ_MENU_LKPBU_801_REPORT = 1;
            public static final int OBJ_MENU_LKPBU_802_REPORT = 2;
            public static final int OBJ_MENU_LKPBU_803_REPORT = 3;
            public static final int OBJ_MENU_LKPBU_804_REPORT = 4;
            public static final int OBJ_MENU_LKPBU_805_REPORT = 5;
            public static final int OBJ_MENU_LKPBU_806_REPORT = 6;
    ...
    public static final int G1_MENU_ORGANISASI = 24;
        ...
        public static final int G2_MENU_EMPLOYEE_AMOUNT = 7;
            public static final int OBJ_MENU_EMPLOYEE_AMOUNT = 0;
    ...
    /* MENU HEADER HORISONTAL */  
    /* [26] MENU CANDIDATE */
    public static final int G1_MENU_CANDIDATE = 26;
    /* [27] MENU COMPETENCY */
    public static final int G1_MENU_COMPETENCY = 27;
        public static final int G2_MENU_COMPETENCY_TYPE = 0;
            public static final int OBJ_MENU_COMPETENCY_TYPE = 0;
        public static final int G2_MENU_COMPETENCY_GROUP = 1;
            public static final int OBJ_MENU_COMPETENCY_GROUP = 0;
        public static final int G2_MENU_TALENT_POOL = 2;
            public static final int OBJ_MENU_TALENT_POOL = 0;
        public static final int G2_MENU_COMPETENCY = 3;
            public static final int OBJ_MENU_COMPETENCY = 0;
        public static final int G2_MENU_DETAIL_COMPETENCY = 4;
            public static final int OBJ_MENU_DETAIL_COMPETENCY = 0;
        public static final int G2_MENU_LEVEL_COMPETENCY = 5;
            public static final int OBJ_MENU_LEVEL_COMPETENCY = 0;
        public static final int G2_MENU_LAPORAN_KOMPETENSI = 6;
            public static final int OBJ_MENU_RPT_GAP_COMPETENCY = 0;
            public static final int OBJ_MENU_RPT_PENCAPAIAN_COMPETENCY = 1;
            public static final int OBJ_MENU_RPT_DAFTAR_COMPETENCY = 2;
    /* [28] MENU PERFORMA */
    public static final int G1_MENU_PERFORMA = 28;
    /* [29] MENU KENERJA */
    public static final int G1_MENU_KINERJA = 29;
    /* [30] MENU DOCUMENT */
    public static final int G1_MENU_DOCUMENT = 30;
    /* [31] MENU ABSENT */
    public static final int G1_MENU_ABSENT = 31;
    /* [32] MENU OVERTIME */
    public static final int G1_MENU_OVERTIME = 32;
    /* [33] MENU LEAVE */
    public static final int G1_MENU_LEAVE = 33;
    /* [34] MENU REPORT */
    public static final int G1_MENU_REPORT = 34;
    /* (35) menu project*/
public static final int G1_MENU_PROJECT = 35;
        public static final int G2_MENU_PRODUCT = 0;
            public static final int OBJ_MENU_ORGANIZE_PRODUCT = 0;
    ...
    public static final String[] titleG1 = {
        ...
        /* [24] */ "MENU ORGANISASI",
        /* [25] */ "DOKUMEN SURAT",
        /* [26] MENU CANDIDATE */ "MENU CANDIDATE",
        /* [27] MENU COMPETENCY */ "MENU COMPETENCY",
        /* [28] MENU PERFORMA */ "MENU PERFORMA",
        /* [29] MENU KENERJA */ "MENU KENERJA",
        /* [30] MENU DOCUMENT */ "MENU DOCUMENT",
        /* [31] MENU ABSENT */ "MENU ABSENT",
        /* [32] MENU OVERTIME */ "MENU OVERTIME",
        /* [33] MENU LEAVE */ "MENU LEAVE",
        /* [34] MENU REPORT */ "MENU REPORT"
    };
    ...
    public static final String[][][] objectTitles = {
        ...
        { // MENU RPT STAFF CONTROL
            ...
            {"MENU LEAVE & DP SUMMARY", "MENU LEAVE & DP DETAIL", "MENU LEAVE & DP SUMMARY PERIOD", "MENU LEAVE & DP DETAIL PERIOD", "MENU SPECIAL & UNPAID PERIOD", "DP EXPIRED", "LEAVE REPORT", "REKAP CUTI"},
            ...
            {"MENU LIST OF SALARY SUMMARY", "MENU OVERTIME REPORT"},
            {"REPORT MENU"},
            {"FAMILY REPORT", "LKPBU 801 REPORT", "LKPBU 802 REPORT", "LKPBU 803 REPORT", "LKPBU 804 REPORT", "LKPBU 805 REPORT", "LKPBU 806 REPORT"}
        },
        /* [13] CANTEEN */
        { // CNT DATA CANTEEN
        ...
        /* [27] MENU COMPETENCY */
        {
            ...
            {
            "RPT GAP COMPETENCE",
            "RPT PENCAPAIAN COMPETENCE",
            "RPT DAFTAR COMPETENCE"
            }
        },
        /* [28] MENU PERFORMA */
        {{"MENU PERFORMA OBJ"}},
    ...
    public static final int[][][][] objectCommands = {
        ...
        { // EMP DATABANK
            { // EMP DATABANK
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE, COMMAND_PRINT, COMMAND_GENERATE_SALARY_LEVEL, COMMAND_VIEW_ALL_DIVISION, COMMAND_VIEW_ONLY_WITH_SEARCH},
                /* "DATABANK PERSONAL DATA", */
            ...
            { // TRAINING HISTORY
                ...
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE, COMMAND_PRINT},
                // TRAINING SEARCH
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE, COMMAND_PRINT, COMMAND_VIEW_ALL_DIVISION},
        ...
        // 5 REPORT
        {
            ...
            // RPT PRESENCE
            {
                ...
                {COMMAND_VIEW, COMMAND_PRINT},
                // DAILY REPORT
                {COMMAND_VIEW, COMMAND_PRINT, COMMAND_VIEW_ALL_DIVISION},
                // WEEKLY REPORT
                {COMMAND_VIEW, COMMAND_PRINT},
                // MONTHLY REPORT
                {COMMAND_VIEW, COMMAND_PRINT},
            ...
            // RPT PAYROLL REPORT
            {
                ...
                /* Update by Gunadi | 2017-08-17 */
                {COMMAND_VIEW, COMMAND_VIEW_ALL_DIVISION, COMMAND_VIEW_DIVISION_GROUP},
                {COMMAND_VIEW, COMMAND_VIEW_ALL_DIVISION, COMMAND_VIEW_DIVISION_GROUP},
                {COMMAND_VIEW, COMMAND_VIEW_ALL_DIVISION, COMMAND_VIEW_DIVISION_GROUP}
            }
        },
        ...
        { // MD COMPANY
            { // DEPARTMENT
                ...
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE},
                {COMMAND_VIEW, COMMAND_VIEW_ALL_DIVISION}
            },
            // MD EMPLOYEE
            { // EDUCATION
                {COMMAND_VIEW, COMMAND_ADD, COMMAND_UPDATE, COMMAND_DELETE},
