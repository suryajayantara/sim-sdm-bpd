...
public class ScheduleSymbol extends Entity { 
	...
	private int minService;
        ...
        private int showOnLeave;
        private int showPresent;
        private int perhitunganUangMakan;
        private double workDuration;
        private int ableToApprove;
    ...
    /**
     * @return the showOnLeave
     */
    public int getShowOnLeave() {
        return showOnLeave;
    }

    /**
     * @param showOnLeave the showOnLeave to set
     */
    public void setShowOnLeave(int showOnLeave) {
        this.showOnLeave = showOnLeave;
    }

    /**
     * @return the showPresent
     */
    ...
    /**
     * @param showPresent the showPresent to set
     */
    public void setShowPresent(int showPresent) {
        this.showPresent = showPresent;
    }

	/**
	 * @return the perhitunganUangMakan
	 */
	public int getPerhitunganUangMakan() {
		return perhitunganUangMakan;
	}

	/**
	 * @param perhitunganUangMakan the perhitunganUangMakan to set
	 */
	public void setPerhitunganUangMakan(int perhitunganUangMakan) {
		this.perhitunganUangMakan = perhitunganUangMakan;
	}
    ...
    /**
     * @param workDuration the workDuration to set
     */
    ...
    /**
     * @return the ableToApprove
     */
    public int getAbleToApprove() {
        return ableToApprove;
    }

    /**
     * @param ableToApprove the ableToApprove to set
     */
    public void setAbleToApprove(int ableToApprove) {
        this.ableToApprove = ableToApprove;
    }
}
