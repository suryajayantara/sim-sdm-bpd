...
public class PstScheduleSymbol extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_REPORT_TYPE = 15;
    public static final int FLD_SHOW_ON_USER_LEAVE = 16;
    public static final int FLD_SHOW_PRESENT_ON_WEEKEND = 17;
	public static final int FLD_PERHITUNGAN_UANG_MAKAN = 18;
        public static final int FLD_WORK_DURATION = 19;
        public static final int FLD_ABLE_TO_APPROVE = 20;
    public static final String[] fieldNames = {
        ...
        "REPORT_TYPE",
        "SHOW_ON_USER_LEAVE",
        "SHOW_PRESENT_ON_WEEKEND",
		"PERHITUNGAN_UANG_MAKAN",
                "WORK_DURATION"
    };
	...
	public static final int UANG_MAKAN_NONE = 0;
	public static final int UANG_MAKAN_BY_TIME = 1;
	public static final int UANG_MAKAN_FULL = 2;
	public static final int UANG_MAKAN_FAKULTATIF = 3;
	public static final int UANG_MAKAN_JAM_MURNI = 4;
        public static final int UANG_MAKAN_NO_REST = 5;
	public static final String[] fieldNamesUangMakan = {
		"Tidak Dihitung",
		"Berdasarkan jam kerja",
		"Full",
		"Fakultatif",
		"Berdasarkan murni jam kerja",
                "Berdasarkan jam kerja tanpa istirahat"
	};
    
    public static final int REPORT_NONE = 0;
    public static final int REPORT_H = 1;
    public static final int REPORT_TB = 2;
    public static final int REPORT_DL = 3;
    public static final int REPORT_CB = 4;
    public static final int REPORT_CT = 5;
    public static final int REPORT_CP = 6;
    public static final int REPORT_CS = 7;
    public static final int REPORT_S = 8;
    public static final int REPORT_CH = 9;
    public static final int REPORT_DET = 10;
    public static final int REPORT_DIS = 11;
    public static final String[] fieldNamesReport = {
        "None",
        "Hadir",
        "Tugas Belajar",
        "Dinas Luar",
    ...
    public static ScheduleSymbol fetchExc(long oid) throws DBException {
        try {
            ...
            schedulesymbol.setReportType(pstScheduleSymbol.getInt(FLD_REPORT_TYPE));
            schedulesymbol.setShowOnLeave(pstScheduleSymbol.getInt(FLD_SHOW_ON_USER_LEAVE));
            schedulesymbol.setShowPresent(pstScheduleSymbol.getInt(FLD_SHOW_PRESENT_ON_WEEKEND));
			schedulesymbol.setPerhitunganUangMakan(pstScheduleSymbol.getInt(FLD_PERHITUNGAN_UANG_MAKAN));
                        schedulesymbol.setWorkDuration(pstScheduleSymbol.getdouble(FLD_WORK_DURATION));
    ...
    public static long insertExc(ScheduleSymbol schedulesymbol) throws DBException {
        try {
            ...
            pstScheduleSymbol.setInt(FLD_REPORT_TYPE, schedulesymbol.getReportType());
            pstScheduleSymbol.setInt(FLD_SHOW_ON_USER_LEAVE, schedulesymbol.getShowOnLeave());
            pstScheduleSymbol.setInt(FLD_SHOW_PRESENT_ON_WEEKEND, schedulesymbol.getShowPresent());
			pstScheduleSymbol.setInt(FLD_PERHITUNGAN_UANG_MAKAN, schedulesymbol.getPerhitunganUangMakan());
                        pstScheduleSymbol.setDouble(FLD_WORK_DURATION, schedulesymbol.getWorkDuration());
...
//                        System.out.println("sql : " + sql);
    ...
    private static void resultToObject(ResultSet rs, ScheduleSymbol schedulesymbol) {
        try {
            ...
            schedulesymbol.setReportType(rs.getInt(PstScheduleSymbol.fieldNames[PstScheduleSymbol.FLD_REPORT_TYPE]));
            schedulesymbol.setShowOnLeave(rs.getInt(PstScheduleSymbol.fieldNames[PstScheduleSymbol.FLD_SHOW_ON_USER_LEAVE]));
            schedulesymbol.setShowPresent(rs.getInt(PstScheduleSymbol.fieldNames[PstScheduleSymbol.FLD_SHOW_PRESENT_ON_WEEKEND]));
			schedulesymbol.setPerhitunganUangMakan(rs.getInt(PstScheduleSymbol.fieldNames[PstScheduleSymbol.FLD_PERHITUNGAN_UANG_MAKAN]));
                        schedulesymbol.setWorkDuration(rs.getInt(PstScheduleSymbol.fieldNames[PstScheduleSymbol.FLD_WORK_DURATION]));
    ...
    public static String listScheduleSymbolbyReportType(int reportType){
        DBResultSet dbrs = null;
        String result = "";
        try {
            String sql = "SELECT " + fieldNames[FLD_SCHEDULE_ID] + " FROM " + TBL_HR_SCHEDULE_SYMBOL + " WHERE " + fieldNames[FLD_REPORT_TYPE]
                    + " = " + reportType;
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
	...
	public static String listScheduleSymbolbyReportTypeIn(String inReportType){
        DBResultSet dbrs = null;
        String result = "";
        try {
            String sql = "SELECT " + fieldNames[FLD_SCHEDULE_ID] + " FROM " + TBL_HR_SCHEDULE_SYMBOL + " WHERE " + fieldNames[FLD_REPORT_TYPE]
