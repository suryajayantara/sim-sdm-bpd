...
public class PstCompetencyType extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_ACCUMULATE_IN_ACHIEVMENT = 3;
    public static String[] fieldNames = {
        "COMPETENCY_TYPE_ID",
        "TYPE_NAME",
        "NOTE",
        "ACCUMULATE_IN_ACHIEVMENT"
    };
    ...
    public static CompetencyType fetchExc(long oid) throws DBException {
        try {
            ...
            entCompetencyType.setAccumulate(pstCompetencyType.getInt(FLD_ACCUMULATE_IN_ACHIEVMENT));
    ...
    public static long insertExc(CompetencyType entCompetencyType) throws DBException {
        try {
            ...
            pstCompetencyType.setInt(FLD_ACCUMULATE_IN_ACHIEVMENT, entCompetencyType.getAccumulate());
    ...
    private static void resultToObject(ResultSet rs, CompetencyType entCompetencyType) {
        try {
            ...
            entCompetencyType.setAccumulate(rs.getInt(PstCompetencyType.fieldNames[PstCompetencyType.FLD_ACCUMULATE_IN_ACHIEVMENT]));
