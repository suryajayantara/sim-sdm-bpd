...
public class PstDocMasterFlow extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static final int FLD_FILTER_FOR_DIVISION_ID = 10;
    ...
    public static String[] filterBy = {
        "-Select-","Perusahaan", "Satuan Kerja", "Unit", "Level", 
        "Jabatan", "Karyawan"
    };
   ...
   public PstDocMasterFlow() {
    ...
    public static DocMasterFlow fetchExc(long oid) throws DBException {
        try {
         ...
         docMasterFlow.setFilter_for_division_id(pstDocMasterFlow.getlong(FLD_FILTER_FOR_DIVISION_ID));
    ...
    public static long insertExc(DocMasterFlow docMasterFlow) throws DBException {
        try {
            ...
            pstDocMasterFlow.setLong(FLD_FILTER_FOR_DIVISION_ID, docMasterFlow.getFilter_for_division_id());
    ...
    public static Vector list(int limitStart, int recordToGet, String whereClause, String order) {
      ...
      public static void resultToObject(ResultSet rs, DocMasterFlow docMasterFlow) {
        try {
               ...
               docMasterFlow.setFilter_for_division_id(rs.getLong(PstDocMasterFlow.fieldNames[PstDocMasterFlow.FLD_FILTER_FOR_DIVISION_ID]));
        } catch (Exception e) {
        }
    }
