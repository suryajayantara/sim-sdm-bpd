...
public class PstTraining extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_KODE_ANGGARAN = 5;
     public static final int FLD_MASA_BERLAKU = 6;
    ...
    public static Training fetchExc(long oid) throws DBException {
        try {
            ...
            //Arys 20160819
            training.setCode(pstTraining.getString(FLD_CODE));
            training.setKodeAnggaran(pstTraining.getString(FLD_KODE_ANGGARAN));
            training.setMasaBerlaku(pstTraining.getInt(FLD_MASA_BERLAKU));
            return training;
    ...
    public static long insertExc(Training training) throws DBException {
        try {
            ...
            pstTraining.setLong(FLD_TYPE, training.getType());
             //Arys 20160819
            pstTraining.setString(FLD_CODE, training.getCode());
            pstTraining.setString(FLD_KODE_ANGGARAN, training.getKodeAnggaran());
            pstTraining.setInt(FLD_MASA_BERLAKU, training.getMasaBerlaku());
    ...
    public static void resultToObject(ResultSet rs, Training training) {
        try {
            ...
            training.setType(rs.getLong(PstTraining.fieldNames[PstTraining.FLD_TYPE]));
             //Arys 20160819
            training.setCode(rs.getString(PstTraining.fieldNames[PstTraining.FLD_CODE]));
            training.setKodeAnggaran(rs.getString(PstTraining.fieldNames[PstTraining.FLD_KODE_ANGGARAN]));
            training.setMasaBerlaku(rs.getInt(PstTraining.fieldNames[PstTraining.FLD_MASA_BERLAKU]));
        } catch (Exception e) {
        }
    }
