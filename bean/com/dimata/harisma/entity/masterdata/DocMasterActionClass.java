...
public class DocMasterActionClass {
       ...
       //update by priska
    public static final int[] actionValue = {0,1,2,3,4,5,6,7};    
    public static final String[] actionKey = {"Mutation","Update Gaji Employee","Update Employee","Mutation to All","Get Value Mapping","Approval Replacement","Schedule","Kelebihan/Kekurangan"};
    ...
    public static final String[][] actionListParameterKey = {
        ...
        {"Value Mapping"},
		{"Up Position","Down Position","Start Date Replacement","End Date Replacement"},
		{"Employee","Start Date Schedule","End Date Schedule"},
