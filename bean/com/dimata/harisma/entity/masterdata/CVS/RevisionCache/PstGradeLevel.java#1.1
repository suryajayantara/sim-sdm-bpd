...
public class PstGradeLevel extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
        ...
        public static final  int FLD_GRADE_RANK = 2;
        ...
        public static GradeLevel fetchExc(long oid) throws DBException{ 
                try{ 
                        ...
                        gradeLevel.setGradeRank(pstLevel.getInt(FLD_GRADE_RANK));
        ...
        public static long insertExc(GradeLevel gradeLevel) throws DBException{ 
                try{ 
                        ...
                        pstLevel.setInt(FLD_GRADE_RANK, gradeLevel.getGradeRank());
...
public static Hashtable hashlistLevel(){
   ...
   return hashListLeavel;
        ...
        public static void resultToObject(ResultSet rs, GradeLevel gradeLevel){
                try{
                        ...
                        gradeLevel.setGradeRank(rs.getInt(PstGradeLevel.fieldNames[PstGradeLevel.FLD_GRADE_RANK]));
 ...
 public static String getGradeLevelName(String glevelId) {
        String gradeLevel = "";
        DBResultSet dbrs = null;
        String sql = "";
        try {
            sql = "SELECT " + PstGradeLevel.fieldNames[PstGradeLevel.FLD_GRADE_CODE]
                    + " FROM " + PstGradeLevel.TBL_HR_GRADE_LEVEL + " WHERE " + PstGradeLevel.fieldNames[PstGradeLevel.FLD_GRADE_LEVEL_ID]
                    + "=" + glevelId;
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                gradeLevel = rs.getString(1);
            }
