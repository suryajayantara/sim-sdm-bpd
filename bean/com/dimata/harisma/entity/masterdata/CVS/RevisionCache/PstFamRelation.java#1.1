...
public class PstFamRelation extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language{
	...
	public static final  int FLD_FAMILY_RELATION_TYPE = 2;
        public static final  int FLD_SHOW_IN_CV = 3;
    ...
    public static final int CV_NO = 0;
    public static final int CV_YES = 1;
    
    public static String[] cvNames = 
    {
      "No",
      "Yes"
    };
...
c = Suami atau istri
d = Mertua atau Besan
e = Anak Kandung/ Tiri/ Angkat
f = Kakek atau Nenek Kandung/ Tiri/ Angkat
g = Cucu Kandung/ Tiri/ Angkat
     */
    public static final int ORANG_TUA_KANDUNG = 0;
    public static final int SAUDARA_KANDUNG = 1;
    public static final int SUAMI_ATAU_ISTRI = 2;
    public static final int MERTUA_ATAU_BESAN = 3;
    public static final int ANAK_KANDUNG = 4;
    public static final int KAKEK_ATAU_NENEK_KANDUNG = 5;
    public static final int CUCU_KANDUNG = 6;
    public static final int SAUDARA_KANDUNG_ORANG_TUA = 7;
    public static final int SUAMI_ATAU_ISTRI_DARI_ANAK = 8;
    public static final int KAKEK_ATAU_NENEK_DARI_SUAMI_ATAU_ISTRI = 9;
    public static final int SUAMI_ATAU_ISTRI_DARI_CUCU = 10;
    public static final int SAUDARA_KANDUNG_DARI_SUAMI_ATAU_ISTRI = 11;
    
    public static String[] typeRelation = {
	...
	public static FamRelation fetchExc(long oid) throws DBException{
		try{
			...
			famRelation.setFamRelation(pstFamRelation.getString(FLD_FAMILY_RELATION));
                        ...
                        famRelation.setShowInCv(pstFamRelation.getInt(FLD_SHOW_IN_CV));
	...
	public static long insertExc(FamRelation famRelation) throws DBException{
		try{
			...
			pstFamRelation.setString(FLD_FAMILY_RELATION, famRelation.getFamRelation());
                        ...
                        pstFamRelation.setInt(FLD_SHOW_IN_CV, famRelation.getShowInCv());
	...
	private static void resultToObject(ResultSet rs, FamRelation famRelation){
		try{
			...
			famRelation.setFamRelation(rs.getString(PstFamRelation.fieldNames[PstFamRelation.FLD_FAMILY_RELATION]));
                        ...
                        famRelation.setShowInCv(rs.getInt(PstFamRelation.fieldNames[PstFamRelation.FLD_SHOW_IN_CV]));
