...
public class PstEmployeeCompetency extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_TRAINING_ACTIVITY_ACTUAL_ID=8;
    public static final int FLD_TRAINING_COMPETENCY_MAPPING_DETAIL_ID=9;
    ...
    public static synchronized long updateExcPending(EmployeeCompetency entEmployeeCompetency) throws DBException {
        try {
            if (entEmployeeCompetency.getOID() != 0) {
                PstEmployeeCompetency pstEmployeeCompetency = new PstEmployeeCompetency(entEmployeeCompetency.getOID());
                pstEmployeeCompetency.setLong(FLD_EMPLOYEE_ID, entEmployeeCompetency.getEmployeeId());
                ...
                pstEmployeeCompetency.setInt(FLD_HISTORY, entEmployeeCompetency.getHistory());
                pstEmployeeCompetency.setLong(FLD_PROVIDER_ID, entEmployeeCompetency.getProviderId());
                query = pstEmployeeCompetency.getUpdateSQL();
                return entEmployeeCompetency.getOID();
            }
        } catch (DBException dbe) {
            throw dbe;
    ...
    public static synchronized long deleteExcPending(long oid) throws DBException {
        try {
            PstEmployeeCompetency pstEmployeeCompetency = new PstEmployeeCompetency(oid);
            query = pstEmployeeCompetency.getDeleteSQL();
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
            throw new DBException(new PstEmployeeCompetency(0), DBException.UNKNOWN);
    ...
    public static synchronized long insertExc(EmployeeCompetency entEmployeeCompetency) throws DBException {
        try {
            ...
            pstEmployeeCompetency.setInt(FLD_HISTORY, entEmployeeCompetency.getHistory());
            pstEmployeeCompetency.setLong(FLD_PROVIDER_ID, entEmployeeCompetency.getProviderId());
            pstEmployeeCompetency.setLong(FLD_TRAINING_ACTIVITY_ACTUAL_ID, entEmployeeCompetency.getTrainingActivityActualId());
            pstEmployeeCompetency.setLong(FLD_TRAINING_COMPETENCY_MAPPING_DETAIL_ID, entEmployeeCompetency.getTrainingCompetencyMappingDetailId());
    ...
    public static synchronized long insertExcPending(EmployeeCompetency entEmployeeCompetency) throws DBException {
        try {
            PstEmployeeCompetency pstEmployeeCompetency = new PstEmployeeCompetency(0);
            pstEmployeeCompetency.setLong(FLD_EMPLOYEE_ID, entEmployeeCompetency.getEmployeeId());
            pstEmployeeCompetency.setLong(FLD_COMPETENCY_ID, entEmployeeCompetency.getCompetencyId());
            ...
            pstEmployeeCompetency.setLong(FLD_TRAINING_ACTIVITY_ACTUAL_ID, entEmployeeCompetency.getTrainingActivityActualId());
            pstEmployeeCompetency.setLong(FLD_TRAINING_COMPETENCY_MAPPING_DETAIL_ID, entEmployeeCompetency.getTrainingCompetencyMappingDetailId());
            query = pstEmployeeCompetency.getInsertQuery();
            entEmployeeCompetency.setOID(pstEmployeeCompetency.getLong(FLD_EMPLOYEE_COMP_ID));
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
    ...
    public static void resultToObject(ResultSet rs, EmployeeCompetency entEmployeeCompetency) {
        try {
            ...
            entEmployeeCompetency.setTrainingActivityActualId(rs.getLong(PstEmployeeCompetency.fieldNames[PstEmployeeCompetency.FLD_TRAINING_ACTIVITY_ACTUAL_ID]));
            entEmployeeCompetency.setTrainingCompetencyMappingDetailId(rs.getLong(PstEmployeeCompetency.fieldNames[PstEmployeeCompetency.FLD_TRAINING_COMPETENCY_MAPPING_DETAIL_ID]));
        } catch (Exception e) {
        }
    }
    ...
    public static Hashtable<String, Float> listSumEmpCompetency(int limitStart, int recordToGet, String whereClause, String order) {
        Hashtable<String, Float> lists = new Hashtable();
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT " +fieldNames[FLD_EMPLOYEE_ID]+", "
					+ "SUM(IF(REQ."+PstCandidatePositionCompetency.fieldNames[PstCandidatePositionCompetency.FLD_BOBOT]
					+" > 0, (REQ."+PstCandidatePositionCompetency.fieldNames[PstCandidatePositionCompetency.FLD_BOBOT]+" / 100) * "
					+ fieldNames[FLD_LEVEL_VALUE]+", "+ fieldNames[FLD_LEVEL_VALUE]+") ) AS SUM_COMP FROM " + TBL_EMPLOYEE_COMPETENCY
					+ " LEFT JOIN "+PstCandidatePositionCompetency.TBL_CANDIDATE_POSITION_COMPETENCY+" REQ ON "
					+ TBL_EMPLOYEE_COMPETENCY+"."+fieldNames[FLD_COMPETENCY_ID]+" = REQ."+PstCandidatePositionCompetency.fieldNames[PstCandidatePositionCompetency.FLD_COMPETENCY_ID];
            if (whereClause != null && whereClause.length() > 0) {
                sql = sql + " WHERE " + whereClause;
            }
            ...
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                String empId = ""+rs.getLong(PstEmployeeCompetency.fieldNames[PstEmployeeCompetency.FLD_EMPLOYEE_ID]);
                Float sumComp = (rs.getFloat("SUM_COMP"));
