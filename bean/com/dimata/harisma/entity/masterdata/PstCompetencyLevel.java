...
public class PstCompetencyLevel extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_COMPETENCY_GROUP_ID = 9;
    public static final int FLD_LEVEL_NAME = 10;
    ...
    public static CompetencyLevel fetchExc(long oid) throws DBException {
        try {
            ...
            entCompetencyLevel.setCompetencyGroupId(pstCompetencyLevel.getlong(FLD_COMPETENCY_GROUP_ID));
            entCompetencyLevel.setLevelName(pstCompetencyLevel.getString(FLD_LEVEL_NAME));
    ...
    public static long insertExc(CompetencyLevel entCompetencyLevel) throws DBException {
        try {
            ...
            pstCompetencyLevel.setLong(FLD_COMPETENCY_GROUP_ID, entCompetencyLevel.getCompetencyGroupId());
            pstCompetencyLevel.setString(FLD_LEVEL_NAME, entCompetencyLevel.getLevelName());
    ...
    private static void resultToObject(ResultSet rs, CompetencyLevel entCompetencyLevel) {
        try {
            ...
            entCompetencyLevel.setCompetencyGroupId(rs.getLong(PstCompetencyLevel.fieldNames[PstCompetencyLevel.FLD_COMPETENCY_GROUP_ID]));
            entCompetencyLevel.setLevelName(rs.getString(PstCompetencyLevel.fieldNames[PstCompetencyLevel.FLD_LEVEL_NAME]));
        } catch (Exception e) {
        }
    }
