...
public class PositionCompetencyRequired extends Entity {
    ...
    private int levelDivision = 0;
    private int levelDepartment = 0;
    ...
    /**
     * @return the levelDivision
     */
    public int getLevelDivision() {
        return levelDivision;
    }

    /**
     * @param levelDivision the levelDivision to set
     */
    public void setLevelDivision(int levelDivision) {
        this.levelDivision = levelDivision;
    }

    /**
     * @return the levelDepartment
     */
    public int getLevelDepartment() {
        return levelDepartment;
    }

    /**
     * @param levelDepartment the levelDepartment to set
     */
    public void setLevelDepartment(int levelDepartment) {
        this.levelDepartment = levelDepartment;
    }
