...
public class PstPositionCompetencyRequired extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    //add by Eri Yudi 2021-07-31 untuk mapping ke kelas satuan kerja,unit dan sub unit
    public static final int FLD_LEVEL_DIVISION = 12;
    public static final int FLD_LEVEL_DEPARTMENT = 13;
    public static final int FLD_LEVEL_SECTION = 14;
    ...
    public static PositionCompetencyRequired fetchExc(long oid) throws DBException {
        try {
            ...
            entPositionCompetencyRequired.setLevelDivision(pstPositionCompetencyRequired.getInt(FLD_LEVEL_DIVISION));
            entPositionCompetencyRequired.setLevelDepartment(pstPositionCompetencyRequired.getInt(FLD_LEVEL_DEPARTMENT));
            entPositionCompetencyRequired.setLevelSection(pstPositionCompetencyRequired.getInt(FLD_LEVEL_SECTION));
    ...
    public static long insertExc(PositionCompetencyRequired entPositionCompetencyRequired) throws DBException {
        try {
            ...
            pstPositionCompetencyRequired.setInt(FLD_LEVEL_DIVISION, entPositionCompetencyRequired.getLevelDivision());
            pstPositionCompetencyRequired.setInt(FLD_LEVEL_DEPARTMENT, entPositionCompetencyRequired.getLevelDepartment());
            pstPositionCompetencyRequired.setInt(FLD_LEVEL_SECTION, entPositionCompetencyRequired.getLevelSection());
    ...
    private static void resultToObject(ResultSet rs, PositionCompetencyRequired entPositionCompetencyRequired) {
        try {
            ...
            entPositionCompetencyRequired.setLevelDivision(rs.getInt(PstPositionCompetencyRequired.fieldNames[PstPositionCompetencyRequired.FLD_LEVEL_DIVISION]));
            entPositionCompetencyRequired.setLevelDepartment(rs.getInt(PstPositionCompetencyRequired.fieldNames[PstPositionCompetencyRequired.FLD_LEVEL_DEPARTMENT]));
            entPositionCompetencyRequired.setLevelSection(rs.getInt(PstPositionCompetencyRequired.fieldNames[PstPositionCompetencyRequired.FLD_LEVEL_SECTION]));
        } catch (Exception e) {
        }
    }
