...
//Method for API
   ...
   public static long syncExc(JSONObject jSONObject) throws DBException {
      long oid = 0;
      try{
         oid = Long.valueOf((String)jSONObject.get(PstKpiSettingGroup.fieldNames[PstKpiSettingGroup.FLD_KPI_SETTING_GROUP_ID]));         KpiSettingGroup entKpiSettingGroup = PstKpiSettingGroup.parseJsonObject(jSONObject);
