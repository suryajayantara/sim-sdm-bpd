...
public class PstDivision extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    /* add by Eri Yudi 2021-07-31 untuk mapping kompetensi pada kelas satuan kerja*/
    public static final int FLD_LEVEL_DIVISON = 20;
    ...
    // add by Eri Yudi 2021-07-31 untuk mapping kompetensi pada kelas satuan kerja 
    public static int[] divisionLevel = {0,1,2,3,4};
    public static String[] divisionLevelName = {"Default", "Kelas 1", "Kelas 2", "Kelas 3","Kelas 4"};
    ...
    public static Division fetchExc(long oid) throws DBException {
        try {
            ...
            division.setLevelDivision(pstDivision.getInt(FLD_LEVEL_DIVISON));
            /* end */
            return division;
    ...
    public static long insertExc(Division division) throws DBException {
        try {
            ...
            pstDivision.setInt(FLD_LEVEL_DIVISON, division.getLevelDivision());
            /* end */
...
+ " INNER JOIN "+PstDepartment.TBL_HR_DEPARTMENT + " AS DEPT ON DIVX."+PstDivision.fieldNames[PstDivision.FLD_DIVISION_ID] + "=dept."+PstDepartment.fieldNames[PstDepartment.FLD_DIVISION_ID];
    ...
    public static void resultToObject(ResultSet rs, Division division) {
        try {
            ...
            division.setLevelDivision(rs.getInt(PstDivision.fieldNames[PstDivision.FLD_LEVEL_DIVISON]));
            /* end */
