...
public class PstDepartment extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    //add by Eri Yudi 2021-07-31 untuk mapping kompetensi berdasarkan kelas unit
    public static final int FLD_LEVEL_DEPARTMENT = 19;
    ...
    // add by Eri Yudi 2021-07-31 untuk mapping kompetensi pada kelas unit 
    public static int[] departmentLevel = {0,1,2,3,4};
    public static String[] departmentLevelName = {"Default", "Kelas 1", "Kelas 2", "Kelas 3","Kelas 4"};
    ...
    public static Department fetchExc(long oid) throws DBException {
        try {
            ...
            department.setLevelDepartment(pstDepartment.getInt(FLD_LEVEL_DEPARTMENT));
            return department;
    ...
    public static long insertExc(Department department) throws DBException {
        try {
            ...
            pstDepartment.setInt(FLD_LEVEL_DEPARTMENT, department.getLevelDepartment());
    ...
    public static Vector listVerySimple(String where) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        String untukTest = "";
        try {
            String sql = "SELECT * FROM "+TBL_HR_DEPARTMENT+ " WHERE "+where;
    ...
    public static Vector listDepartmentVer1(int limitStart, int recordToGet, String companyId, String divisionId) {
        ...
        try {
            String sql  = "SELECT hr_department.DEPARTMENT_ID, hr_department.DEPARTMENT FROM hr_department ";
                   ...
                   sql += " AND hr_division.VALID_STATUS = " + VALID_ACTIVE;
    ...
    public static Vector listDepartmentVer1In(int limitStart, int recordToGet, String companyId, String divisionId) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        String untukTest = "";
        try {
            String sql  = "SELECT hr_department.DEPARTMENT_ID, hr_department.DEPARTMENT FROM hr_department ";
                   sql += "INNER JOIN hr_division ON hr_department.DIVISION_ID=hr_division.DIVISION_ID ";
                   sql += "INNER JOIN pay_general ON hr_division.COMPANY_ID=pay_general.GEN_ID ";
                   sql += "WHERE hr_division.COMPANY_ID IN ("+companyId+") AND hr_division.DIVISION_ID IN("+divisionId+")";
                   sql += " AND hr_division.VALID_STATUS = 1";
    ...
    public static Vector listDepartmentVersi2(String whereClause) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
        String untukTest = "";
        try {
            String sql  = "SELECT "+TBL_HR_DEPARTMENT+"."+fieldNames[FLD_DEPARTMENT_ID]+", ";
                   sql += TBL_HR_DEPARTMENT+"."+fieldNames[FLD_DEPARTMENT]+" FROM "+TBL_HR_DEPARTMENT+" ";
                   sql += "INNER JOIN "+PstDivision.TBL_HR_DIVISION+" ON ";
                   sql += TBL_HR_DEPARTMENT+"."+fieldNames[FLD_DIVISION_ID]+"="+PstDivision.TBL_HR_DIVISION+"."+PstDivision.fieldNames[PstDivision.FLD_DIVISION_ID]+" ";
                   sql += "INNER JOIN "+PstCompany.TBL_HR_COMPANY+" ON ";
                   sql += PstDivision.TBL_HR_DIVISION+"."+PstDivision.fieldNames[PstDivision.FLD_COMPANY_ID]+"=";
                   sql += PstCompany.TBL_HR_COMPANY+"."+PstCompany.fieldNames[PstCompany.FLD_COMPANY_ID]+" ";
    ...
    public static void resultToObject(ResultSet rs, Department department) {
        ...
        try {
            ...
            department.setLevelDepartment(rs.getInt(PstDepartment.fieldNames[PstDepartment.FLD_LEVEL_DEPARTMENT]));
        } catch (Exception e) {
        }
    }
