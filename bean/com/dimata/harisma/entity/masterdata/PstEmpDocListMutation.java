...
public class PstEmpDocListMutation extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
   ...
   public static final int FLD_PAY_COMPONENT = 20;
    ...
    //gunadi 2017
    public static int REPLACEMENT = 6;
    
    public static String[] tipeDoc = {"Mutasi Dan Promosi", "Pengangkatan", "Resign", "Penerimaan", "Perpanjangan Kontrak", "Salary Component", "Replacement"};
	...
	public static EmpDocListMutation fetchExc(long oid) throws DBException{ 
		try{ 
                            ...
                            empDocListMutation.setPayComponent(pstEmpDocListMutation.getString(FLD_PAY_COMPONENT));
	...
	public static long insertExc(EmpDocListMutation empDocListMutation) throws DBException{ 
		try{ 
            ...
            pstEmpDocListMutation.setString(FLD_PAY_COMPONENT, empDocListMutation.getPayComponent());
	...
	private static void resultToObject(ResultSet rs, EmpDocListMutation empDocListMutation){
		try{
			empDocListMutation.setOID(rs.getLong(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_EMP_DOC_LIST_MUTATION_ID]));
                        ...
                        empDocListMutation.setPayComponent(rs.getString(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_PAY_COMPONENT]));
		}catch(Exception e){ }
	}
