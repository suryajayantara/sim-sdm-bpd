...
public class PstCompetencyGroup extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_COMPETENCY_TYPE_ID = 3;
    ...
    public static CompetencyGroup fetchExc(long oid) throws DBException {
        try {
            ...
            entCompetencyGroup.setCompetencyTypeId(pstCompetencyGroup.getLong(FLD_COMPETENCY_TYPE_ID));
    ...
    public static long insertExc(CompetencyGroup entCompetencyGroup) throws DBException {
        try {
            ...
            pstCompetencyGroup.setLong(FLD_COMPETENCY_TYPE_ID, entCompetencyGroup.getCompetencyTypeId());
    ...
    private static void resultToObject(ResultSet rs, CompetencyGroup entCompetencyGroup) {
        try {
            ...
            entCompetencyGroup.setCompetencyTypeId(rs.getLong(PstCompetencyGroup.fieldNames[PstCompetencyGroup.FLD_COMPETENCY_TYPE_ID]));
