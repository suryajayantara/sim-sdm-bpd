...
public class PstSection extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_LEVEL_SECTION = 8;
    ...
    // add by Eri Yudi 2021-07-31 untuk mapping kompetensi pada kelas sub unit 
    public static int[] sectionLevel = {-1,0,1,2,3,4};
    public static String[] sectionLevelName = {"Default", "Level -", "Kelas 1", "Kelas 2", "Kelas 3","Kelas 4"};
    ...
    public static Section fetchExc(long oid) throws DBException {
        try {
            ...
            section.setLevelSection(pstSection.getInt(FLD_LEVEL_SECTION));
            return section;
    ...
    public static long insertExc(Section section) throws DBException {
        try {
            ...
            pstSection.setInt(FLD_LEVEL_SECTION, section.getLevelSection());
            pstSection.insert();
...
//                        System.out.println("sql section : " + sql);
    ...
    private static void resultToObject(ResultSet rs, Section section) {
        try {
            ...
            section.setLevelSection(rs.getInt(PstSection.fieldNames[PstSection.FLD_LEVEL_SECTION]));
        } catch (Exception e) {
        }
    }
