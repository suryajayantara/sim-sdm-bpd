...
public class PstReprimand extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language{
    ...
    public static final int FLD_VALID_UNTIL = 3;
    public static final int FLD_SATUAN_VALID_UNTIL = 4;
    public static final int FLD_SHOW_IN_CV = 5;
    ...
    public static final int SATUAN_VALID_UNTIL_HARIAN = 0;
    public static final int SATUAN_VALID_UNTIL_BULANAN = 1;
    public static final String[] namaSatuanValidUntil = {
        "Hari",
        "Bulan"
    };
    
    public static final String[] nameConfigShowInCV = {
        "YA",
        "TIDAK"
    };
   ...
   public PstReprimand(int i) throws DBException {
    ...
    public static Reprimand fetchExc(long oid) throws DBException {
        try {
            ...
            reprimand.setValidUntil(pstReprimand.getInt(FLD_VALID_UNTIL));
            reprimand.setSatuanValidUntil(pstReprimand.getInt(FLD_SATUAN_VALID_UNTIL));
            reprimand.setShowInCV(pstReprimand.getInt(FLD_SHOW_IN_CV));
            return reprimand;
    ...
    public static long insertExc(Reprimand reprimand) throws DBException {
        try {
            ...
            pstReprimand.setInt(FLD_VALID_UNTIL, reprimand.getValidUntil());
            pstReprimand.setInt(FLD_SATUAN_VALID_UNTIL, reprimand.getSatuanValidUntil());
            pstReprimand.setInt(FLD_SHOW_IN_CV, reprimand.getShowInCV());
   ...
   public static long updateExc(Reprimand reprimand) throws DBException {
    ...
    private static void resultToObject(ResultSet rs, Reprimand reprimand) {
        try {
            ...
            reprimand.setValidUntil(rs.getInt(PstReprimand.fieldNames[PstReprimand.FLD_VALID_UNTIL]));
            reprimand.setSatuanValidUntil(rs.getInt(PstReprimand.fieldNames[PstReprimand.FLD_SATUAN_VALID_UNTIL]));
            reprimand.setShowInCV(rs.getInt(PstReprimand.fieldNames[PstReprimand.FLD_SHOW_IN_CV]));
