...
public class PstWarning extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static Warning fetchExc(long oid) throws DBException {
        try {
            ...
            warning.setValidUntil(pstWarning.getInt(FLD_VALID_UNTIL));
            warning.setSatuanValidUntil(pstWarning.getInt(FLD_SATUAN_VALID_UNTIL));
            return warning;
    ...
    public static long insertExc(Warning warning) throws DBException {
        try {
            ...
            pstWarning.setInt(FLD_VALID_UNTIL, warning.getValidUntil());
            pstWarning.setInt(FLD_SATUAN_VALID_UNTIL, warning.getSatuanValidUntil());
    ...
    private static void resultToObject(ResultSet rs, Warning warning) {
        try {
            ...
            warning.setValidUntil(rs.getInt(PstWarning.fieldNames[PstWarning.FLD_VALID_UNTIL]));
            warning.setSatuanValidUntil(rs.getInt(PstWarning.fieldNames[PstWarning.FLD_SATUAN_VALID_UNTIL]));
