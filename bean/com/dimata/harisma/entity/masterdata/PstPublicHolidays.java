    ...
    */
    ...
    public static Vector getHolidayByDate(Date dtHolidayDate){
        ...
        String stSQL = " SELECT * FROM "+ TBL_PUBLIC_HOLIDAYS +
                       ...
                       " = '" + Formater.formatDate(dtHolidayDate, "yyyy-MM-dd")+"' OR '"
                       + Formater.formatDate(dtHolidayDate, "yyyy-MM-dd") + "' BETWEEN "
                       + PstPublicHolidays.fieldNames[PstPublicHolidays.FLD_HOLIDAY_DATE]+ " AND "
                       + PstPublicHolidays.fieldNames[PstPublicHolidays.FLD_HOLIDAY_DATE_TO];
