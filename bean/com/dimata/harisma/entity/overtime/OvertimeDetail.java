...
public class OvertimeDetail extends Entity{
    ...
    public final static String normalOvtKey[] = {"Yes", "No"};
    public final static int normalOvtVal[] = {0,1};
    
    public final static String lateAppKey[] = {"No", "Yes"};
    public final static int lateAppVal[] = {0,1};
    ...
    public static Vector getNormalOvtByKey(){
        Vector key = new Vector();        
        for(int i=0; i < normalOvtKey.length;i++ ){
            key.add(""+normalOvtKey[i]);
        }
        return key;
    }
    ...
    public static Vector getNormalOvtByVal(){
        Vector val = new Vector();        
        for(int i=0; i < normalOvtVal.length;i++ ){
            val.add(""+normalOvtVal[i]);
        }
        return val;
    }
    
    public static Vector getLateApprovalByKey(){
        Vector key = new Vector();        
        for(int i=0; i < lateAppKey.length;i++ ){
            key.add(""+lateAppKey[i]);
        }
        return key;
    }
    
    public static Vector getLateApprovalByVal(){
        Vector val = new Vector();        
        for(int i=0; i < lateAppVal.length;i++ ){
            val.add(""+lateAppVal[i]);
        }
        return val;
    }
...
//        }
    ...
    /**
     * @return the lateApproval
     */
    public int getLateApproval() {
        return lateApproval;
    }

    /**
     * @param lateApproval the lateApproval to set
     */
    public void setLateApproval(int lateApproval) {
        this.lateApproval = lateApproval;
    }
