...
//add by priska 20151214   
    ...
    public static Vector listEmpLevelwithDateResign(String salaryLevel, Vector  posLevelIdx,long oidDivision, long oidDepartment, Date minCommencingDate, int status_resign, Date startDate, Date endDate, Date resignDateFrom, Date resignDateTo, long payrollGroupId) {
        return listEmpLevelwithDateResign(salaryLevel, posLevelIdx, oidDivision,  oidDepartment,  minCommencingDate,  status_resign,  startDate,  endDate,  resignDateFrom,  resignDateTo,  payrollGroupId, "");
    }
     
     public static Vector listEmpLevelwithDateResign(String salaryLevel, Vector  posLevelIdx,long oidDivision, long oidDepartment, Date minCommencingDate, int status_resign, Date startDate, Date endDate, Date resignDateFrom, Date resignDateTo, long payrollGroupId, String empNum) {
        DBResultSet dbrs = null;
        Vector result = new Vector(1,1);
        System.out.println("salaryLevel"+salaryLevel);
        if (salaryLevel == "")
