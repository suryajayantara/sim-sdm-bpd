...
public class CustomRptMain extends Entity {
    ...
    private int rptMainFullAccess = 0;
    ...
    /**
     * @return the rptMainFullAccess
     */
    public int getRptMainFullAccess() {
        return rptMainFullAccess;
    }

    /**
     * @param rptMainFullAccess the rptMainFullAccess to set
     */
    public void setRptMainFullAccess(int rptMainFullAccess) {
        this.rptMainFullAccess = rptMainFullAccess;
    }
