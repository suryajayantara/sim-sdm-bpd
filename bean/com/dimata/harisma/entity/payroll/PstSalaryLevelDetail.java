...
public class PstSalaryLevelDetail extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
   ...
   public static int findLimitCommand(int start, int recordToGet, int vectSize)
     ...
     * created by Yunny
     */
   public static Vector listComponent(int limitStart,int recordToGet,String salaryLevel,int compType, String compCode, String compName){
        Vector lists = new Vector(); 
        DBResultSet dbrs = null;
        try {
				 ...
				 if (compCode.length()>0){
					 sql += " AND comp."+PstPayComponent.fieldNames[PstPayComponent.FLD_COMP_CODE]+" LIKE '%"+compCode+"%'";
				 }
				 
				 if (compName.length()>0){
					 sql += " AND comp."+PstPayComponent.fieldNames[PstPayComponent.FLD_COMP_NAME]+" LIKE  '%"+compName+"%'";
				 }
...
PENSION = 0 
    ...
    *   Created By Yunny
    **/
   public static int getCountListComponent(String salaryLevel,int compType, String compCode, String compName){
        DBResultSet dbrs = null;
        try {
