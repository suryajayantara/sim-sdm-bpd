	...
	public static final  int FLD_STD_WORK_HOUR_BEGIN  = 4;
		...
		TYPE_STRING,
          ...
          public static final String[]nameOvt = {
                "--select--","Working Day","Holiday","DP on Working Day","DP on Public Holiday", "Overtime End of Year", "Overtime Schedule Off", "DP End of Year", "DP Schedule Off", "Weekends"
          };
          public static final String[]nameOvtIndonesia = {
                "--pilih--","Hari kerja","Libur nasional","DP di hari kerja","DP di libur nasional", "Lembur akhir tahun", "Lembur jadwal libur", "DP akhir tahun", "DP Jadwal libur", "Akhir Pekan"
          };
