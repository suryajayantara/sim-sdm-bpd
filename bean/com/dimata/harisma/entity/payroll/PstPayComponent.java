...
public class PstPayComponent extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_SECOND_SLIP = 17;
    ...
    public static int GAJI_MBT = 5;
    public static int POTONGAN_GAJI_MBT = 6;
    public static int TUNJANGAN_MBT = 7;
    public static int BONUS_THR_MBT = 8;
       //untuk deduction
    //public static int BONUS_THR = 3;

    public static String[] taxItem = {
        "Non Tax Component", "Continue Salary", "Non Continue", "Yearly Bonus & THR", "Salary to Tax Deduction", "Continue Salary MBT", "Salary to Tax Deduction MBT", "Non Continue MBT", "Yearly Bonus & THR MBT"
    };
    ...
    public final static int TAX_RPT_SELECT_NONE = 2;
    ...
    // add to second slip
    public static int NO_SECOND_SLIP = 0;
    public static int YES_SECOND_SELIP = 1;

    public static String[] secondSlip = {
        "No", "Yes"
    };
    ...
    public static PayComponent fetchExc(long oid) throws DBException {
        try {
            ...
            payComponent.setSecondSlip(pstPayComponent.getInt(FLD_SECOND_SLIP));
            return payComponent;
    ...
    public static long insertExc(PayComponent payComponent) throws DBException {
        try {
            ...
            pstPayComponent.setInt(FLD_SECOND_SLIP, payComponent.getSecondSlip());
    ...
    public static void resultToObject(ResultSet rs, PayComponent payComponent) {
        try {
            ...
            payComponent.setSecondSlip(rs.getInt(PstPayComponent.fieldNames[PstPayComponent.FLD_SECOND_SLIP]));
    ...
    public static boolean isSecondPayslip(String compCode){
        boolean status = false;
        
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT "+PstPayComponent.fieldNames[PstPayComponent.FLD_SECOND_SLIP]
                    + " FROM " +TBL_PAY_COMPONENT+ " WHERE "+PstPayComponent.fieldNames[PstPayComponent.FLD_COMP_CODE]
                    + " = '"+compCode+"'";
            ...
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                int secondSlip = rs.getInt(PstPayComponent.fieldNames[PstPayComponent.FLD_SECOND_SLIP]);
                if (secondSlip == 1){
                    status = true;
                }
                return status;
