...
//update by satrya 2012-11-14
    ...
    private Date skTanggal = new Date();
    private String nkk = "";
    /* Update by Hendra Putu | 2016-06-15 */
    private String skNomorGrade = "";
    private Date skTanggalGrade = new Date(); 
    private String nameCard = "";
    private long nationalityId = 0;
    private long bpjsTkPensiun = 0;
    private Date bpjsTkPensiunDate = new Date(); 
    private long productTypeId;
 
    private Date firstContractDate = null; 
...
//Gede_15Nov2011{
    ...
    /**
     * @param skNomor the skNomor to set
     */
    ...
    /**
     * @param skTanggal the skTanggal to set
     */
    ...
    /**
     * @return the skNomorGrade
     */
    public String getSkNomorGrade() {
        return skNomorGrade;
    }

    /**
     * @param skNomorGrade the skNomorGrade to set
     */
    public void setSkNomorGrade(String skNomorGrade) {
        this.skNomorGrade = skNomorGrade;
    }

    /**
     * @return the skTanggalGrade
     */
    public Date getSkTanggalGrade() {
        return skTanggalGrade;
    }

    /**
     * @param skTanggalGrade the skTanggalGrade to set
     */
    public void setSkTanggalGrade(Date skTanggalGrade) {
        this.skTanggalGrade = skTanggalGrade;
    }
    ...
    /**
     * @param firstContractDate the firstContractDate to set
     */
    ...
    /**
     * @return the bpjsTkPensiunDate
     */
    public Date getBpjsTkPensiunDate() {
        return bpjsTkPensiunDate;
    }

    /**
     * @param bpjsTkPensiunDate the bpjsTkPensiunDate to set
     */
    public void setBpjsTkPensiunDate(Date bpjsTkPensiunDate) {
        this.bpjsTkPensiunDate = bpjsTkPensiunDate;
    }

    /**
     * @return the bpjsTkPensiun
     */
    public long getBpjsTkPensiun() {
        return bpjsTkPensiun;
    }

    /**
     * @param bpjsTkPensiun the bpjsTkPensiun to set
     */
    public void setBpjsTkPensiun(long bpjsTkPensiun) {
        this.bpjsTkPensiun = bpjsTkPensiun;
    }
    ...
    public void setProductTypeId(long levelId) {
