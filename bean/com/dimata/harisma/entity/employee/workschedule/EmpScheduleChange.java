...
public class EmpScheduleChange extends Entity{
    ...
    private String approvalLevel1Note = "";
    private String approvalLevel2Note = "";
    ...
    /**
     * @return the approvalLevel1Note
     */
    public String getApprovalLevel1Note() {
        return approvalLevel1Note;
    }

    /**
     * @param approvalLevel1Note the approvalLevel1Note to set
     */
    public void setApprovalLevel1Note(String approvalLevel1Note) {
        this.approvalLevel1Note = approvalLevel1Note;
    }

    /**
     * @return the approvalLevel2Note
     */
    public String getApprovalLevel2Note() {
        return approvalLevel2Note;
    }

    /**
     * @param approvalLevel2Note the approvalLevel2Note to set
     */
    public void setApprovalLevel2Note(String approvalLevel2Note) {
        this.approvalLevel2Note = approvalLevel2Note;
    }
