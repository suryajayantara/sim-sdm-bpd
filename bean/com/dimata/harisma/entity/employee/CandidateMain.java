...
public class CandidateMain extends Entity {
	...
	/**
	 * @param statusAktif the statusAktif to set
	 */
	...
	/**
	 * @return the statusMBT
	 */
	public int getStatusMBT() {
		return statusMBT;
	}

	/**
	 * @param statusMBT the statusMBT to set
	 */
	public void setStatusMBT(int statusMBT) {
		this.statusMBT = statusMBT;
	}
