...
public class PstCandidateMain extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
	...
	public static final int FLD_STATUS_AKTIF = 19;
	public static final int FLD_STATUS_MBT = 20;
	public static final int FLD_STATUS_RESIGN = 21;
    ...
    public static int KONDISI_OR = 0;
    public static int KONDISI_AND = 1;
    ...
    public static synchronized long insertExc(CandidateMain entCandidateMain) throws DBException {
        try {
            if(entCandidateMain.getTitle()==null || entCandidateMain.getTitle().length()< 1){
                return 0;
            }
