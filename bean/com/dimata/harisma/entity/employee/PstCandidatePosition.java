...
public class PstCandidatePosition extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static synchronized long deleteExc(long oid) throws DBException {     
        CandidatePosition canPos =  null;
        try {
            canPos = PstCandidatePosition.fetchExc(oid);
        } catch (Exception exc) {
            System.out.println(exc);
        }
         
        if(canPos!=null && canPos.getCandidateMainId() !=0){
            try {
                 PstCandidatePositionExperience.delete(
                   "delete from " + PstCandidatePositionExperience.TBL_CANDIDATE_POS_EXPERIENCE + " where " +       
                   PstCandidatePositionExperience.fieldNames[PstCandidatePositionExperience.FLD_CANDIDATE_MAIN_ID]+"="+ canPos.getCandidateMainId());
            } catch (Exception exc) {
                System.out.println(exc);
            }
            ...
            try {
                 PstCandidatePositionCompetency.delete( 
                   "delete from " + PstCandidatePositionCompetency.TBL_CANDIDATE_POSITION_COMPETENCY + " where " +  
                   PstCandidatePositionCompetency.fieldNames[PstCandidatePositionCompetency.FLD_CANDIDATE_MAIN_ID]+"="+ canPos.getCandidateMainId());
            } catch (Exception exc) {
                System.out.println(exc);
            }
            ...
            try {
                 PstCandidatePositionEducation.delete(
                   "delete from " + PstCandidatePositionEducation.TBL_CANDIDATE_POSITION_EDUCATION + " where " +  
                   PstCandidatePositionEducation.fieldNames[PstCandidatePositionEducation.FLD_CANDIDATE_MAIN_ID]+"="+ canPos.getCandidateMainId());
            } catch (Exception exc) {
                System.out.println(exc);
            }
            ...
            try {
                 PstCandidatePositionKpi.delete(
                         "delete from " + PstCandidatePositionKpi.TBL_CANDIDATE_POSITION_KPI + " where " +  
                   PstCandidatePositionKpi.fieldNames[PstCandidatePositionKpi.FLD_CANDIDATE_MAIN_ID]+"="+ canPos.getCandidateMainId());
            } catch (Exception exc) { 
                System.out.println(exc);
            }
            ...
            try {
                 PstCandidatePositionTraining.delete(
                         "delete from " + PstCandidatePositionTraining.TBL_CANDIDATE_POSITION_TRAINING + " where " +  
                   PstCandidatePositionTraining.fieldNames[PstCandidatePositionTraining.FLD_CANDIDATE_MAIN_ID]+"="+ canPos.getCandidateMainId());
            } catch (Exception exc) {
                System.out.println(exc); 
            }
        }
