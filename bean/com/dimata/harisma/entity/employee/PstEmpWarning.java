...
public class PstEmpWarning extends DBHandler implements I_Language, I_PersintentExc, I_DBInterface, I_DBType {
    ...
    public static long insertExcPending(EmpWarning warning) throws DBException {
        try {
            PstEmpWarning pstWarning = new PstEmpWarning(0);
            ...
            query = pstWarning.getInsertQuery();
    ...
    public static long updateExcPending(EmpWarning warning) throws DBException {
        try {
            if (warning.getOID() != 0) {
                PstEmpWarning pstWarning = new PstEmpWarning(warning.getOID());
    ...
    public static long deleteExcPending(long oid) throws DBException {
        try {
            PstEmpWarning pstEmpWarning = new PstEmpWarning(oid);
            query = pstEmpWarning.getDeleteSQL();
        } catch (DBException dbe) {
            throw dbe;
        } catch (Exception e) {
            throw new DBException(new PstEmpWarning(0), DBException.UNKNOWN);
