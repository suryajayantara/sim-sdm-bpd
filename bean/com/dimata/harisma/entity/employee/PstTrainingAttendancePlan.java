...
public class PstTrainingAttendancePlan extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final String TBL_TRAIN_ATTEND_PLAN    =   "hr_training_attendance_plan";
        ...
        public static final int FLD_POINT               =   4;
	...
	public static TrainingAttendancePlan fetchExc(long oid) throws DBException {
            try{ 
                ...
                attendancePlan.setPoint(pstAttendancePlan.getInt(PstTrainingAttendancePlan.FLD_POINT));
                attendancePlan.setRemark(pstAttendancePlan.getString(PstTrainingAttendancePlan.FLD_REMARK));
        ...
        public static long insertExc(TrainingAttendancePlan attendancePlan) throws DBException {
            try{ 
                ...
                pstAttendancePlan.setInt(FLD_POINT, attendancePlan.getPoint());
                pstAttendancePlan.setString(FLD_REMARK, attendancePlan.getRemark());
	...
	public static void resultToObject(ResultSet rs, TrainingAttendancePlan attendancePlan){
            try{
                ...
                attendancePlan.setPoint(rs.getInt(PstTrainingAttendancePlan.fieldNames[PstTrainingAttendancePlan.FLD_POINT]));
                attendancePlan.setRemark(rs.getString(PstTrainingAttendancePlan.fieldNames[PstTrainingAttendancePlan.FLD_REMARK]));
            }
            catch(Exception e){ 
                e.printStackTrace();
            }
