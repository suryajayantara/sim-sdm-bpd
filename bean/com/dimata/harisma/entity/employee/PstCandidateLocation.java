...
public class PstCandidateLocation extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static CandidateLocation fetchExc(long oid) throws DBException {
        try {
            ...
            entCandidateLocation.setCompanyId(pstCandidateLocation.getLong(FLD_COMPANY_ID));
            ...
            entCandidateLocation.setCode(pstCandidateLocation.getInt(FLD_CODE));
    ...
    public static synchronized long updateExc(CandidateLocation entCandidateLocation) throws DBException {
        try {
            if (entCandidateLocation.getOID() != 0) {
                ...
                pstCandidateLocation.setLong(FLD_COMPANY_ID, entCandidateLocation.getCompanyId());
                ...
                pstCandidateLocation.setInt(FLD_CODE, entCandidateLocation.getCode());
    ...
    public static void resultToObject(ResultSet rs, CandidateLocation entCandidateLocation) {
        try {
            ...
            entCandidateLocation.setCompanyId(rs.getLong(PstCandidateLocation.fieldNames[PstCandidateLocation.FLD_COMPANY_ID]));
            ...
            entCandidateLocation.setCode(rs.getInt(PstCandidateLocation.fieldNames[PstCandidateLocation.FLD_CODE]));
        } catch (Exception e) {
        }
    }
