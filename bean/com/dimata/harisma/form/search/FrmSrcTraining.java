...
public class FrmSrcTraining extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    /* Update by Hendra Putu | 2016-01-29 */
    ...
    public static String[] fieldNames = {
        ...
        "FRM_FIELD_TRAIN_TYPE", "FRM_FIELD_POSITION", "FRM_FIELD_DIVISION"
    };
    public static int[] fieldTypes = {
        TYPE_LONG, TYPE_LONG,
        TYPE_INT, TYPE_INT,
        TYPE_INT, TYPE_LONG, TYPE_LONG
    };
    ...
    public SrcTraining getEntityObject() {
        return srcTraining;
    }
    ...
    public void requestEntityObject(SrcTraining srcTraining) {
        try {
            ...
            srcTraining.setPositionId(getLong(FRM_FIELD_POSITION));
            srcTraining.setDivisionId(getLong(FRM_FIELD_DIVISION));
        } catch (Exception e) {
