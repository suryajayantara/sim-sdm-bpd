...
//update by satrya 2013-04-14
        ...
        public static final int FRM_FIELD_DOC_STATUS_TO_BE_CANCELED = 25;
        public static final int FRM_FIELD_DOC_STATUS_DECLINED = 26;
        public static final int FRM_FIELD_ARR_DIVISION = 27;
        public static final int FRM_FIELD_ARR_DEPARTMENT = 28;
        public static final int FRM_FIELD_ARR_SECTION = 29;
        public static final int FRM_FIELD_ARR_JENIS_CUTI = 30;
        public static final int FRM_FIELD_ARR_POSITION = 31;
	public static String[] fieldNames = 
		...
		"FRM_FIELD_POSITION",
                ...
                "FRM_FIELD_DOC_STATUS_TO_BE_CANCELED",
                "FRM_FIELD_DOC_STATUS_DECLINED",
                "FRM_FIELD_ARR_DIVISION",
                "FRM_FIELD_ARR_DEPARTMENT",
                "FRM_FIELD_ARR_SECTION",
                "FRM_FIELD_ARR_JENIS_CUTI",
	...
	public void requestEntityObject(SrcLeaveApp srcLeaveApp) 
		...
		try
			...
			srcLeaveApp.setPositionId(getLong(FRM_FIELD_POSITION));
                        ...
                        srcLeaveApp.setToBeCanceled(getBoolean(FRM_FIELD_DOC_STATUS_TO_BE_CANCELED));
                        srcLeaveApp.setCanceled(getBoolean(FRM_FIELD_DOC_STATUS_CANCELED));
                        srcLeaveApp.setDeclined(getBoolean(FRM_FIELD_DOC_STATUS_DECLINED));
                       ...
                       //update by satrya 2013-03-08
                        ...
                        //UPDATE BY SATRYA 2013-04-14
                        try {
                            srcLeaveApp.setSelectedFrom(java.sql.Date.valueOf(getString(FRM_FIELD_SELECTED_DATE_FROM_LEAVE)));                            
                        } catch (Exception exc){
                            srcLeaveApp.setSelectedFrom(null); 
                        }

                        try {
                            srcLeaveApp.setSelectedTo(java.sql.Date.valueOf(getString(FRM_FIELD_SELECTED_DATE_TO_LEAVE)));
                        } catch (Exception exc){
                            srcLeaveApp.setSelectedTo(null);
                        }
                        ...
                        srcLeaveApp.addArrDivision(getParamsStringValues(fieldNames[FRM_FIELD_ARR_DIVISION]));
                        srcLeaveApp.addArrDepartment(getParamsStringValues(fieldNames[FRM_FIELD_ARR_DEPARTMENT]));
                        srcLeaveApp.addArrSection(getParamsStringValues(fieldNames[FRM_FIELD_ARR_SECTION]));
                        srcLeaveApp.addArrJenisCuti(getParamsStringValues(fieldNames[FRM_FIELD_ARR_JENIS_CUTI]));
                        srcLeaveApp.addArrPosition(getParamsStringValues(fieldNames[FRM_FIELD_ARR_POSITION]));
		}
                catch(Exception e)
                {
