...
public class FrmScheduleSymbol extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_REPORT_TYPE = 15;
    public static final int FRM_FIELD_SHOW_ON_USER_LEAVE = 16;
    public static final int FRM_FIELD_SHOW_PRESENT_ON_WEEKEND = 17;
	public static final int FRM_FIELD_PERHITUNGAN_UANG_MAKAN = 18;
        public static final int FRM_FIELD_WORK_DURATION = 19;
    public static String[] fieldNames = {
        ...
        "FRM_FIELD_TRANSPORT_ALLOWANCE", "FRM_FIELD_NIGHT_ALLOWANCE", "FRM_FIELD_WORK_DAYS", "FRM_FIELD_REPORT_TYPE", "FRM_FIELD_SHOW_ON_USER_LEAVE",
        "FRM_FIELD_SHOW_PRESENT_ON_WEEKEND", "FRM_FIELD_PERHITUNGAN_UANG_MAKAN", "FRM_FIELD_WORK_DURATION"
    };
    public static int[] fieldTypes = {
        ...
        TYPE_INT, TYPE_INT, TYPE_INT, TYPE_INT, TYPE_INT, TYPE_INT, TYPE_INT, TYPE_FLOAT
    };
    ...
    public void requestEntityObject(ScheduleSymbol scheduleSymbol) {
        try {
            ...
            if (getDate(FrmScheduleSymbol.FRM_FIELD_TIME_OUT) == null) {
                Date dT = new Date();
                dT.setHours(0);
                dT.setMinutes(0);
                dT.setSeconds(0);
            ...
            scheduleSymbol.setReportType(getInt(FRM_FIELD_REPORT_TYPE));
            scheduleSymbol.setShowOnLeave(getInt(FRM_FIELD_SHOW_ON_USER_LEAVE));
            scheduleSymbol.setShowPresent(getInt(FRM_FIELD_SHOW_PRESENT_ON_WEEKEND));
            scheduleSymbol.setPerhitunganUangMakan(getInt(FRM_FIELD_PERHITUNGAN_UANG_MAKAN));
            scheduleSymbol.setWorkDuration(getInt(FRM_FIELD_WORK_DURATION));
        } catch (Exception e) {
