...
public class FrmPositionCompetencyRequired extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_LEVEL_DIVISION = 12;
    public static final int FRM_FIELD_LEVEL_DEPARTMENT = 13;
    public static final int FRM_FIELD_LEVEL_SECTION = 14;
...
//            entPositionCompetencyRequired.setValidEnd(Date.valueOf(getString(FRM_FIELD_VALID_END)));
            entPositionCompetencyRequired.setLevelDivision(getInt(FRM_FIELD_LEVEL_DIVISION));
            entPositionCompetencyRequired.setLevelDepartment(getInt(FRM_FIELD_LEVEL_DEPARTMENT));
            entPositionCompetencyRequired.setLevelSection(getInt(FRM_FIELD_LEVEL_SECTION));
        } catch (Exception e) {
