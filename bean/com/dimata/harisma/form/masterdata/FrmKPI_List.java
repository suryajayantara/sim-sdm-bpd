...
//    private String value_type;
	...
	public static final int FRM_FIELD_KPI_POSITION = 9;
	public static final int FRM_FIELD_PARENT_ID = 10;
	public static final int FRM_FIELD_KORELASI = 11;
    public static final int FRM_FIELD_RANGE_START = 12;
    public static final int FRM_FIELD_RANGE_END = 13;
    ...
    public static String[] fieldNames = {
		...
		"FRM_FIELD_KPI_POSITION",
		"FRM_FIELD_PARENT_ID",
		"FRM_FIELD_KORELASI",
                "FRM_FIELD_RANGE_START",
                "FRM_FIELD_RANGE_END"
    };
    ...
    public void requestEntityObject(KPI_List kPI_List) {
        try {
			...
			kPI_List.addArrkpiposition(this.getParamsStringValues(fieldNames[FRM_FIELD_KPI_POSITION]));
			kPI_List.setInputType(getInt(FRM_FIELD_INPUT_TYPE));
			kPI_List.setParentId(getLong(FRM_FIELD_PARENT_ID));
			kPI_List.setKorelasi(getInt(FRM_FIELD_KORELASI));
                        kPI_List.setRangeStart(getFloat(FRM_FIELD_RANGE_START));
                        kPI_List.setRangeEnd(getFloat(FRM_FIELD_RANGE_END));
