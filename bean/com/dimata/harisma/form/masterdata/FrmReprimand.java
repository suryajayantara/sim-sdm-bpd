...
public class FrmReprimand extends FRMHandler implements I_FRMInterface, I_FRMType{
	...
	public static final int FRM_FIELD_REPRIMAND_DESC                =  1 ;
        ...
        public static final int FRM_FIELD_VALID_UNTIL               = 3;
        public static final int FRM_FIELD_SATUAN_VALID_UNTIL               = 4;
        public static final int FRM_FIELD_SHOW_IN_CV               = 5;

	public static String[] fieldNames = {
		"FRM_FIELD_REPRIMAND_ID",
                "FRM_FIELD_REPRIMAND_DESC",
                "FRM_FIELD_REPRIMAND_POINT",
                "FRM_FIELD_VALID_UNTIL",
                "FRM_FIELD_SATUAN_VALID_UNTIL",
                "FRM_FIELD_SHOW_IN_CV"
	} ;
	...
	public void requestEntityObject(Reprimand reprimand) {
		try{
			...
			reprimand.setReprimandDesc(getString(FRM_FIELD_REPRIMAND_DESC));
                        ...
                        reprimand.setValidUntil(getInt(FRM_FIELD_VALID_UNTIL));
                        reprimand.setSatuanValidUntil(getInt(FRM_FIELD_SATUAN_VALID_UNTIL));
                        reprimand.setShowInCV(getInt(FRM_FIELD_SHOW_IN_CV));
		}catch(Exception e){
