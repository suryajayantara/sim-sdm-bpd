...
public class FrmDocMasterFlow extends FRMHandler implements I_FRMInterface, I_FRMType{
  ...
  public static final int FRM_FIELD_FILTER_FOR_DIVISION_ID = 10;
    ...
    "FRM_FIELD_FILTER_FOR_DIVISION_ID"
    };
    ...
    docMasterFlow.setFilter_for_division_id(getLong(FRM_FIELD_FILTER_FOR_DIVISION_ID));
