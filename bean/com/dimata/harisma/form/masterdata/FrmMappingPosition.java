...
public class FrmMappingPosition extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_VERTICAL_LINE = 7;
    ...
    public void requestEntityObject(MappingPosition entMappingPosition) {
        try {
            ...
            entMappingPosition.setVerticalLine(getInt(FRM_FIELD_VERTICAL_LINE));
            entMappingPosition.setDivisionId(getLong(FRM_FIELD_DIVISION_ID));
        } catch (Exception e) {
