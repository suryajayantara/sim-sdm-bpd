...
public class FrmCompetencyLevel extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_COMPETENCY_GROUP_ID = 9;
    public static final int FRM_FIELD_LEVEL_NAME = 10;
...
//            entCompetencyLevel.setValidEnd(Date.valueOf(getString(FRM_FIELD_VALID_END)));
            entCompetencyLevel.setCompetencyGroupId(getLong(FRM_FIELD_COMPETENCY_GROUP_ID));
            entCompetencyLevel.setLevelName(getString(FRM_FIELD_LEVEL_NAME));
