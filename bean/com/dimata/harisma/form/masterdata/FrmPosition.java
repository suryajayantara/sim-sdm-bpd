...
public class FrmPosition extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    //ARYS 20160818
    public static final int FRM_FIELD_TENAGA_KERJA = 21;
    public static final int FRM_FIELD_JENIS_JABATAN = 22;
    public static final int FRM_FIELD_ALIAS = 23;
    public static final int FRM_FIELD_POSITION_TYPE_ID = 24;
    ...
    public static String[] fieldNames = {
        ...
        //ARYS 20160818
        "FRM_FIELD_TENAGA_KERJA",
        "FRM_FIELD_JENIS_JABATAN",
        "FRM_FIELD_ALIAS",
    ...
    public void requestEntityObject(Position position) {
        try {
            ...
            //arys 20160819
            position.setTenagaKerja(getInt(FRM_FIELD_TENAGA_KERJA));
            position.setJenisJabatan(getInt(FRM_FIELD_JENIS_JABATAN));
            position.setAlias(getString(FRM_FIELD_ALIAS));
            position.setPosTypeId(getLong(FRM_FIELD_POSITION_TYPE_ID));
        } catch (Exception e) {
