...
public class FrmKPI_Employee_Target extends FRMHandler implements I_FRMInterface, I_FRMType{
	...
	public static final int FRM_FIELD_ACHIEV_DATE = 8;
	public static final int FRM_FIELD_ACHIEV_PROOF = 9;
    ...
    public void requestEntityObject(KPI_Employee_Target kPI_Employee_Target) {
        try {
			...
			kPI_Employee_Target.setAchievDate(Formater.formatDate(getString(FRM_FIELD_ACHIEV_DATE), "yyyy-MM-dd"));
			kPI_Employee_Target.setAchievProof(getString(FRM_FIELD_ACHIEV_PROOF));
