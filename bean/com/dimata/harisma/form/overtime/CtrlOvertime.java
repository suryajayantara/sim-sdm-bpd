...
//                overtime.setRequestDate(dateReq);
                ...
                if (overtime.getOID() == 0) {    // insert
                    ...
                    try {
                        if (this.overtime.getStatusDoc() == I_DocStatus.DOCUMENT_STATUS_DRAFT) {
                            this.overtime.setRequestId(0);
                            this.overtime.setApprovalId(0);
                            this.overtime.setApproval1Id(0);
                            this.overtime.setApproval2Id(0);
                            this.overtime.setApproval3Id(0);
                            this.overtime.setApproval4Id(0);
                            this.overtime.setApproval5Id(0);
                            this.overtime.setApproval6Id(0);
                        }
            ...
            case Command.DELETE:
                if (oid != 0) {
                    try {
                        ...
                        String whereOvDetail = PstOvertimeDetail.fieldNames[PstOvertimeDetail.FLD_OVERTIME_ID]+"="+oid;
                        Vector listOvDetail = PstOvertimeDetail.list(0, 0, whereOvDetail, "");
                        if (listOvDetail.size() > 0){
                            for (int i=0; i < listOvDetail.size(); i++){
                                OvertimeDetail ovDetail = (OvertimeDetail) listOvDetail.get(i);
                                long resultOvDetail = PstOvertimeDetail.deleteExc(ovDetail.getOID());
                            }
                        }
