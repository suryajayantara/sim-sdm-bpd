...
public class FrmOvertime extends FRMHandler implements /*I_Language,*/ I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_OVERTIME_TYPE =35;
    ...
    public void requestEntityObject(Overtime overtime) {
        try {
            this.requestParam();
            overtime.setRequestDate(java.sql.Date.valueOf(getString(FRM_FIELD_REQ_DATE)));
           ...
           if(getLong(FRM_FIELD_ACK_ID)!=0){
            ...
            overtime.setApproval5Id(getLong(FRM_FIELD_APPROVAL_5_ID));
            overtime.setTimeApproval5(getDate(FRM_FIELD_TIME_APPROVAL_5));
            overtime.setApproval6Id(getLong(FRM_FIELD_APPROVAL_6_ID));
            overtime.setTimeApproval6(getDate(FRM_FIELD_TIME_APPROVAL_6));
            overtime.setOvertimeType(getInt(FRM_FIELD_OVERTIME_TYPE));
