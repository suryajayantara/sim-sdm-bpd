...
public class FrmAppUser extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_ADMIN_STATUS = 15;
    ...
    public static  final String[] fieldNames = {
        ...
        , "USER_GROUP","EMPLOYEE_ID","POSITION_LEVEL_ID","EXCEL_IO", "FRM_ADMIN_STATUS"
    } ;
    ...
    public static int[] fieldTypes = {
        ...
        TYPE_LONG,TYPE_STRING,TYPE_INT,TYPE_INT
    };
    ...
    {        
        try {
            ...
            entObj.setAdminStatus(this.getInt(FRM_ADMIN_STATUS));
            this.appUser = entObj;
        }catch(Exception e) {
