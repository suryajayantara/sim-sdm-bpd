...
public class FrmCustomRptMain extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_RPT_MAIN_FULL_ACCESS = 7;
    public static String[] fieldNames = {
        ...
        "FRM_FIELD_RPT_MAIN_FULL_ACCESS"
    };
    ...
    public void requestEntityObject(CustomRptMain entCustomRptMain) {
        try {
            ...
            entCustomRptMain.setRptMainFullAccess(getInt(FRM_FIELD_RPT_MAIN_FULL_ACCESS));
        } catch (Exception e) {
