...
public class FrmEmployee extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_SK_NOMOR = 93;
    public static final int FRM_FIELD_SK_TANGGAL = 94;
    public static final int FRM_FIELD_NKK = 95;
    /* Update By Hendra Putu | 2016-06-15 */
    public static final int FRM_FIELD_SK_NOMOR_GRADE = 96;
    public static final int FRM_FIELD_SK_TANGGAL_GRADE = 97;
    public static final int FRM_FIELD_NAME_ON_CARD = 98;
    public static final int FRM_FIELD_NATIONALITY = 99;
     public static final int FRM_FIELD_FIRST_CONTRACT_DATE = 100;
    public static final int FRM_FIELD_BPJS_TK_PENSIUN = 101;
    public static final int FRM_FIELD_BPJS_TK_PENSIUN_DATE = 102;
    
    /* date string alternative - 2016-12-21 */
    public static final int FRM_FIELD_COMMENCING_DATE_STR = 103;
    public static final int FRM_FIELD_PROBATION_END_DATE_STR = 104;
    public static final int FRM_FIELD_START_DATE_PENSIUN_STR = 105;
    public static final int FRM_FIELD_END_CONTRACT_STR = 106;
    public static final int FRM_FIELD_RESIGNED_DATE_STR = 107;
    ...
    public static String[] fieldNames = {
        ...
        /* Update By Hendra Putu | 2016-06-08 */
        "FRM_FIELD_SK_NOMOR",
        "FRM_FIELD_SK_TANGGAL",
        "FRM_FIELD_NKK",
        "FRM_FIELD_SK_NOMOR_GRADE",
        "FRM_FIELD_SK_TANGGAL_GRADE",
        "FRM_FIELD_NAME_ON_CARD",
        "FRM_FIELD_NATIONALITY",
        "FRM_FIELD_FIRST_CONTRACT_DATE",
        "FRM_FIELD_BPJS_TK_PENSIUN",
        "FRM_FIELD_BPJS_TK_PENSIUN_DATE",
        "FRM_FIELD_COMMENCING_DATE_STR",
        "FRM_FIELD_PROBATION_END_DATE_STR",
        "FRM_FIELD_START_DATE_PENSIUN_STR",
        "FRM_FIELD_END_CONTRACT_STR",
        "FRM_FIELD_RESIGNED_DATE_STR"
    };
    ...
    public static int[] fieldTypes = {
        ...
        TYPE_LONG,
        TYPE_DATE,
        TYPE_STRING,/*"FRM_FIELD_COMMENCING_DATE_STR",*/
        TYPE_STRING,/*"FRM_FIELD_PROBATION_END_DATE_STR",*/
        TYPE_STRING,/*"FRM_FIELD_START_DATE_PENSIUN_STR",*/
        TYPE_STRING,/*"FRM_FIELD_END_CONTRACT_STR",*/
        TYPE_STRING/*"FRM_FIELD_RESIGNED_DATE_STR"*/
    ...
    public void requestEntityObject(Employee employee) {
        try {
            ...
            if (getDate(FRM_FIELD_COMMENCING_DATE) == null){
                if (getString(FRM_FIELD_COMMENCING_DATE_STR).equals("")||getString(FRM_FIELD_COMMENCING_DATE_STR).equals("null")){
                    employee.setCommencingDate(null);
                } else {
                    employee.setCommencingDate(format.parse(getString(FRM_FIELD_COMMENCING_DATE_STR)));
                }
            } else {
            ...
            if (getDate(FRM_FIELD_RESIGNED_DATE)==null){
                if (getString(FRM_FIELD_RESIGNED_DATE_STR).equals("")||getString(FRM_FIELD_RESIGNED_DATE_STR).equals("null")){
                    employee.setResignedDate(null);
                } else {
                    employee.setResignedDate(format.parse(getString(FRM_FIELD_RESIGNED_DATE_STR)));
                }
            } else {
            ...
            if (getDate(FRM_FIELD_END_CONTRACT)==null){
                if (getString(FRM_FIELD_END_CONTRACT_STR).equals("")||getString(FRM_FIELD_END_CONTRACT_STR).equals("null")){
                    employee.setEnd_contract(null);
                } else {
                    employee.setEnd_contract(format.parse(getString(FRM_FIELD_END_CONTRACT_STR)));
                }
            } else {
            ...
            if (getDate(FRM_FIELD_PROBATION_END_DATE)==null){
                if (getString(FRM_FIELD_PROBATION_END_DATE_STR).equals("")||getString(FRM_FIELD_PROBATION_END_DATE_STR).equals("null")){
                    employee.setProbationEndDate(null);
                } else {
                    employee.setProbationEndDate(format.parse(getString(FRM_FIELD_PROBATION_END_DATE_STR)));
                }
            } else {
            ...
            if (getDate(FRM_FIELD_START_DATE_PENSIUN)== null){
                if (getString(FRM_FIELD_START_DATE_PENSIUN_STR).equals("")||getString(FRM_FIELD_START_DATE_PENSIUN_STR).equals("null")){
                    employee.setStartDatePensiun(null);
                } else {
                    employee.setStartDatePensiun(format.parse(getString(FRM_FIELD_START_DATE_PENSIUN_STR)));
                }
            } else {
            ...
            employee.setNameCard(getString(FRM_FIELD_NAME_ON_CARD));
            employee.setNationalityId(getLong(FRM_FIELD_NATIONALITY));
            ...
            employee.setFirstContractDate(getDate(FRM_FIELD_FIRST_CONTRACT_DATE));
            employee.setBpjsTkPensiunDate(getDate(FRM_FIELD_BPJS_TK_PENSIUN_DATE));
            employee.setBpjsTkPensiun(getLong(FRM_FIELD_BPJS_TK_PENSIUN));
            /* Update By Hendra Putu | 2016-06-08 */
            
            employee.setSkNomor(getString(FRM_FIELD_SK_NOMOR));
            employee.setSkNomorGrade(getString(FRM_FIELD_SK_NOMOR_GRADE));
            if (getString(FRM_FIELD_SK_TANGGAL).equals("")||getString(FRM_FIELD_SK_TANGGAL).equals("null")){
                employee.setSkTanggal(null);
            } else {
                employee.setSkTanggal(format.parse(getString(FRM_FIELD_SK_TANGGAL)));
            }
            
            if (getString(FRM_FIELD_SK_TANGGAL_GRADE).equals("")||getString(FRM_FIELD_SK_TANGGAL_GRADE).equals("null")){
                employee.setSkTanggalGrade(null);
            } else {
                employee.setSkTanggalGrade(format.parse(getString(FRM_FIELD_SK_TANGGAL_GRADE)));
            }
            employee.setNkk(getString(FRM_FIELD_NKK));
