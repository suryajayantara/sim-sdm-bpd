...
String getEmployeePresence="";
   String[] stsPresence = null;
            ...
            //document.add(new Paragraph("First page of the document."));
             ...
             Vector vCompany = PstCompany.list(0, 0, inCompany.equals("")?"":PstCompany.fieldNames[PstCompany.FLD_COMPANY_ID]+" IN ("+inCompany+")", PstCompany.fieldNames[PstCompany.FLD_COMPANY]+" ASC ");
            for(int c=0; c < vCompany.size(); c++){
               Company company = (Company) vCompany.get(c);
               Vector vdivision = PstDivision.list(0,1000, !inDivision.equals("")?PstDivision.fieldNames[PstDivision.FLD_DIVISION_ID]+" IN ("+inDivision+")":PstDivision.fieldNames[PstDivision.FLD_COMPANY_ID]+" IN ("+company.getOID()+")",PstDivision.fieldNames[PstDivision.FLD_DIVISION]+" ASC ");            
