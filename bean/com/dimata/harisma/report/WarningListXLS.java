...
public class WarningListXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setHeader("Content-Disposition", "attachment; filename=daftar_peringatan.xls");
        ...
        String[] tableHeaderEng = {
            "NO", "PAYROLL", "EMPLOYEE", "DIVISION", "DEPARTMENT", "POSITION", "DATE", "FACTS", "LEVEL", "WARN BY"
        };
        
        String[] tableHeaderID = {
            "NO", "NRK", "Nama Karyawan", "Satuan Kerja", "Unit", "Jabatan", "Tanggal", "Deskripsi", "Level", "Diberikan Oleh"
        };
        ...
        for (int i = 0; i < listSource.size(); i++) {
            ...
            cell.setCellStyle(styleTop);
            cell = row.createCell((short) 3);
            cell.setCellValue(div.getDivision());
            cell.setCellStyle(styleTop);
