...
public class EsptReportXLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(getInBenSalBrutto.equals("1")){
            String where = PstPayComponent.fieldNames[PstPayComponent.FLD_COMP_TYPE] + " = 1 AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_TAX_ITEM] + " IN (1,2)";
        ...
        if (listEspt != null && listEspt.size() > 0) {
            for (int i = 0; i < listEspt.size(); i++) {
                ...
                String strNpwp = espt.getNpwp().replace(".", "");
                strNpwp = strNpwp.replace("-", "");
                
                cell = row.createCell((short) 4);
                cell.setCellValue(strNpwp);
                cell.setCellStyle(style2);
//              
