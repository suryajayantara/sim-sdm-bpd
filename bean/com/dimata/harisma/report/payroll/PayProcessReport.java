...
public class PayProcessReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        long payrollGroupId = FRMQueryString.requestLong(request, "payGroupId");
        ...
        if (periodId != 0){
            listEmpLevel = PstPayEmpLevel.listEmpLevelwithDateResign(levelCode, checkValues,oidDivision, oidDepartment, null , PstEmployee.NO_RESIGN, payPeriod123.getStartDate(), payPeriod123.getEndDate(),payPeriod123.getStartDate(), payPeriod123.getEndDate(),payrollGroupId );
        } else {
