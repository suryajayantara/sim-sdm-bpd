...
import com.dimata.harisma.entity.admin.UserGroup;
     ...
     for (int i = 0; i < userGroupList.size(); i++) {
         ...
         if (groupList != null && groupList.size() > 0) {
             ...
             if (appGroup.getGroupName().equals("Admin Cabang")){
                 ...
                 statusUser = 2;
             } else if (appGroup.getGroupName().equals("Admin Divisi")){
                 statusUser = 3;
             }
...
//if(statusUser == 0 && appUserSess.getAdminStatus() != 1){
//    flyout.addMenuFlyOut("employee.jsp", dictionaryD.getWord(I_Dictionary.EMPLOYEE), dictionaryD.getWord(I_Dictionary.DATA_BANK), true, "Profil Pribadi", "data_bank", "#", ""+approot+"/employee/databank/employee_view_new.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
//             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_DATABANK, AppObjInfo.OBJ_MENU_MY_PROFILE), 
//             AppObjInfo.COMMAND_VIEW)));
//} else {
//    flyout.addMenuFlyOut("employee.jsp", dictionaryD.getWord(I_Dictionary.EMPLOYEE), dictionaryD.getWord(I_Dictionary.DATA_BANK), true, dictionaryD.getWord(I_Dictionary.DATA_BANK), "data_bank", "#" , ""+approot+"/employee/databank/srcemployee.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("organisasi.jsp", dictionaryD.getWord(I_Dictionary.COMPANY_ORGANIZATION), "Jabatan Kosong", false, null, "company_structure", ""+approot+"/organization/empty_position.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_ORGANISASI, AppObjInfo.G2_MENU_STRUKTUR_ORGANISASI, AppObjInfo.OBJ_MENU_STRUKTUR_ORGANISASI), 
             AppObjInfo.COMMAND_VIEW)));
/*
...
flyout.addMenuFlyOut("organisasi.jsp", dictionaryD.getWord(I_Dictionary.COMPANY_ORGANIZATION), "Jumlah Karyawan", false, null, "search_amount_emp", ""+approot+"/masterdata/search_amount_emp.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_ORGANISASI, AppObjInfo.G2_MENU_EMPLOYEE_AMOUNT, AppObjInfo.OBJ_MENU_EMPLOYEE_AMOUNT), 
             AppObjInfo.COMMAND_VIEW)));
/*
...
flyout.addMenuFlyOut("organisasi.jsp", dictionaryD.getWord(I_Dictionary.COMPANY_ORGANIZATION), "Master Data Organisasi", true, dictionaryD.getWord(I_Dictionary.SECTION), "srcsection", "#", ""+approot+"/masterdata/section_new.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("organisasi.jsp", dictionaryD.getWord(I_Dictionary.COMPANY_ORGANIZATION), "Master Data Organisasi", true, "Jenis Jabatan", "position_type", "#", ""+approot+"/masterdata/position_type.jsp",userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("organisasi.jsp", dictionaryD.getWord(I_Dictionary.COMPANY_ORGANIZATION), "Master Data Organisasi", true, "Notification", "MasterNotification", "#", ""+approot+"/masterdata/MasterNotification.jsp",userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_ORGANISASI, AppObjInfo.G2_MENU_STRUKTUR_PERUSAHAAN, AppObjInfo.OBJ_MENU_JABATAN), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("employee.jsp", dictionaryD.getWord(I_Dictionary.EMPLOYEE), "Master Data", true, "Nationality", "employee", "#", ""+approot+"/masterdata/nationality.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_DATABANK, AppObjInfo.OBJ_MENU_DATABANK), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("employee.jsp", dictionaryD.getWord(I_Dictionary.EMPLOYEE), "Master Data", true, "Ubah Status Perkawinan", "employee", "#", ""+approot+"/masterdata/change_marital_status.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_DATABANK, AppObjInfo.OBJ_MENU_DATABANK), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("employee.jsp", dictionaryD.getWord(I_Dictionary.EMPLOYEE), "Master Data", true, "Character Power", "employee", "#", ""+approot+"/masterdata/power_character.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_DATABANK, AppObjInfo.OBJ_MENU_DATABANK), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("payroll.jsp", dictionaryD.getWord(I_Dictionary.PAYROLL), dictionaryD.getWord(I_Dictionary.CHART_OF_ACCOUNT), false, null, "chartofaccount", ""+approot+"/payroll/setup/chart_of_account.jsp", "",userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_PAYROLL, AppObjInfo.G2_MENU_PAYROLL_SETUP, AppObjInfo.OBJ_MENU_CURRENCY_RATE), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("payroll.jsp", dictionaryD.getWord(I_Dictionary.PAYROLL), dictionaryD.getWord(I_Dictionary.PAYSLIP_PRINTING), false, null, "payroll_process", "" + approot + "/payroll/process/pay-printing.jsp", "",userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_PAYROLL, AppObjInfo.G2_PAYROLL_PROCESS, AppObjInfo.OBJ_PAYROLL_PROCESS_PRINT), 
             AppObjInfo.COMMAND_VIEW)));
/*
...
4) Kandidat
  ...
  Persyaratan Jabatan
*/
flyout.addMenuFlyOut("candidate.jsp", dictionaryD.getWord(I_Dictionary.CANDIDATE), dictionaryD.getWord(I_Dictionary.CANDIDATE_SEARCH), false, null, "candidate", ""+approot+"/employee/candidate/candidate_process_simple.jsp?type_menu=0", "", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("competence.jsp", "Kompetensi & Talent Pool", "Tipe Kompetensi", false, null, "competency_type", ""+approot+"/masterdata/competency_type.jsp", "",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_COMPETENCY, AppObjInfo.G2_MENU_COMPETENCY_TYPE, AppObjInfo.OBJ_MENU_COMPETENCY_TYPE), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("competence.jsp", "Kompetensi & Talent Pool", dictionaryD.getWord(I_Dictionary.COMPETENCY_GROUP), false, null, "competency_group", ""+approot+"/masterdata/competency_group.jsp", "",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_COMPETENCY, AppObjInfo.G2_MENU_COMPETENCY_GROUP, AppObjInfo.OBJ_MENU_COMPETENCY_GROUP), 
             AppObjInfo.COMMAND_VIEW)));
/* Update by Hendra | 20161005 | sub menu talent pool */
flyout.addMenuFlyOut("competence.jsp", "Kompetensi & Talent Pool", "Talent Pool", false, null, "talent_pool", ""+approot+"/employee/talent/talent_pool.jsp", "",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_COMPETENCY, AppObjInfo.G2_MENU_TALENT_POOL, AppObjInfo.OBJ_MENU_TALENT_POOL), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("competence.jsp", "Kompetensi & Talent Pool", dictionaryD.getWord(I_Dictionary.COMPETENCY), false, null, "competency", ""+approot+"/masterdata/competency.jsp", "",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_COMPETENCY, AppObjInfo.G2_MENU_COMPETENCY, AppObjInfo.OBJ_MENU_COMPETENCY), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("competence.jsp", "Kompetensi & Talent Pool", dictionaryD.getWord(I_Dictionary.COMPETENCY_DETAIL), false, null, "competency_detail", ""+approot+"/masterdata/competency_detail.jsp", "",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_COMPETENCY, AppObjInfo.G2_MENU_DETAIL_COMPETENCY, AppObjInfo.OBJ_MENU_DETAIL_COMPETENCY), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("competence.jsp", "Kompetensi & Talent Pool", dictionaryD.getWord(I_Dictionary.COMPETENCY_LEVEL), false, null, "competency_level", ""+approot+"/masterdata/competency_level.jsp", "",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_COMPETENCY, AppObjInfo.G2_MENU_LEVEL_COMPETENCY, AppObjInfo.OBJ_MENU_LEVEL_COMPETENCY), 
             AppObjInfo.COMMAND_VIEW)));

 flyout.addMenuFlyOut("competence.jsp", "Kompetensi & Talent Pool", "Laporan Kompetensi", true, "GAP Kompetensi", "competency", "#", ""+approot+"/report/competency/gap_competency.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
            AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_COMPETENCY, AppObjInfo.G2_MENU_LAPORAN_KOMPETENSI, AppObjInfo.OBJ_MENU_RPT_GAP_COMPETENCY), 
             AppObjInfo.COMMAND_VIEW)));
 flyout.addMenuFlyOut("competence.jsp", "Kompetensi & Talent Pool", "Laporan Kompetensi", true, "Pencapaian Kompetensi", "competency", "#", ""+approot+"/report/competency/report_memenuhi_kompetensi.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
            AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_COMPETENCY, AppObjInfo.G2_MENU_LAPORAN_KOMPETENSI, AppObjInfo.OBJ_MENU_RPT_DAFTAR_COMPETENCY), 
             AppObjInfo.COMMAND_VIEW)));
 flyout.addMenuFlyOut("competence.jsp", "Kompetensi & Talent Pool", "Laporan Kompetensi", true, "Daftar Kompetensi", "competency", "#", ""+approot+"/report/competency/report_daftar_kompetensi.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
            AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_COMPETENCY, AppObjInfo.G2_MENU_LAPORAN_KOMPETENSI, AppObjInfo.OBJ_MENU_RPT_DAFTAR_COMPETENCY), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("performance.jsp", "Performance Management", "Target & Distribusi", false, null, "absence_management", ""+approot+"/masterdata/kpi_target_list.jsp", "",userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_PERFORMANCE, AppObjInfo.OBJ_KPI_COMPANY_TARGET), 
             AppObjInfo.COMMAND_VIEW))); 
			 
flyout.addMenuFlyOut("performance.jsp", "Performance Management", "Target Karyawan", false, null, "absence_management", ""+approot+"/masterdata/kpi_achievment.jsp", "",userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_PERFORMANCE, AppObjInfo.OBJ_KPI_LIST), 
             AppObjInfo.COMMAND_VIEW))); 
			 
			 
flyout.addMenuFlyOut("performance.jsp", "Performance Management", "Input Realisasi", false, null, "absence_management", ""+approot+"/masterdata/kpi_achievment.jsp", "",userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_PERFORMANCE, AppObjInfo.OBJ_KPI_COMPANY_TARGET), 
             AppObjInfo.COMMAND_VIEW))); 
flyout.addMenuFlyOut("performance.jsp", "Performance Management", "Akumulasi Performa", false, null, "absence_management", ""+approot+"/masterdata/kpi_company_target_real.jsp", "",userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_PERFORMANCE, AppObjInfo.OBJ_KPI_LIST), 
             AppObjInfo.COMMAND_VIEW))); 
...
flyout.addMenuFlyOut("kinerja.jsp", "Penilaian", "Manajemen Kinerja", true, "Penilaian Karyawan", "assessment", "#", ""+approot+"/employee/appraisalnew/srcappraisal.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("kinerja.jsp", "Penilaian", "Manajemen Kinerja", true, "Laporan Kinerja", "assessment", "#", ""+approot+"/employee/kpi/kpi_achievement.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("kinerja.jsp", "Penilaian", "Form Penilaian", true, "Tingkat Karyawan", "assessment", "#", ""+approot+"/masterdata/grouprankHR.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("kinerja.jsp", "Penilaian", "Form Penilaian", true, "Kriteria Penilaian", "assessment", "#", ""+approot+"/masterdata/evaluation.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("kinerja.jsp", "Penilaian", "Form Penilaian", true, "Form Creator", "assessment", "#", ""+approot+"/masterdata/assessment/assessmentFormMain.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("surat.jsp", "Surat Perusahaan", "Master Data", true, "Template Surat", "company", "#", ""+approot+"/masterdata/doc_master.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_MASTERDATA, AppObjInfo.G2_MENU_MD_COMPANY, AppObjInfo.OBJ_MENU_DIVISION), 
             AppObjInfo.COMMAND_VIEW)));
/* update by Hendra 2016-12-13 */
flyout.addMenuFlyOut("surat.jsp", "Surat Perusahaan", "Master Data", true, "Setup Jurnal Voucher", "surat", "#", ""+approot+"/masterdata/setup_jv.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_MASTERDATA, AppObjInfo.G2_MENU_MD_COMPANY, AppObjInfo.OBJ_MENU_DIVISION), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("surat.jsp", "Surat Perusahaan", "Daftar Surat", false, null, "Surat",  ""+approot+"/employee/document/emp_document.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_DOKUMEN_SURAT, AppObjInfo.G2_EMP_DOCUMENT, AppObjInfo.OBJ_EMP_DOCUMENT), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("training.jsp", dictionaryD.getWord(I_Dictionary.TRAINING), dictionaryD.getWord(I_Dictionary.TRAINING_HISTORY), false, null, "training_history", ""+approot+"/employee/training/search_training_history.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("training.jsp", dictionaryD.getWord(I_Dictionary.TRAINING), "Riwayat Pelatihan/Sertifikasi", false, null, "training_history", ""+approot+"/employee/training/search_data_riwayat_pelatihan.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_PELATIHAN, AppObjInfo.G2_MENU_SEJARAH_PELATIHAN, AppObjInfo.OBJ_MENU_SEJARAH_PELATIHAN), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("training.jsp", dictionaryD.getWord(I_Dictionary.TRAINING), "Gap Training", false, null, "training_history", ""+approot+"/employee/training/search_gap_training.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
...
flyout.addMenuFlyOut("training.jsp", dictionaryD.getWord(I_Dictionary.TRAINING), "Training Area"    , false, null,  "training_area", ""+approot+"/masterdata/training_area.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_PELATIHAN, AppObjInfo.G2_MENU_TIPE_PELATIHAN, AppObjInfo.OBJ_MENU_TIPE_PELATIHAN), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("training.jsp", dictionaryD.getWord(I_Dictionary.TRAINING), "Training Location Type"    , false, null,  "training_location_type", ""+approot+"/masterdata/training_location_type.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_PELATIHAN, AppObjInfo.G2_MENU_TIPE_PELATIHAN, AppObjInfo.OBJ_MENU_TIPE_PELATIHAN), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("training.jsp", dictionaryD.getWord(I_Dictionary.TRAINING), "Anggaran Training"    , false, null,  "training_budget", ""+approot+"/masterdata/training_budget.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_PELATIHAN, AppObjInfo.G2_MENU_TIPE_PELATIHAN, AppObjInfo.OBJ_MENU_TIPE_PELATIHAN), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("absensi.jsp", "Absensi", dictionaryD.getWord(I_Dictionary.ATTENDANCE), true, "Update Schedule", "attendance", "#", ""+approot+"/report/presence/update_schedule.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_ATTENDANCE, AppObjInfo.OBJ_MENU_REGENERATE_SCHEDULE_HOLIDAYS), 
             AppObjInfo.COMMAND_VIEW)));
...
if(statusUser != 1 && appUserSess.getAdminStatus() != 1 && statusUser != 3){
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), dictionaryD.getWord(I_Dictionary.LEAVE_APPLICATION), true, dictionaryD.getWord(I_Dictionary.LEAVE_APPLICATION), "leave_application", "#", ""+approot+"/employee/leave/leave_app_form.jsp?employee_id="+oidEmp, userSession.checkPrivilege(AppObjInfo.composeCode(
        AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_LEAVE_APPLICATION, AppObjInfo.OBJ_MENU_LEAVE_FORM), 
        AppObjInfo.COMMAND_VIEW)));	
} else {
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), dictionaryD.getWord(I_Dictionary.LEAVE_APPLICATION), true, "Form Cuti", "leave_application", "#", "" + approot + "/employee/leave/cuti.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
    AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_APPLICATION, AppObjInfo.OBJ_LEAVE_APPLICATION),
    AppObjInfo.COMMAND_VIEW)));
}
...
if (statusUser == 1){
	...
	flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), dictionaryD.getWord(I_Dictionary.LEAVE_BALANCING), true, "Annual Leave", "leave_balancing", "#", "" + approot + "/system/leave/AL_Balancing.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
        AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_BALANCING, AppObjInfo.OBJ_LEAVE_BALANCING_ANNUAL_LEAVE),
        AppObjInfo.COMMAND_VIEW)));

	flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), dictionaryD.getWord(I_Dictionary.LEAVE_BALANCING), true, "Long Leave", "leave_balancing", "#", "" + approot + "/system/leave/LL_Balancing.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
        AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_BALANCING, AppObjInfo.OBJ_LEAVE_BALANCING_LONG_LEAVE),
        AppObjInfo.COMMAND_VIEW)));
}
...
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), dictionaryD.getWord(I_Dictionary.LEAVE_BALANCING), true, "Day off Payment", "leave_balancing", "#", "" + approot + "/system/leave/DP_Balancing.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
        AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_BALANCING, AppObjInfo.OBJ_DAY_OFF_PAYMENT),
        AppObjInfo.COMMAND_VIEW)));
}
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), "Cut Off Cuti", true, dictionaryD.getWord(I_Dictionary.LEAVEL_AL_CLOSING), "leave_application", "#", "" + approot + "/employee/leave/leave_al_closing.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
        AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_MANAGEMENT, AppObjInfo.OBJ_LEAVE_AL_CLOSING),
        AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), "Cut Off Cuti", true, dictionaryD.getWord(I_Dictionary.LEAVE_LL_CLOSING), "leave_application", "#", "" + approot + "/employee/leave/leave_ll_closing.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
        AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_MANAGEMENT, AppObjInfo.OBJ_LEAVE_LI_CLOSING),
        AppObjInfo.COMMAND_VIEW)));
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), "History Cuti Karyawan", false, null, "leave_application", ""+approot+"/employee/leave/leave_list_emp.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_APPLICATION, AppObjInfo.OBJ_HISTORY_LEAVE_EMPLOYEE), 
             AppObjInfo.COMMAND_VIEW)));
if (statusUser == 1 || appUserSess.getAdminStatus() == 1 || statusUser == 3){
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), "Daftar Cuti", false, null, "leave_application", ""+approot+"/employee/leave/leave_app_search.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
         AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_APPLICATION, AppObjInfo.OBJ_LEAVE_APPLICATION), 
         AppObjInfo.COMMAND_VIEW)));
}
if (statusUser == 1 || appUserSess.getAdminStatus() == 1){
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), "Daftar Cuti Approved", false, null, "leave_application", ""+approot+"/employee/leave/list_emp_approved.jsp", "", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_APPLICATION, AppObjInfo.OBJ_LEAVE_APPLICATION), 
             AppObjInfo.COMMAND_VIEW)));
}
...
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), dictionaryD.getWord(I_Dictionary.DP_MANAGEMENT), true, dictionaryD.getWord(I_Dictionary.DP_MANAGEMENT), "leave_application", "#", "" + approot + "/employee/attendance/dp.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
        AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_APPLICATION, AppObjInfo.OBJ_DP_MANAGEMENT),
        AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("leave.jsp", dictionaryD.getWord(I_Dictionary.LEAVE), dictionaryD.getWord(I_Dictionary.DP_MANAGEMENT), true, dictionaryD.getWord(I_Dictionary.DP_RECALCULATE), "leave_application", "#", "" + approot + "/employee/leave/if_dp_not_balance.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
        AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_LEAVE_APPLICATION, AppObjInfo.OBJ_DP_RECALCULATE),
        AppObjInfo.COMMAND_VIEW)));
}
...
flyout.addMenuFlyOut("teguran.jsp", "Kasus Karyawan", dictionaryD.getWord(I_Dictionary.WARNING_AND_REPRIMAND), true, dictionaryD.getWord(I_Dictionary.WARNING), "teguran", "#", ""+approot+"/employee/warning/src_warning.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             ...
             AppObjInfo.COMMAND_VIEW)));
flyout.addMenuFlyOut("teguran.jsp", "Kasus Karyawan", dictionaryD.getWord(I_Dictionary.WARNING_AND_REPRIMAND), true, dictionaryD.getWord(I_Dictionary.REPRIMAND), "teguran", "#", ""+approot+"/employee/warning/src_reprimand.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
...
/* ===== REPORT / PRESENCE ===== */		 
    ...
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PRESENCE_REPORT, AppObjInfo.OBJ_REKAPITULASI_ABSENSI), 
    AppObjInfo.COMMAND_VIEW)));
    ...
    flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.PRESENCE), true, "Kehadiran Per Simbol", "staff_control", "#", ""+approot+"/report/presence/rekap_kehadiran_per_symbol.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
    AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_STAFF_CONTROL_REPORT, AppObjInfo.OBJ_MENU_ATTENDANCE_RECORD_REPORT), 
    AppObjInfo.COMMAND_VIEW)));
    
    flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.PRESENCE), true, "Grafik Kehadiran", "staff_control", "#", ""+approot+"/report/presence/graphic_report_presence.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
    AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_STAFF_CONTROL_REPORT, AppObjInfo.OBJ_MENU_ATTENDANCE_RECORD_REPORT), 
    AppObjInfo.COMMAND_VIEW)));
...
/* ===== REPORT / LATENESS ===== */				 
    ...
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_LATENESS_REPORT, AppObjInfo.OBJ_LATENESS_DAILY_REPORT), 
    AppObjInfo.COMMAND_VIEW)));
    ...
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_LATENESS_REPORT, AppObjInfo.OBJ_LATENESS_WEEKLY_REPORT), 
    AppObjInfo.COMMAND_VIEW)));
    ...
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_LATENESS_REPORT, AppObjInfo.OBJ_LATENESS_MONTHLY_REPORT), 
    AppObjInfo.COMMAND_VIEW)));
...
/* ===== REPORT / PAYROLL ===== */
    ...
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_GAJI_TRANSFER), 
    AppObjInfo.COMMAND_VIEW)));             
    /* REKAP GAJI (BENEFIT DEDUCTION) */
    ...
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_REKAP_GAJI), 
    AppObjInfo.COMMAND_VIEW)));
    /* LAPORAN REKONSILIASI (BENEFIT DEDUCTION DEPARTMENT) */
...
//    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_REKONSILIASI), 
//    AppObjInfo.COMMAND_VIEW)));
    /* ESPT BULANAN */
    ...
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_ESPT_MONTH), 
    AppObjInfo.COMMAND_VIEW)));
    /* ESPT A1 */
    ...
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_ESPT_A1), 
    AppObjInfo.COMMAND_VIEW)));
    /* JURNAL REPORT */
if(appUserSess.getAdminStatus() == 1){    
    flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.PAYROLL), true, dictionaryD.getWord(I_Dictionary.JV_REPORT), "payroll", "#", ""+approot+"/report/payroll/jurnal_report.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_JURNAL_REPORT), 
    AppObjInfo.COMMAND_VIEW)));
}
...
//    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_LEAVE_ENTITLE), 
//    AppObjInfo.COMMAND_VIEW)));
//    /* TAKEN LEAVE REPORT */
...
//    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_TAKEN_LEAVE), 
//    AppObjInfo.COMMAND_VIEW)));
    /* CUSTOM REPORT */
    flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.PAYROLL), true, dictionaryD.getWord(I_Dictionary.CUSTOM_REPORT), "payroll", "#", ""+approot+"/report/payroll/custom_rpt_main.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_CUSTOM_RPT_MAIN), 
    AppObjInfo.COMMAND_VIEW)));
    /* MEAL ALLOWANCE */
    flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.PAYROLL), true, "Uang Makan", "payroll", "#", ""+approot+"/report/payroll/meal_allowance_report.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_MEAL_ALLOWANCE_RPT), 
    AppObjInfo.COMMAND_VIEW)));
    /* SPJ REPORT */
    flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.PAYROLL), true, "Spj Report", "payroll", "#", ""+approot+"/report/payroll/spj_report.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_SPJ_REPORT), 
    AppObjInfo.COMMAND_VIEW)));
    /*PERIODICAL COMPONENT REPORT*/
    flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.PAYROLL), true, "Periodical Component Report", "payroll", "#", ""+approot+"/report/payroll/periodical_component_report.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
    AppObjInfo.composeObjCode(AppObjInfo.G1_REPORTS, AppObjInfo.G2_PAYROLL_REPORT, AppObjInfo.OBJ_PERIODICAL_COMP_REPORT), 
    AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.LEAVE_REPORT), true, "Laporan Cuti", "leave_report", "#", ""+approot+"/employee/leave/leave_report.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_LEAVE_REPORT, AppObjInfo.OBJ_MENU_LEAVE_REPORT), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.LEAVE_REPORT), true, "Rekap Cuti", "leave_report", "#", ""+approot+"/report/leavedp/rekap_cuti.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_LEAVE_REPORT, AppObjInfo.OBJ_MENU_REKAP_CUTI), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.LEAVE_REPORT), true, "Laporan Akumulasi Cuti", "leave_report", "#", ""+approot+"/report/leavedp/akumulasi_cuti.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_LEAVE_REPORT, AppObjInfo.OBJ_MENU_REKAP_CUTI), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.LEAVE_REPORT), true, "Daftar Penerima Cuti Besar", "leave_report", "#", ""+approot+"/report/leavedp/ll_owning_report.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_LEAVE_REPORT, AppObjInfo.OBJ_MENU_LEAVE_REPORT), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), dictionaryD.getWord(I_Dictionary.OVERTIME), true, dictionaryD.getWord(I_Dictionary.OVERTIME), "overtime_report", "#", ""+approot+"/report/payroll/overtime_report.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_PAYROLL_REPORT, AppObjInfo.OBJ_MENU_OVERTIME_RPT), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Databank Karyawan", true, "Riwayat Jabatan", "employee", "#", ""+approot+"/report/employee/position_history.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_EMPLOYEE_REPORT, AppObjInfo.OBJ_MENU_LIST_EMPLOYEE_RACE_REPORT), 
             AppObjInfo.COMMAND_VIEW)));

//ADDED BY DEWOK 20190408
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Databank Karyawan", true, "Masa Jabatan Terakhir", "employee", "#", ""+approot+"/report/employee/masa_jabatan_terakhir.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_EMPLOYEE_REPORT, AppObjInfo.OBJ_MENU_LIST_EMPLOYEE_RACE_REPORT), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Databank Karyawan", true, "Usia dan Masa Kerja Karyawan", "employee", "#", ""+approot+"/report/employee/list_employee_age.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_EMPLOYEE_REPORT, AppObjInfo.OBJ_MENU_LIST_EMPLOYEE_RACE_REPORT), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Databank Karyawan", true, "Ulang Tahun Karyawan", "employee", "#", ""+approot+"/report/employee/employee_birthday.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_EMPLOYEE_REPORT, AppObjInfo.OBJ_MENU_LIST_EMPLOYEE_RACE_REPORT), 
             AppObjInfo.COMMAND_VIEW)));
...
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Laporan Khusus", true, "Laporan Pihak Terkait", "laporan_khusus", "#", ""+approot+"/report/employee/laporan_pihak_terkait.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_SPECIFIC_REPORT, AppObjInfo.OBJ_MENU_FAMILY_REPORT), 
             AppObjInfo.COMMAND_VIEW))); 
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Laporan Khusus", true, "Laporan LKPBU Form 801", "laporan_khusus", "#", ""+approot+"/report/employee/list_lkpbu_801.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_SPECIFIC_REPORT, AppObjInfo.OBJ_MENU_LKPBU_801_REPORT), 
             AppObjInfo.COMMAND_VIEW))); 			 
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Laporan Khusus", true, "Laporan LKPBU Form 802", "laporan_khusus", "#", ""+approot+"/report/employee/list_lkpbu_802.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_SPECIFIC_REPORT, AppObjInfo.OBJ_MENU_LKPBU_802_REPORT), 
             AppObjInfo.COMMAND_VIEW))); 
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Laporan Khusus", true, "Laporan LKPBU Form 803", "laporan_khusus", "#", ""+approot+"/report/employee/list_lkpbu_803.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_SPECIFIC_REPORT, AppObjInfo.OBJ_MENU_LKPBU_803_REPORT), 
             AppObjInfo.COMMAND_VIEW))); 
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Laporan Khusus", true, "Laporan LKPBU Form 804", "laporan_khusus", "#", ""+approot+"/report/employee/list_lkpbu_804.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_SPECIFIC_REPORT, AppObjInfo.OBJ_MENU_LKPBU_804_REPORT), 
             AppObjInfo.COMMAND_VIEW))); 
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Laporan Khusus", true, "Laporan LKPBU Form 805", "laporan_khusus", "#", ""+approot+"/report/employee/list_lkpbu_805.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_SPECIFIC_REPORT, AppObjInfo.OBJ_MENU_LKPBU_805_REPORT), 
             AppObjInfo.COMMAND_VIEW))); 
flyout.addMenuFlyOut("reports.jsp", dictionaryD.getWord(I_Dictionary.REPORT), "Laporan Khusus", true, "Laporan LKPBU Form 806", "laporan_khusus", "#", ""+approot+"/report/employee/list_lkpbu_806.jsp",	userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_REPORTS, AppObjInfo.G2_MENU_SPECIFIC_REPORT, AppObjInfo.OBJ_MENU_LKPBU_806_REPORT), 
             AppObjInfo.COMMAND_VIEW))); 
...
flyout.addMenuFlyOut("project.jsp", "Project", "Master Data", true, "Company", "company", "#", ""+approot+"/service/service_center.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_SYSTEM, AppObjInfo.G2_MENU_SERVICE_CENTER, AppObjInfo.OBJ_MENU_SERVICE_CENTER), 
             AppObjInfo.COMMAND_VIEW))); 

flyout.addMenuFlyOut("project.jsp", "Project", "Master Data", true, "Product", "product", "#", ""+approot+"/masterdata/product.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_SYSTEM, AppObjInfo.G2_MENU_MANUAL_PROCESS, AppObjInfo.OBJ_MENU_MANUAL_PROCESS), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("project.jsp", "Project", "Master Data", true, "MasterProduct", "MasterProduct", "#", ""+approot+"/masterdata/master_product.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_SYSTEM, AppObjInfo.G2_MENU_MANUAL_PROCESS, AppObjInfo.OBJ_MENU_MANUAL_PROCESS), 
             AppObjInfo.COMMAND_VIEW)));

flyout.addMenuFlyOut("project.jsp", "Project", "Master Data", true, "Master Tipe Produk", "Master Tipe Produk", "#", ""+approot+"/masterdata/product_type.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_SYSTEM, AppObjInfo.G2_MENU_MANUAL_PROCESS, AppObjInfo.OBJ_MENU_MANUAL_PROCESS), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("project.jsp", "Project", "Master Data", true, "Contract", "contract", "#", ""+approot+"/service/attendance_manual_calculation.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_SYSTEM, AppObjInfo.G2_MENU_MANUAL_PROCESS, AppObjInfo.OBJ_MENU_MANUAL_PROCESS), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("project.jsp", "Project", "Master Data", true, "Project", "project", "#", ""+approot+"/service/attendance_manual_calculation.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_SYSTEM, AppObjInfo.G2_MENU_MANUAL_PROCESS, AppObjInfo.OBJ_MENU_MANUAL_PROCESS), 
             AppObjInfo.COMMAND_VIEW)));
			 
flyout.addMenuFlyOut("project.jsp", "Project", "Master Data", true, "Task", "task", "#", ""+approot+"/service/attendance_manual_calculation.jsp", userSession.checkPrivilege(AppObjInfo.composeCode(
             AppObjInfo.composeObjCode(AppObjInfo.G1_MENU_SYSTEM, AppObjInfo.G2_MENU_MANUAL_PROCESS, AppObjInfo.OBJ_MENU_MANUAL_PROCESS), 
             AppObjInfo.COMMAND_VIEW)));
