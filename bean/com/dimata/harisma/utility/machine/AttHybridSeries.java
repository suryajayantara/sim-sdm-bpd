...
public class AttHybridSeries implements AttTransfer_I, Runnable {
    ...
    String password="dsj4bpd";//""
    String dbName="fin_pro";//melia
    ...
    String checkType ="inoutmode";    // field name - jenis IN, OUT, OUT-PERSONAL, IN-PERSONAL, OUT ON DUTY, CALLBACLsesuai 
    ...
    int flagSdhSelesaiCountMencariDataTgl=1;
     ...
     public AttHybridSeries() {
            ...
            "pin", "sn", "scan_date", "inoutmode", "verify_mode", "STATUS"); 
            ...
            try {
                ...
                String inPkData = "" ; //   update HIstory_backup set STATUS=1 where EventSeqId in ( 1213, 12134 )
                  while (theSize>0 && rs.next() && this.running) {
                     ...
                     dataID = rs.getString(this.dataIDFld);
