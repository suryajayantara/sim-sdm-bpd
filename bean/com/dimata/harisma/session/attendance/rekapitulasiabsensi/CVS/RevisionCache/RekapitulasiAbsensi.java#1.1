...
//        
        ...
        if(this.getResignSts()!=2){
            whereClauseEMployee = whereClauseEMployee +" AND ("+  PstEmployee.fieldNames[PstEmployee.FLD_RESIGNED] + "=" + this.getResignSts() +" OR "+PstEmployee.fieldNames[PstEmployee.FLD_RESIGNED_DATE]+ " >= \""+Formater.formatDate(this.getDtFrom(), "yyyy-MM-dd")+"\" )";
