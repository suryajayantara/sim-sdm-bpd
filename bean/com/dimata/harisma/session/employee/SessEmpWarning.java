...
public class SessEmpWarning {
    ...
    public static Vector getEmployeeWarning(SrcEmpWarning srcWarning, int start, int recordToGet) {
        ...
        try {
            ...
            sql.append(" WRN.").append(PstEmpWarning.fieldNames[PstEmpWarning.FLD_WARN_LEVEL_ID]).append(",");
            ...
            {       
                ...
                wrn.setWarnLevelId(rs.getLong(PstEmpWarning.fieldNames[PstEmpWarning.FLD_WARN_LEVEL_ID]));
