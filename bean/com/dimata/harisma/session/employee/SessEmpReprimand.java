...
public class SessEmpReprimand {
    ...
    public static Vector getEmployeeReprimand(SrcEmpReprimand srcReprimand, int start, int recordToGet) {
        ...
        try {
            ...
            sql.append(" RPM.").append(PstEmpReprimand.fieldNames[PstEmpReprimand.FLD_REPRIMAND_LEVEL_ID]).append(",");
            ...
            {       
                ...
                rep.setReprimandLevelId(rs.getLong(PstEmpReprimand.fieldNames[PstEmpReprimand.FLD_REPRIMAND_LEVEL_ID]));
