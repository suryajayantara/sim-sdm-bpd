    ...
    public static Vector searchAppraisal(SrcAppraisal srcAppraisal, int start, int recordToGet)
    {
        ...
        try {
            String sql = " SELECT "+
                         ...
                         " , EMAP."+PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_1_ID]+
                         " , EMAP."+PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_2_ID]+
                         " , EMAP."+PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_3_ID]+
                         " , EMAP."+PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_4_ID]+
                         " , EMAP."+PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_5_ID]+
                         " , EMAP."+PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_6_ID]+                    
            ...
            while(rs.next()) {
                ...
                empApp.setApproval1Id(rs.getLong(PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_1_ID]));
                empApp.setApproval2Id(rs.getLong(PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_2_ID]));
                empApp.setApproval3Id(rs.getLong(PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_3_ID]));
                empApp.setApproval4Id(rs.getLong(PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_4_ID]));
                empApp.setApproval5Id(rs.getLong(PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_5_ID]));
                empApp.setApproval6Id(rs.getLong(PstAppraisalMain.fieldNames[PstAppraisalMain.FLD_APPROVAL_6_ID]));
