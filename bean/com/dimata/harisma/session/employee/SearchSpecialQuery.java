...
public class SearchSpecialQuery {
    ...
    private Vector productTypeName = new Vector();
   ...
   // private int monthBirth;
    ...
    //Gunadi 28-09-2016
    private Vector arrCompetencyId = new Vector();
...
//        return Integer.parseInt((String) radiocommdate.get(x));
   ...
   public String[] getArrLocationId(int idx) {
    ...
    /**
     * @return the arrCompetencyId
     */
    public String[] getArrCompetencyId(int idx) {
        //return arrLanguageId;
         if(idx>=arrCompetencyId.size()){
            return null;
        }
        return (String[])arrCompetencyId.get(idx);
    }

    /**
     * @param arrCompetencyId the arrCompetencyId to set
     */
    public void addArrCompetencyId(String[] arrCompetencyId) {
        //this.arrCompetencyId = arrCompetencyId;
         this.arrCompetencyId.add(arrCompetencyId);
    }
