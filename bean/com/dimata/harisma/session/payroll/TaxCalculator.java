...
public class TaxCalculator {
    ...
    public static final int STATUS_TIDAK_KAWIN_ANAK_1 = 5;
    public static final int STATUS_TIDAK_KAWIN_ANAK_2 = 6;
    public static final int STATUS_TIDAK_KAWIN_ANAK_3 = 7;
    public static final int STATUS_KAWIN_DENGAN_ISTRI_ANAK_0 = 8;
    public static final int STATUS_KAWIN_DENGAN_ISTRI_ANAK_1 = 9;
    public static final int STATUS_KAWIN_DENGAN_ISTRI_ANAK_2 = 10;
    public static final int STATUS_KAWIN_DENGAN_ISTRI_ANAK_3 = 11;
    public static final String[] STATUS_EMPLOYEE = {
        "Single",
        "Married",
        "Married w/ 1 child",
        "Married w/ 2 children",
        "Married w/ 3 or more children",
        "Single w/ 1 child",
        "Single w/ 2 child",
        "Single w/ 3 child or more children",
        "Married income combined with Wife",
        "Married income combined with Wife w/ 1 child",
        "Married income combined with Wife w/ 2 child",
        "Married income combined with Wife w/ 3 child or more children"
        
    };
    public static final String[][] STATUS_EMPLOYEE_LANG = {
        {"Tidak Kawin",
            "Kawin",
            "Kawin 1 Tanggungan",
            "Kawin 2 Tanggungan",
            "Kawin 3 Tanggungan atau lebih",
            "Tidak Kawin 1 Tanggungan ",
            "Tidak Kawin 2 Tanggungan ",
            "Tidak Kawin 3 Tanggungan atau lebih",
            "Kawin dengan penghasilan Istri digabung",
            "Kawin dengan penghasilan Istri digabung 1 Tanggungan",
            "Kawin dengan penghasilan Istri digabung 2 Tanggungan",
            "Kawin dengan penghasilan Istri digabung 3 Tanggungan atau lebih"
        },
        { "Single",
            "Married",
            "Married w/ 1 child",
    ...
    public static final String[] STATUS_EMPLOYEE_CODE = {
        "TK0",
        "K0",
        "K1",
        "K2",
    ...
    public static final int[] STATUS_EMPLOYEE_IDX = {
        STATUS_DIRI_SENDIRI,
        STATUS_KAWIN,
        STATUS_KAWIN_ANAK_1,
        STATUS_KAWIN_ANAK_2,
        STATUS_KAWIN_ANAK_3,
        STATUS_TIDAK_KAWIN_ANAK_1,
        STATUS_TIDAK_KAWIN_ANAK_2,
        STATUS_TIDAK_KAWIN_ANAK_3,
        STATUS_KAWIN_DENGAN_ISTRI_ANAK_0,
        STATUS_KAWIN_DENGAN_ISTRI_ANAK_1,
        STATUS_KAWIN_DENGAN_ISTRI_ANAK_2,
        STATUS_KAWIN_DENGAN_ISTRI_ANAK_3
    };
    
    static Vector<PTKP> vPTKP = new Vector();
    public static double BIAYA_JABATAN_MAX = 6000000;  // MAXIMUM PER TAHUN
    public static double BIAYA_JABATAN_BULANAN = BIAYA_JABATAN_MAX / 12;
    ...
    public static String GAJI_NON_RUTIN_THIS_PERIOD = "Gaji Non Rutin Period Ini";
    public static String TOTAL_BRUTO_THIS_PERIOD = "Total Bruto Period Ini";
    ...
    public static void loadPTKP() {
        ...
        PTKP ptkp2016 = new PTKP();
        Date date2016 = new Date(2016 - 1900, 1 - 1, 1);
        ptkp2016.setStartDate(date2016);
        ptkp2016.setPTKP_DIRI_SENDIRI(54000000.0);
        ptkp2016.setPTKP_KAWIN(58500000.0);// 
        ptkp2016.setPTKP_KAWIN_ANAK_1(63000000.0);// 
        ptkp2016.setPTKP_KAWIN_ANAK_2(67500000.0);// 
        ptkp2016.setPTKP_KAWIN_ANAK_3(72000000.0);// 
            ...
            if (employee.getResigned() == 0 || (employee.getResigned() == 1 && employee.getResignedDate().after(payPeriod.getEndDate()))) {
                ...
                switch (employeeTaxType) {
                    case EMPLOYEE_TAX_TYPE_PERMANENT:
                        ...
                        int countJumlahPaySlip = PstPaySlip.getJumlahPayslip(employeeId, payPeriod);
                        double nilaiMaksimum = (12 * TaxCalculator.BIAYA_JABATAN_BULANAN);
    ...
    public static double calcSalaryTaxBPD(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak) {
        return calcSalaryTaxBPD(employeeId, payPeriod, prevPeriod, pajak, null);
    }

    public static double calcSalaryTaxBPD(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak, Vector withoutComponents) {
        return calcSalaryTaxBPD(employeeId, payPeriod, prevPeriod, pajak, withoutComponents, false);
    }

    public static double calcSalaryTaxBPD(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak, Vector withoutComponents, boolean returnPeriodToEndYear) {
        return calcSalaryTaxBPD(employeeId, payPeriod, prevPeriod, pajak, withoutComponents, returnPeriodToEndYear, 0);
    }

    public static double calcSalaryTaxBPD(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak, Vector withoutComponents, boolean returnPeriodToEndYear, int backPeriod) {
        //public static double calcSalaryTax(long employeeId, Period period, Period prevPeriod){
        double pph21KurangBayarBulanTerhitung = 0.0;
        double pph21KurangBayarBulanTerhitungWONonRutin = 0.0;
        double pph21 = 0.0;
        double pph21Rutin = 0.0;
        double pph21NonRutin = 0.0;
        double pph21Total = 0.0;
        double brutoPajak = 0.0;
        if (payPeriod == null || payPeriod.getOID() == 0) {
            return 0.0d;
        }
        ...
        long paySlipOID = getPayslipOID(employeeId, payPeriod);
        PaySlip paySlip = null;
        if (paySlipOID > 0) {
            try {
                paySlip = PstPaySlip.fetchExc(paySlipOID);
            } catch (Exception exc) {
                System.out.println(exc);
            }
        }
        ...
        int umurPensiun = 0;
        try {
            umurPensiun = Integer.valueOf(PstSystemProperty.getValueByName("RETIREMENT_AGE"));
        } catch (Exception exc) {
            System.out.println(exc);
        }

        long oidMBT = Long.valueOf(PstSystemProperty.getValueByName("MASA_BEBAS_TUGAS"));
        int empAge = curYear - (employee.getBirthDate().getYear() + 1900);

        Division division = null;
        try {
            division = PstDivision.fetchExc(oidMBT);
        } catch (Exception exc) {
            System.out.println(exc);
        }
        ...
        try {
            ...
            //untuk karyawn yang resign check apakah tanggal resign cocok perperiode ini
            //if (employee.getResigned() == 0 || (employee.getResigned() == 1 && employee.getResignedDate().after(payPeriod.getEndDate()))) {
            if ((employee.getResigned() == 0 || (employee.getResigned() == 1 && employee.getResignedDate().after(payPeriod.getEndDate()) && (!(employee.getResignedDate().equals(payPeriod.getStartDate())))))) {
                ///String where = PstFamilyMember.fieldNames[PstFamilyMember.FLD_EMPLOYEE_ID] + "=" + employeeId;
                //String order = PstFamilyMember.fieldNames[PstFamilyMember.FLD_RELATIONSHIP];
                //Vector<FamilyMember> familymember = PstFamilyMember.list(0, 0, where, order);    
                ...
                String whereGajiBruto = " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_TAX_ITEM] + " IN ( " + PstPayComponent.TUNJANGAN + ", " + PstPayComponent.BONUS_THR + ", " + PstPayComponent.GAJI + ") ";

                double gajiRutinYearToPrevPeriod = prevPeriod != null && prevPeriod.getEndDate().getYear() == payPeriod.getEndDate().getYear() ? PstPaySlip.getSumSalaryYearToPeriod(prevPeriod.getOID(), employeeId, whereGajiRutin) : 0.0d; // gaji tetap dari awal tahun sampai periode sebelumnya, dalam tahun yg sama             
                double gajiBrutoPrevPeriod = prevPeriod != null && prevPeriod.getEndDate().getYear() == payPeriod.getEndDate().getYear() ? PstPaySlip.getSumSalaryYearPeriodToPrev(prevPeriod.getOID(), employeeId, whereGajiBruto) : 0.0d;
                double gajiRutinOfPeriod = 0;
                ...
                pajak.setHtmlDetailCalc("<table><tr><td>A. " + GAJI_RUTIN_YEAR_TO_PREV_PERIOD + "</td><td>:</td><td>" + Formater.formatNumber(gajiBrutoPrevPeriod, FORMAT_DECIMAL) + "</td></tr>");
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>B. " + GAJI_RUTIN_THIS_PERIOD + "</td><td>:</td><td>" + Formater.formatNumber(gajiRutinOfPeriod, FORMAT_DECIMAL) + "</td></tr>");
                ...
                jumlahPeriodeKedepan = jumlahBulan - payPeriod.getEndDate().getMonth();
                //   }
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>C. " + NUMBER_OF_NEXT_PERIOD + "</td><td>:</td><td>" + jumlahPeriodeKedepan + "</td></tr>");


                //double gajiNonRutinYearToPrevPeriod = prevPeriod != null && prevPeriod.getEndDate().getYear() == payPeriod.getEndDate().getYear() ? PstPaySlip.getSumSalaryYearToPeriod(prevPeriod.getOID(), employeeId, whereGajiTidakRutin) : 0.0d;

                double gajiRutinSetahun = gajiBrutoPrevPeriod + (gajiRutinOfPeriod * jumlahPeriodeKedepan);
                ...
                double gajiNonRutinPeriod = PstPaySlip.getSumSalaryOfPeriod(payPeriod.getOID(), employeeId, whereGajiTidakRutin);
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>E. " + GAJI_NON_RUTIN_YTD + "</td><td>:</td><td>" + Formater.formatNumber(gajiNonRutinPeriod, FORMAT_DECIMAL) + "</td></tr>");
                printComponent(whereGajiTidakRutin, payPeriod.getOID(), employeeId, pajak);
                gajiNonRutinThisPeriod = PstPaySlip.getSumSalaryBenefit(payPeriod.getOID(), employeeId, whereGajiTidakRutin);

                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>E.1. " + GAJI_NON_RUTIN_THIS_PERIOD + "</td><td>:</td><td>" + Formater.formatNumber(gajiNonRutinThisPeriod, FORMAT_DECIMAL) + "</td></tr>");
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>E.2. " + TOTAL_BRUTO_THIS_PERIOD + "</td><td>:</td><td>" + Formater.formatNumber(gajiRutinOfPeriod + gajiNonRutinThisPeriod, FORMAT_DECIMAL) + "</td></tr>");
                brutoPajak = gajiRutinOfPeriod + gajiNonRutinThisPeriod;
                double compGajiOfPeriodWithout = (sWithout == null || sWithout.trim().length() < 1) ? 0.0d
                        : (PstPaySlip.getSumSalaryOfPeriod(payPeriod.getOID(), employeeId, whereGajiRutin + " " + sWithout)
                        + PstPaySlip.getSumSalaryOfPeriod(payPeriod.getOID(), employeeId, whereGajiTidakRutin + " " + sWithout));  // total component gaji yang ppph nya sudah dipotong terpisah
                if (compGajiOfPeriodWithout != 0) {
                ...
                double gajiTotalSetahun = gajiRutinSetahun + gajiNonRutinPeriod - compGajiOfPeriodWithout;
                double gajiTotalSetahunWONonRutin = gajiRutinSetahun - compGajiOfPeriodWithout;

                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>F. " + TOTAL_GAJI_SETAHUN + "= D + E</td><td>:</td><td>" + Formater.formatNumber(gajiTotalSetahun, FORMAT_DECIMAL) + "</td></tr>");

                int employeeTaxType = getEmployeeTypeMap(employee.getEmpCategoryId());  // dapat dari jenis karyawan                        
                double pendapatanNettoSetahun = 0.0;
                double pendapatanNettoSetahunWONonRutin = 0.0;
                ...
                switch (employeeTaxType) {
                    case EMPLOYEE_TAX_TYPE_PERMANENT:
                        ...
                        //update by devin 2014-02-15                    
                        double biayaJabatan = Math.round(gajiTotalSetahun * (pajak != null && pajak.getBiayaJabatanPersen() != 0 ? pajak.getBiayaJabatanPersen() : BIAYA_JABATAN_PERSEN));
                        double biayaJabatanWONonRutin = Math.round(gajiTotalSetahunWONonRutin * (pajak != null && pajak.getBiayaJabatanPersen() != 0 ? pajak.getBiayaJabatanPersen() : BIAYA_JABATAN_PERSEN));
                        //update by priska karena biaya jabatan tidak boleh melebihi jumlah payslip dikali rata rata bulan dalam pajak 20151217
                        //int countJumlahPaySlip = PstPaySlip.getJumlahPayslip(employeeId, ""+(payPeriod.getEndDate().getYear()+1900));
                        int countJumlahPaySlip = PstPaySlip.getJumlahPayslip(employeeId, payPeriod);
                        double nilaiMaksimum = (12 * TaxCalculator.BIAYA_JABATAN_BULANAN);
                        ...
                        if (biayaJabatanWONonRutin > nilaiMaksimum) {
                            biayaJabatanWONonRutin = nilaiMaksimum;
                        }


                        if ((biayaJabatan) <= (pajak != null && pajak.getBiayaJabatanMaksimal() != 0 ? pajak.getBiayaJabatanMaksimal() : BIAYA_JABATAN_MAX)) {
                            pendapatanNettoSetahun = gajiTotalSetahun - biayaJabatan;
                            pendapatanNettoSetahunWONonRutin = gajiTotalSetahunWONonRutin - biayaJabatan;
                            pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>H. " + TITLE_BIAYA_JABATAN + "= F x  " + (pajak != null && pajak.getBiayaJabatanPersen() != 0 ? pajak.getBiayaJabatanPersen() : BIAYA_JABATAN_PERSEN) * 100 + " %</td><td>:</td><td>" + Formater.formatNumber(biayaJabatan, FORMAT_DECIMAL) + "</td></tr>");
                        } else {
                            pendapatanNettoSetahun = gajiTotalSetahun - (pajak != null && pajak.getBiayaJabatanMaksimal() != 0 ? pajak.getBiayaJabatanMaksimal() : BIAYA_JABATAN_MAX);
                            pendapatanNettoSetahunWONonRutin = gajiTotalSetahunWONonRutin - (pajak != null && pajak.getBiayaJabatanMaksimal() != 0 ? pajak.getBiayaJabatanMaksimal() : BIAYA_JABATAN_MAX);
                            pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>H. " + TITLE_BIAYA_JABATAN + "= F x  " + (pajak != null && pajak.getBiayaJabatanPersen() != 0 ? pajak.getBiayaJabatanPersen() : BIAYA_JABATAN_PERSEN) * 100 + " %</td><td>:</td><td>" + Formater.formatNumber((pajak != null && pajak.getBiayaJabatanMaksimal() != 0 ? pajak.getBiayaJabatanMaksimal() : BIAYA_JABATAN_MAX), FORMAT_DECIMAL) + "</td></tr>");
                        }
                    ...
                    case EMPLOYEE_TAX_TYPE_NON_PERMANENT:
                        ...
                        pendapatanNettoSetahun = gajiTotalSetahun;
                        pendapatanNettoSetahunWONonRutin = gajiTotalSetahunWONonRutin;
                        break;
                    ...
                    case EMPLOYEE_TAX_TYPE_CONSULTANT:
                        ...
                        //update by devin 2014-02-15
                        pendapatanNettoSetahun = (pajak != null && pajak.getNettoPercenKonsultan() != 0 ? pajak.getNettoPercenKonsultan() : NETTO_PERCENT_CONSULTANT) * gajiTotalSetahun;
                        pendapatanNettoSetahunWONonRutin = (pajak != null && pajak.getNettoPercenKonsultan() != 0 ? pajak.getNettoPercenKonsultan() : NETTO_PERCENT_CONSULTANT) * gajiTotalSetahunWONonRutin;
                        break;
                    default:
                        pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>G. " + EMPLOYEE_TYPE + "</td><td>:</td><td>" + NON_SPECIFIC_EMPLOYEE_TYPE + "</td></tr>");
                ...
                if (totalPotongan <= POTONGAN_GAJI_KENA_PAJAK_MAX) {
                    pendapatanNettoSetahun = pendapatanNettoSetahun - totalPotongan;
                    pendapatanNettoSetahunWONonRutin = pendapatanNettoSetahunWONonRutin - totalPotongan;
                } else {
                    pendapatanNettoSetahun = pendapatanNettoSetahun - POTONGAN_GAJI_KENA_PAJAK_MAX;
                    pendapatanNettoSetahunWONonRutin = pendapatanNettoSetahunWONonRutin - POTONGAN_GAJI_KENA_PAJAK_MAX;
                }
                ...
                double pkpSetahun = pendapatanNettoSetahun - ptkpSetahun;
                double pkpSetahunWONonRutin = pendapatanNettoSetahunWONonRutin - ptkpSetahun;
                if (pkpSetahun < 0.00) {
                    pkpSetahun = 0.0;
                }
                pkpSetahun = Math.floor(pkpSetahun / 1000d) * 1000d;
                pkpSetahunWONonRutin = Math.floor(pkpSetahunWONonRutin / 1000d) * 1000d;

                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>O. " + TITLE_PKP_SETAHUN + " = M - N </td><td>:</td><td>" + Formater.formatNumber(pkpSetahun, FORMAT_DECIMAL) + "</td></tr>");

                double pph21Setahun = hitungTarifPPH21(pkpSetahun, pajak, employee.getNpwp());
                double pph21SetahunWONonRutin = hitungTarifPPH21(pkpSetahunWONonRutin, pajak, employee.getNpwp());
                pph21 = pph21Setahun;
                pph21Rutin = pph21SetahunWONonRutin;
                ...
                /*update by devin 2104-02-14 agar tidak dibulatkan  Math.round((pph21Setahun-pph21SampaiBulanSebelumnya)/jumlahPeriodeKedepan)*/
                pph21KurangBayarBulanTerhitung = Math.floor(((double) (pph21Setahun - pph21SampaiBulanSebelumnya) / ((double) jumlahPeriodeKedepan)) - pph21PrepayBulanIni); // update by Kartika -pph21PrepayBulanIni
                pph21KurangBayarBulanTerhitungWONonRutin = Math.floor(((double) (pph21SetahunWONonRutin - pph21SampaiBulanSebelumnya) / ((double) jumlahPeriodeKedepan)) - pph21PrepayBulanIni);
                // -  pph21SampaiBulanSebelumnya)/ (12 -jumlahBulanDihitung-1 );            

                //pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>Q. " + TITLE_PPH21_THIS_PERIOD + " = ( P - Q ) / C </td><td>:</td><td>" + Formater.formatNumber(pph21KurangBayarBulanTerhitungWONonRutin, FORMAT_DECIMAL) + "</td></tr>");
                ...
                double gajiRutinSdgnResign = gajiBrutoPrevPeriod + gajiRutinOfPeriod;
                ...
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>E " + GAJI_NON_RUTIN_YTD + "</td><td>:</td><td>" + Formater.formatNumber(gajiNonRutinYearToPeriod, FORMAT_DECIMAL) + "</td></tr>");
                 pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>E.1. " + GAJI_NON_RUTIN_THIS_PERIOD + "</td><td>:</td><td>" + Formater.formatNumber(gajiNonRutinThisPeriod, FORMAT_DECIMAL) + "</td></tr>");
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>E.2 " + TOTAL_BRUTO_THIS_PERIOD + "</td><td>:</td><td>" + Formater.formatNumber(gajiNonRutinYearToPeriod, FORMAT_DECIMAL) + "</td></tr>");
                ...
                double gajiTotalSdnPeriode = gajiRutinSdgnResign + gajiNonRutinYearToPeriod - compGajiOfPeriodWithout;
                double gajiTotalSdnPeriodeWONonRutin = gajiRutinSdgnResign - compGajiOfPeriodWithout;

                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>F. " + TOTAL_GAJI_SDGN_PERIODE + "= D + E</td><td>:</td><td>" + Formater.formatNumber(gajiTotalSdnPeriode, FORMAT_DECIMAL) + "</td></tr>");
                 brutoPajak = gajiTotalSdnPeriode;
                int employeeTaxType = getEmployeeTypeMap(employee.getEmpCategoryId());  // dapat dari jenis karyawan                        
                double pendapatanNettoSdgnPeriode = 0.0;
                double pendapatanNettoSdgnPeriodeWONonRutin = 0.0;
                switch (employeeTaxType) {
                    case EMPLOYEE_TAX_TYPE_PERMANENT:
                        pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>G. " + EMPLOYEE_TYPE + "</td><td>:</td><td>" + EMPLOYEE_TAX_TYPE[EMPLOYEE_TAX_TYPE_PERMANENT] + "</td></tr>");
                        ...
                        //update by devin 2014-02-15                    
                        double biayaJabatan = Math.round(gajiTotalSdnPeriode * (pajak != null && pajak.getBiayaJabatanPersen() != 0 ? pajak.getBiayaJabatanPersen() : BIAYA_JABATAN_PERSEN));
                        double biayaJabatanWONonRutin = Math.round(gajiTotalSdnPeriodeWONonRutin * (pajak != null && pajak.getBiayaJabatanPersen() != 0 ? pajak.getBiayaJabatanPersen() : BIAYA_JABATAN_PERSEN));

                        double nilaiMaksimum = (jumlahPerioYTD * TaxCalculator.BIAYA_JABATAN_BULANAN);
                        if (biayaJabatan > nilaiMaksimum) {
                            biayaJabatan = nilaiMaksimum;
                        }
                        if (biayaJabatanWONonRutin > nilaiMaksimum) {
                        ...
                        if ((biayaJabatan) <= ((pajak != null && pajak.getBiayaJabatanMaksimal() != 0 ? pajak.getBiayaJabatanMaksimal() : BIAYA_JABATAN_MAX) * ((float) jumlahPerioYTD / 12f))) {
                            pendapatanNettoSdgnPeriode = gajiTotalSdnPeriode - biayaJabatan;
                            pendapatanNettoSdgnPeriodeWONonRutin = gajiTotalSdnPeriodeWONonRutin - biayaJabatanWONonRutin;
                            pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>H. " + TITLE_BIAYA_JABATAN + "= F x  " + (pajak != null && pajak.getBiayaJabatanPersen() != 0 ? pajak.getBiayaJabatanPersen() : BIAYA_JABATAN_PERSEN) * 100 + " %</td><td>:</td><td>" + Formater.formatNumber(biayaJabatan, FORMAT_DECIMAL) + "</td></tr>");
                        } else {
                            pendapatanNettoSdgnPeriode = gajiTotalSdnPeriode - ((pajak != null && pajak.getBiayaJabatanMaksimal() != 0 ? pajak.getBiayaJabatanMaksimal() : BIAYA_JABATAN_MAX) * ((float) jumlahPerioYTD / 12f));
                            pendapatanNettoSdgnPeriodeWONonRutin = gajiTotalSdnPeriodeWONonRutin - ((pajak != null && pajak.getBiayaJabatanMaksimal() != 0 ? pajak.getBiayaJabatanMaksimal() : BIAYA_JABATAN_MAX) * ((float) jumlahPerioYTD / 12f));
                            pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>H. " + TITLE_BIAYA_JABATAN + "= F x  " + (pajak != null && pajak.getBiayaJabatanPersen() != 0 ? pajak.getBiayaJabatanPersen() : BIAYA_JABATAN_PERSEN) * 100 + " %</td><td>:</td><td>" + Formater.formatNumber((pajak != null && pajak.getBiayaJabatanMaksimal() != 0 ? pajak.getBiayaJabatanMaksimal() : BIAYA_JABATAN_MAX), FORMAT_DECIMAL) + "</td></tr>");
                        }
                    ...
                    case EMPLOYEE_TAX_TYPE_NON_PERMANENT:
                        ...
                        pendapatanNettoSdgnPeriode = gajiTotalSdnPeriode;
                        pendapatanNettoSdgnPeriodeWONonRutin = gajiTotalSdnPeriodeWONonRutin;
                        break;
                    ...
                    case EMPLOYEE_TAX_TYPE_CONSULTANT:
                        ...
                        //update by devin 2014-02-15
                        pendapatanNettoSdgnPeriode = (pajak != null && pajak.getNettoPercenKonsultan() != 0 ? pajak.getNettoPercenKonsultan() : NETTO_PERCENT_CONSULTANT) * gajiTotalSdnPeriode;
                        pendapatanNettoSdgnPeriodeWONonRutin = (pajak != null && pajak.getNettoPercenKonsultan() != 0 ? pajak.getNettoPercenKonsultan() : NETTO_PERCENT_CONSULTANT) * gajiTotalSdnPeriodeWONonRutin;
                        break;
                    default:
                        pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>G. " + EMPLOYEE_TYPE + "</td><td>:</td><td>" + NON_SPECIFIC_EMPLOYEE_TYPE + "</td></tr>");
                ...
                if (totalPotongan <= POTONGAN_GAJI_KENA_PAJAK_MAX) {
                    pendapatanNettoSdgnPeriode = pendapatanNettoSdgnPeriode - totalPotongan;
                    pendapatanNettoSdgnPeriodeWONonRutin = pendapatanNettoSdgnPeriodeWONonRutin - totalPotongan;
                } else {
                    pendapatanNettoSdgnPeriode = pendapatanNettoSdgnPeriode - POTONGAN_GAJI_KENA_PAJAK_MAX;
                    pendapatanNettoSdgnPeriodeWONonRutin = pendapatanNettoSdgnPeriodeWONonRutin - POTONGAN_GAJI_KENA_PAJAK_MAX;
                }
                ...
                double pkpSetahun = pendapatanNettoSdgnPeriode - ptkpSetahun;
                double pkpSetahunWONonRutin = pendapatanNettoSdgnPeriodeWONonRutin - ptkpSetahun;
                if (pkpSetahun < 0.00) {
                    pkpSetahun = 0.0;
                }
                if (pkpSetahunWONonRutin < 0.00) {
                    pkpSetahunWONonRutin = 0.0;
                }
                pkpSetahun = Math.floor(pkpSetahun / 1000d) * 1000d;
                pkpSetahunWONonRutin = Math.floor(pkpSetahunWONonRutin / 1000d) * 1000d;
                ...
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>Q. " + TITLE_PPH21_SDGN_PREV_PERIOD + "</td><td>:</td><td>" + Formater.formatNumber(pph21SampaiBulanSebelumnya, FORMAT_DECIMAL) + "</td></tr>");
                String prevPphComp = getComponentWithFormula("PPH21_UNTIL_PREV_PERIOD");
                updateSlipComp(payPeriod.getOID(), employeeId, pph21SampaiBulanSebelumnya, prevPphComp);
                // update by Kartika 2015-07-23
                double pph21PrepayBulanIni = PstPaySlip.getTaxPrepayPeriod(payPeriod.getOID(), employeeId);
                if (pph21PrepayBulanIni != 0) {
                    pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>Q1. " + TITLE_PPH21_PREPAY_THIS_PERIOD + "</td><td>:</td><td>" + Formater.formatNumber(pph21PrepayBulanIni, FORMAT_DECIMAL) + "</td></tr>");
                ...
                /* baris code di atas pph21KurangBayarBulanTerhitung diganti dengn code di bawah*/
                pph21KurangBayarBulanTerhitung = Math.floor((double) (pph21Setahun - pph21SampaiBulanSebelumnya - pph21PrepayBulanIni));
                pph21KurangBayarBulanTerhitungWONonRutin = Math.floor((double) (pph21SetahunWONonRutin - pph21SampaiBulanSebelumnya - pph21PrepayBulanIni));
                // -  pph21SampaiBulanSebelumnya)/ (12 -jumlahBulanDihitung-1 );            
...
//                updateSlipComp(payPeriod.getOID(), employeeId, pph21KurangBayarBulanTerhitung);
            ...
            //String gUPComponent = "BNF19";// chk di salary level detail
            String gUPComponent = getComponentWithFormula("SALARY_GR_UP_TAX");
            String taxNonRutinComp = getComponentWithFormula("SALARY_TAX_NON_RUTIN");
            String gUPComponent2 = getComponentWithFormula("SALARY_MBT_GR_UP_TAX");
            String taxNonRutinComp2 = getComponentWithFormula("SALARY_MBT_TAX_NON_RUTIN");
            String brutoComp = getComponentWithFormula("BRUTO_PAJAK_UNTIL_PERIOD");
            String taxAdjComp = PstSystemProperty.getValueByName("TAX_ADJUSTMENT_COMP_CODE");
            
            if (gUPComponent != null && gUPComponent.length() > 0 && pph21 > 0) {
                //ambil nilainya
                double nilaiGUPTax = getGrossUpValue(employeeId, payPeriod, gUPComponent);
                double nilaiTaxNonRutin = getTaxNonRutinValue(employeeId, payPeriod, taxNonRutinComp);
                double nilaiGUPTax2 = getGrossUpValue(employeeId, payPeriod, gUPComponent2);
                double nilaiTaxNonRutin2 = getTaxNonRutinValue(employeeId, payPeriod, taxNonRutinComp2);
                double nilaiTaxAdj = getTaxNonRutinValue(employeeId, payPeriod, taxAdjComp);
                double nilaiGUbruto = getGrossUpValue(employeeId, payPeriod, brutoComp);
                long paySlipId = getPayslipId(employeeId, payPeriod, gUPComponent);
                // ambil nilai g up tax dari payrollslip
                pph21NonRutin = Math.floor(pph21 - pph21Rutin);
                pph21KurangBayarBulanTerhitung = pph21KurangBayarBulanTerhitungWONonRutin;
                setTaxNonRutinValue(paySlipId, taxNonRutinComp, pph21NonRutin);

                double totalPPh = pph21KurangBayarBulanTerhitung + pph21NonRutin + nilaiTaxAdj;
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>Q. " + TITLE_PPH21_THIS_PERIOD + " = ( P - Q ) / C </td><td>:</td><td>" + Formater.formatNumber(totalPPh, FORMAT_DECIMAL) + "</td></tr>");
                updateSlipComp(payPeriod.getOID(), employeeId, totalPPh + nilaiGUPTax2 + nilaiTaxNonRutin2);
                updateSlipComp(payPeriod.getOID(), employeeId, brutoPajak, brutoComp);
                if (nilaiGUPTax != pph21KurangBayarBulanTerhitung || brutoPajak != nilaiGUbruto) { // di bulatkan dengan even terlebih dahulu ....

                    //set nilai gross Up component =  pph21KurangBayarBulanTerhitung;
                    setGrossUpValue(paySlipId, gUPComponent, pph21KurangBayarBulanTerhitung);
                    pph21KurangBayarBulanTerhitung = calcSalaryTaxBPD(employeeId, payPeriod, prevPeriod, pajak);
                    setGrossUpValue(paySlipId, gUPComponent, pph21KurangBayarBulanTerhitung);
                ...
                double totalPPh = pph21KurangBayarBulanTerhitung + pph21NonRutin;
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>Q. " + TITLE_PPH21_THIS_PERIOD + " = ( P - Q ) / C </td><td>:</td><td>" + Formater.formatNumber(totalPPh, FORMAT_DECIMAL) + "</td></tr>");
                setGrossUpValue(paySlipOID, gUPComponent, 0);
                setTaxNonRutinValue(paySlipOID, taxNonRutinComp, 0);
                updateSlipComp(payPeriod.getOID(), employeeId, pph21);
                updateSlipComp(payPeriod.getOID(), employeeId, brutoPajak, brutoComp);
            }
    ...
    public static double calcSalaryTaxBPDSecondSlip(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak) {
        return calcSalaryTaxBPDSecondSlip(employeeId, payPeriod, prevPeriod, pajak, null);
    }

    public static double calcSalaryTaxBPDSecondSlip(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak, Vector withoutComponents) {
        return calcSalaryTaxBPDSecondSlip(employeeId, payPeriod, prevPeriod, pajak, withoutComponents, false);
    }

    public static double calcSalaryTaxBPDSecondSlip(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak, Vector withoutComponents, boolean returnPeriodToEndYear) {
        return calcSalaryTaxBPDSecondSlip(employeeId, payPeriod, prevPeriod, pajak, withoutComponents, returnPeriodToEndYear, 0);
    }

    public static double calcSalaryTaxBPDSecondSlip(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak, Vector withoutComponents, boolean returnPeriodToEndYear, int backPeriod) {
        //public static double calcSalaryTax(long employeeId, Period period, Period prevPeriod){
        double pph21KurangBayarBulanTerhitung = 0.0;
        double pph21KurangBayarBulanTerhitungWONonRutin = 0.0;
        double pph21 = 0.0;
        ...
        long paySlipOID = PstPaySlip.getSecondPaySlipId(payPeriod.getOID(), employeeId);
        PaySlip paySlip = null;
        if (paySlipOID > 0) {
            try {
                paySlip = PstPaySlip.fetchExc(paySlipOID);
        ...
        String whereGajiTidakRutin = " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_TAX_ITEM]
                + " IN ( " + PstPayComponent.TUNJANGAN + ", " + PstPayComponent.BONUS_THR + ") AND "
                + PstPayComponent.fieldNames[PstPayComponent.FLD_SECOND_SLIP]+"=1";
        ...
        try {
            ...
            if ((employee.getResigned() == 0 || (employee.getResigned() == 1 && employee.getResignedDate().after(payPeriod.getEndDate()) && (!(employee.getResignedDate().equals(payPeriod.getStartDate())))))) {
                ...
                String wherePrev = ""+PstCareerPath.fieldNames[PstCareerPath.FLD_WORK_TO]+" BETWEEN '"+Formater.formatDate(payPeriod.getStartDate(), "yyyy-MM-dd")+"'"
                                    + " AND '"+Formater.formatDate(payPeriod.getEndDate(), "yyyy-MM-dd")+"' AND "+PstCareerPath.fieldNames[PstCareerPath.FLD_EMPLOYEE_ID]+" = "+employeeId;
                Vector listCareer = PstCareerPath.list(0, 0, wherePrev, "");
                String whereGajiRutin = "";
                if (listCareer.size() > 0 && paySlip.getDivision().equals(division.getDivision())){
                    whereGajiRutin = " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_TAX_ITEM] + " IN (" + PstPayComponent.GAJI_MBT+","+PstPayComponent.GAJI+")";
                } else {
                    whereGajiRutin = " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_TAX_ITEM] + " = " + PstPayComponent.GAJI_MBT;
                }
                String whereGajiBruto = " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_TAX_ITEM] + " IN ( " + PstPayComponent.TUNJANGAN_MBT + ", " + PstPayComponent.BONUS_THR_MBT + ", " + PstPayComponent.GAJI_MBT + ") ";

                double gajiRutinYearToPrevPeriod = prevPeriod != null && prevPeriod.getEndDate().getYear() == payPeriod.getEndDate().getYear() ? PstPaySlip.getSumSalaryYearToPeriod(prevPeriod.getOID(), employeeId, whereGajiRutin) : 0.0d; // gaji tetap dari awal tahun sampai periode sebelumnya, dalam tahun yg sama             
                double gajiBrutoPrevPeriod = prevPeriod != null && prevPeriod.getEndDate().getYear() == payPeriod.getEndDate().getYear() ? PstPaySlip.getSumSalaryYearToPeriod(prevPeriod.getOID(), employeeId, whereGajiBruto) : 0.0d;
                double gajiRutinOfPeriod = 0;
                ...
                if (empAge > umurPensiun || empAge == umurPensiun) {
                    jumlahBulan = employee.getBirthDate().getMonth() + 1;
                }
                jumlahPeriodeKedepan = jumlahBulan - payPeriod.getEndDate().getMonth();
                //   }
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>C. " + NUMBER_OF_NEXT_PERIOD + "</td><td>:</td><td>" + jumlahPeriodeKedepan + "</td></tr>");
                ...
                whereGajiTidakRutin = " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_TAX_ITEM]
                        + " IN ( " + PstPayComponent.TUNJANGAN_MBT + ", " + PstPayComponent.BONUS_THR_MBT + ") ";
                ...
                String wherePotonganGaji = " AND " + PstPayComponent.fieldNames[PstPayComponent.FLD_TAX_ITEM] + " = " + PstPayComponent.POTONGAN_GAJI_MBT;
...
//                updateSlipComp(payPeriod.getOID(), employeeId, pph21KurangBayarBulanTerhitung);
            ...
            //String gUPComponent = "BNF19";// chk di salary level detail
            String gUPComponent = getComponentWithFormula("SALARY_MBT_GR_UP_TAX");
            String taxNonRutinComp = getComponentWithFormula("SALARY_MBT_TAX_NON_RUTIN");
            String gUPComponent2 = getComponentWithFormula("SALARY_GR_UP_TAX ");
            String taxNonRutinComp2 = getComponentWithFormula("SALARY_TAX_NON_RUTIN");
            ...
            if (gUPComponent != null && gUPComponent.length() > 0 && pph21 > 0) {
                ...
                if (nilaiGUPTax != pph21KurangBayarBulanTerhitung) { // di bulatkan dengan even terlebih dahulu ....
                    ...
                    //set nilai gross Up component =  pph21KurangBayarBulanTerhitung;
                    setGrossUpValue(paySlipId, gUPComponent, pph21KurangBayarBulanTerhitung);
                    pph21KurangBayarBulanTerhitung = calcSalaryTaxBPDSecondSlip(employeeId, payPeriod, prevPeriod, pajak);
                    setGrossUpValue(paySlipId, gUPComponent, pph21KurangBayarBulanTerhitung);

                }
            } else {
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>Q. " + TITLE_PPH21_THIS_PERIOD + " = ( P - Q ) / C </td><td>:</td><td>" + Formater.formatNumber(pph21, FORMAT_DECIMAL) + "</td></tr>");
                setGrossUpValue(paySlipOID, gUPComponent, 0);
                setTaxNonRutinValue(paySlipOID, taxNonRutinComp, 0);
                updateSlipComp(payPeriod.getOID(), employeeId, pph21);
            }
    ...
    public static double calcSalaryTaxBPDBeforeMBT(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak) {
        return calcSalaryTaxBPDBeforeMBT(employeeId, payPeriod, prevPeriod, pajak, null);
    }

    public static double calcSalaryTaxBPDBeforeMBT(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak, Vector withoutComponents) {
        return calcSalaryTaxBPDBeforeMBT(employeeId, payPeriod, prevPeriod, pajak, withoutComponents, false);
    }

    public static double calcSalaryTaxBPDBeforeMBT(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak, Vector withoutComponents, boolean returnPeriodToEndYear) {
        return calcSalaryTaxBPDBeforeMBT(employeeId, payPeriod, prevPeriod, pajak, withoutComponents, returnPeriodToEndYear, 0);
    }
    
    public static double calcSalaryTaxBPDBeforeMBT(long employeeId, PayPeriod payPeriod, PayPeriod prevPeriod, Pajak pajak, Vector withoutComponents, boolean returnPeriodToEndYear, int backPeriod) {
        //public static double calcSalaryTax(long employeeId, Period period, Period prevPeriod){
        double pph21KurangBayarBulanTerhitung = 0.0;
        double pph21KurangBayarBulanTerhitungWONonRutin = 0.0;
        double pph21 = 0.0;
        ...
        try {
            ...
            if (gUPComponent != null && gUPComponent.length() > 0 && pph21 > 0) {
                ...
                double totalPPh = pph21KurangBayarBulanTerhitung + pph21NonRutin;
                pajak.setHtmlDetailCalc(pajak.getHtmlDetailCalc() + "<tr><td>Q. " + TITLE_PPH21_THIS_PERIOD + " = ( P - Q ) / C </td><td>:</td><td>" + Formater.formatNumber(totalPPh, FORMAT_DECIMAL) + "</td></tr>");
                updateSlipComp(payPeriod.getOID(), employeeId, totalPPh);
                if (nilaiGUPTax != pph21KurangBayarBulanTerhitung) { // di bulatkan dengan even terlebih dahulu ....

                    //set nilai gross Up component =  pph21KurangBayarBulanTerhitung;
                    setGrossUpValue(paySlipId, gUPComponent, pph21KurangBayarBulanTerhitung);
                    pph21KurangBayarBulanTerhitung = calcSalaryTaxBPDBeforeMBT(employeeId, payPeriod, prevPeriod, pajak);
                    setGrossUpValue(paySlipId, gUPComponent, pph21KurangBayarBulanTerhitung);
    ...
    public static double getGrossUpValueByPayslip(long employeeId, long oidPaySlip, String gUPComponent) {
        double compValue = 0;
        DBResultSet dbrs = null;

        try {

            String sql = "SELECT " + PstPaySlipComp.fieldNames[PstPaySlipComp.FLD_COMP_VALUE]
                    + " FROM " + PstPaySlipComp.TBL_PAY_SLIP_COMP
                    + " WHERE " + PstPaySlipComp.fieldNames[PstPaySlipComp.FLD_PAY_SLIP_ID] + "=" + oidPaySlip
                    + " AND " + PstPaySlipComp.fieldNames[PstPaySlipComp.FLD_COMP_CODE] + "= \"" + gUPComponent + "\"";
    ...
    public static double getTaxNonRutinValue(long employeeId, PayPeriod payPeriod, String taxNonRutinComp) {
        double compValue = 0;
        DBResultSet dbrs = null;
        ...
        try {
            ...
            String sql = "SELECT PAY." + PstPaySlipComp.fieldNames[PstPaySlipComp.FLD_COMP_VALUE]
                    ...
                    + " WHERE SLIP." + PstPaySlip.fieldNames[PstPaySlip.FLD_PERIOD_ID] + "=" + payPeriod.getOID()
                    + " AND SLIP." + PstPaySlip.fieldNames[PstPaySlip.FLD_EMPLOYEE_ID] + "=" + employeeId
                    + " AND PAY." + PstPaySlipComp.fieldNames[PstPaySlipComp.FLD_COMP_CODE] + "= \"" + taxNonRutinComp + "\"";
    ...
    public static double getTaxNonRutinValueByPayslip(long employeeId, long oidPaySlip, String taxNonRutinComp) {
        double compValue = 0;
        DBResultSet dbrs = null;
        ...
        try {
            ...
            String sql = "SELECT " + PstPaySlipComp.fieldNames[PstPaySlipComp.FLD_COMP_VALUE]
                    + " FROM " + PstPaySlipComp.TBL_PAY_SLIP_COMP
                    + " WHERE " + PstPaySlipComp.fieldNames[PstPaySlipComp.FLD_PAY_SLIP_ID] + "=" + oidPaySlip
                    + " AND " + PstPaySlipComp.fieldNames[PstPaySlipComp.FLD_COMP_CODE] + "= \"" + taxNonRutinComp + "\"";
    ...
    public static long getPayslipOID(long employeeId, PayPeriod payPeriod) {
        long compValue = 0;
        DBResultSet dbrs = null;
    ...
    public static int setTaxNonRutinValue(long paySLipId, String taxNonRutinComp, double value) {
        try {
            String sql = " UPDATE  pay_slip_comp SET `COMP_VALUE` = " + value
                    + " WHERE `PAY_SLIP_ID` = " + paySLipId + " AND `COMP_CODE` = \"" + taxNonRutinComp + "\"";
...
//        }
    ...
    private static void updateSlipCompMBT(long periodId, long employeeId, double pph21) {
        long paySlipId = 0;
        String whereSlip = " EMPLOYEE_ID=" + employeeId + " AND PERIOD_ID=" + periodId + " ";
        Vector listPaySlip = PstPaySlip.list(0, 0, whereSlip, "");
        if (listPaySlip != null && listPaySlip.size() > 0) {
        ...
        String whereClause = " PAY_SLIP_ID=" + paySlipId + " AND COMP_CODE='PPH21MBT' ";
        /* SELECT * FROM pay_slip_comp WHERE PAY_SLIP_ID=504404593041301260 AND COMP_CODE='PPH21' */
        Vector listPaySlipComp = PstPaySlipComp.list(0, 0, whereClause, "");
        if (listPaySlipComp != null && listPaySlipComp.size() > 0) {
            PaySlipComp paySlipComp = new PaySlipComp();
