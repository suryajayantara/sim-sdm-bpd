    ...
    public static Vector searchOvertime(SrcOvertime srcOvertime, int start, int recordToGet) {
        ...
        try {
            String sql = " SELECT OV." + PstOvertime.fieldNames[PstOvertime.FLD_OVERTIME_ID]
                    ...
                    + ", OV." + PstOvertime.fieldNames[PstOvertime.FLD_APPROVAL_1_ID]
                    + ", OV." + PstOvertime.fieldNames[PstOvertime.FLD_APPROVAL_2_ID]
                    + ", OV." + PstOvertime.fieldNames[PstOvertime.FLD_APPROVAL_3_ID]
                    + ", OV." + PstOvertime.fieldNames[PstOvertime.FLD_APPROVAL_4_ID]
                    + ", OV." + PstOvertime.fieldNames[PstOvertime.FLD_APPROVAL_5_ID]
                    + ", OV." + PstOvertime.fieldNames[PstOvertime.FLD_APPROVAL_6_ID]
			...
			if (!srcOvertime.getNotIn().equals("")) {
                whereClause = whereClause + " OV." + PstOvertime.fieldNames[PstOvertime.FLD_OVERTIME_ID]
                        + " NOT IN (" + srcOvertime.getNotIn() + ") AND ";
            }
