...
public class PstPerkiraan extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language, I_ChartOfAccountGroup {
    ...
    public static final int FLD_KODE_PERKIRAAN = 16;
    ...
    public static Perkiraan fetchExc(long oid) throws DBException {
        try {
            ...
            perkiraan.setKodePerkiraan(pPerkiraan.getString(FLD_KODE_PERKIRAAN));
            return perkiraan;
    ...
    public static long insertExc(Perkiraan perkiraan) throws DBException {
        try {
            ...
            pPerkiraan.setString(FLD_KODE_PERKIRAAN, perkiraan.getKodePerkiraan());
            pPerkiraan.insert();
    ...
    private static void resultToObject(ResultSet rs, Perkiraan perkiraan) {
        try {
            ...
            perkiraan.setKodePerkiraan(rs.getString(fieldNames[FLD_KODE_PERKIRAAN]));
        } catch (Exception e) {
        ...
        try {
            ...
            while (firstLoop || !stack.empty()) {
                ...
                while (rs.next()) {
                    ...
                    account.setKodePerkiraan(rs.getString(PstPerkiraan.fieldNames[PstPerkiraan.FLD_KODE_PERKIRAAN]));
                    stack.push(account); 
                    numRow++;
                }
                if(numRow>0){
