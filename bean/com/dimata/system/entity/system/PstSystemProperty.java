...
//update by satrya 2013-02-15
        ...
        try {        
          ...
          //  System.out.println("SYSTEM : "+sql);
            ...
            while(rs.next()) {   
                ...
                val= sysProp.getValue();//""+rs.getLong(1); //val = rs.getString(1);
                break;
            }
            rs.close();
            return val;
    ...
    private static void resultToObject(ResultSet rs, SystemProperty sysProp) {
        try {
            sysProp.setOID(rs.getLong(fieldNames[FLD_SYSPROP_ID] /*+ 1*/));
            sysProp.setName(rs.getString(fieldNames[FLD_NAME] /*+ 1*/));
            sysProp.setValue(rs.getString(fieldNames[FLD_VALUE] /*+ 1*/));
            sysProp.setValueType(rs.getString(fieldNames[FLD_VALTYPE] /*+ 1*/));
            sysProp.setDisplayType(rs.getString(fieldNames[FLD_DISTYPE] /*+ 1*/));
            sysProp.setGroup(rs.getString(fieldNames[FLD_GROUP] /*+ 1*/));
            sysProp.setNote(rs.getString(fieldNames[FLD_NOTE] /*+ 1*/));
